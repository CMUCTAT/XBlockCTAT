...
(function(a) {
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      for (var e = {}, g = b.olson.dst_rules.zones, k = g.length, l = a[f], y = 0;y < k;y++) {
        var B = g[y], C;
        C = g[y];
        for (var q = 0, x = 0;x < d.length;x++) {
          if (C.rules[x] && d[x]) {
            if (d[x].s >= C.rules[x].s && d[x].e <= C.rules[x].e) {
              q = 0, q += Math.abs(d[x].s - C.rules[x].s), q += Math.abs(C.rules[x].e - d[x].e);
            } else {
              q = "N/A";
              break;
            }
      ...
      for (var u in e) {
        if (e.hasOwnProperty(u) && -1 != l.indexOf(u)) {
          return u;
        }
      }
      return f;
      ...
      var d = function() {
        for (var a = [], d = 0;d < b.olson.dst_rules.years.length;d++) {
          ...
          for (var g = (new Date(c)).getTimezoneOffset(), k = null, h = null;c < e - 864E5;) {
            var l = new Date(c), m = l.getTimezoneOffset();
            m !== g && (m < g && (k = l), m > g && (h = l), g = m);
            c += 864E5;
          }
          e = k && h ? {s:f(k).getTime(), e:f(h).getTime()} : !1;
          a.push(e);
        }
        return a;
      }();
...
(function(a, b) {
  ...
  function c(a, b, d, f) {
    ...
    n[e] || (t.insertRule("@" + (c && "-" + c + "-" || "") + "keyframes " + e + "{0%{opacity:" + f + "}" + d + "%{opacity:" + a + "}" + (d + .01) + "%{opacity:1}" + (d + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + f + "}}", t.cssRules.length), n[e] = 1);
    return e;
  }
  function e(a, b) {
    var d = a.style, f, e;
  ...
  function l() {
    ...
    h.prototype.lines = function(a, e) {
      function c() {
        return g(d("group", {coordsize:l + " " + l, coordorigin:-h + " " + -h}), {width:l, height:l});
      }
      function k(a, l, p) {
        b(r, b(g(c(), {rotation:360 / e.lines * a + "deg", left:~~l}), b(g(d("roundrect", {arcsize:e.corners}), {width:h, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:p}), d("fill", {color:f(e.color, a), opacity:e.opacity}), d("stroke", {opacity:0}))));
      }
      var h = e.scale * (e.length + e.width), l = 2 * e.scale * h, p = -(e.width + e.length) * e.scale * 2 + "px", r = g(c(), {position:"absolute", top:p, left:p});
      if (e.shadow) {
        for (p = 1;p <= e.lines;p++) {
          k(p, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
        }
      }
      for (p = 1;p <= e.lines;p++) {
        k(p);
  ...
  var k = ["webkit", "Moz", "ms", "O"], n = {}, m, t, r = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!m) {
      var c = 0, k = (f.lines - 1) * (1 - f.direction) / 2, h, l = f.fps, p = l / f.speed, r = (1 - f.opacity) / (p * f.trail / 100), n = p / f.lines;
      (function F() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          h = Math.max(1 - (c + (f.lines - a) * n) % p * r, f.opacity), d.opacity(e, a * f.direction + k, h, f);
        }
        d.timeout = d.el && setTimeout(F, ~~(1E3 / l));
      })();
    }
    return d;
  }, stop:function() {
    ...
    for (var h = 0, l = (e.lines - 1) * (1 - e.direction) / 2, p;h < e.lines;h++) {
      p = g(a(), {position:"absolute", top:1 + ~(e.scale * e.width / 2) + "px", transform:e.hwaccel ? "translate3d(0,0,0)" : "", opacity:e.opacity, animation:m && c(e.opacity, e.trail, l + h * e.direction, e.lines) + " " + 1 / e.speed + "s linear infinite"}), e.shadow && b(p, g(k("#000", "0 0 4px #000"), {top:"2px"})), b(d, b(p, k(f(e.color, h), "0 0 1px rgba(0,0,0,.1)")));
    }
    return d;
  ...
  if ("undefined" !== typeof document) {
    ...
    var p = g(a("group"), {behavior:"url(#default#VML)"});
    !e(p, "transform") && p.adj ? l() : m = e(p, "animation");
  }
  return h;
});
  ...
  this.addSelectorAttribute = function(a, b, d) {
    ...
    a: {
      if (0 === c) {
        ...
        for (var g = 0;g < e.length && null !== e[g][0];g++) {
          if (e[g][0] == a) {
            a = g;
            break a;
          }
...
function CTATXBlock(a, b) {
  ...
  $(function(a) {
    ...
    c.runXBlockDiagnostics(window, "window");
  ...
  this.translateResourceFile = function(a) {
    c.ctatdebug("translateResourceFile (" + a + ")");
  };
}
...
;var CTATGlobalFunctions = {stringToBoolean:function(a) {
  ...
  return window["data-params"] ? jQuery.parseJSON(window["data-params"]) : {admit_code:"ies", authenticity_token:"none", auth_token:"none", BehaviorRecorderMode:"AuthorTimeTutoring", class_name:"", curriculum_service_url:"", dataset_level_name:"", dataset_level_name1:"Unit1", dataset_level_type1:"unit", dataset_level_type:"ProblemSet", dataset_name:"FlashLoggingTest_xxx", expire_logout_url:"none", info:"", instructor_name:"none", instrumentation_log:"off", lcId:"none", Logging:"None", log_service_url:"http://pslc-qa.andrew.cmu.edu/log/server", 
  log_to_disk_directory:".", keyboard:"disabled", problem_name:"xxx", problem_position:"none", problem_started_url:"none", problem_state_status:"empty", question_file:"", refresh_session_url:"none", remoteSocketPort:"80", remoteSocketURL:"http://localhost", restore_problem_url:"none", reuse_swf:"false", run_problem_url:"none", school_name:"none", SessionLog:"true", session_id:"none", session_timeout:"none", skills:"", source_id:"PACT_CTAT_HTML5", student_interface:"none", student_problem_id:"none", 
  study_condition_name:"", study_condition_type:"", study_condition_description:"", study_name:"Study1", target_frame:"none", TutorShopDeliveryMethod:"sendandload", tutoring_service_communication:"javascript", user_guid:"qa-test", wmode:"opaque", DeliverUsingOLI:!1, ssl:"off", sui:"", centerTutor:!1, previewMode:!1, width:550, height:450};
...
var CTATGraphicsTools = function(a, b, c, e, g, d) {
  ...
  var f = b || 1, h = c || "#000000", l = e || "#EEEEEE", k = g || !1, n = "Arial", m = a || null;
  a = d || !1;
  var t = 0, r = this;
  if (null == m) {
  ...
  this.drawText = function(a, b, d) {
    if (null != m) {
      ...
      b += t;
      try {
        m.fillStyle = h, m.font = n + " 12pt", m.fillText(d, a, b);
      } catch (e) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTextFormatted = function(a, b, d, e, f, c, g, k, h, l) {
    if (null != m) {
      a += t;
      b += t;
      e = "";
...
;var CTATShape = function(a, b, c, e, g, d) {
  ...
  var h = [], l = [], k = g, n = d, m = b, t = void 0, r = "black", p = "black", w = "Arial", v = 12, y = [], B = 1, C = 5, q = document.createElement("canvas");
  q.id = m;
  q.width = k;
  q.height = n;
  var x = new CTATCSS;
  x.addCSSAttribute("position", "absolute");
  x.addCSSAttribute("left", c + "px");
  x.addCSSAttribute("top", e + "px");
  x.addCSSAttribute("visibility", "visible");
  x.addCSSAttribute("background-color", "rgba(0, 0, 0, 0)");
  x.addCSSAttribute("border-style", "none");
  q.setAttribute("style", x.toCSSString());
  getSafeElementById(a).appendChild(q);
  var u = new CTATGraphicsTools(q.getContext("2d"));
  u.setGraphicBorderWidth(B);
  u.setLineColor(r);
  u.setFillColor(p);
  ...
  this.setXPoints = function(a) {
    h = a;
    x.modifyCSSAttribute("left", h[0] + "px");
    q.setAttribute("style", x.toCSSString());
  };
  this.setYPoints = function(a) {
    l = a;
    x.modifyCSSAttribute("top", l[0] + "px");
    q.setAttribute("style", x.toCSSString());
  };
  ...
  this.shapeMagicTrigFunctionX = function(a) {
    u.magicTrigFunctionX(a);
  };
  this.shapeMagicTrigFunctionY = function(a) {
    u.magicTrigFunctionY(a);
  };
  this.drawLine = function() {
    u.drawLine(h[0] + B, l[0] + B, h[1], l[1], r, B);
  };
  this.drawCircle = function() {
    u.drawCircle(h[0] + C, l[0] + C, C);
  };
  this.drawCircleFilled = function() {
    u.drawCircleFilled(h[0] + C, l[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, d, e) {
    u.drawRectangle(a[0] + B, b[0] + B, k - B, n - B);
  };
  this.drawRectangleFilled = function() {
    u.drawRectangleFilled(h[0], l[0], k, n);
  };
  this.drawRoundedRect = function() {
    u.drawRoundedRect(h[0] + B, l[0] + B, k - C - B, n - C - B, C);
  };
  this.drawRoundedRectFilled = function() {
    u.drawRoundedRectFilled(h[0] + B, l[0] + B, k - C - B, n - C - B, C);
  };
  this.drawText = function() {
    u.drawText(v / 2, v / 2, t);
  };
  this.drawTriangle = function() {
    u.drawTriangle(h[0] + B, l[0] + B, h[1], l[1], h[2], l[2]);
  };
  this.drawTriangleFilled = function() {
    u.drawTriangleFilled(h[0], l[0], h[1], l[1], h[2], l[2]);
  };
  this.save = function() {
    u.save();
  };
  ...
  this.erase = function() {
    ...
    for (var b = 0;b < y.length;b++) {
      q.addEventListener(y[b][0], y[b][1]);
    }
  };
};
var CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (u.ctatdebug("errScrimUp (" + a + ")"), 1 == g ? 1 == r && (r = !1, getSafeElementById(ctatcontainer).removeChild(q)) : 1 == f && (r = !0), u.scrimUp(a));
  }
  function c(a, b) {
    u.ctatdebug("makeHTMLButton ()");
    var d = document.createElement("input");
    d.type = "button";
    d.value = b;
    null != a ? (u.ctatdebug("clickHandle!=null"), d.onclick = a) : (u.ctatdebug("clickHandle==null"), d.onclick = u.defaultClickHandler);
    d.id = b;
    d.setAttribute("class", "scrimButton");
    return d;
  }
  CTATBase.call(this, "CTATScrim", "__undefined__");
  var e = !1, g = !1, d = !0, f = !1, h = !1, l = !0, k = !0, n = "", m = !1, t = !1, r = !1, p = null, w = null, v = new CTATCanvasComponent("CTAT Scrim"), y = [], B = null, C = null, q = null, x = null, u = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (u.ctatdebug("scrimUp ()"), u.ctatdebug("Message: " + b), 1 == e ? (n = 1 == d ? b : n + (" \n " + b), v.removeComponent()) : (n = b, e = !0), u.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        u.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + n + "<br><br></div></div></div>\t\t"), !0 === r && (q = c(a, "close"), $(q).appendTo("#scrimpanel")), !0 === m && (B = c(p, "yes"), $(B).appendTo("#scrimpanel")), !0 === t && (C = c(w, "no"), $(C).appendTo("#scrimpanel")), 
        1 == d)) {
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (u.ctatdebug("waitScrimUp ()"), d = !0, u.scrimUp("Please wait while the tutor is being loaded"));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (u.ctatdebug("nextProblemScrimUp ()"), u.scrimUp("Retrieving the Next Problem..."));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (u.ctatdebug("OKScrimUp (" + a + "," + b + ")"), u.scrimUp(a), x = c(b, spaceUsedUp, "OK"), $(x).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (u.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), t = m = !0, w = d, p = b, u.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == l ? (u.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), y.push("ERROR: " + a), g = !0) : 0 == k ? u.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (g = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == l ? (u.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), y.push("WARNING: " + a), f = !0) : 0 == k ? u.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (f = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    h = !0;
    u.scrimUp("The tutor has disconnected. Please refresh the page.");
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == e ? u.ctatdebug("The scrim isn't up, returning") : 1 == g ? u.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == f ? u.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == h ? u.ctatdebug("The scrim is up for a connection issue leave it up!") : ($("#scrim").remove(), v.removeComponent(), d = e = !1, n = ""));
  };
  this.defaultClickHandler = function() {
    u.ctatdebug("defaultClickHandler ()");
    u.scrimDown();
  };
  this.setInAuthorTime = function(a) {
    u.ctatdebug("setting inAuthorTime = " + a);
    l = !0;
    k = a;
    if (!a) {
...
var CTATWSConnection = function(a) {
  ...
  var b = -1, c = "", e = "", g = !1, d = this, f = null, d = this, h = [], l = !1, k = 0, n = 0, m = null;
  this.setConsumed = function(a) {
    g = a;
  ...
  this.init = function() {
    ...
    f.addEventListener("message", function(a) {
      ...
      d.ctatdebug("Received: " + a.data + " <b>(" + (n - k) + "ms)</b>");
      m ? m() : d.ctatdebug("Error: no processing function provided");
    });
  ...
  this.send = function() {
    d.ctatdebug("send ()");
    0 == l ? (d.ctatdebug("Connection not ready yet, storing ..."), h.push(e)) : (d.ctatdebug("Connection ready, sending data ..."), k = (new Date).getTime(), f.send(e));
  };
};
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var e = "", g = 0, d = [], f = a ? a : null, h = null == b ? !0 : b, l = !0, k = null, n = c ? c : {}, m = this;
  ...
  this.send_post = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      try {
        ...
        m.ctatdebug("Error in newConnection.httpObject.open: " + f.message);
        return;
      }
      try {
        e.init();
      } catch (f) {
        m.ctatdebug("Error in newConnection.init: " + f.message);
        return;
      }
      e.send();
    }
  ...
  this.checkEntries = function() {
    ...
    for (var a = 0, b = 0, b = 0;b < d.length;b++) {
      ...
      var f = e.getHTTPObject();
      m.ctatdebug("Check, readyState: " + f.readyState + ", consumed: " + e.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, d) {
    ...
    e.onreadystatechange = function() {
      ...
      if (4 == e.readyState && 200 == e.status) {
        var f = null;
        e.responseXML ? (m.ctatdebug("parsing brd xml using something else"), f = e.responseXML.documentElement) : (m.ctatdebug("parsing brd xml using node"), f = (b = new CTATXML).parseXML(e.responseText));
        null == f ? (f = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), m.ctatdebug("error parsing xmlFile " + a + ": " + f), CTAT.ToolTutor.sendToInterface(f, !0)) : d.processXML(f);
      }
    };
    e.onerror = function() {
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, e = !1, g = !1, d = [], f = "undefined", h = "undefined", l = "undefined", k = "undefined", n = "undefined", m = "undefined", t = "undefined", r = "undefined", p = "UnassignedDataset", w = "UnassignedLevelName", v = "UnassignedLevelType", r = (new CTATGuid).guid();
  void 0 != a && null != a ? (e = a, 0 == e && (commLogMessageBuilder = new CTATLogMessageBuilder)) : commLogMessageBuilder = new CTATLogMessageBuilder;
  var y = new CTATCommLibrary;
  y.setName("commLoggingLibrary");
  y.setUseCommSettings(!1);
  y.assignHandler(this);
  ...
  this.setupExternalLibraryUsage = function() {
    ...
    d.session_id = "ctat_session_" + a.guid();
    d.source_id = "tutor";
    d.dataset_level_name1 = w;
    d.dataset_level_type1 = v;
  ...
  this.logSemanticEvent = function(a, d, c, f, e, k) {
    b.ctatdebug("logSemanticEvent ()");
    b.initCheck();
    var g = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(e, k);
    commLogMessageBuilder.addCustomField("tool_event_time", commLogMessageBuilder.formatTimeStamp(g) + " UTC");
    a = commLogMessageBuilder.createSemanticEventToolMessage(d, a, c, f, !0);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, d, c, f, e, k, g, h, l) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var m = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(h, l);
    commLogMessageBuilder.addCustomField("tutor_event_time", commLogMessageBuilder.formatTimeStamp(m) + " UTC");
    b.ctatdebug("Formatting feedback ...");
    h = "";
    void 0 != k && null != k ? -1 != k.indexOf("'") || -1 != k.indexOf('"') || -1 != k.indexOf("<") || -1 != k.indexOf(">") || -1 != k.indexOf("&") ? (b.ctatdebug("Feedback message contains invalid characters, wrapping in CDATA ..."), h = "<![CDATA[" + k + "]]\x3e") : (b.ctatdebug("Feedback message doesn't contain any invalid characters, using as-is"), h = k) : (b.ctatdebug("No feedback provided, using empty string"), h = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(d, a, c, e, h, f, g, !0);
    this.sendMessage(a);
  };
  ...
  this.logResponse = function(a, d, c, f, e, k, g, h) {
    b.ctatdebug("logResponse ()");
    d = new CTATSAI(d, c, f);
    d.setInput(f);
    f = new CTATActionEvaluationData("");
    f.setEvaluation(k);
    void 0 == h ? this.logTutorResponse(a, d, e, "", f, g) : this.logTutorResponse(a, d, e, "", f, g, h.getCustomElementNames(), h.getCustomElementTypes());
  };
  this.logResponseSAI = function(a, d, c, f, e, k) {
    b.ctatdebug("logResponse ()");
    var g = new CTATActionEvaluationData("");
    g.setEvaluation(f);
    void 0 == k ? this.logTutorResponse(a, d, c, "", g, e) : this.logTutorResponse(a, d, c, "", g, e, k.getCustomElementNames(), k.getCustomElementTypes());
  };
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var f = c || 0, h = e || 0, l = g || -2, k = d || -2, n = 50, m = 25, t = !1, r = "", p = !1, w = !0, v = null, y = "", B = -1;
  this.isTabIndexable = !0;
  var C = 0, q = null, x = null, u = this, D = null, A = "hidden", z = CTATGlobalFunctions.gensym.z_index(), E = CTATGlobalFunctions.gensym.div_id(), F = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.setZIndex = function(a) {
    u.ctatdebug("Setting z index to: " + a);
    C = a;
    null !== v && (v.style.zIndex = a);
  };
  ...
  this.processCommShellEvent = function(a, b) {
    u.ctatdebug("processCommShellEvent (" + a + ")");
  };
  this.makeDivWrapper = function(a) {
    v = document.createElement("div");
    v.id = this.getName();
    v.setAttribute("onkeypress", "return noenter(event)");
    v.setAttribute("data-ctat-component", this.getClassName());
    v.style.position = "absolute";
    v.style.left = f + "px";
    v.style.top = h + "px";
    v.style.zIndex = z;
    v.style.width = u.getWidth() + "px";
    v.style.height = u.getHeight() + "px";
    $(v).data("CTATComponent", this);
    a.appendChild(v);
  };
  ...
  this.setClassName = function(a) {
    K(a);
    v && v.setAttribute("data-ctat-component", this.getClassName());
  };
  this.wrapComponent = function(a) {
    u.ctatdebug("wrapComponent ()");
    u.makeDivWrapper(a);
    u.ctatdebug("wrapComponent () done");
  };
  this.createCanvas = function() {
    u.ctatdebug("createCanvas ()");
    ...
    D.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == A ? "visibility: hidden; " : "") + "z-index:" + F + ";");
    v.firstChild ? v.insertBefore(D, v.firstChild) : v.appendChild(D);
    return D;
  };
  this.redraw = function() {
    var a = v.style.display;
  ...
  this.getWidth = function() {
    if (0 >= l) {
      var a;
      q ? a = window.getComputedStyle(q) : v && (a = window.getComputedStyle(v));
      if (a) {
  ...
  this.getHeight = function() {
    if (0 >= k && v) {
      var a = window.getComputedStyle(v);
  ...
  this.setEnabled = function(a) {
    ...
    u.assignEnabled(a);
    q ? q.disabled = !w : u.ctatdebug("Error: component pointer is null");
  };
  this.lock = this.setEnabled.bind(u, !1);
  this.unlock = this.setEnabled.bind(u, !0);
  ...
  this.init = function() {
    u.ctatdebug("THIS IS THE BASE INIT METHOD");
  };
  this.initialize = function() {
    u.ctatdebug("initialize ()");
    u.configFromDescription();
    u.init();
    u.processSerialization();
    u.render();
    u.processTabOrder();
    u.ctatdebug("initialize () done");
  };
  this.getInitialized = function() {
    return p;
  };
  this.setInitialized = function(a) {
    u.ctatdebug("setInitialized (" + a + ")");
    p = a;
    !0 !== p || v ? u.ctatdebug("Not wrapping, initialized=" + p + ", divWrapper = " + v) : (u.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (u.ctatdebug("Attaching component to existing MovieClip ..."), u.wrapComponent(a.getDivWrapper())) : (u.ctatdebug("Attaching component to main div ..."), $("#" + ctatcontainer).first() && u.wrapComponent(getSafeElementById(ctatcontainer))));
    u.ctatdebug("setInitialized () done");
  };
  this.addSafeEventListener = function(a, b, d) {
    u.ctatdebug("addSafeEventListener (" + a + ")");
    u.ctatdebug("Adding event listener to: " + d);
    d ? d.addEventListener(a, b) : (q ? (u.ctatdebug("Adding eventlistener to component instead of target"), q.addEventListener(a, b)) : u.ctatdebug("Error: pointer to component is null, can't add event listener"), u.ctatdebug("addSafeEventListener () done"));
  };
  this.drawComponent = function() {
  };
  this.addComponentReference = function(a, b) {
    u.ctatdebug("addComponentReference (" + a.getName() + " -> " + b.getAttribute("id") + ")");
    a.tabIndex = this.getTabIndex();
    CTATComponentReference.add(a, b);
    u.ctatdebug("addComponentReference ()");
  };
  this.getComponentFromID = function(a) {
    return CTATComponentReference.getComponentFromID(a);
  };
  this.processSerialization = function() {
    u.ctatdebug("processSerialization()");
    u.ctatdebug("implement in child class");
  };
  this.move = function(a, b) {
    f = a;
    h = b;
    v && (v.style.left = f + "px", v.style.top = h + "px");
  };
  this.setSize = function(a, b) {
    u.ctatdebug("setSize (" + a + "," + b + ")");
    this.setWidth(a);
    this.setHeight(b);
  };
  this.SetVisible = this.setVisible = function(a) {
    ...
    A = !0 === a ? "block" : "hidden";
    D && D.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + f + "px; top:" + h + "px; z-index:" + F + ";");
    v.style.visibility = !0 === a ? null : "hidden";
  };
  ...
  this.processOnFocus = function() {
    u.ctatdebug("processOnFocus (" + u.getName() + ")");
    ...
    CTATGlobals.Tab.Focus != u ? (u.ctatdebug("CTATGlobals.Tab.Focus!=pointer, updating CTATGlobals.Tab.Focus ..."), CTATGlobals.Tab.Focus = u) : u.ctatdebug("CTATGlobals.Tab.Focus==pointer");
    u.ctatdebug("processOnFocus () done");
  };
  this.processFocus = function(a) {
    useDebugging = !0;
    u.ctatdebug("processFocus ()");
    a.currentTarget.getAttribute("id");
    if (u) {
      mobileAPI && !0 === mobileAPI.getEnabled() && u.hideKeyboard();
      commShell && commShell.processComponentFocus(u);
      if (CTATGlobals.Tab.Focus) {
        u.ctatdebug("old focus: " + CTATGlobals.Tab.Focus.getName() + ", new focus:" + u.getName());
        if (CTATGlobals.Tab.Focus == u) {
          u.ctatdebug("We're already there!");
          return;
        }
        CTATGlobals.Tab.Focus.backgrade && CTATGlobals.Tab.Focus.processAction();
      } else {
        u.ctatdebug("No previously focused component yet, can't grade");
      }
      "hint" == u.getClassName() || "CTATHintButton" == u.getClassName() ? u.ctatdebug("Info: focus moved to hint, bump") : (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = u, u.ctatdebug("processFocus () done"));
    } else {
      u.ctatdebug("Error: component reference is null");
    }
  };
  this.processTabOrder = function() {
    u.ctatdebug("processTabOrder (" + B + ")");
    !0 === t ? u.ctatdebug("Component is an abstract component, bump") : q ? (u.ctatdebug("We have a component, actually assigning to html component ..."), q.tabIndex = B, q.onfocus = u.processOnFocus) : u.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
var CTATMovieClip = function(a, b, c, e, g) {
  ...
  this.wrapComponent = function(a) {
    ...
    n.setAttribute("id", f);
    n.setAttribute("name", this.getName());
    n.setAttribute("style", "z-index: " + d);
    n.setAttribute("width", e + "px");
    n.setAttribute("height", g + "px");
    n.setAttribute("style", "border: 0px; position: absolute; left:" + b + "px; top:" + c + "px; z-index:" + h + ";");
    a.appendChild(n);
    return n;
  };
...
var CTATSkill = function() {
  ...
  this.toSetPreferencesXMLString = function() {
    ...
    return f += '" pKnown="' + k + '" category="' + c + '" pLearn="' + n + '" name="' + a + '" pGuess="' + h + '" />';
  };
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var l = CTATGlobals.Visual.BackgroundColor, k = "white", n = 1, m = CTATGlobals.Visual.BorderColor, t = !1, r = "solid", p = 0, w = "1px", v = 0, y = CTATGlobals.Font.color, B = "black", C = CTATGlobals.Font.family, q = CTATGlobals.Font.size, x = !1, u = !1, D = !1;
  ...
  this.getBorderRoundness = function() {
    return this.component ? $(this.component).css("border-radius") : p;
  };
  this.setBorderRoundness = function(a) {
    a = parseInt(a);
    p = isNaN(a) ? 0 : a;
    this.component && this.getBorderRoundness() !== p && (this.component.style.borderRadius = p);
    return this;
  };
  ...
  this.getPadding = function() {
    return this.component ? parseInt($(this.component).css("padding-left")) : v;
  };
  this.setPadding = function(a) {
    v = parseInt(a);
    isNaN(v) && (v = 0);
    this.component && this.getPadding() !== v && (this.component.style.padding = v + "px");
    return this;
  };
  ...
  this.setFontColor = function(a) {
    y = CTATGlobalFunctions.formatColor(a);
    this.component && this.getFontColor() !== y && (this.component.style.color = y);
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== t && (t ? (this.setBorderStyle(r), this.setBorderWidth(w)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getBolded = function() {
    return this.component ? "bold" === window.getComputedStyle(this.component).getPropertyValue("font-weight") : x;
  };
  this.setBolded = function(a) {
    x = CTATGlobalFunctions.stringToBoolean(a);
    this.component && this.getBolded() !== x && (this.component.style.fontWeight = x ? "bold" : null);
    return this;
  };
  this.getItalicized = function() {
    return this.component ? "italic" === window.getComputedStyle(this.component).getPropertyValue("font-style") : u;
  };
  this.setItalicized = function(a) {
    u = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getItalicized() !== u && (this.component.style.fontStyle = u ? "italic" : null);
    return this;
  };
  var A = this;
  a = function(a) {
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), c = 0;c < a.length;c++) {
            ...
            var g = document.createElement("div"), p = f.getLevel();
            .95 > p ? g.classList.add("CTAT-skill-window--bar--nonmastered") : g.classList.add("CTAT-skill-window--bar--mastery");
            g.style.width = .95 < p ? "100%" : 100 * p + "%";
            e.appendChild(g);
            b.appendChild(e);
...
var CTATSAI = function(a, b, c, e) {
  function g(a, b, d, c) {
    c = String(p.getElementName(b)).toLowerCase();
    if (c == a || "value" == c) {
      if (c = p.getElementChildren(b), !Array.isArray(c) || 1 > c.length) {
        d.push(p.getNodeTextValue(b));
      } else {
  ...
  var d = "undefined", f = "undefined", h = new CTATStringUtil, l = [], k = [], n = [], m = [], t = [], r = [], p;
  p = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.setSAI = function(a, b, c, e, k) {
  ...
  this.fromXML = function(a) {
    ...
    l = [];
    a = p.getElementChildren(a);
    for (var b = null, d = 0;d < a.length;d++) {
      var c = a[d];
      if ("selection" == p.getElementName(c) || "Selection" == p.getElementName(c)) {
        for (var f = p.getElementChildren(c), e = !1, k = 0;k < f.length;k++) {
          b = f[k], "value" == p.getElementName(b) && (b = p.getNodeTextValue(b), 1 > k ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = p.getNodeTextValue(c), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == p.getElementName(c) || "Action" == p.getElementName(c)) {
        f = p.getElementChildren(c);
        e = !1;
        for (k = 0;k < f.length;k++) {
          b = f[k], "value" == p.getElementName(b) && (b = p.getNodeTextValue(b), 1 > k ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = p.getNodeTextValue(c), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == p.getElementName(c) || "value" == p.getElementName(c) || "Input" == p.getElementName(c)) {
        var b = p.getElementChildren(c), g = null;
        l = [];
        ...
        for (var h = 0;h < b.length;h++) {
          var n = b[h];
          "value" == p.getElementName(n) && (g = p.getElementChildren(n), null !== g ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + g.length), 1 === g.length ? (g = f.htmlDecode(p.getNodeTextValue(n)), this.ctatdebug("Setting new value to: " + g), e.setValue(g)) : (g = f.htmlDecode(p.getNodeTextValue(n)), this.ctatdebug("Setting new value to: " + g), e.setValue(g), e.setName(n.attributes.getNamedItem("name").value), e.setType(n.attributes.getNamedItem("type").value), 
          e.setFormat(n.attributes.getNamedItem("format").value), k++), 1 > h ? this.setInputArray(g) : this.appendToInputArray(g)) : (n = f.htmlDecode(p.getNodeTextValue(n)), this.ctatdebug("Setting new value to: " + n), e.setValue(n), 1 > h ? this.setInputArray(n) : this.appendToInputArray(n)));
        }
      }
      if ("prompt" == p.getElementName(c) || "Prompt" == p.getElementName(c)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(p.getNodeTextValue(c));
      }
    }
    this.checkDefaultArgument();
  };
  this.setArrayFromElements = function(a) {
    if (a && Array.isArray(a) && !(1 > a.length)) {
      var b = null, d = String(p.getElementName(a[0])).toLowerCase();
      switch(d) {
        case "selection":
          b = m = [];
          break;
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == p.getElementName(c) || "Input" == p.getElementName(c)) {
        b = c.childNodes;
        l = [];
        var f = new CTATHTMLManager, e = new CTATArgument, k = 0, g = null;
        l.push(e);
        for (var h = 0;h < b.length;h++) {
          if (g = b[h], "value" == p.getElementName(g)) {
            var n = p.getElementChildren(g);
            null !== n ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + n.length), 1 === n.length ? (g = f.htmlDecode(p.getNodeTextValue(g)), this.ctatdebug("Setting new value to: " + g), e.setValue(g)) : (g = f.htmlDecode(p.getNodeTextValue(g)), this.ctatdebug("Setting new value to: " + g), e.setValue(g), e.setName(p.getElementAttr("name")), e.setType(p.getElementAttr("type")), e.setFormat(p.getElementAttr("format")), k++)) : (g = f.htmlDecode(p.getNodeTextValue(g)), this.ctatdebug("Setting new value to: " + 
            g), e.setValue(g));
            1 > h ? this.setInputArray(g) : this.appendToInputArray(g);
          }
        }
      }
      if ("prompt" == p.getElementName(c) || "Prompt" == p.getElementName(c)) {
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, f = !1, h = new CTATSkillSet, l = "", k = "", n = "", m = "", t = "", r = null, p = !1;
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == l) {
      ...
      for (c = 0;c < a.length;c++) {
        if (k = a[c], "tool_message" == e.getElementName(k)) {
          for (k = e.getElementChildren(k), g = 0;g < k.length;g++) {
            p = k[g], "event_descriptor" == e.getElementName(p) && (r = new CTATSAI, r.fromXMLInternal(p));
          }
        }
      }
      f = !0;
      ...
      if (d) {
        ...
        for (var u = e.getElementChildren(b), D = 0;D < u.length;D++) {
          var A = u[D];
          if ("event_descriptor" == e.getElementName(A)) {
            for (var A = e.getElementChildren(A), z = 0;z < A.length;z++) {
              var E = A[z];
              "selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), p.push(E));
              "action" == e.getElementName(E) && (c = e.getNodeTextValue(E), q.push(E));
              "input" == e.getElementName(E) && (k = e.getNodeTextValue(E), x.push(E));
              "prompt" == e.getElementName(E) && (g = e.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), u = e.getElementChildren(b), D = 0;D < u.length;D++) {
          if (A = u[D], "properties" == e.getElementName(A)) {
            for (A = e.getElementChildren(A), z = 0;z < A.length;z++) {
              E = A[z], this.ctatdebug("Nodename: " + e.getElementName(E)), "Skills" == e.getElementName(E) && h.parseByValue(E), "SuccessMsg" == e.getElementName(E) && (n = a = e.getNodeTextValue(E)), "BuggyMsg" == e.getElementName(E) && (m = e.getNodeTextValue(E)), "Selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), p.push(E)), "Action" == e.getElementName(E) && (c = e.getNodeTextValue(E), q.push(E)), "Input" == e.getElementName(E) && (k = e.getNodeTextValue(E), x.push(E)), "prompt" == 
              e.getElementName(E) && (g = e.getNodeTextValue(E)), "HighlightMsgText" == e.getElementName(E) && (t = e.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + k);
      "" !== a && null !== a ? (r = new CTATSAI(a, c, k, g), r.setArrayFromElements(p), r.setArrayFromElements(q), r.setArrayFromElements(x), f = !0) : (this.ctatdebug("No SAI found"), f = !1);
      this.ctatdebug("parseSAI () done, hassai: " + f + ", (" + a + "," + c + "," + k + "," + g + ")");
    }
  };
    ...
    for (var a = e.getElementChildren(b), d = 0;d < a.length;d++) {
      ...
      if ("properties" == e.getElementName(c)) {
        for (var c = e.getElementChildren(c), f = 0;f < c.length;f++) {
          var k = c[f];
          "MessageType" == e.getElementName(k) && (l = e.getNodeTextValue(k));
        }
      }
    }
...
CTAT.Component.Base.Tutorable = function(a, b, c, e, g, d, f) {
  ...
  var h = !0, l = !0, k = !0, n = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, m = !0, t = this, r = !1;
  ...
  this.getTutorComponent = function() {
    ...
    return h && l && k ? a.TUTOR : h && l && !k ? a.TUTOR_NO_FEEDBACK : !h && l ? a.DO_NOT_TUTOR : n;
  };
  ...
  this.setHintHighlight = function(a, b) {
    ...
    0 != a && (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = t, t.component.focus ? CTATGlobals.Tab.Focus.getComponent().focus() : CTATGlobals.Tab.Focus.getDivWrap().focus());
    if (p) {
...
var CTATImageButtonComponent = function(a, b, c, e, g, d, f) {
  ...
  var h = "", l = "", k = "", n = "", m = !1, t = "Image to Component", r = this;
  ...
  this.setEnabled = function(a) {
    ...
    r.assignEnabled(a);
    null === r.getComponent() ? r.ctatdebug("Error: pointer is null!") : (r.getComponent().disabled = !a, !1 === r.getEnabled() ? r.assignActiveImage(n) : r.assignActiveImage(h), r.ctatdebug("setEnabled () -> " + r.getEnabled()));
  };
...
CTAT.Component.Base.SVG = function(a, b, c, e, g, d, f) {
  ...
  this.getBoundingBox = function() {
    var a = new DOMRect(0, 0, this.getWidth(), this.getHeight()), b = this.getComponent(), d = window.getComputedStyle(b), b = parseInt(d.getPropertyValue("padding-left")), c = parseInt(d.getPropertyValue("padding-right")), f = parseInt(d.getPropertyValue("padding-bottom")), e = parseInt(d.getPropertyValue("padding-right")), g = parseInt(d.getPropertyValue("border-left-width")), h = parseInt(d.getPropertyValue("border-right-width")), v = parseInt(d.getPropertyValue("border-bottom-width")), d = parseInt(d.getPropertyValue("border-right-width"));
    a.width -= b + e + g + d;
    a.height -= c + f + h + v;
    return a;
  };
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  var l = "#FF00FF", k = 1, n = "#FF00FF", m = .2, t = "black", r = 1;
  ...
  this.setDeselectedColor = function(a) {
    ...
    for (var b = 0;b < a.length;b++) {
      a[b].setAttributeNS(null, "fill", n);
    }
  };
  ...
  this.clickHandler = function(a) {
    !0 === w.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), y(this, !a), w.setActionInput("SetPieces", w.updateValue()), w.processAction());
  };
  this.updateSAI = function() {
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = x(b), this.get_denominator() != a)) {
      var d = w.evaluate();
      w.clear();
      a = [];
      d.set_denominator(b);
  ...
  this.get_denominator = function() {
    return p.reduce(function(a, b, d, c) {
  ...
  this.change_number_pieces = function(a) {
    this.set_number_pieces(p.length + a);
  };
    ...
    if (0 !== Object.keys(D).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        ...
        if (a instanceof CTATSAI) {
          if (a.getSelection() != w.getName() && D.hasOwnProperty(a.getSelection())) {
            return D[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != w.getName() && D.hasOwnProperty(a)) {
              return D[a];
            }
          } else {
            if (a instanceof Element && a != w.getComponent() && D.hasOwnProperty(a.id)) {
              return D[a.id];
            }
          }
        }
  ...
  this.change_numerator = function(a) {
    0 !== a && (0 < a ? p.every(function(b) {
      !1 === v(b) && (y(b, !0), a--);
      return 0 < a;
    }) : (p.reverse(), p.every(function(b) {
      !0 === v(b) && (y(b, !1), a++);
      return 0 > a;
    }), p.reverse()));
  };
    ...
    if (this.baseGroup) {
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? c -= d / 2 : (f += d / 2, c = b.x + b.width >= v ? c - d / 2 : c - d);
...
var CTATJumble = function(a, b, c, e, g) {
  ...
  var d = "", f = "center", h = 0, l = 10, k = !1, n = this;
  n.setActionInput("SetOrder", d);
  var m = null;
  this.init = function() {
    n.setInitialized(!0);
    ...
    a ? (m.innerHTML = a, $(m).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      ...
      this.addEventListener("dragenter", w, !1);
      this.addEventListener("dragover", p, !1);
      this.addEventListener("dragleave", v, !1);
      this.addEventListener("drop", y, !1);
  ...
  this.init_items = function(a) {
    if (m) {
      ...
      for (var d = a.length, c = 0;c < d;c++) {
        ...
        f.addEventListener("dragenter", w, !1);
        f.addEventListener("dragover", p, !1);
        f.addEventListener("dragleave", v, !1);
        f.addEventListener("drop", y, !1);
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  var w = null, v = function(a, b, d, c) {
    ...
    this.getAxisValue = function(a) {
      return CTAT.Math.round(k + this.scalar() * this.min_loc.distance(this.getProjectedPoint(a)));
    };
  };
  this._tickmarks = [];
  this.genTickmark = function(a, b, d) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var e = document.createElementNS(f, "line"), g = w.getPosition(a), k = CTAT.Geom.Point.polar(d / 2, p.theta + Math.PI / 2).add(g);
      d = CTAT.Geom.Point.polar(-d / 2, p.theta + Math.PI / 2).add(g);
      e.setAttributeNS(null, "x1", k.x);
      e.setAttributeNS(null, "y1", k.y);
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            k = "" + String(a.denominator);
            g.style.fontSize = "0.6em";
            g.setAttributeNS(null, "text-align", "center");
            var h = document.createElementNS(f, "tspan"), l = document.createElementNS(f, "tspan");
            ...
            b.length > k.length ? h.style.textDecoration = "underline" : l.style.textDecoration = "overline";
  ...
  var y = function(a) {
    ...
    var k = document.createDocumentFragment(), h = document.createElementNS(f, "g");
    ...
    k.appendChild(h);
    if (0 < a) {
      for (g.set(c).reduce();g <= n;) {
        g >= m && h.appendChild(p.genTickmark(g, e, b)), g = g.add(a);
      }
      g.set(c).reduce();
      for (g = g.subtract(a);g >= m;) {
        g <= n && h.appendChild(p.genTickmark(g, e, b)), g = g.subtract(a);
      }
    }
    return k;
  }.bind(this), C = null, q = function() {
    var a = this.getBoundingBox(), a = CTAT.Geom.Rectangle.inflate(a, -2, -2), b = new DOMPoint(a.width / 2, a.height / 2), d = b.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, p.theta)), c = Math.sin(p.theta), e = -Math.cos(p.theta), g = c * b.x + e * b.y, k = -a.height * e, r = -c * a.width, B = new DOMPoint(a.left, b.y), b = new DOMPoint(a.right, b.y);
    if (0 < Math.abs(CTAT.Math.round(k))) {
      var k = new DOMPoint(a.left, (g - c * a.left) / e), u = new DOMPoint(a.right, (g - c * a.right) / e);
      if (a.contains(k) || a.contains(u)) {
        d.distance(k) < d.distance(u) ? (B = u, b = k) : (B = k, b = u);
      }
    }
    ...
    c.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(B) + ") rotate(" + p.getOrientation() + ")");
    d.appendChild(c);
    B = document.createElementNS(f, "path");
    B.setAttributeNS(null, "d", "M -10,6 L 0,0 L -10,-6");
    B.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(b) + ") rotate(" + p.getOrientation() + ")");
    d.appendChild(B);
    this._tickmarks = [];
    a.appendChild(y(h));
    a.appendChild(y(l));
    ...
    a.appendChild(C);
    p.baseGroup.innerHTML = "";
    p.baseGroup.appendChild(a);
    B = this.theta + Math.PI / 2;
    CTAT.Geom.Point.polar(3, B);
    CTAT.Math.round(Math.cos(B));
    CTAT.Math.round(Math.sin(B));
  }.bind(this), x = null, u = 0, D = new DOMPoint(-30, -30), A = !1, z = function(a) {
    D.x = a.clientX;
    D.y = a.clientY;
  }, E = function(a) {
    ...
    if (!0 === p.getEnabled()) {
      p.setHintHighlight(!1);
      var b;
      r ? (b = K(a.clientX, a.clientY), a = b.location, b = b.data) : (b = G(a.clientX, a.clientY), a = w.getProjectedPoint(b), b = w.getAxisValue(b));
      ...
      x.innerHTML = "";
      x.appendChild(d);
      p.setActionInput("AddPoint", b.toString());
      p.processAction();
    }
  };
  this.init = function() {
    ...
    this.getComponent().appendChild(this.baseGroup);
    q();
    x = document.createElementNS(f, "g");
    x.setAttributeNS(null, "fill", "black");
    x.setAttributeNS(null, "stroke-width", 1);
    x.setAttributeNS(null, "stroke", "black");
    this.baseGroup.appendChild(x);
    p.addComponentReference(p, p.getDivWrap());
    p.addSafeEventListener("mousemove", z);
    p.addSafeEventListener("mouseleave", E);
    p.addSafeEventListener("mouseenter", function() {
      !0 === p.getEnabled() && (A = !0, C.style.fillOpacity = null, u = requestAnimationFrame(H));
    });
    p.addSafeEventListener("click", F);
    this.component.addEventListener("focus", this.processFocus);
  };
  var G = function(a, b) {
    this.svgPoint = this.svgPoint ? this.svgPoint : p.getComponent().createSVGPoint();
    this.svgPoint.x = a;
    this.svgPoint.y = b;
    var d = p.getComponent().getScreenCTM().inverse();
    this.svgPoint = this.svgPoint.matrixTransform(d);
    return new DOMPoint(this.svgPoint.x, this.svgPoint.y);
  }, K = function(a, b) {
    for (var d = w.getProjectedPoint(G(a, b)), c = null, f = Number.POSITIVE_INFINITY, e, g, k = 0;k < p._tickmarks.length;k++) {
      e = p._tickmarks[k], g = d.distance(e.location), g < f && (c = e, f = g);
    }
    return c;
  }, H = function() {
    if (A && !0 === p.getEnabled()) {
      if (r) {
        ...
        C.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(w.getProjectedPoint(G(D.x, D.y)), !0));
      }
  ...
  this.placePointByNum = function(a) {
    a = p.calcXCoordinate(a);
    return p.placePointByCoor(a);
  };
  this.calcXCoordinate = function(a) {
    a = new d(a);
    var b = p.getWidth() - 30, b = Math.abs(b - 30), c = n.subtract(m);
    return 30 + a.subtract(m).divide(c) / b;
  };
  this.calcNum = function(a) {
    var b = p.getWidth() - 30, b = Math.abs(b - 30);
    a = n.subtract(m).multiply((a - 30) / b);
    return m.add(a);
  };
  ...
  this.setPointSize = function(a) {
    t = Number(a);
    C && (C.setAttributeNS(null, "r", t), x.setAttributeNS(null, "r", t));
  };
  ...
  this.set_precision = function(a) {
    p.setPrecision(parseInt(a));
    p.render();
  };
  this.Points = function(a) {
    a = a.split(";");
    for (var b = 0;b < a.length;b++) {
      p.placePointByNum(a[b]);
    }
  };
  this.set_denominator = function(a) {
  };
...
var CTATPieChart = function(a, b, c, e, g) {
  ...
  var d = 3, f = 3, h = 3, l = this, k, n, m, t = null, r = CTATGlobals.NameSpace.svg;
  this.init = function() {
    l.initSVG();
      ...
      a.reduce(function(a, b, g, k) {
        if (1 <= b.valueOf()) {
          ...
          if (0 < d && d < c) {
            ...
            k = CTAT.Geom.Point.circle_intersection(n, k, f, c).reduce(p.bind(this, k));
            m = m.add(h);
            m = CTAT.Geom.Point.circle_intersection(n, m, f, c).reduce(p.bind(this, m));
          }
          h = CTAT.Geom.Point.to2DString;
          n = "M " + h(n);
          p = new DOMPoint(c, c);
          n += " L " + h(k);
          n += " A " + h(p) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + h(m);
...
var CTATMessageHandler = function() {
  ...
  this.processSingleMessage = function(d) {
    ...
    for (var g = 0;g < d.length;g++) {
      ...
      if ("properties" == e.getElementName(l)) {
        ...
        for (var k = e.getElementChildren(l), n = 0;n < k.length;n++) {
          var m = k[n];
          if ("MessageType" == e.getElementName(m)) {
            ...
            if ("AssociatedRules" == m) {
              ...
              for (var t = "", r = "", p = 0;p < k.length;p++) {
                var w = k[p];
                "TutorAdvice" == e.getElementName(w) && (t = e.getNodeTextValue(w));
                "Actor" == e.getElementName(w) && e.getNodeTextValue(w);
                "Indicator" == e.getElementName(w) && (r = e.getNodeTextValue(w));
                "StepID" == e.getElementName(w) && e.getNodeTextValue(w);
                "LogAsResult" == e.getElementName(w) && e.getNodeTextValue(w);
                "tool_selection" == e.getElementName(w) && e.getNodeTextValue(w);
                "Skills" == e.getElementName(w) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(w));
              }
            ...
            if ("ShowHintsMessage" == m) {
              ...
              for (p = 0;p < k.length;p++) {
                if (w = k[p], "HintsMessage" == e.getElementName(w)) {
                  for (var w = e.getElementChildren(w), v = 0;v < w.length;v++) {
                    var y = w[v];
                    "value" == e.getElementName(y) && (r.push(e.getNodeTextValue(y)), t = !0);
                  }
                }
              }
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", g = "Unknown", l = null, k = 0;k < a.length;k++) {
      var n = a[k];
      b.ctatdebug("Inspecting element: " + e.getElementName(n));
      "WidgetType" == e.getElementName(n) && (b.ctatdebug("Widget type: " + e.getNodeTextValue(n)), c = e.getNodeTextValue(n));
      "CommName" == e.getElementName(n) && (b.ctatdebug("Instance name: " + e.getNodeTextValue(n)), g = e.getNodeTextValue(n));
      if ("serialized" == e.getElementName(n)) {
        b.ctatdebug("Prepareing to de-serialize component ...");
        for (var m = e.getElementChildren(n), t = 0;t < m.length;t++) {
          var r = m[t];
          -1 != e.getElementName(r).indexOf("CTAT") && (l = r);
        }
      }
      "interface" == e.getElementName(n) && (b.ctatdebug("Storing interface for post start-state reconstruction ..."), CTATGlobals.interfaceElement = n);
      "script" == e.getElementName(n) && (b.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."), scriptElement = e.getNodeTextValue(n));
    }
  ...
  this.deserializeComponent = function(a, c, g) {
    ...
    if (null === e.getElementAttr(g, "x")) {
      ...
      var l = e.getElementAttr(g, "x"), k = e.getElementAttr(g, "y"), n = e.getElementAttr(g, "width"), m = e.getElementAttr(g, "height"), t = e.getElementAttr(g, "tabIndex"), r = e.getElementAttr(g, "zIndex");
      null === t && (t = -1);
      null === r && (r = 0);
      var p = new CTATComponentDescription;
      p.type = a;
      p.name = c;
      p.x = Math.floor(l);
      p.y = Math.floor(k);
      ...
      p.height = Math.floor(m);
      CTATShellTools.registerComponentDescription(p);
      g = e.getElementChildren(g);
      for (l = 0;l < g.length;l++) {
        k = g[l];
        e.getElementName(k);
        if ("Parameters" == e.getElementName(k)) {
          for (this.ctatdebug("Processing component parameters ..."), n = e.getElementChildren(k)[0], n = e.getElementChildren(n), m = 0;m < n.length;m++) {
            var w = n[m];
            if ("CTATComponentParameter" == e.getElementName(w)) {
              this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
              for (var r = t = void 0, w = e.getElementChildren(w), v = 0;v < w.length;v++) {
                var y = w[v];
                "name" == e.getElementName(y) && (this.ctatdebug("Found parameter name: " + e.getNodeTextValue(y)), t = e.getNodeTextValue(y));
                "value" == e.getElementName(y) && (this.ctatdebug("Found parameter value: " + e.getNodeTextValue(y)), r = e.getNodeTextValue(y).trim());
              }
              this.ctatdebug("Parameter name: " + t + ", value: " + r);
              void 0 !== t && (p.params[t] = r, "group" == t && (p.groupName = r));
            }
          }
        }
        if ("Styles" == e.getElementName(k)) {
          for (this.ctatdebug("Processing component styles ..."), k = e.getElementChildren(k)[0], k = e.getElementChildren(k), n = 0;n < k.length;n++) {
            if (r = k[n], "CTATStyleProperty" == e.getElementName(r)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              t = m = "";
              r = e.getElementChildren(r);
              for (w = 0;w < r.length;w++) {
                v = r[w], "name" == e.getElementName(v) && (m = e.getNodeTextValue(v)), "value" == e.getElementName(v) && (t = e.getNodeTextValue(v).trim());
              }
...
var CTATCheckBox = function(a, b, c, e, g) {
  ...
  this.init = function() {
    ...
    d.addEventListener("click", n.bind(this));
  ...
  this.removeCorrect = p.bind(this, "CTAT--correct");
  this.showInCorrect = function(a) {
    p("CTAT--correct");
    p("CTAT--hint");
    r("CTAT--incorrect");
  };
  this.removeInCorrect = p.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    p("CTAT--incorrect");
    p("CTAT--correct");
    a ? r("CTAT--hint") : p("CTAT--hint");
  };
};
...
var CTATHintWindow = function(a, b, c, e, g) {
  ...
  var d = this;
  d.isTabIndexable = !1;
  var f = null, h = null, l = null, k = null, n = null;
  ...
  this.init = function() {
    ...
    if (m) {
      h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), h.innerHTML = m;
    } else {
      if (t) {
        ...
        h.appendChild(a);
        a = document.createElementNS(CTATGlobals.NameSpace.svg, "text");
        a.setAttributeNS(null, "pointer-events", "none");
        a.textContent = "Previous";
        a.setAttributeNS(null, "text-anchor", "middle");
        a.setAttributeNS(null, "x", "50px");
        a.setAttributeNS(null, "dominant-baseline", "middle");
        a.setAttributeNS(null, "y", "50%");
        h.appendChild(a);
      } else {
        h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), a = document.createElement("span"), a.style.fontWeight = "bold", a.style.marginLeft = "6px", a.style.marginRight = "4px", a.textContent = "\u25c0", h.appendChild(a), a.style.cssFloat = "left", h.appendChild(document.createTextNode("Previous"));
      }
    }
    ...
    k.appendChild(h);
    n ? (l = document.createElement("button"), l.classList.add("CTAT-hint-window--next"), l.innerHTML = n) : (t ? (l = document.createElementNS(CTATGlobals.NameSpace.svg, "svg"), l.classList.add("CTAT-hint-window--next"), l.setAttributeNS(null, "viewBox", "0 0 82 20"), a = document.createElementNS(CTATGlobals.NameSpace.svg, "path"), a.style.fill = "none", a.style.strokeWidth = "3px", a.style.strokeLinecap = "round", a.setAttributeNS(null, "d", "M75 10 h-12 M75 10 m-4 -4 l4 4 -4 4"), a.setAttributeNS(null, 
    "pointer-events", "none"), l.appendChild(a), a = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), a.setAttributeNS(null, "pointer-events", "none"), a.textContent = "Next", a.setAttributeNS(null, "text-anchor", "middle"), a.setAttributeNS(null, "x", "34px"), a.setAttributeNS(null, "dominant-baseline", "middle"), a.setAttributeNS(null, "y", "50%")) : (l = document.createElement("button"), l.classList.add("CTAT-hint-window--next"), a = document.createElement("span"), a.style.fontWeight = 
    "bold", a.style.marginRight = "6px", a.textContent = "\u25b6", a.style.cssFloat = "right", l.appendChild(document.createTextNode("Next"))), l.appendChild(a));
...
var CTATTable = function(a, b, c, e, g) {
  ...
  this.init = function() {
    d.ctatdebug("init (" + d.getName() + ")");
    k = CTATGlobalFunctions.gensym.div_id();
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = f.createTBody(), g = b;g < l;g++) {
    ...
    for (a = 0;a < f.rows.length;a++) {
      for (b = f.rows[a], c = 0;c < b.cells.length;c++) {
        var k = b.cells[c], v = d.getName() + ".R" + a + "C" + c;
        CTATShellTools.findComponent(v).forEach(function(a) {
          var b = d.getGrDescription();
          b.name = v;
          a.setCellContainer(k);
          a.setGrDescription(b);
          a = a.getDivWrap();
          null != a ? (a.parentNode.removeChild(a), a.style.position = null, a.style.top = null, a.style.left = null, k.appendChild(a)) : d.ctatdebug("Error: unable to get div wrapper from component");
        });
      }
    }
  };
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, c = null, e = null, g = {}, d = null, f = null, h = null, l = [], e = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.processStartState = function() {
    ...
    inStartState = !0;
    null != a ? (this.ctatdebug("Calling tutor.createInterface () ..."), useDebugging = !0, a.createInterface(), useDebugging = !1) : (this.ctatdebug("Error: no tutor object available, calling createInterface globally ..."), window.hasOwnProperty("createInterface") && (useDebugging = !0, window.createInterface(), useDebugging = !1));
  ...
  this.requestHint = function() {
    ...
    if ("none" == CTATConfig.external) {
      b.ctatdebug("Calling built-in hint request driver ..."), CTATGlobals.Tab.previousFocus ? (a = new CTATSAI("hint", "ButtonPressed", "hint request"), CTATGlobals.Tab.previousFocus instanceof CTAT.Component.Base.SAIHandler ? (b.ctatdebug("CTATGlobals.Tab.previousFocus!==null, requesting hint for: " + CTATGlobals.Tab.previousFocus.getSAI().getSelection()), a.addSelection(CTATGlobals.Tab.previousFocus.getSAI().getSelection()), a.addAction("PreviousFocus")) : b.ctatdebug("Current focus is not a CTAT component, can't ask for a hint yet")) : 
  ...
  this.processCorrectAction = function(a) {
    ...
    if (g[f] && null != d) {
      ...
      var e = CTATShellTools.findComponent(f);
      if (null != e) {
        ctatdebug("Processing " + e.length + " components ...");
        for (var l = 0;l < e.length;l++) {
          ctatdebug("Check " + e[l].getName()), e[l] ? e[l].setCorrect && e[l].setCorrect(a) : b.ctatdebug("Internal error, component pointer is null");
        }
        if ("done" == f && (CTATScrim.scrim.scrimUp("Please wait, wrapping up ..."), commLibrary.sendXML(commMessageBuilder.createProblemSummaryRequestMessage()), null != c)) {
          window[c]();
        }
      } else {
        b.ctatdebug("Error: component is null for selection " + f);
      }
    }
  ...
  this.processAssociatedRules = function(a, d, c) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      ...
      var l = [];
      null != h ? l = h.getTouched() : ctatdebug("Error: skills object is null in message");
      ctatdebug("Sending log message ...");
      null != commLoggingLibrary ? commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, f, "", e, c, l, d, g) : this.ctatdebug("Info: no logging library available!");
    } else {
      b.updateSkillWindow(null);
    }
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var l = b(this) ? Object(new this(h)) : Array(h), k = 0, n;k < h;) {
      n = g[k], l[k] = d ? "undefined" === typeof f ? d(n, k) : d.call(f, n, k) : n, k += 1;
    }
    l.length = h;
    return l;
  };
...
(function(a) {
  ...
  var e = /[^s]/, g = /[def]/, d = /^[^\x25]+/, f = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, l = /^([a-z_][a-z_\d]*)/i, k = /^\.([a-z_][a-z_\d]*)/i, n = /^\[(\d+)\]/, m = /^[\+\-]/;
  b.format = function(a, d) {
    var f = 1, k = a.length, h = "", l = [], n, t, x, u, D = !0, A = "";
    for (n = 0;n < k;n++) {
      if (h = c(a[n]), "string" === h) {
        l[l.length] = a[n];
      } else {
        if ("array" === h) {
          x = a[n];
          if (x[2]) {
            for (h = d[f], t = 0;t < x[2].length;t++) {
              if (!h.hasOwnProperty(x[2][t])) {
                throw Error(b("[sprintf] property '%s' does not exist", x[2][t]));
              }
              h = h[x[2][t]];
            }
          } else {
          ...
          "function" == c(h) && (h = h());
          if (e.test(x[8]) && "number" != c(h) && isNaN(h)) {
            throw new TypeError(b("[sprintf] expecting number but found %s", c(h)));
          }
          g.test(x[8]) && (D = 0 <= h);
          switch(x[8]) {
            case "b":
            ...
            case "d":
              ...
              break;
            case "e":
              h = x[7] ? h.toExponential(x[7]) : h.toExponential();
              break;
            case "f":
              h = x[7] ? parseFloat(h).toFixed(x[7]) : parseFloat(h);
              break;
            case "o":
              h = h.toString(8);
              break;
            case "s":
              h = (h = String(h)) && x[7] ? h.substring(0, x[7]) : h;
              break;
            case "u":
              h >>>= 0;
              break;
          ...
          if (!D || g.test(x[8]) && x[3]) {
            A = D ? "+" : "-", h = h.toString().replace(m, "");
          }
          t = x[4] ? "0" == x[4] ? "0" : x[4].charAt(1) : " ";
          u = x[6] - (A + h).length;
          u = x[6] ? Array(u + 1).join(t) : "";
          l[l.length] = x[5] ? A + h + u : 0 == t ? A + u + h : u + A + h;
        }
      }
    }
    return l.join("");
        ...
        if (null !== (b = f.exec(a))) {
          ...
          if (null !== (b = h.exec(a))) {
            if (b[2]) {
              var e = e | 1, g = [], m = b[2], t = [];
              if (null !== (t = l.exec(m))) {
                for (g[g.length] = t[1];"" !== (m = m.substring(t[0].length));) {
                  if (null !== (t = k.exec(m))) {
                    g[g.length] = t[1];
                  } else {
                    if (null !== (t = n.exec(m))) {
  ...
  "undefined" !== typeof exports ? (exports.sprintf = b, exports.vsprintf = t) : (a.sprintf = b, a.vsprintf = t, "function" === typeof define && define.amd && define(function() {
    return {sprintf:b, vsprintf:t};
  }));
...
var CTATExampleTracerSkill = function(a, b, c, e, g, d) {
  ...
  var f = null == a || "" == a.trim() ? b : b + " " + a, h = e, l = 0, k = 0, n = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, m = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, t = null, r = this;
  this.getSkillName = function() {
    return f;
  };
  this.getCategory = function() {
  ...
  this.setVersion = function(a) {
    null !== a && "undefined" !== typeof a && 0 < a.length && (n = CTATExampleTracerSkill.versionToSkillBarDelimiter(a));
  };
  this.setLabel = function(a) {
    t = a;
  };
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var e = Number.MAX_VALUE, g = b, d = 0, f = new Date, h = {}, l = 0, k = 0, n = 0, m = 0, t = 0, r = 0, p = 0, w = CTATMsgType.CompletionValue[0], v = this;
  ...
  this.toXML = function(b) {
    var c;
    c = "" + (' ProblemName="' + a + '"');
    c += ' CompletionStatus="' + w + '"';
    c += ' Correct="' + l + '"';
    c += ' UniqueCorrect="' + t + '"';
    c += ' UniqueCorrectUnassisted="' + r + '"';
    c += ' Hints="' + k + '"';
    c += ' UniqueHints="' + m + '"';
    c += ' HintsOnly="' + v.getHintsOnly() + '"';
    c += ' Errors="' + n + '"';
    c += ' UniqueErrors="' + p + '"';
    c += ' ErrorsOnly="' + v.getErrorsOnly() + '"';
    c += ' UniqueSteps="' + v.getUniqueSteps() + '"';
    c += ' RequiredSteps="' + v.getRequiredSteps() + '"';
    c += ' TimeElapsed="' + d + '"';
    var f = v.getSkills() ? v.getSkills().toXML(b) : "";
  ...
  this.addHint = function(a) {
    ...
    v.ctatdebug("exiting addHint() hint count " + k + ", trial " + b);
  };
  this.addError = function(a) {
    v.ctatdebug("addError(" + a + ")");
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++p, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), h[a] = b, p++);
    n++;
    b.setLastResult(CTATStep.StepResult[1]);
    v.ctatdebug("exiting addError() error count " + n + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = h[a];
    v.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++t, 1 > b.getNFirstHints() && r++), b.incrementNCorrect()) : (v.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, t++, r++);
    l++;
    b.setLastResult(CTATStep.StepResult[3]);
    v.ctatdebug("exiting addCorrect() correct count " + l + ", trial " + b);
  };
  this.setCompletionStatus = function(a, b) {
    v.ctatdebug("setCompletionStatus(" + a + ", " + b + ")");
    if (CTATMsgType.CompletionValue[1] != w || b) {
      w = a;
    }
  };
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (e && a) {
      ...
      if (ProblemStateSaver.inOLI()) {
        var k = h.getRequiredSteps(), n = h.getCorrect();
        0 == k ? (console.log("WARNING problem summary number of required steps is 0\n" + h.toXML(!1)), l.percentScore = 100, l.completed = !0) : (l.percentScore = Math.round(100 * n / k), l.completed = n >= k);
      } else {
...
(function() {
  var a, b, c, e, g, d, f, h, l, k, n, m = [].slice;
  g = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  e = /^\d+(\.\d\d)?$/;
  d = /((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?/g;
  k = /^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;
  ...
  a = function() {
    ...
    a.matchWithPrecision = function(a, d) {
      var c, f;
      return (c = String(a).match(k)) && (f = String(d).match(k)) && n(c) === n(f) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, d) {
      var f, e;
      return (f = String(a).match(k)) && (e = String(d).match(k)) && (a = n(f) > n(e) ? (+a).toFixed(c(e)) : String(a)) && b(a, d, function(a, b) {
        return a === b;
      });
    };
  ...
  a = function(a) {
    ...
    c.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        var c, e, g, n;
        n = b.constant() ? [null, b] : b.power() ? b.exponent.constant() ? (b.pushInversion(), [b.base, b.exponent]) : (b.exponent = b.exponent.multiplyOne(), [b, b.exponent.factors.shift()]) : (b = b.powerOne(), [b.base, b.exponent]);
        return (c = a.find(function(a) {
          var b;
          return null != (b = a[0]) ? b.equals(n[0]) : void 0;
        })) ? c[1] += (null != (e = n[1]) ? e.evaluate() : void 0) || 1 : a.push([n[0], (null != (g = n[1]) ? g.evaluate() : void 0) || 1]);
      });
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], e = [1, 7], g = [1, 10], d = [1, 11], f = [1, 12], h = [1, 13], l = [1, 21], k = [1, 22], n = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], m = [1, 23], t = [1, 24], r = [1, 26], p = [1, 27], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], v = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:l, 15:k}, b(n, [2, 11], {22:9, 19:25, 16:m, 18:t, 20:r, 21:p, 24:g, 25:d, 27:f, 28:h}), b(w, [2, 17]), {13:c, 15:e, 17:28, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:29, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(w, [2, 20]), b(w, [2, 23], {23:[1, 30]}), {13:c, 15:e, 17:31, 19:8, 22:9, 24:g, 25:d, 27:f, 
  28:h}, {6:32, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(v, [2, 25]), b(v, [2, 26]), {1:[2, 1]}, {6:33, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:34, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:35, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:36, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:37, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:38, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 
  24:g, 25:d, 27:f, 28:h}, {13:c, 14:39, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 14:40, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:41, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:42, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(w, [2, 14]), {13:c, 15:e, 17:43, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:44, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(w, [2, 18]), b(w, [2, 19]), {13:c, 15:e, 17:45, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(w, [2, 22]), {13:l, 
  15:k, 26:[1, 46]}, {5:[2, 2], 13:l, 15:k}, {5:[2, 3], 13:l, 15:k}, {5:[2, 4], 13:l, 15:k}, {5:[2, 5], 13:l, 15:k}, {5:[2, 6], 13:l, 15:k}, {5:[2, 7], 13:l, 15:k}, b(n, [2, 9], {22:9, 19:25, 16:m, 18:t, 20:r, 21:p, 24:g, 25:d, 27:f, 28:h}), b(n, [2, 10], {22:9, 19:25, 16:m, 18:t, 20:r, 21:p, 24:g, 25:d, 27:f, 28:h}), b(w, [2, 12]), b(w, [2, 13]), b(w, [2, 15]), b(w, [2, 16]), b(w, [2, 21]), b(v, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, h = 0, k = 0, l = d.slice.call(arguments, 1), m = Object.create(this.lexer), n = {}, p;
    for (p in this.yy) {
    ...
    for (var r, w, v, I, M = {}, N, J;;) {
      v = b[b.length - 1];
      if (this.defaultActions[v]) {
        I = this.defaultActions[v];
      } else {
      ...
      if ("undefined" === typeof I || !I.length || !I[0]) {
        ...
        this.parseError(O, {text:m.match, token:this.terminals_[r] || r, line:m.yylineno, loc:p, expected:J});
      }
      if (I[0] instanceof Array && 1 < I.length) {
        throw Error("Parse Error: multiple actions possible at state: " + v + ", token: " + r);
      }
      switch(I[0]) {
        case 1:
          b.push(r);
          ...
          b.push(I[1]);
          r = null;
          w ? (r = w, w = null) : (h = m.yyleng, f = m.yytext, g = m.yylineno, p = m.yylloc, 0 < k && k--);
          break;
        case 2:
          ...
          v = this.performAction.apply(M, [f, h, g, n, I[1], c, d].concat(l));
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, l, k) {
      var n, m, t, r, p, w, v, y;
      try {
        p = "undefined" !== typeof window && null !== window ? window : global;
        n = function() {
          var a;
          a = [];
          for (t in p) {
        ...
        v = null != (w = a.match(b)) ? w : [];
        m = 0;
        for (r = v.length;m < r;m++) {
          t = v[m], 0 > g.call(c, t) && CTATFormulaFunctions.assign(t, void 0);
        }
        for (t in y = this.variableTable.getTable()) {
          p[t] = y[t];
        }
        ...
        }).apply(p, [d, l, k].concat(e.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (t in p) {
          null != t && 0 > g.call(n, t) && (y[t] = p[t], delete p[t]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      for (t = r.length;g < t;a = ++g) {
        e = r[a], p.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return p.join("");
    };
    return a;
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, f = "undefined" === typeof c || null === c ? null : c, h = null, l = 1, k = 1, n = "CORRECT_ACTION", m = [], t = !1, r = null, p = "", w = null, v = null, y = this;
  this.getUniqueID = function() {
    return e;
  };
  this.getMatcher = function() {
    y.ctatdebug("CTATExampleTracerLink --\x3e in getMatcher");
    return h;
  };
  this.matchesSAI = function(a, b, c) {
    var d = y.getMatcher();
    y.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAI(); matcher " + d + ", typeof " + typeof d + ", sai " + a);
    a = d.match(a.getSelectionArray(), a.getActionArray(), a.getInputArray(), b, c);
    y.ctatdebug("CTATExampleTracerLink --\x3e out of matchesSAI: result = " + a);
    return a;
  };
  this.matchesSAIforHint = function(a, b, c, d) {
    y.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAIforHint(" + a + ", " + b + ") selectionArray " + a.getSelectionArray());
    if (!1 === y.getMatcher().matchForHint(a.getSelectionArray(), a.getActionArray(), b, d)) {
      return y.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false because no match"), !1;
    }
    if (null !== c && "undefined" !== typeof c && !0 === c.getWantReportableHints() && (a = null === y.getAllHints() || "undefined" === typeof y.getAllHints() ? 0 : y.getAllHints().length, 1 > a)) {
      return y.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false nStaticHints " + a + "< 1"), !1;
    }
    y.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning true");
    return !0;
  };
  ...
  this.toString = function() {
    var a;
    a = "[link " + y.getUniqueID();
    a += " (" + y.getPrevNode() + "-" + y.getNextNode();
    a += ") " + y.getType();
    return a + "]";
  };
  this.getTutorSAI = function(a, b) {
    return y.getMatcher().getTutorSAI(a, b, y.getActionType());
  };
  this.getEvaluatedInput = function(a, b) {
    return y.getMatcher().getEvaluatedInput(a, b);
  };
  ...
  this.isDone = function() {
    var a = String(y.getDefaultSAI().getSelection()).toLowerCase(), b = String(y.getDefaultSAI().getAction()).toLowerCase(), a = CTATMsgType.DONE.toLowerCase() == a && CTATMsgType.BUTTON_PRESSED.toLowerCase() == b;
    y.ctatdebug("CTATExampleTracerLink.isDone() returns " + a);
    return a;
  };
  this.interpolateHints = function(a) {
    y.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints(" + a + ")");
    var b = [];
    ...
    m.forEach(function(a) {
      if (!(1 > String(a).trim().length)) {
        var d = y.getDefaultSAI().getSelection(), e = y.getDefaultSAI().getAction(), f = CTATVariableTable.standardizeType(y.getDefaultSAI().getInput());
        y.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate(" + a + ", " + d + ", " + e + ", " + f + ")");
        a = c.interpolate(a, d, e, f);
        y.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate() returns " + a);
        b.push(a);
      }
    });
    y.ctatdebug("CTATExampleTracerLink --\x3e out of interpolateHints " + b);
    return b;
  };
  this.getHints = function() {
    y.ctatdebug("CTATExampleTracerLink --\x3e in getHints");
    var a = [];
    y.interpolateHints(null).forEach(function(b) {
      y.ctatdebug("CTATExampleTracerLink --\x3e in getHints loop");
      b.toString() !== "".toString() && a.push(b);
    });
    y.ctatdebug("CTATExampleTracerLink --\x3e out of getHints");
    return a;
  };
  ...
  this.isTraversable = function() {
    return 1 > y.getMaxTraversals() ? !1 : CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() == y.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() == y.getActionType().toString().toUpperCase() ? !0 : !1;
  };
  this.replaceInput = function() {
    return CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() !== y.getActionType().toString().toUpperCase() && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() !== y.getActionType().toString().toUpperCase() ? !1 : y.getMatcher().replaceInput();
  };
  this.evaluateReplacement = function(a, b, c) {
    return y.getMatcher().evaluateReplacement(a, b, c);
  };
  this.getActor = function() {
    return y.getMatcher().getActor();
  };
  this.getDefaultSAI = function() {
    y.ctatdebug(y.toString() + ".getSAI(): " + (h ? h.getDefaultSAI() : "(matcher null)"));
  ...
  this.setSelection = function(a) {
    y.getMatcher().setDefaultSelection(null === a[0] || "undefined" === typeof a[0] ? "" : a[0].toString());
  };
  this.setAction = function(a) {
    y.getMatcher().setDefaultAction(null === a[0] || "undefined" === typeof a[0] ? "" : a[0].toString());
  };
  this.setActionType = function(a) {
    if (null === a || "undefined" === typeof a || a.toString() !== CTATExampleTracerLink.CORRECT_ACTION.toString() && a.toString() !== CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString() && a.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString() && a.toString() !== CTATExampleTracerLink.HINT_ACTION.toString() && a.toString() !== CTATExampleTracerLink.UNTRACEABLE_ERROR.toString() && a.toString() !== CTATExampleTracerLink.CLT_ERROR_ACTION.toString() && a.toString() !== CTATExampleTracerLink.GIVEN_ACTION.toString()) {
      throw new CTATExampleTracerException("invalid action type " + n);
    }
    n = a;
  };
  ...
  this.addSkillName = function(a) {
    y.ctatdebug("ETLink[" + e + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === v || "undefined" === typeof v) {
        v = [];
      }
      -1 < v.indexOf(a) || (v.push(a), y.ctatdebug("ETLink.addSkillName() return with skillNames " + v));
    }
  };
  ...
  this.isTutorPerformed = function(a) {
    if (CTATExampleTracerLink.CORRECT_ACTION.toUpperCase() !== y.getActionType().toUpperCase()) {
      return !1;
    }
    var b = y.getMatcher();
  ...
  this.setIsPreferredLink = function(a) {
    y.ctatdebug("ETLink.setIsPreferredLink() was " + t + ", now " + a);
    t = a;
  };
  this.setVisualData = function(a) {
    w = a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.evaluateReplacement = function(a, b, e) {
    ...
    try {
      ...
      c.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + g + ") " + n.name + ": " + n.message), e = null;
    }
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var e = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, f = !1, h = null, l = null, k = "student", n = null, m = null, t = "", r = null, p = null, w = null, v = null, y = null, B = [], C = !1, q = null, x = this;
  this.getActor = function() {
    return k;
  };
  this.setActor = function(a) {
  ...
  this.getTransactionID = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + e);
    return e;
  };
  this.setTransactionID = function(a) {
  ...
  this.getResult = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + d);
    return d;
  };
  ...
  this.getWantReportableHints = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + C);
    return C;
  };
  ...
  this.isOutOfOrder = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + r);
    return r;
  };
  ...
  this.setInterpolateSAI = function(a, b, c) {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolateSAI(selection " + a + " action " + b + " input " + c + ")");
  };
  ...
  this.getSuccessOrBuggyMsg = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + y);
    return y;
  };
  this.getReportableHints = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + B);
    return B;
  };
  this.getReportableLink = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + n);
    return n;
  };
  this.getReportableVariableTable = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + v);
    return v;
  };
  this.getReportableInterpretation = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + m);
    return m;
  };
  this.getStepID = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + t);
    return t;
  };
  ...
  this.getTutorInput = function() {
    return null !== w && "undefined" !== typeof w ? x.getEvaluatedInputArray() : null !== l && "undefined" !== typeof l ? l.getInputArray() : null;
  };
...
var CTATVectorMatcher = function(a, b, c, e) {
  function g(a, b, c, e, g) {
    ...
    w[CTATMatcher.INPUT] = c;
    for (var v = 0;3 > v;v++) {
      var y = l[v][0], B = y instanceof CTATExpressionMatcher ? y.matchConcatenation(a, b, c, e) : y.matchConcatenation(w[v]);
      k.ctatdebug("CTATVectorMatcher --\x3e in _match[" + v + "] after " + y + ".concat returns: " + B);
      if (g) {
        g.push(B);
      } else {
        if (!1 === B) {
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function e(a, b, e) {
    ...
    q.ctatdebug("interps # : " + p.length);
    q.ctatdebug("interps: " + p);
    ...
    var n = null;
    !0 === a.isSolverResult() ? (q.ctatdebug("In evaluate -- in if branch of isSolverResult"), n = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (q.ctatdebug("In evaluate -- in else branch of isSolverResult"), n = r.getLastMatchedLink().getType());
    if (!0 === e) {
      q.ctatdebug("In evaluate -- in if Branch doUpdate()");
      v.push(a.getStudentSAI());
      if (n.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || n.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        ...
        for (var y in w) {
          w.hasOwnProperty(y) && delete w[y];
        }
        k.forEach(function(a) {
          w[a.getLastMatchedLink().getUniqueID()] = a.getLastMatchedLink();
        });
      }
      n.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && v.splice(v.length - 1, 1);
    }
    t = r.getLastMatchedLink();
    a.isSolverResult() || (q.ctatdebug("In evaluate inside the solver result if condition + " + n), a.setResult(n));
    ...
    a.setHintRequest(b);
    b || (y = t.getTutorSAI(a.getStudentSAI(), r.getVariableTable()), q.ctatdebug("In evaluate -- TUTORSAI object: " + y + ", getInput() " + y.getInput() + ";"), a.setTutorSAI(y));
    y = n == CTATExampleTracerLink.CORRECT_ACTION ? t.getSuccessMsg() : t.getBuggyMsg();
    a.setSuccessOrBuggyMsg(c(y, r.getVariableTable(), a.getStudentSAI()));
    y = a.getStudentSAI();
    a.setInterpolateSAI(y.getSelection(), y.getAction(), y.getInput());
    ...
    return n.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString();
  }
  function g(a, b, c, d, e) {
    q.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks(" + a + ", " + b + ", " + c + ")");
    var f = [];
    y.getLinks().forEach(function(g) {
      if (!1 === c) {
  ...
  function d(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === y.observesOrderingConstraints(h, a, f, e) || !1 === n(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
  ...
  function t(a, b, c, e) {
    ...
    b.getSortedLinks().forEach(function(b) {
      ...
      !0 === a.isTraversed(b, e) || !0 === r(b) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), g = !0) : (!0 === g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), y.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
  ...
  var p = null, w = null, v = null, y = a, B = null;
  ...
  this.resetTracer = function() {
    ...
    null === p || "undefined" === typeof p ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), p = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), p.length = 0);
    ...
    C = a;
    if (null === w || "undefined" === typeof w) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), w = {};
    } else {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");
      for (var c in w) {
        w.hasOwnProperty(c) && delete w[c];
      }
    }
    null === v || "undefined" === typeof v ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), v = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), v.length = 0);
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = m(!1, [a])) ? a.getPrevNode() : y ? y.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, c) {
  ...
  function f(a, b, c, d) {
    ...
    A.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === A.isLinkInGroup(a, b) && 0 !== A.getGroupLinkCount(a)) {
        var l = h(a, d);
        null !== l && "undefined" !== typeof l && (l = l.getDepth(), l < b.getDepth() && l > e && (!1 === n(a) || !0 === m(a, c)) && (e = l, f = a), l > b.getDepth() && l < g && (!1 === n(a) || !0 === m(a, c)) && (g = l, k = a));
      }
    });
  ...
  var v = null, y = null, B = null, C = null, q = null, x = null, u = new Set, D = null, A = null, z = this;
  this.getLinks = function() {
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === f && (b = z.getSmallestContainingGroup(b), !0 === A.isLinkInGroup(b, g) && !1 === A.isGroupOrdered(b) && !0 === k(b, c, d))) {
      return !1;
    }
  ...
  this.getNode = function(a) {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getNode(" + a + ") returning " + C[a]);
    return C[a];
  };
  ...
  this.getStartNode = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + q);
    return q;
  };
  ...
  this.getStudentStartsHereNode = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + x);
    return x;
  };
  ...
  this.getExampleTracer = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning " + v);
    return v;
  };
  ...
  this.getVisualData = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + D);
    return D;
  };
  (function(a, b) {
    ...
    v = new CTATExampleTracerTracer(z, c);
...
var CTATMessageTank = function(a, b) {
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (f && !(1 > f.length)) {
      c(a);
      m.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + f.length + ", transaction_id " + n);
      for (var d = [], k = 0;k < f.length;++k) {
        var v = f[k];
        if (v.msg) {
          var y = v.msgType, B = v.evt;
          m.ctatdebug("entering processInterfaceVariables() msgType " + y + ", evt " + B);
          y && (m.ctatdebug("entering processInterfaceVariables() et " + g + ", tracer " + (g ? g.getTracer() : null)), y = y.toLowerCase(), 0 !== y.indexOf("correct") && 0 !== y.indexOf("interfaceaction") || g.getTracer().addInterfaceVariablesFromEvent(B));
          e(v) || d.push(v.msg);
        }
      }
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, m, t = a = -1, u = CTATMsgType.DEFAULT_ACTOR, D = !1, A = 0;A < e.length;A++) {
      ...
      if ("actionLabel" === f.getElementName(e[A])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[A], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[A], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[A], "maxTraversals")), z = f.getElementChildren(e[A]), E = 0;E < z.length;E++) {
          "uniqueID" === f.getElementName(z[E]) && (m = f.getNodeTextValue(z[E]), c.setUniqueID(parseInt(f.getNodeTextValue(z[E]))));
          ...
          if ("matchers" === f.getElementName(z[E])) {
            for (var F = f.getElementChildren(z[E]), G = 0;G < F.length;G++) {
              "Selection" === f.getElementName(F[G]) && (g = b(F[G], 0)), "Action" === f.getElementName(F[G]) && (h = b(F[G], 1)), "Input" === f.getElementName(F[G]) && (k = b(F[G], 2)), "Actor" === f.getElementName(F[G]) && (u = f.getNodeTextValue(F[G]), D = (D = f.getElementAttr(F[G], "linkTriggered")) && "false" != D.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === f.getElementName(z[E])) {
            ...
            var G = F = u = k = void 0, K = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var u = new CTATExactMatcher(CTATMatcher.ACTION, null), H = 0;H < h.length;H++) {
              ...
              "matcherParameter" === f.getElementName(h[H])) {
                ...
                "action" == L && u.setParameter(f.getNodeTextValue(h[H]));
    ...
    m = new CTATVectorMatcher(g, h, k, u);
    m.setDefaultSAI(l.getSAI());
    m.setCaseInsensitive(n);
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      ...
      if ("link" === f.getElementName(l[m])) {
        var n = Number(f.getElementAttr(l[m], "id")), t = b[n];
        if (null !== t || void 0 !== t) {
          ctatdebug("Added link ID : " + n), d.add(t);
        }
      }
  ...
  new XMLSerializer;
  var k, n = !0, m = CTATMsgType.SHOW_ALL_FEEDBACK, t = !0;
  ...
  this.parseGraph = function(b, e) {
    ctatdebug("parseBRD()");
    var w = 0, v = f.getElementAttr(b, "startStateNodeName"), y = "true" === f.getElementAttr(b, "unordered");
    n = "false" != String(f.getElementAttr(b, "caseInsensitive")).toLowerCase();
    t = f.getElementAttr(b, "lockWidget");
    var B = new CTATVariableTable;
    d = new CTATExampleTracerGraph(y, !1, B);
    ...
    var x = f.getElementAttr(b, "confirmDone");
    e.setHintPolicy(f.getElementAttr(b, "hintPolicy"));
    e.setOutOfOrderMessage(f.getElementAttr(b, "outOfOrderMessage"));
    for (var B = null, u = 0;u < C.length;u++) {
      switch(f.getElementName(C[u])) {
        case "startNodeMessages":
          l = f.getElementChildren(C[u]);
          var D = new CTATTutorMessageBuilder;
          "true" !== x && "false" !== x && m === CTATMsgType.HIDE_ALL_FEEDBACK && (x = "true");
          h = D.createStateGraphMessage(n, y, t, m === CTATMsgType.HIDE_ALL_FEEDBACK, q, confirmDone, e.getSkillBarVector());
          break;
        case "node":
          w++;
          D = C[u];
          ctatdebug("processNode(" + D + ")");
          for (var A = f.getElementChildren(D), z = -1, D = "", E = 0;E < A.length;E++) {
          ...
          D = A;
          d.addNode(D);
          1 == w && (d.setStartNode(D), d.setStudentStartsHereNode(D));
          D.getNodeName() == v && d.setStudentStartsHereNode(D);
          break;
        case "edge":
          d.addLink(a(C[u]));
          break;
    ...
    if (B) {
      w = f.getElementAttr(B, "ordered");
      if (null === w || "undefined" == typeof isordered) {
        w = !y;
      }
      ctatdebug("parseGraph() value of isOrdered = " + w);
      ctatdebug("parseGraph() value of isUnordered = " + y);
      ctatdebug("parseGraph() typeof isOrdered: " + typeof w);
      ctatdebug("parseGraph()typeof isUnordered: " + typeof y);
      v = B;
      ctatdebug("processGroup()");
      k = d.getGroupModel();
      y = k.createIdToLinkMap();
      k.setGroupOrdered(k.getTopLevelGroup(), w);
      ...
      ctatdebug("processGroup() order of group: isOrdered= " + w);
      ctatdebug("processGroup() order of group: isOrdered typeof= " + typeof w);
      w = f.getElementChildren(v);
      for (v = 0;v < w.length;v++) {
        "group" == f.getElementName(w[v]) && c(w[v], y);
      }
    }
    d.redoLinkDepths();
...
var CTATExampleTracer = function() {
  function a() {
    k.ctatdebug("workTheQueue() working " + F + ", workQueue.length " + E.length + ", restoreQueue.length " + z.length);
    if (0 == F) {
      for (;0 != (F = 0 < E.length | (0 < z.length) << 1);) {
        var a = null, c = !1;
        0 < z.length ? (a = z.shift(), c = !0) : a = E.shift();
        if (!b(a, c)) {
          k.ctatdebug("workTheQueue() suspending workQueue.length " + E.length + ", restoreQueue.length " + z.length);
          k.setWorking(c ? 1 : 0, !0);
          break;
        }
        k.ctatdebug("workTheQueue() bottom workQueue.length " + E.length + ", restoreQueue.length " + z.length);
      }
    }
  }
  function b(a, b) {
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && k.sendBundle([a]), e(a, f, p, d), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && k.sendBundle([a]), g(a, f, p, d), !0;
  ...
  function c(a, b, c, d) {
    ...
    G = !1;
    x = b.getProperty("problem_name");
    k.ctatdebug("SetPreferences.problem_name = " + x);
      ...
      if (d = c.getElementName(a[b]), k.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            d = [];
            for (var e = p.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              var g = p.getElementName(e[f]);
              if (g && "skill" == g.toLowerCase()) {
                var h = p.getElementAttr(e[f], "name");
                if (h && "" != h.trim()) {
                  var g = p.getElementAttr(e[f], "label"), l = p.getElementAttr(e[f], "pSlip"), m = p.getElementAttr(e[f], "description"), q = p.getElementAttr(e[f], "pKnown"), r = p.getElementAttr(e[f], "category"), t = p.getElementAttr(e[f], "pLearn"), w = p.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(r, h, w, q, l, t);
                  h.setLabel(g);
                  h.setDescription(m);
                  d.push(h);
                }
          ...
          case "curriculum_service_url":
            u.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
    ...
    k.ctatdebug("questionFile " + n + ", outputStatus " + A + ", problemStateRestorer " + D);
    a = n;
  ...
  function e(a, b, c, d) {
    ...
    u.appendToProblemState(a, k.getOutputStatus(), !1);
    if (!G) {
      return !1;
    }
  ...
  function g(a, b, c, d) {
    ...
    !d[0] || "hint" != d[0].toLowerCase() && "help" != d[0].toLowerCase() ? (k.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), h(null, b.getSAI(), "student", !0, c, a)) : (k.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + v + ", errorSAI " + w), v === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < d.length && (d[1] = ""), 1 < e.length && (e[1] = "")) : v !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (v === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? w && w.getSelection() ? (d.splice(1, 0, w.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : v === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && w && w.getSelection() && (d.splice(1, 0, w.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), k.startSkillTransaction(), a = [], d = m.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), b.setStepID(d.getUniqueID()), k.updateSkills(CTATExampleTracerSkill.HINT, 
    ...
    c, b), c = k.getProblemSummary(b.getReportableInterpretation()), k.messageTank.flushMessageTank(c, !0), k.ctatdebug("handleInterfaceAction() sent hint result " + b), w = null);
    return !0;
  }
  function d(a, b, c, d) {
  ...
  function h(a, b, c, e, f, g) {
    ...
    h.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || u.appendToProblemState(g, k.getOutputStatus(), !1);
    ...
    if (h.isSolverResult()) {
      ...
      if (h.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        ...
        g, k.getSkillBarVector(), r.getUniqueID(), n, q), h), k.ctatdebug("finishNewExampleTrace() successMsg " + q), q && k.messageTank.addToMessageTank("SuccessMessage", p.createSuccessMessage(n, q), h), w = null, e && (t = d(r ? r.getNextNode() : null, m.findCurrentState(!1, !1), k.lastMessage ? k.lastMessage.getSAI() : null, h)) && (h = t);
      } else {
        ...
        var t = k.lastSilentHintResult = new CTATExampleTracerEvent(k, g, c), v = m.traceForHint(t);
        k.ctatdebug("silent hint result: " + t + "; hintLink " + v);
        v || (v = m.getBestNextLink(!1, t), k.ctatdebug("getBestNextLink result: " + t + "; hintLink " + v));
        l = t ? t.getTutorSAI() : null;
        v && (q = "" + v.getUniqueID(), h.setStepID(q));
        var y = h, x = {tutorAdvice:null, msg:null, msgType:null};
        if (y.getReportableLink()) {
          x.tutorAdvice = y.getSuccessOrBuggyMsg(), x.tutorAdvice && x.tutorAdvice.trim() ? (x.msg = p.createBuggyMessage(y.getTransactionID(), x.tutorAdvice), x.msgType = "BuggyMessage") : x.tutorAdvice = null;
        } else {
          if (k.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()"), y.isDoneStepFailed()) {
            x.tutorAdvice = CTATMsgType.NOT_DONE_MSG, x.msg = p.createBuggyMessage(y.getTransactionID(), x.tutorAdvice), x.msgType = "BuggyMessage";
          } else {
            k.ctatdebug("CTATET.createBuggyMessage() past isDoneStepFailed()");
            var z = t && t.getTutorSAI() ? t.getTutorSAI().getSelection() : null, z = z && "" !== z.trim() ? z : null, A = y.getStudentSAI() ? y.getStudentSAI().getSelection() : null, A = A && "" !== A.trim() ? A : null;
            k.ctatdebug("CTATET.createBuggyMessage() past hintSelection0 " + z + ", studentSelection0 " + A);
            y.getResult() == CTATExampleTracerLink.NO_MODEL && y.isOutOfOrder() && z && z != A && (k.ctatdebug("CTATET.createBuggyMessage() to create out of order"), k.isHighlightRightSelection() ? (x.tutorAdvice = k.getOutOfOrderMessage(), x.msg = p.createHighlightWidgetMessage(z, t.getTutorSAI().getAction(), x.tutorAdvice, y.getTransactionID()), x.msgType = "HighlightMsg", k.ctatdebug("createBuggyMessage() out of order with highlight; rtn: " + x)) : (x.tutorAdvice = "You need to do other steps first, before doing the step you just worked on. You might request a hint for more help.", 
            x.msg = p.createBuggyMessage(y.getTransactionID, x.tutorAdvice), x.msgType = "BuggyMessage", k.ctatdebug("createBuggyMessage() out of order without highlight; rtn: " + x)));
            k.ctatdebug("createBuggyMessage() exiting rtn: " + x);
          }
        }
        k.ctatdebug("createBuggyMessage() tutorAdvice: " + x.tutorAdvice + ";\n  msg " + x.msg);
        k.updateSkills(CTATExampleTracerSkill.INCORRECT, v.getSkillNames(), v.getUniqueID());
        k.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, p.createAssociatedRulesMessageForAction(h.getResult(), l && l.getSelection() ? l : g, g, k.getSkillBarVector(), q, n, x.tutorAdvice), h);
        x.msg && k.messageTank.addToMessageTank(x.msgType, x.msg, h);
        w = g;
  ...
  var k = this, n = null, m, t, r, p = new CTATXML;
  new XMLSerializer;
  var w = null, v, y = CTATMsgType.SHOW_ALL_FEEDBACK, B = !0, C = !1, q = null, x = null, u = new ProblemStateSaver(k), D = null, A = new CTATProblemStateStatus, z = [], E = [], F = 0, G = !1, K = "";
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      k.ctatdebug("No of children" + p.getElementChildren(a).length);
      ...
      for (var c = [], e = new XMLSerializer, f = -1, g = 0;g < a.length;g++) {
        if ("message" == p.getElementName(a[g])) {
          var h = e.serializeToString(a[g]), l = CTATMsgType.getMessageType(h);
          CTATMsgType.UNTUTORED_ACTION != l && CTATMsgType.INTERFACE_ACTION != l || k.setVariablesFromSAI(a[g], p);
  ...
  this.sendBundle = function(a) {
    ...
    for (var b = 0, c = 0;c < a.length;c++) {
      ...
      u.forwardToInterface(d, c >= a.length - 1, A) && ++b;
    }
    return 0 < b;
  };
  this.setHintPolicy = function(a) {
    v = CTATHintPolicyEnum.lookup(a);
  };
  ...
  this.setFeedbackPolicy = function(a) {
    y = "false" === a ? CTATMsgType.SHOW_ALL_FEEDBACK : "true" === a ? CTATMsgType.HIDE_ALL_FEEDBACK : a;
  };
