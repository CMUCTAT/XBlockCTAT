...
(function(a) {
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      return 864E5 === b ? m(c, 36E5, 6E4) : 36E5 === b ? m(c, 6E4, 1E3) : c;
    }, h = function(a, b, d, f) {
      if ("N/A" !== d) {
        return d;
      }
      ...
      for (var e = {}, g = b.olson.dst_rules.zones, l = g.length, k = a[f], w = 0;w < l;w++) {
        var B = g[w], C;
        C = g[w];
        for (var q = 0, z = 0;z < d.length;z++) {
          if (C.rules[z] && d[z]) {
            if (d[z].s >= C.rules[z].s && d[z].e <= C.rules[z].e) {
              q = 0, q += Math.abs(d[z].s - C.rules[z].s), q += Math.abs(C.rules[z].e - d[z].e);
            } else {
              q = "N/A";
              break;
            }
      ...
      for (var x in e) {
        if (e.hasOwnProperty(x) && -1 != k.indexOf(x)) {
          return x;
        }
      }
      return f;
      ...
      var d = function() {
        for (var a = [], d = 0;d < b.olson.dst_rules.years.length;d++) {
          ...
          for (var g = (new Date(c)).getTimezoneOffset(), l = null, k = null;c < e - 864E5;) {
            var h = new Date(c), m = h.getTimezoneOffset();
            m !== g && (m < g && (l = h), m > g && (k = h), g = m);
            c += 864E5;
          }
          e = l && k ? {s:f(l).getTime(), e:f(k).getTime()} : !1;
          a.push(e);
        }
        return a;
      }();
    ...
    return {determine:function() {
      var f = d();
      f || (f = b.olson.timezones[g()], "undefined" !== typeof a[f] && (f = k(f)));
...
(function(a, b) {
  ...
  function c(a, b, d, f) {
    ...
    var c = m.substring(0, m.indexOf("Animation")).toLowerCase();
    p[e] || (t.insertRule("@" + (c && "-" + c + "-" || "") + "keyframes " + e + "{0%{opacity:" + f + "}" + d + "%{opacity:" + a + "}" + (d + .01) + "%{opacity:1}" + (d + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + f + "}}", t.cssRules.length), p[e] = 1);
    return e;
  }
  function e(a, b) {
    var d = a.style, f, e;
  ...
  function l() {
    ...
    h.prototype.lines = function(a, e) {
      function c() {
        return g(d("group", {coordsize:h + " " + h, coordorigin:-k + " " + -k}), {width:h, height:h});
      }
      function l(a, h, n) {
        b(p, b(g(c(), {rotation:360 / e.lines * a + "deg", left:~~h}), b(g(d("roundrect", {arcsize:e.corners}), {width:k, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:n}), d("fill", {color:f(e.color, a), opacity:e.opacity}), d("stroke", {opacity:0}))));
      }
      var k = e.scale * (e.length + e.width), h = 2 * e.scale * k, n = -(e.width + e.length) * e.scale * 2 + "px", p = g(c(), {position:"absolute", top:n, left:n});
      if (e.shadow) {
        for (n = 1;n <= e.lines;n++) {
  ...
  var k = ["webkit", "Moz", "ms", "O"], p = {}, m, t, r = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!m) {
      var c = 0, l = (f.lines - 1) * (1 - f.direction) / 2, k, h = f.fps, n = h / f.speed, p = (1 - f.opacity) / (n * f.trail / 100), r = n / f.lines;
      (function F() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          k = Math.max(1 - (c + (f.lines - a) * r) % n * p, f.opacity), d.opacity(e, a * f.direction + l, k, f);
        }
        d.timeout = d.el && setTimeout(F, ~~(1E3 / h));
      })();
    }
    return d;
  }, stop:function() {
    ...
    function l(b, d) {
      return g(a(), {position:"absolute", width:e.scale * (e.length + e.width) + "px", height:e.scale * e.width + "px", background:b, boxShadow:d, transformOrigin:"left", transform:"rotate(" + ~~(360 / e.lines * k + e.rotate) + "deg) translate(" + e.scale * e.radius + "px,0)", borderRadius:(e.corners * e.scale * e.width >> 1) + "px"});
    }
    for (var k = 0, h = (e.lines - 1) * (1 - e.direction) / 2, n;k < e.lines;k++) {
      n = g(a(), {position:"absolute", top:1 + ~(e.scale * e.width / 2) + "px", transform:e.hwaccel ? "translate3d(0,0,0)" : "", opacity:e.opacity, animation:m && c(e.opacity, e.trail, h + k * e.direction, e.lines) + " " + 1 / e.speed + "s linear infinite"}), e.shadow && b(n, g(l("#000", "0 0 4px #000"), {top:"2px"})), b(d, b(n, l(f(e.color, k), "0 0 1px rgba(0,0,0,.1)")));
    }
    return d;
  ...
  if ("undefined" !== typeof document) {
    ...
    var n = g(a("group"), {behavior:"url(#default#VML)"});
    !e(n, "transform") && n.adj ? l() : m = e(n, "animation");
  }
  return h;
});
  ...
  this.addSelectorAttribute = function(a, b, d) {
    ...
    a: {
      if (0 === c) {
        ...
        for (var p = 0;p < e.length && null !== e[p][0];p++) {
          if (e[p][0] == a) {
            a = p;
            break a;
          }
...
var commLibrary = CTATGlobals.selectedTextInput = null, commLMSService = null, commMessageBuilder = null, commMessageHandler = null, commLogMessageBuilder = null, commLoggingLibrary = null, nameTranslator = null, hints = [], hintIndex = 0, caseInsensitive = !0, unordered = !0, lockWidget = !0;
...
function CTATXBlock(a, b) {
  ...
  this.runXBlockDiagnostics = function(a, b) {
    ...
    if (a) {
      for (var d in a) {
        a.hasOwnProperty(d) && ("string" === typeof a[d] ? console.log("XBlock " + a + " : " + d + ' ["' + a[d] + '"]') : console.log("XBlock " + a + " : " + d + " (Object)"));
      }
    } else {
      console.log("Internal error: Object is null or undefined, can't traverse");
    }
    console.log("runXBlockDiagnostics () done");
  };
  this.getRuntime = function(a) {
    if (!this.versions.hasOwnProperty(a)) {
      throw "Unsupported XBlock version: " + a;
    }
  ...
  $(function(a) {
    ...
    c.runXBlockDiagnostics(window.self, "window.self");
    c.runXBlockDiagnostics(window.self.RuntimeProvider.getRuntime(a), "window.self.RuntimeProvider.getRuntime (version)");
    c.runXBlockDiagnostics(window.XBlock, "window.XBlock");
    c.runXBlockDiagnostics(window.XBlock.data, "window.XBlock.data");
    loadCTAT();
  });
...
;var CTATGlobalFunctions = {stringToBoolean:function(a) {
  ...
  return {admit_code:"ies", authenticity_token:"none", auth_token:"none", BehaviorRecorderMode:"AuthorTimeTutoring", class_name:"", curriculum_service_url:"", dataset_level_name:"", dataset_level_name1:"Unit1", dataset_level_type1:"unit", dataset_level_type:"ProblemSet", dataset_name:"FlashLoggingTest_xxx", expire_logout_url:"none", info:"", instructor_name:"none", instrumentation_log:"off", lcId:"none", Logging:"None", log_service_url:"http://pslc-qa.andrew.cmu.edu/log/server", log_to_disk_directory:".", 
  keyboard:"disabled", problem_name:"xxx", problem_position:"none", problem_started_url:"none", problem_state_status:"empty", question_file:"html_interface_test.brd", refresh_session_url:"none", remoteSocketPort:"80", remoteSocketURL:"http://localhost", restore_problem_url:"none", reuse_swf:"false", run_problem_url:"none", school_name:"none", SessionLog:"true", session_id:"none", session_timeout:"none", skills:"", source_id:"PACT_CTAT_HTML5", student_interface:"none", student_problem_id:"none", study_condition_name:"", 
  study_condition_type:"", study_condition_description:"", study_name:"Study1", target_frame:"none", TutorShopDeliveryMethod:"sendandload", tutoring_service_communication:"javascript", user_guid:"qa-test", wmode:"opaque", DeliverUsingOLI:!1, ssl:"off", sui:"", centerTutor:!1, previewMode:!1, width:550, height:450};
...
var CTATGraphicsTools = function(a, b, c, e, g, d) {
  ...
  var f = b || 1, h = c || "#000000", l = e || "#EEEEEE", k = g || !1, p = "Arial", m = a || null;
  a = d || !1;
  var t = 0, r = this;
  if (null == m) {
  ...
  this.drawLine = function(a, b, d, f, e, c) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawLine");
    a += t;
    d += t;
    b += t;
    f += t;
  ...
  this.drawCircle = function(a, b, d) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawCircle");
    a += t;
    b += t;
    m.strokeStyle = h;
    m.lineWidth = f;
    m.beginPath();
    m.arc(a, b, d, 0, 2 * Math.PI);
    m.stroke();
  };
  this.drawCircleFilled = function(a, b, d) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawCircleFilled");
    a += t;
    b += t;
    m.fillStyle = l;
    m.beginPath();
  ...
  this.drawRectangle = function(a, b, d, e) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangle");
    a += t;
    b += t;
    m.lineWidth = f;
    1 == k ? (m.fillStyle = l, m.fillRect(a, b, d, e)) : (m.strokeStyle = h, m.beginPath(), m.rect(a, b, d, e), m.stroke());
  };
  this.drawRectangleFilled = function(a, b, d, f) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangleFilled");
    a += t;
    b += t;
    m.fillStyle = l;
    m.fillRect(a, b, d, f);
  ...
  this.drawRoundedRect = function(a, b, d, e, c) {
    a += t;
    b += t;
    null != m && (m.strokeStyle = h, m.lineWidth = f, m.beginPath(), m.moveTo(a, b + c), m.lineTo(a, b + e - c), m.quadraticCurveTo(a, b + e, a + c, b + e), m.lineTo(a + d - c, b + e), m.quadraticCurveTo(a + d, b + e, a + d, b + e - c), m.lineTo(a + d, b + c), m.quadraticCurveTo(a + d, b, a + d - c, b), m.lineTo(a + c, b), m.quadraticCurveTo(a, b, a, b + c), m.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, d, e, c) {
    a += t;
    b += t;
    null != m && (m.strokeStyle = h, m.lineWidth = f, m.beginPath(), m.moveTo(a, b + c), m.lineTo(a, b + e - c), m.quadraticCurveTo(a, b + e, a + c, b + e), m.lineTo(a + d - c, b + e), m.quadraticCurveTo(a + d, b + e, a + d, b + e - c), m.lineTo(a + d, b + c), m.quadraticCurveTo(a + d, b, a + d - c, b), m.lineTo(a + c, b), m.quadraticCurveTo(a, b, a, b + c), m.stroke(), m.fillStyle = l, m.beginPath(), m.moveTo(a, b + c), m.lineTo(a, b + e - c), m.quadraticCurveTo(a, b + e, a + c, b + e), m.lineTo(a + 
    d - c, b + e), m.quadraticCurveTo(a + d, b + e, a + d, b + e - c), m.lineTo(a + d, b + c), m.quadraticCurveTo(a + d, b, a + d - c, b), m.lineTo(a + c, b), m.quadraticCurveTo(a, b, a, b + c), m.fill());
  };
  this.drawText = function(a, b, d) {
    if (null != m) {
      ...
      b += t;
      try {
        m.fillStyle = h, m.font = p + " 12pt", m.fillText(d, a, b);
      } catch (e) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTextFormatted = function(a, b, d, e, f, c, g, l, k, h) {
    if (null != m) {
      a += t;
      b += t;
      e = "";
      ...
      e += "12pt " + p;
      try {
        m.fillStyle = c, m.font = e, m.fillText(d, a, b);
      } catch (r) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  ...
  this.drawTriangle = function(a, b, d, e, c, g) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangle");
    a += t;
    d += t;
    c += t;
    b += t;
  ...
  this.drawTriangleFilled = function(a, b, d, e, c, g) {
    null == m && r.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangleFilled");
    a += t;
    d += t;
    c += t;
    b += t;
  ...
  this.clearCanvas = function(a, b, d, e) {
    "ctat" == CTATConfig.platform && m.clearRect(a, b, d, e);
  };
};
...
var CTATMobileTutorHandler = function(a, b) {
  ...
  this.processTextFocus = function(a, b, h, l, k) {
    this.ctatdebug("processTextFocus (" + a + "," + b + "," + h + "," + l + "," + k + ")");
    ...
    if ("disabled" != e && ("auto" != e || 0 != g)) {
      ...
      if (null != b) {
        try {
          ...
          this.ctatdebug("Error description: " + c.message);
        }
      } else {
...
;var CTATShape = function(a, b, c, e, g, d) {
  ...
  var h = [], l = [], k = g, p = d, m = b, t = void 0, r = "black", n = "black", v = "Arial", u = 12, w = [], B = 1, C = 5, q = document.createElement("canvas");
  q.id = m;
  q.width = k;
  q.height = p;
  var z = new CTATCSS;
  z.addCSSAttribute("position", "absolute");
  z.addCSSAttribute("left", c + "px");
  z.addCSSAttribute("top", e + "px");
  z.addCSSAttribute("visibility", "visible");
  z.addCSSAttribute("background-color", "rgba(0, 0, 0, 0)");
  z.addCSSAttribute("border-style", "none");
  q.setAttribute("style", z.toCSSString());
  getSafeElementById(a).appendChild(q);
  var x = new CTATGraphicsTools(q.getContext("2d"));
  x.setGraphicBorderWidth(B);
  x.setLineColor(r);
  x.setFillColor(n);
  ...
  this.setXPoints = function(a) {
    h = a;
    z.modifyCSSAttribute("left", h[0] + "px");
    q.setAttribute("style", z.toCSSString());
  };
  this.setYPoints = function(a) {
    l = a;
    z.modifyCSSAttribute("top", l[0] + "px");
    q.setAttribute("style", z.toCSSString());
  };
  this.setWidth = function(b) {
    k = b;
    "main-canvas" != a && (q.width = k);
  };
  this.setHeight = function(b) {
    p = b;
    "main-canvas" != a && (q.height = p);
  };
  this.setName = function(a) {
    m = a;
  };
  ...
  this.modifyCanvasCSS = function(a, b) {
    z.modifyCSSAttribute(a, b);
    q.setAttribute("style", z.toCSSString());
  };
  this.detatchCanvas = function() {
    a == ctatcontainer ? getSafeElementById(a).removeChild(q) : getSafeElementById("ctatdiv" + a).removeChild(q);
  };
  ...
  this.drawLine = function() {
    x.drawLine(h[0] + B, l[0] + B, h[1], l[1], r, B);
  };
  this.drawCircle = function() {
    x.drawCircle(h[0] + C, l[0] + C, C);
  };
  this.drawCircleFilled = function() {
    x.drawCircleFilled(h[0] + C, l[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, d, e) {
    x.drawRectangle(a[0] + B, b[0] + B, k - B, p - B);
  };
  this.drawRectangleFilled = function() {
    x.drawRectangleFilled(h[0], l[0], k, p);
  };
  this.drawRoundedRect = function() {
    x.drawRoundedRect(h[0] + B, l[0] + B, k - C - B, p - C - B, C);
  };
  this.drawRoundedRectFilled = function() {
    x.drawRoundedRectFilled(h[0] + B, l[0] + B, k - C - B, p - C - B, C);
  };
  this.drawText = function() {
    x.drawText(u / 2, u / 2, t);
  };
  this.drawTriangle = function() {
    x.drawTriangle(h[0] + B, l[0] + B, h[1], l[1], h[2], l[2]);
  };
  this.drawTriangleFilled = function() {
    x.drawTriangleFilled(h[0], l[0], h[1], l[1], h[2], l[2]);
  };
  this.save = function() {
    x.save();
  };
  ...
  this.erase = function() {
    ...
    z.addCSSAttribute("border-style", "none");
    q.setAttribute("style", z.toCSSString());
    a == ctatcontainer ? getSafeElementById(a).appendChild(q) : getSafeElementById("ctatdiv" + a).appendChild(q);
    for (var b = 0;b < w.length;b++) {
      q.addEventListener(w[b][0], w[b][1]);
    }
  };
};
var CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (x.ctatdebug("errScrimUp (" + a + ")"), 1 == g ? 1 == r && (r = !1, getSafeElementById(ctatcontainer).removeChild(q)) : 1 == f && (r = !0), x.scrimUp(a));
  }
  function c(a, b) {
    x.ctatdebug("makeHTMLButton ()");
    var d = document.createElement("input");
    d.type = "button";
    d.value = b;
    null != a ? (x.ctatdebug("clickHandle!=null"), d.onclick = a) : (x.ctatdebug("clickHandle==null"), d.onclick = x.defaultClickHandler);
    d.id = b;
    d.setAttribute("class", "scrimButton");
    return d;
  }
  CTATBase.call(this, "CTATScrim", "__undefined__");
  var e = !1, g = !1, d = !0, f = !1, h = !1, l = !0, k = !0, p = "", m = !1, t = !1, r = !1, n = null, v = null, u = new CTATCanvasComponent("CTAT Scrim"), w = [], B = null, C = null, q = null, z = null, x = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (x.ctatdebug("scrimUp ()"), x.ctatdebug("Message: " + b), 1 == e ? (p = 1 == d ? b : p + (" \n " + b), u.removeComponent()) : (p = b, e = !0), x.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        x.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + p + "<br><br></div></div></div>\t\t"), !0 === r && (q = c(a, "close"), $(q).appendTo("#scrimpanel")), !0 === m && (B = c(n, "yes"), $(B).appendTo("#scrimpanel")), !0 === t && (C = c(v, "no"), $(C).appendTo("#scrimpanel")), 
        1 == d)) {
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (x.ctatdebug("waitScrimUp ()"), d = !0, x.scrimUp("Please wait while the tutor is being loaded"));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (x.ctatdebug("nextProblemScrimUp ()"), x.scrimUp("Retrieving the Next Problem..."));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (x.ctatdebug("OKScrimUp (" + a + "," + b + ")"), x.scrimUp(a), z = c(b, spaceUsedUp, "OK"), $(z).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (x.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), t = m = !0, v = d, n = b, x.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == l ? (x.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), w.push("ERROR: " + a), g = !0) : 0 == k ? x.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (g = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == l ? (x.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), w.push("WARNING: " + a), f = !0) : 0 == k ? x.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (f = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    h = !0;
    x.scrimUp("The tutor has disconnected. Please refresh the page.");
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == e ? x.ctatdebug("The scrim isn't up, returning") : 1 == g ? x.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == f ? x.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == h ? x.ctatdebug("The scrim is up for a connection issue leave it up!") : ($("#scrim").remove(), u.removeComponent(), d = e = !1, p = ""));
  };
  this.defaultClickHandler = function() {
    x.ctatdebug("defaultClickHandler ()");
    x.scrimDown();
  };
  this.setInAuthorTime = function(a) {
    x.ctatdebug("setting inAuthorTime = " + a);
    l = !0;
    k = a;
    if (!a) {
      f = g = !1, r && null.removeChild(q);
    } else {
      if (g || f) {
        for (var d in w) {
          b(d);
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var e = "", g = 0, d = [], f = a ? a : null, h = null == b ? !0 : b, l = !0, k = null, p = c ? c : {}, m = this;
  ...
  this.getURL = function() {
    m.ctatdebug("getURL ()");
    if ("" != e) {
      return m.ctatdebug("Returning fixedURL: " + e), e;
    }
  ...
  this.sendXMLURL = function(a, b) {
    ...
    m.ctatdebug("Sending: " + d);
    1 == this.getUseCommSettings() ? "javascript" == e.tutoring_service_communication ? CTAT.ToolTutor.sendToTutor(d) : this.send_post(b, d) : this.send_post(b, d);
  };
  ...
  this.send = function(a) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      d.push(b);
      b.setURL(a);
      b.getHTTPObject().onreadystatechange = this.processReply;
      try {
        b.getHTTPObject().open("GET", a, !0);
      } catch (e) {
        this.ctatdebug("Error in newConnection.httpObject.open: " + e.message);
        return;
      }
      try {
        b.init();
      } catch (e) {
        this.ctatdebug("Error in newConnection.init: " + e.message);
        return;
      }
      try {
        b.getHTTPObject().send(null);
      } catch (e) {
        this.ctatdebug("Error in newConnection.httpObject.send: " + e.message);
      }
    }
  };
  this.send_post = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var e = new CTATConnection(p);
      e.setID(g);
      g++;
      if (null === e.getHTTPObject()) {
        return alert("Cannot create XMLHTTP instance"), !1;
      }
      d.push(e);
      m.ctatdebug(b);
      ...
      e.setURL(a);
      e.setData(b);
      e.getHTTPObject().onreadystatechange = this.processReply;
      e.getHTTPObject().onerror = function() {
        m.ctatdebug("Networking error!");
      };
      try {
        e.getHTTPObject().open("POST", a, !0);
      } catch (c) {
        m.ctatdebug("Error in newConnection.httpObject.open: " + c.message);
        return;
      }
      try {
        e.init();
      } catch (c) {
        m.ctatdebug("Error in newConnection.init: " + c.message);
        return;
      }
      try {
        e.getHTTPObject().send(b);
      } catch (c) {
  ...
  this.processReply = function(a) {
    ...
    var b = 0, e = !1;
    a = [];
    for (var c = 0, c = 0;c < d.length;c++) {
      var g = d[c], l = g.getHTTPObject();
      m.ctatdebug("Testing connection entry " + c + ", readyState: " + l.readyState + ", testConnection.consumed: " + g.getConsumed());
      4 == l.readyState && 0 == g.getConsumed() ? (m.ctatdebug("Investigating request response: " + b + " -> " + l.status + ", for: " + g.getURL()), e = !1, 0 === l.status && (e = !0, m.ctatdebug("Received message (status 0): " + l.responseText)), 408 == l.status && (e = !0, m.ctatdebug("Received message (status 408): " + l.responseText), h && CTATScrim.scrim.scrimDown()), 502 == l.status && (e = !0, m.ctatdebug("Received message (status 502): " + l.responseText), h && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == l.status ? (e = !0, m.ctatdebug("Processing 200 response ..."), null !== f ? (a.push(l.responseText), null != k && k.processIncoming(l.responseText)) : m.ctatdebug("Error: httphandler is null, can't process response!")) : f && f.processError && (e = !0, m.ctatdebug("Processing non-200 response, status " + l.status), f.processError(l.status, l.responseText)), !1 === e && m.ctatdebug("Error: status not handled for: " + l.status), m.ctatdebug("Marking connection as consumed ..."), g.setConsumed(!0)) : 
      (0 === l.readyState && m.ctatdebug("Received message (status 0, request not initialized)"), 1 === l.readyState && m.ctatdebug("Received message (status 1, server connection established)"), 2 === l.readyState && m.ctatdebug("Received message (status 2, request received)"), 3 === l.readyState && m.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    m.cleanup();
    for (b = 0;b < a.length;b++) {
      e = a[b], -1 != e.indexOf("status=success") ? m.ctatdebug("Info: logging success message received, not propagating to message handler") : (m.ctatdebug("Processing incoming message: " + e), f.processMessage(e));
    }
  };
  ...
  this.checkEntries = function() {
    ...
    for (var a = 0, b = 0, b = 0;b < d.length;b++) {
      var e = d[b];
      if (!0 === e.getConsumed()) {
        return m.ctatdebug("Removing : " + e.getID()), d.splice(a, 1), !0;
      }
      var c = e.getHTTPObject();
      m.ctatdebug("Check, readyState: " + c.readyState + ", consumed: " + e.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, d) {
    ...
    e.onreadystatechange = function() {
      m.ctatdebug("onready... GET for xmlFile xmlhttp.readyState " + e.readyState + ", .status " + e.status + ", parser " + b);
      if (4 == e.readyState && 200 == e.status) {
        var c = null;
        e.responseXML ? (m.ctatdebug("parsing brd xml using something else"), c = e.responseXML.documentElement) : (m.ctatdebug("parsing brd xml using node"), c = (b = new CTATXML).parseXML(e.responseText));
        null == c ? (c = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), m.ctatdebug("error parsing xmlFile " + a + ": " + c), CTAT.ToolTutor.sendToInterface(c, !0)) : d.processXML(c);
      }
    };
    e.onerror = function() {
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    if (null != b && null != h) {
      ...
      for (var c = "<dataset>" + ("<name>" + d.dataset_name + "</name>"), l = 0;l < b.length;l++) {
        a.ctatdebug("Adding ..."), c += '<level type="' + b[l] + '">', c += "<name>" + h[l] + "</name>";
      }
      c += "<problem ";
    ...
    if (0 < b.length) {
      for (l = 0;l < b.length;l++) {
        d += "<condition><name>" + b[l] + "</name>", d += "" == c[l] ? "" : "<type>" + c[l] + "</type>", d += "" == h[l] ? "" : "<desc>" + h[l] + "</desc>", d += "</condition>";
      }
    }
    var f = f + d, d = flashVars.getCustomFields(), k;
    for (k in d) {
      d.hasOwnProperty(k) && (f += "<custom_field>", f += "<name>" + k + "</name>", f += "<value>" + d[k] + "</value>", f += "</custom_field>");
    }
    f += "</context_message>";
  ...
  this.createUIEventToolMessage = function(e, g, d, f) {
    ...
    f || (l += this.makeMetaElement(h));
    l += '<ui_event name="' + g + '">' + d + "</ui_event>";
  ...
  this.createTutorMessage = function(e, g, d, f, h, l, k, p) {
    a.ctatdebug("createTutorMessage()");
    var m = new Date;
    flashVars.getRawFlashVars();
    k = '<tutor_message context_message_id="' + this.getContextName() + '">';
    p || (k += this.makeMetaElement(m));
    g = '<semantic_event transaction_id="' + g + '" name="' + d + '"';
    "" !== l && (g += ' subtype="' + l + '"');
    k += g + "/>";
    ...
    k += e;
    "" != h && (k += "<tutor_advice>" + h + "</tutor_advice>");
    void 0 != skillSet && null != skillSet ? (a.ctatdebug("Adding " + skillSet.getSize() + " skills to log message ..."), k += skillSet.toLogString()) : a.ctatdebug("No skills defined for this message");
    k += this.createCustomFields(b, c);
    k += "</tutor_message>";
    a.ctatdebug("messageString = " + k);
    return k;
  ...
  this.wrapForOLI = function(b) {
    ...
    f = d["data-activitycontextguid"] ? f + ('external_object_id="' + d["data-activitycontextguid"] + '" info_type="tutor_message.dtd">') : f + 'external_object_id="" info_type="tutor_message.dtd">';
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, e = !1, g = !1, d = [], f = "undefined", h = "undefined", l = "undefined", k = "undefined", p = "undefined", m = "undefined", t = "undefined", r = "undefined", n = "UnassignedDataset", v = "UnassignedLevelName", u = "UnassignedLevelType", r = (new CTATGuid).guid();
  void 0 != a && null != a ? (e = a, 0 == e && (commLogMessageBuilder = new CTATLogMessageBuilder)) : commLogMessageBuilder = new CTATLogMessageBuilder;
  var w = new CTATCommLibrary;
  w.setName("commLoggingLibrary");
  w.setUseCommSettings(!1);
  w.assignHandler(this);
  ...
  this.logTutorResponse = function(a, d, c, f, e, g, l, k, h) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var p = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(k, h);
    commLogMessageBuilder.addCustomField("tutor_event_time", commLogMessageBuilder.formatTimeStamp(p) + " UTC");
    b.ctatdebug("Formatting feedback ...");
    k = "";
    void 0 != g && null != g ? -1 != g.indexOf("'") || -1 != g.indexOf('"') || -1 != g.indexOf("<") || -1 != g.indexOf(">") || -1 != g.indexOf("&") ? (b.ctatdebug("Feedback message contains invalid characters, wrapping in CDATA ..."), k = "<![CDATA[" + g + "]]\x3e") : (b.ctatdebug("Feedback message doesn't contain any invalid characters, using as-is"), k = g) : (b.ctatdebug("No feedback provided, using empty string"), k = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(d, a, c, e, k, f, l, !0);
    this.sendMessage(a);
  };
  ...
  this.logResponse = function(a, d, c, f, e, g, l, k) {
    b.ctatdebug("logResponse ()");
    d = new CTATSAI(d, c, f);
    d.setInput(f);
    f = new CTATActionEvaluationData("");
    f.setEvaluation(g);
    void 0 == k ? this.logTutorResponse(a, d, e, "", f, l) : this.logTutorResponse(a, d, e, "", f, l, k.getCustomElementNames(), k.getCustomElementTypes());
  };
  this.logResponseSAI = function(a, d, c, f, e, g) {
    b.ctatdebug("logResponse ()");
    var l = new CTATActionEvaluationData("");
    l.setEvaluation(f);
    void 0 == g ? this.logTutorResponse(a, d, c, "", l, e) : this.logTutorResponse(a, d, c, "", l, e, g.getCustomElementNames(), g.getCustomElementTypes());
  };
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var f = c || 0, h = e || 0, l = g || -2, k = d || -2, p = 50, m = 25, t = !1, r = "", n = !1, v = !0, u = null, w = "", B = -1;
  this.isTabIndexable = !0;
  var C = 0, q = null, z = null, x = this, D = null, A = "hidden", y = CTATGlobalFunctions.gensym.z_index(), E = CTATGlobalFunctions.gensym.div_id(), F = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.makeDivWrapper = function(a) {
    ...
    u.id = this.getName();
    u.setAttribute("onkeypress", "return noenter(event)");
    u.setAttribute("data-ctat-component", this.getClassName());
    u.style.position = "absolute";
    u.style.left = f + "px";
    u.style.top = h + "px";
    u.style.zIndex = y;
    u.style.width = x.getWidth() + "px";
    u.style.height = x.getHeight() + "px";
    $(u).data("CTATComponent", this);
    a.appendChild(u);
  };
  ...
  this.setClassName = function(a) {
    K(a);
    u && u.setAttribute("data-ctat-component", this.getClassName());
  };
  ...
  this.createCanvas = function() {
    ...
    D.setAttribute("id", G);
    D.setAttribute("onkeypress", "return noenter(event)");
    D.setAttribute("width", l + canvasCalibrate + "px");
    D.setAttribute("height", k + canvasCalibrate + "px");
    D.setAttribute("style", "border: 1px " + this.borderColor + " solid; visibility:" + A + "; z-index:" + F + ";");
    u.firstChild ? u.insertBefore(D, u.firstChild) : u.appendChild(D);
    return D;
  };
  this.redraw = function() {
    var a = u.style.display;
  ...
  this.getWidth = function() {
    if (0 >= l) {
      var a;
      q ? a = window.getComputedStyle(q) : u && (a = window.getComputedStyle(u));
      if (a) {
  ...
  this.setEnabled = function(a) {
    ...
    x.assignEnabled(a);
    q ? q.disabled = !v : x.ctatdebug("Error: component pointer is null");
  };
  ...
  this.setComponent = function(a) {
    q = a;
    q.classList.add("CTAT-gen-component");
  ...
  this.initialize = function() {
    ...
    this.render();
    this.processTabOrder();
  };
  this.addSafeEventListener = function(a, b, d) {
    x.ctatdebug("addSafeEventListener (" + a + ")");
    x.ctatdebug("Adding event listener to: " + d);
    d ? d.addEventListener(a, b) : (q ? q.addEventListener(a, b) : x.ctatdebug("Error: pointer to component is null, can't add event listener"), x.ctatdebug("addSafeEventListener () done"));
  };
  this.setInitialized = function(a) {
    x.ctatdebug("setInitialized (" + a + ")");
    n = a;
    !0 !== n || u ? x.ctatdebug("Not wrapping, initialized=" + n + ", divWrapper = " + u) : (x.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (x.ctatdebug("Attaching component to existing MovieClip ..."), x.wrapComponent(a.getDivWrapper())) : (x.ctatdebug("Attaching component to main div ..."), $("#" + ctatcontainer).first() && x.wrapComponent(getSafeElementById(ctatcontainer))));
  ...
  this.move = function(a, b) {
    f = a;
    h = b;
    u && (u.style.left = f + "px", u.style.top = h + "px");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    A = !0 === a ? "block" : "hidden";
    D && D.setAttribute("style", "border: 0px; position: absolute; visibility:" + A + "; left:" + f + "px; top:" + h + "px; z-index:" + F + ";");
    u.style.visibility = !0 === a ? "block" : "hidden";
  };
  ...
  this.processOnFocus = function() {
    ...
    CTATGlobals.Tab.previousFocus && CTATGlobals.Tab.previousFocus.setHintHighlight(!1, null, null);
  ...
  this.processTabOrder = function() {
    x.ctatdebug("processTabOrder (" + B + ")");
    !0 === t ? x.ctatdebug("Component is an abstract component, bump") : q ? (x.ctatdebug("We have a component, actually assigning to html component ..."), q.tabIndex = B, q.onfocus = x.processOnFocus) : x.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
var CTATMovieClip = function(a, b, c, e, g) {
  ...
  this.wrapComponent = function(a) {
    ...
    p.setAttribute("id", f);
    p.setAttribute("name", this.getName());
    p.setAttribute("style", "z-index: " + d);
    p.setAttribute("width", e + "px");
    p.setAttribute("height", g + "px");
    p.setAttribute("style", "border: 0px; position: absolute; left:" + b + "px; top:" + c + "px; z-index:" + h + ";");
    a.appendChild(p);
    return p;
  };
...
var CTATPlayButton = function() {
  ...
  (function() {
    ...
    g = new CTATShape("PlayTutor", "play circle", h.width / 2 - l, h.height / 2 - l, 2 * l, 2 * l);
    g.addPoint(0, 0);
    g.setFillColor("green");
    g.setRadius(l);
    g.drawCircleFilled();
...
var CTATSkill = function() {
  ...
  this.toSetPreferencesXMLString = function() {
    var f = '<skill label="' + b + '" pSlip="' + l + '" description="' + d;
    return f += '" pKnown="' + k + '" category="' + c + '" pLearn="' + p + '" name="' + a + '" pGuess="' + h + '" />';
  };
...
var CTATSkillSet = function() {
    ...
    if (null == b) {
      ...
      if (b = b.childNodes, null == b) {
        ...
        for (var c = 0;c < b.length;c++) {
          var e = b[c];
          "Skill" == e.nodeName && (this.ctatdebug("Parsing node (" + c + "): " + e.nodeName + " -> " + e.nodeValue), this.addSkill(e.attributes.getNamedItem("name").value, e.attributes.getNamedItem("pKnown").value, .95, e.attributes.getNamedItem("label").value, e.attributes.getNamedItem("label").value, e.attributes.getNamedItem("category").value, e.attributes.getNamedItem("pGuess").value, e.attributes.getNamedItem("pLearn").value, e.attributes.getNamedItem("pSlip").value));
        }
      }
    }
  };
  ...
  this.addSkill = function(a, c, e, g, d, f, h, l, k) {
    this.ctatdebug("addSkill() name = " + a + " level = " + c + " mastery = " + e + " aDescription = " + g + " adisplayName = " + d + " aCategory = " + f + " pguess= " + h + " plearn = " + l + " pslip = " + k);
    ...
    "" !== h && (a.setPGuess(h), a.setPLearn(l), a.setPSlip(k));
    return a;
  };
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var l = CTATGlobals.Visual.BackgroundColor, k = "white", p = 1, m = CTATGlobals.Visual.BorderColor, t = !1, r = "solid", n = 0, v = "1px", u = 0, w = CTATGlobals.Font.color, B = "black", C = CTATGlobals.Font.family, q = CTATGlobals.Font.size, z = !1, x = !1, D = !1;
  ...
  this.getBorderColor = function() {
    return this.component ? $(this.component).css("border-color") : m;
  };
  this.setBorderColor = function(a) {
    m = CTATGlobalFunctions.formatColor(a);
    this.component && m !== this.getBorderColor() && (this.component.style.borderColor = m);
    return this;
  };
  this.getBorderRoundness = function() {
    return this.component ? $(this.component).css("border-radius") : n;
  };
  this.setBorderRoundness = function(a) {
    a = parseInt(a);
    n = isNaN(a) ? 0 : a;
    this.component && this.getBorderRoundness() !== n && (this.component.style.borderRadius = n);
    return this;
  };
  ...
  this.getPadding = function() {
    return this.component ? parseInt($(this.component).css("padding-left")) : u;
  };
  this.setPadding = function(a) {
    u = parseInt(a);
    isNaN(u) && (u = 0);
    this.component && this.getPadding() !== u && (this.component.style.padding = u + "px");
    return this;
  };
  ...
  this.setFontColor = function(a) {
    w = CTATGlobalFunctions.formatColor(a);
    this.component && this.getFontColor() !== w && (this.component.style.color = w);
    return this;
  };
  ...
  this.setFontSize = function(a) {
    a = parseInt(a);
    q = isNaN(a) ? CTATGlobals.Font.size : a;
    this.component && parseInt(this.getFontSize()) !== q && (this.component.style.fontSize = q + "pt");
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== t && (t ? (this.setBorderStyle(r), this.setBorderWidth(v)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getUnderlined = function() {
    return this.component ? "underline" === window.getComputedStyle(this.component).getPropertyValue("text-decoration") : D;
  };
  this.setUnderlined = function(a) {
    D = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getUnderlined() !== D && (this.component.style.textDecoration = D ? "underline" : null);
    return this;
  };
  this.getBolded = function() {
    return this.component ? "bold" === window.getComputedStyle(this.component).getPropertyValue("font-weight") : z;
  };
  this.setBolded = function(a) {
    z = CTATGlobalFunctions.stringToBoolean(a);
    this.component && this.getBolded() !== z && (this.component.style.fontWeight = z ? "bold" : null);
    return this;
  };
  ...
  this.processAttributes = function() {
    for (var a in this.data_ctat_handlers) {
      if (this.getDivWrap()) {
        var b = $(this.getDivWrap()).data("ctat-" + a);
        void 0 !== b && this.data_ctat_handlers[a].apply(this, [b]);
      }
    }
  };
...
var CTATSkillWindow = function(a, b, c, e, g) {
  ...
  this.updateSkillSet = function(a) {
    ...
    if (null == skillSet) {
      ...
      for (var b = 0;b < a.length;b++) {
        var c = a[b];
        d.ctatdebug("Updating skill " + c.getSkillName() + " to level: " + c.getLevel() + " ...");
        skillSet.setSkillLevel(c.getSkillName(), c.getLevel(), 1);
      }
      this.drawComponent();
    }
  };
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), c = 0;c < a.length;c++) {
            var f = a[c];
            d.ctatdebug("Drawing skill " + c + " " + f.getDisplayName() + " level: " + f.getLevel() + " ...");
            var e = document.createElement("div");
            e.classList.add("CTAT-skill-window--bar");
            var g = document.createElement("div"), n = f.getLevel();
            .95 > n ? g.classList.add("CTAT-skill-window--bar--nonmastered") : g.classList.add("CTAT-skill-window--bar--mastery");
            g.style.width = .95 < n ? "100%" : 100 * n + "%";
            e.appendChild(g);
            b.appendChild(e);
            e = document.createElement("div");
            e.textContent = f.getDisplayName() || "no-name";
...
var CTATSAI = function(a, b, c, e) {
  function g(a, b, d, c) {
    c = String(n.getElementName(b)).toLowerCase();
    if (c == a || "value" == c) {
      if (c = n.getElementChildren(b), !Array.isArray(c) || 1 > c.length) {
        d.push(n.getNodeTextValue(b));
      } else {
  ...
  var d = "undefined", f = "undefined", h = new CTATStringUtil, l = [], k = [], p = [], m = [], t = [], r = [], n;
  n = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  this.getArguments = function() {
    return l;
  };
  this.getArgumentsTyped = function() {
    this.ctatdebug("getArgumentsTyped");
    for (var a = 0, b = [], a = 0;a < l.length;a++) {
      var d = l[a];
  ...
  this.appendToActionArray = function(a) {
    null == a ? t.push("") : t.push(String(a));
  };
  this.setActionArray = function(a) {
    t = null == a ? [] : Array.isArray(a) ? a.slice() : [String(a)];
  };
  ...
  this.fromXML = function(a) {
    ...
    l = [];
    a = n.getElementChildren(a);
    for (var b = null, d = 0;d < a.length;d++) {
      var c = a[d];
      if ("selection" == n.getElementName(c) || "Selection" == n.getElementName(c)) {
        for (var f = n.getElementChildren(c), e = !1, g = 0;g < f.length;g++) {
          b = f[g], "value" == n.getElementName(b) && (b = n.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = n.getNodeTextValue(c), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == n.getElementName(c) || "Action" == n.getElementName(c)) {
        f = n.getElementChildren(c);
        e = !1;
        for (g = 0;g < f.length;g++) {
          b = f[g], "value" == n.getElementName(b) && (b = n.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = n.getNodeTextValue(c), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == n.getElementName(c) || "value" == n.getElementName(c) || "Input" == n.getElementName(c)) {
        var b = n.getElementChildren(c), k = null;
        l = [];
        f = new CTATHTMLManager;
        e = new CTATArgument;
        g = 0;
        l.push(e);
        for (var h = 0;h < b.length;h++) {
          var p = b[h];
          "value" == n.getElementName(p) && (k = n.getElementChildren(p), null !== k ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + k.length), 1 === k.length ? (k = f.htmlDecode(n.getNodeTextValue(p)), this.ctatdebug("Setting new value to: " + k), e.setValue(k)) : (k = f.htmlDecode(n.getNodeTextValue(p)), this.ctatdebug("Setting new value to: " + k), e.setValue(k), e.setName(p.attributes.getNamedItem("name").value), e.setType(p.attributes.getNamedItem("type").value), 
          e.setFormat(p.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(k) : this.appendToInputArray(k)) : (p = f.htmlDecode(n.getNodeTextValue(p)), this.ctatdebug("Setting new value to: " + p), e.setValue(p), 1 > h ? this.setInputArray(p) : this.appendToInputArray(p)));
        }
      }
      if ("prompt" == n.getElementName(c) || "Prompt" == n.getElementName(c)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(n.getNodeTextValue(c));
      }
    }
    this.checkDefaultArgument();
  };
  this.setArrayFromElements = function(a) {
    if (a && Array.isArray(a) && !(1 > a.length)) {
      var b = null, d = String(n.getElementName(a[0])).toLowerCase();
      switch(d) {
        case "selection":
          b = m = [];
          break;
      ...
      this.ctatdebug("CTATSAI.setArrayFromElements() eltName " + d + ", length " + c + ", selectionArray " + this.getSelectionArray() + ", actionArray " + this.getActionArray() + ", inputArray " + this.getInputArray());
    }
  };
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == n.getElementName(c) || "Input" == n.getElementName(c)) {
        b = c.childNodes;
        l = [];
        var f = new CTATHTMLManager, e = new CTATArgument, g = 0, k = null;
        l.push(e);
        for (var h = 0;h < b.length;h++) {
          if (k = b[h], "value" == n.getElementName(k)) {
            var p = n.getElementChildren(k);
            null !== p ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + p.length), 1 === p.length ? (k = f.htmlDecode(n.getNodeTextValue(k)), this.ctatdebug("Setting new value to: " + k), e.setValue(k)) : (k = f.htmlDecode(n.getNodeTextValue(k)), this.ctatdebug("Setting new value to: " + k), e.setValue(k), e.setName(n.getElementAttr("name")), e.setType(n.getElementAttr("type")), e.setFormat(n.getElementAttr("format")), g++)) : (k = f.htmlDecode(n.getNodeTextValue(k)), this.ctatdebug("Setting new value to: " + 
            k), e.setValue(k));
            1 > h ? this.setInputArray(k) : this.appendToInputArray(k);
          }
        }
      }
      if ("prompt" == n.getElementName(c) || "Prompt" == n.getElementName(c)) {
  ...
  this.clone = function() {
    ...
    a.setAddedSelections(k.slice(0));
    a.setAddedActions(p.slice(0));
  ...
  var v = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(c) || null == c) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(c), v = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == c ? null : c[0], "String", e);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, c, "String", e), v || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(c) ? c : [c]), v = !0));
};
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, f = !1, h = new CTATSkillSet, l = "", k = "", p = "", m = "", t = "", r = null, n = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      "tool_message" == e.getElementName(b) ? (this.ctatdebug("Detected tool message"), l = "tool_message") : "message" != e.getElementName(b) ? (this.ctatdebug("Detected log message"), d = !0, l = e.getElementName(b)) : (this.ctatdebug("Detected regular message"), d = !1, this.parseMessageType());
      ...
      this.ctatdebug("Message " + l + ", with transaction id: " + k);
    }
  };
    ...
    if ("tool_message" == l) {
      ...
      for (c = 0;c < a.length;c++) {
        if (g = a[c], "tool_message" == e.getElementName(g)) {
          for (g = e.getElementChildren(g), k = 0;k < g.length;k++) {
            n = g[k], "event_descriptor" == e.getElementName(n) && (r = new CTATSAI, r.fromXMLInternal(n));
          }
        }
      }
      f = !0;
      ...
      if (d) {
        ...
        for (var x = e.getElementChildren(b), D = 0;D < x.length;D++) {
          var A = x[D];
          if ("event_descriptor" == e.getElementName(A)) {
            for (var A = e.getElementChildren(A), y = 0;y < A.length;y++) {
              var E = A[y];
              "selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), n.push(E));
              "action" == e.getElementName(E) && (c = e.getNodeTextValue(E), q.push(E));
              "input" == e.getElementName(E) && (g = e.getNodeTextValue(E), z.push(E));
              "prompt" == e.getElementName(E) && (k = e.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), x = e.getElementChildren(b), D = 0;D < x.length;D++) {
          if (A = x[D], "properties" == e.getElementName(A)) {
            for (A = e.getElementChildren(A), y = 0;y < A.length;y++) {
              E = A[y], this.ctatdebug("Nodename: " + e.getElementName(E)), "Skills" == e.getElementName(E) && h.parseByValue(E), "SuccessMsg" == e.getElementName(E) && (p = a = e.getNodeTextValue(E)), "BuggyMsg" == e.getElementName(E) && (m = e.getNodeTextValue(E)), "Selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), n.push(E)), "Action" == e.getElementName(E) && (c = e.getNodeTextValue(E), q.push(E)), "Input" == e.getElementName(E) && (g = e.getNodeTextValue(E), z.push(E)), "prompt" == 
              e.getElementName(E) && (k = e.getNodeTextValue(E)), "HighlightMsgText" == e.getElementName(E) && (t = e.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + g);
      "" !== a && null !== a ? (r = new CTATSAI(a, c, g, k), r.setArrayFromElements(n), r.setArrayFromElements(q), r.setArrayFromElements(z), f = !0) : (this.ctatdebug("No SAI found"), f = !1);
      this.ctatdebug("parseSAI () done, hassai: " + f + ", (" + a + "," + c + "," + g + "," + k + ")");
    }
  };
      ...
      if (!d) {
        for (var a = e.getElementChildren(b), c = 0;c < a.length;c++) {
          ...
          if ("properties" == e.getElementName(f)) {
            for (var f = e.getElementChildren(f), g = 0;g < f.length;g++) {
              var h = f[g];
              "transaction_id" == e.getElementName(h) && (k = e.getNodeTextValue(h));
            }
          }
        }
      }
      this.ctatdebug("parseTransactionID() done, id: " + k);
    }
  };
  this.parseMessageType = function() {
    ...
    for (var a = e.getElementChildren(b), d = 0;d < a.length;d++) {
      ...
      if ("properties" == e.getElementName(c)) {
        for (var c = e.getElementChildren(c), f = 0;f < c.length;f++) {
          var g = c[f];
          "MessageType" == e.getElementName(g) && (l = e.getNodeTextValue(g));
        }
      }
    }
  ...
  k = CTATMessage.makeTransactionId();
  this.parse();
  ...
  this.executeSAI = function(a) {
    ...
    if (b instanceof CTATSAI) {
      ...
      if ("function" == typeof this[d]) {
        ...
        try {
          this.ctatdebug("Executing " + d + "(" + b + "," + typeof a + ")..."), this[d](b, a);
        } catch (c) {
          return this.ctatdebug("ERROR: failed to execute action: " + c.message), !1;
        }
...
CTAT.Component.Base.Tutorable = function(a, b, c, e, g, d, f) {
  ...
  var h = !0, l = !0, k = !0, p = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, m = !0, t = this, r = !1;
  ...
  this.data_ctat_handlers["show-feedback"] = function(a) {
    k = CTATGlobalFunctions.toBoolean(a);
  };
  this.getTutorComponent = function() {
    var a = CTAT.Component.Base.Tutorable.Options.TutorComponent;
    return h && l && k ? a.TUTOR : h && l && !k ? a.TUTOR_NO_FEEDBACK : !h && l ? a.DO_NOT_TUTOR : p;
  };
  ...
  this.setCorrect = function(a) {
    ...
    !0 === m && this.setEnabled(!1);
    !1 === CTATGlobals.suppressStudentFeedback && k && this.showCorrect(a);
  ...
  this.setIncorrect = function(a) {
    ...
    !1 === CTATGlobals.suppressStudentFeedback && k && this.showInCorrect(a);
  ...
  this.setHintHighlight = function(a, b) {
    ...
    0 != a && (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = t, CTATGlobals.Tab.Focus.getComponent().focus());
    if (n) {
      var d = CTATGlobalFunctions.toBoolean(a);
      if (this.component) {
        var c = new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight, {detail:{isHighlighted:d, component:this}, bubbles:!0, cancelable:!0});
        this.getComponent().dispatchEvent(c);
      }
...
var CTATImageButtonComponent = function(a, b, c, e, g, d, f) {
  ...
  var h = "", l = "", k = "", p = "", m = !1, t = "Image to Component", r = this;
  ...
  this.assignImages = function(a, b, d, c) {
  ...
  this.assignActiveImage = function(a) {
    if (null !== r.getComponent() && (r.getComponent().src = a, r.getComponent().style.opacity = this.getTransparencyValue(), "Component to Image" == t)) {
      var b = new Image;
      b.src = a;
      r.setWidth(b.width);
  ...
  this.setEnabled = function(a) {
    ...
    r.assignEnabled(a);
    null === r.getComponent() ? r.ctatdebug("Error: pointer is null!") : (r.getComponent().disabled = !a, !1 === r.getEnabled() ? r.assignActiveImage(p) : r.assignActiveImage(h), r.ctatdebug("setEnabled () -> " + r.getEnabled()));
  };
  this.processMouseOver = function(a) {
    !0 !== m && (m = !0, !0 === r.getEnabled() ? r.assignActiveImage(k) : r.ctatdebug("Error component is disabled"), m = !1);
  };
  this.processMouseOut = function(a) {
    !0 !== m && (m = !0, !0 === r.getEnabled() && r.assignActiveImage(h), m = !1);
  };
};
...
CTAT.Component.Base.SVG = function(a, b, c, e, g, d, f) {
  ...
  this.initSVG = function() {
    ...
    var a = CTATGlobals.NameSpace.svg, b = CTATGlobals.NameSpace.xml, d = CTATGlobals.NameSpace.xlink, c = CTATGlobals.NameSpace.ev, f = document.createDocumentFragment();
    ...
    h.setAttributeNS(b, "xmlns:ev", c);
    a = document.createElementNS(a, "defs");
    h.appendChild(a);
    this.getDivWrap().appendChild(f);
    this.setComponent(h);
  };
  ...
  this.getBoundingBox = function() {
    var a = new DOMRect(0, 0, this.getWidth(), this.getHeight()), b = this.getComponent(), d = window.getComputedStyle(b), b = parseInt(d.getPropertyValue("padding-left")), c = parseInt(d.getPropertyValue("padding-right")), f = parseInt(d.getPropertyValue("padding-bottom")), e = parseInt(d.getPropertyValue("padding-right")), g = parseInt(d.getPropertyValue("border-left-width")), h = parseInt(d.getPropertyValue("border-right-width")), u = parseInt(d.getPropertyValue("border-bottom-width")), d = parseInt(d.getPropertyValue("border-right-width"));
    a.width -= b + e + g + d;
    a.height -= c + f + h + u;
    return a;
  };
...
var CTATTextBasedComponent = function(a, b, c, e, g, d, f) {
  ...
  var t = this.processAction.bind(this);
  this.processAction = function(a, b) {
    this.updateSAI();
    CTATGlobalFunctions.isBlank(this.getValue()) || t(a, b);
  };
    ...
    if (null === d) {
      ...
      switch(h.ctatdebug(d.getName() + " keydown (" + ("google" == CTATConfig.platform ? 0 : window.event ? window.event.keyCode : a.which) + " -> " + a.eventPhase + ") ID: " + b), a.which) {
        ...
        case 39:
          ...
          break;
        case 13:
          return k ? (h.component.blur(), CTATGlobals.Tab.Focus = null, h.processAction(), !1) : !0;
        case 0:
          h.component.blur();
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  var l = "#FF00FF", k = 1, p = "#FF00FF", m = .2, t = "black", r = 1;
  ...
  this.getPiecesBySelected = function(a) {
    for (var b = this.getPieces(), d = [], c, f = 0;f < b.length;f++) {
      c = b[f], u(c) === a && d.push(c);
    }
    return d;
  };
  ...
  this.setDeselectedColor = function(a) {
    ...
    for (var b = 0;b < a.length;b++) {
      a[b].setAttributeNS(null, "fill", p);
    }
  };
  ...
  this.clickHandler = function(a) {
    !0 === v.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), w(this, !a), v.setActionInput("SetPieces", v.updateValue()), v.processAction());
  };
  this.updateSAI = function() {
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = z(b), this.get_denominator() != a)) {
      var d = v.evaluate();
      v.clear();
      a = [];
      d.set_denominator(b);
      for (var c = new CTAT.Math.Fraction(1, b), f = Math.floor(d.numerator), e = b - f, g = 0;g < f;g++) {
        a.push(C(c, !0));
      }
      b = new CTAT.Math.Fraction(d.numerator - f, b);
      b.equals(0) || (a.push(C(b, !0)), a.push(C(c.subtract(b), !1)), e--);
      for (b = 0;b < e;b++) {
        a.push(C(c, !1));
      }
  ...
  this.get_denominator = function() {
    return n.reduce(function(a, b, d, c) {
  ...
  this.set_number_pieces = function(a) {
    ...
    if (!isNaN(a)) {
      ...
      var b = v.numActive();
      v.clear();
      for (var d = [], c = new CTAT.Math.Fraction(1, a), f = 0;f < a;f++) {
        d.push(C(c, 0 < b)), b--;
      }
  ...
  this.change_number_pieces = function(a) {
    this.set_number_pieces(n.length + a);
  };
  ...
  var x = function(a) {
    if (0 !== Object.keys(D).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        if (a != v) {
          if (D.hasOwnProperty(a.getName())) {
            return D[a.getName()];
          }
          if (D.hasOwnProperty(a.getComponentGroup())) {
            return D[a.getComponentGroup()];
          }
        }
      } else {
        if (a instanceof CTATSAI) {
          if (a.getSelection() != v.getName() && D.hasOwnProperty(a.getSelection())) {
            return D[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != v.getName() && D.hasOwnProperty(a)) {
              return D[a];
            }
          } else {
            if (a instanceof Element && a != v.getComponent() && D.hasOwnProperty(a.id)) {
              return D[a.id];
            }
          }
        }
  ...
  this.change_numerator = function(a) {
    0 !== a && (0 < a ? n.every(function(b) {
      !1 === u(b) && (w(b, !0), a--);
      return 0 < a;
    }) : (n.reverse(), n.every(function(b) {
      !0 === u(b) && (w(b, !1), a++);
      return 0 > a;
    }), n.reverse()));
  };
  a = function(a, b, d) {
    var c = parseInt(d.getInput());
    if (!isNaN(c)) {
      switch(d.getAction()) {
        case "ButtonPressed":
          a.call(this, c);
...
var CTATComboBox = function(a, b, c, e, g) {
  ...
  this.setStyleHandler("SplitCharacter", function(a) {
    h = a;
    f && (f.innerHTML = "", this.addLabels(l, h));
  }.bind(this));
  var l = "---,x,y,z";
  ...
  this.init = function() {
    ...
    a ? f.innerHTML = a : this.addLabels(l, h);
    d.assignEnabled(!0);
  ...
  this.addLabels = function(a, b) {
    for (var d = a.split(b ? b : h), c = 0;c < d.length;c++) {
      this.addItem(d[c]);
    }
  };
...
var CTATFractionBar = function(a, b, c, e, g) {
  ...
  var d = 50, f = !0, h = this, l = CTATGlobals.NameSpace.svg;
  this.init = function() {
    h.initSVG();
    this.baseGroup = document.createElementNS(l, "g");
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = h.parseValue(), b = 0, d = document.createDocumentFragment(), c = 0;c < a.length;c++) {
        var f = a[c], e = 100 * f, g = document.createElementNS(l, "rect");
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          var b = window.getComputedStyle(a), d = parseFloat(b.getPropertyValue("padding-left")), c = parseFloat(b.getPropertyValue("stroke-width")), b = a.getBBox();
          a.setAttributeNS(null, "y", b.y + c / 2);
          a.setAttributeNS(null, "height", b.height - c);
          var f = b.x + c / 2, c = b.width - c;
          1 > b.x ? c -= d / 2 : (f += d / 2, c = b.x + b.width >= u ? c - d / 2 : c - d);
...
var CTATImageButton = function(a, b, c, e, g) {
  ...
  var d = this, f = null, h = null, l = null;
  this.configFromDescription();
  this.init = function() {
    f = new Image;
    f.name = d.getName();
    ...
    l.setAttribute("style", "position: absolute;left:0px; top: 0px; z-index: " + CTATGlobalFunctions.gensym.z_index() + ";width: " + d.getWidth() + "px;height: " + d.getHeight() + "px; opacity : 0.0; filter: alpha(opacity=0); background-color: #ffffff");
    d.getDivWrap().appendChild(l);
    d.addSafeEventListener("click", d.processClick, l);
    d.addSafeEventListener("focus", d.processFocus, l);
    d.addSafeEventListener("mouseover", d.processMouseOver, l);
    d.addSafeEventListener("mouseout", d.processMouseOut, l);
  };
};
...
var CTATJumble = function(a, b, c, e, g) {
  ...
  var d = "", f = "center", h = 0, l = 10, k = !1, p = this;
  p.setActionInput("SetOrder", d);
  var m = null;
  this.init = function() {
    p.setInitialized(!0);
    m = document.createElement("div");
    m.classList.add("CTAT-jumble");
    this.setComponent(m);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    this.getDivWrap().appendChild(m);
    p.addComponentReference(p, p.getDivWrap());
    a ? (m.innerHTML = a, $(m).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      this.addEventListener("dragstart", r, !1);
      this.addEventListener("dragenter", v, !1);
      this.addEventListener("dragover", n, !1);
      this.addEventListener("dragleave", u, !1);
      this.addEventListener("drop", w, !1);
      this.addEventListener("dragend", C, !1);
    })) : this.init_items(d);
    this.component.addEventListener("focus", this.processFocus);
  };
  var t = null, r = function(a) {
  ...
  this.init_items = function(a) {
    if (m) {
      ...
      for (var d = a.length, c = 0;c < d;c++) {
        ...
        f.classList.add("CTAT-jumble--item");
        f.addEventListener("dragstart", r, !1);
        f.addEventListener("dragenter", v, !1);
        f.addEventListener("dragover", n, !1);
        f.addEventListener("dragleave", u, !1);
        f.addEventListener("drop", w, !1);
        f.addEventListener("dragend", C, !1);
        b.appendChild(f);
        B.push(f);
      }
      m.innerHTML = "";
  ...
  this.getOrder = function() {
    for (var a = m.children, b = [], c = 0;c < a.length;c++) {
      var f = a[c];
      f.draggable && b.push(f.id);
    }
    return d = b.join(";");
  };
};
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  var k = new a(new d(0), 25, "#FF00FF", !1);
  ...
  var v = null, u = function(a, b, d, c) {
    ...
    Object.defineProperty(this, "length", {get:function() {
      f.hasOwnProperty("length") || (f.length = CTAT.Math.round(this.min_loc.distance(this.max_loc)));
      return f.length;
    }});
    ...
    this.step = function() {
      f.hasOwnProperty("step") || (f.step = this.s_vec().normalize(this.step_size));
      return f.step;
    };
    this.scalar = function() {
      f.hasOwnProperty("scalar") || (f.scalar = this.range / this.length);
      return f.scalar;
    };
    this.zero = function() {
      f.hasOwnProperty("zero") || (f.zero = this.min_loc.add(this.step().scale(-this.min)), f.zero.x = CTAT.Math.round(f.zero.x), f.zero.y = CTAT.Math.round(f.zero.y));
      return f.zero;
    };
    this.angle = function() {
      if (!f.hasOwnProperty("angle")) {
        var a = this.end.add(this.start.scale(-1));
        f.angle = Math.atan2(a.y, a.x);
      }
      return f.angle;
    };
  ...
  this.genTickmark = function(a, b, d) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var e = document.createElementNS(f, "line"), g = v.getPosition(a), l = CTAT.Geom.Point.polar(d / 2, n.theta + Math.PI / 2).add(g);
      d = CTAT.Geom.Point.polar(-d / 2, n.theta + Math.PI / 2).add(g);
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            var k = document.createElementNS(f, "tspan"), h = document.createElementNS(f, "tspan");
            ...
            b.length > l.length ? k.style.textDecoration = "underline" : h.style.textDecoration = "overline";
  ...
  var w = function(a) {
    return B(a.step, a.size, a.orgin, a.show_labels ? null : "", a.color);
  }.bind(this), B = function(a, b, c, e, g) {
    g = new d;
    a = new d(a);
    b = "number" === typeof b ? b : 20;
    var l = document.createDocumentFragment(), k = document.createElementNS(f, "g");
    k.setAttributeNS(null, "data-step-size", a.toString());
    k.setAttributeNS(null, "pointer-events", "none");
    k.classList.add("CTAT-number-line--tickmark");
    l.appendChild(k);
    if (0 < a) {
      for (g.set(c).reduce();g <= p;) {
        g >= m && k.appendChild(n.genTickmark(g, e, b)), g = g.add(a);
      }
      g.set(c).reduce();
      for (g = g.subtract(a);g >= m;) {
        g <= p && k.appendChild(n.genTickmark(g, e, b)), g = g.subtract(a);
      }
    }
    return l;
  }.bind(this), C = null, q = function() {
    var a = this.getBoundingBox(), a = CTAT.Geom.Rectangle.inflate(a, -2, -2), b = new DOMPoint(a.width / 2, a.height / 2), d = b.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, n.theta)), c = Math.sin(n.theta), e = -Math.cos(n.theta), g = c * b.x + e * b.y, k = -a.height * e, r = -c * a.width, B = new DOMPoint(a.left, b.y), b = new DOMPoint(a.right, b.y);
    if (0 < Math.abs(CTAT.Math.round(k))) {
      var k = new DOMPoint(a.left, (g - c * a.left) / e), x = new DOMPoint(a.right, (g - c * a.right) / e);
      if (a.contains(k) || a.contains(x)) {
        d.distance(k) < d.distance(x) ? (B = x, b = k) : (B = k, b = x);
      }
    }
    0 < Math.abs(CTAT.Math.round(r)) && (r = new DOMPoint((g - e * a.top) / c, a.top), c = new DOMPoint((g - e * a.bottom) / c, a.bottom), a.containsPoint(r) || a.containsPoint(c)) && (d.distance(r) < d.distance(c) ? (B = c, b = r) : (B = r, b = c));
    a = document.createDocumentFragment();
    d = document.createElementNS(f, "g");
    d.classList.add("CTAT-number-line--axis");
    a.appendChild(d);
    c = document.createElementNS(f, "line");
    c.setAttributeNS(null, "x1", B.x);
    c.setAttributeNS(null, "y1", B.y);
    ...
    c.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(B) + ") rotate(" + n.getOrientation() + ")");
    d.appendChild(c);
    B = document.createElementNS(f, "path");
    B.setAttributeNS(null, "d", "M -10,6 L 0,0 L -10,-6");
    B.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(b) + ") rotate(" + n.getOrientation() + ")");
    d.appendChild(B);
    this._tickmarks = [];
    a.appendChild(w(h));
    a.appendChild(w(l));
    C = document.createElementNS(f, "circle");
    C.classList.add("CTAT-number-line--cursor");
    C.setAttributeNS(null, "r", t);
    C.setAttributeNS(null, "transform", "translate(-30,-30)");
    a.appendChild(C);
    n.baseGroup.innerHTML = "";
    n.baseGroup.appendChild(a);
    B = this.theta + Math.PI / 2;
    CTAT.Geom.Point.polar(3, B);
    CTAT.Math.round(Math.cos(B));
    CTAT.Math.round(Math.sin(B));
  }.bind(this), z = null, x = 0, D = new DOMPoint(-30, -30), A = !1, y = function(a) {
    D.x = a.clientX;
    D.y = a.clientY;
  }, E = function(a) {
    ...
    if (!0 === n.getEnabled()) {
      n.setHintHighlight(!1);
      var b;
      r ? (b = K(a.clientX, a.clientY), a = b.location, b = b.data) : (b = G(a.clientX, a.clientY), a = v.getProjectedPoint(b), b = v.getAxisValue(b));
      ...
      z.innerHTML = "";
      z.appendChild(d);
      n.setActionInput("AddPoint", b.toString());
      n.processAction();
    }
  };
  this.init = function() {
    ...
    this.getComponent().appendChild(this.baseGroup);
    q();
    z = document.createElementNS(f, "g");
    z.setAttributeNS(null, "fill", "black");
    z.setAttributeNS(null, "stroke-width", 1);
    z.setAttributeNS(null, "stroke", "black");
    this.baseGroup.appendChild(z);
    n.addComponentReference(n, n.getDivWrap());
    n.addSafeEventListener("mousemove", y);
    n.addSafeEventListener("mouseleave", E);
    n.addSafeEventListener("mouseenter", function() {
      !0 === n.getEnabled() && (A = !0, C.style.fillOpacity = null, x = requestAnimationFrame(H));
    });
    n.addSafeEventListener("click", F);
    this.component.addEventListener("focus", this.processFocus);
  };
  var G = function(a, b) {
    this.svgPoint = this.svgPoint ? this.svgPoint : n.getComponent().createSVGPoint();
    this.svgPoint.x = a;
    this.svgPoint.y = b;
    var d = n.getComponent().getScreenCTM().inverse();
    this.svgPoint = this.svgPoint.matrixTransform(d);
    return new DOMPoint(this.svgPoint.x, this.svgPoint.y);
  }, K = function(a, b) {
    for (var d = v.getProjectedPoint(G(a, b)), c = null, f = Number.POSITIVE_INFINITY, e, g, l = 0;l < n._tickmarks.length;l++) {
      e = n._tickmarks[l], g = d.distance(e.location), g < f && (c = e, f = g);
    }
    return c;
  }, H = function() {
    if (A && !0 === n.getEnabled()) {
      if (r) {
        var a = K(D.x, D.y);
        C.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(a.location, !0));
      } else {
        C.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(v.getProjectedPoint(G(D.x, D.y)), !0));
      }
  ...
  this.placePointByNum = function(a) {
    a = n.calcXCoordinate(a);
    return n.placePointByCoor(a);
  };
  this.calcXCoordinate = function(a) {
    a = new d(a);
    var b = n.getWidth() - 30, b = Math.abs(b - 30), c = p.subtract(m);
    return 30 + a.subtract(m).divide(c) / b;
  };
  this.calcNum = function(a) {
    var b = n.getWidth() - 30, b = Math.abs(b - 30);
    a = p.subtract(m).multiply((a - 30) / b);
    return m.add(a);
  };
  ...
  this.setPointSize = function(a) {
    t = Number(a);
    C && (C.setAttributeNS(null, "r", t), z.setAttributeNS(null, "r", t));
  };
  ...
  this.set_precision = function(a) {
    n.setPrecision(parseInt(a));
    n.render();
  };
  this.Points = function(a) {
    a = a.split(";");
    for (var b = 0;b < a.length;b++) {
      n.placePointByNum(a[b]);
    }
  };
  this.set_denominator = function(a) {
  };
...
var CTATPieChart = function(a, b, c, e, g) {
  ...
  var d = 3, f = 3, h = 3, l = this, k, p, m, t = null, r = CTATGlobals.NameSpace.svg;
  this.init = function() {
    l.initSVG();
    this.baseGroup = document.createElementNS(r, "g");
    this.getComponent().appendChild(this.baseGroup);
    this.getComponent().classList.add("CTAT-pie-chart");
    k = document.createElementNS(r, "filter");
    k.id = this.genName("Shadow");
    p = "#" + k.id;
    m = "url(" + p + ")";
    k.setAttributeNS(null, "width", "200%");
    k.setAttributeNS(null, "height", "200%");
    t = document.createElementNS(r, "feOffset");
    t.setAttributeNS(null, "in", "SourceAlpha");
    t.setAttributeNS(null, "result", "offOut");
    t.setAttributeNS(null, "dx", h);
    t.setAttributeNS(null, "dy", h);
    k.appendChild(t);
    ...
    this.baseGroup.setAttributeNS(null, "filter", m);
    this.drawPieces();
    l.addComponentReference(l, l.getDivWrap());
    this.component.addEventListener("focus", this.processFocus);
  };
  this.drawPieces = function() {
    if (this.baseGroup) {
      var a = window.getComputedStyle(l.getComponent()), a = parseFloat(a.getPropertyValue("stroke-width")), b = this.getBoundingBox(), c = Math.min(b.width / 2, b.height / 2) - (a + h + 4), f = new DOMPoint(b.width / 2, b.height / 2), a = l.parseValue(), e = document.createDocumentFragment();
      a.reduce(function(a, b, g, k) {
        if (1 <= b.valueOf()) {
          g = document.createElementNS(r, "circle"), g.classList.add("CTAT-pie-chart--piece"), g.cx.baseVal.value = f.x, g.cy.baseVal.value = f.y, g.r.baseVal.value = c, l.addPieceElem(g, b, b.selected), e.appendChild(g);
        } else {
          ...
          k = f.add(CTAT.Geom.Point.polar(c, h));
          b.reduce();
          var p = f.add(CTAT.Geom.Point.polar(c, 2 * Math.PI * b.valueOf() + h)), n = f.clone();
          if (0 < d && d < c) {
            ...
            k = CTAT.Geom.Point.circle_intersection(n, k, f, c).reduce(m.bind(this, k));
            p = p.add(h);
            p = CTAT.Geom.Point.circle_intersection(n, p, f, c).reduce(m.bind(this, p));
          }
          h = CTAT.Geom.Point.to2DString;
          n = "M " + h(n);
          m = new DOMPoint(c, c);
          n += " L " + h(k);
          n += " A " + h(m) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + h(p);
          g.setAttributeNS(null, "d", n + " Z");
          l.addPieceElem(g, b, b.selected);
        }
        return a.add(b);
      }, new CTAT.Math.Fraction);
      this.baseGroup.innerHTML = "";
  ...
  this.setDropShadowDistance = function(a) {
    h = parseInt(a);
    h = isNaN(h) ? 0 : h;
    t && (t.setAttributeNS(null, "dx", h), t.setAttributeNS(null, "dy", h), 0 >= h && this.baseGroup && this.baseGroup.removeAttributeNS(null, "filter"));
  };
};
...
var CTATSubmitButton = function(a, b, c, e, g) {
  ...
  var l = function(a) {
    return 0 === Object.keys(f).length ? !1 : a instanceof CTAT.Component.Base.Tutorable ? a != d && (f.hasOwnProperty(a.getName()) || f.hasOwnProperty(a.getComponentGroup())) : a instanceof CTATSAI ? a.getSelection() != d.getName() && f.hasOwnProperty(a.getSelection()) : a instanceof String ? a != d.getName() && target.hasOwnProperty(a) : a instanceof Element ? a != d.getComponent() && target.hasOwnProperty(a.id) : !1;
  };
  a = CTAT.Component.Base.Tutorable.EventType;
  document.addEventListener(a.correct, function(a) {
    a.detail.sai && l(a.detail.component) && d.isNotGraded() && d.setCorrect();
  }, !1);
  document.addEventListener(a.incorrect, function(a) {
    a.detail.sai && l(a.detail.component) && (d.setIncorrect(), d.setEnabled(!0));
  }, !1);
  document.addEventListener(a.ungrade, function(a) {
    (a = a.detail.component) && l(a) && d.setNotGraded();
  }, !1);
  document.addEventListener(a.highlight, function(a) {
    var b = a.detail.component;
    b && l(b) && d.setHintHighlight(a.detail.isHighlighted);
  }, !1);
  this.processClick = function(a) {
    if (!0 === d.getEnabled()) {
      for (var b in f) {
...
var CTATTextArea = function(a, b, c, e, g) {
  ...
  this.UpdateTextField = this.UpdateTextArea = function(a) {
    d.ctatdebug("UpdateTextArea (" + a + ")");
    this.setText(a);
  };
};
...
var CTATNameTranslator = function() {
  ...
  this.manufactorJSON = function(a, e) {
    ...
    var d = this.getA1Row(g[0]), f = this.getA1Col(g[0]), h = this.getA1Row(g[1]), l = this.getA1Col(g[1]);
    b.ctatdebug("Manufacturing json from: [" + d + "," + f + "] to: [" + h + "," + l + "]");
    g = "[";
    d = parseInt(h) - parseInt(d);
    f = parseInt(l) - parseInt(f);
    d++;
    f++;
  ...
  this.translateFromCTAT = function(c, e) {
    ...
    if (-1 != g.indexOf(".r")) {
      ...
      if (0 == g.indexOf("r")) {
        var h = g.indexOf("c"), l = parseInt(g.substr(1, h - 1)), g = parseInt(g.substr(h + 1)), d = l + 1, f = g;
        b.ctatdebug("Original row (2nd format) (columnindex: " + h + "): " + l + " -> " + d + ", original col: " + g + " -> " + f);
        f = colName(f, !1) + d;
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), components:{}, component_descriptions:{}, registerComponentDescription:function(a) {
  ...
  var e = CTATShellTools.component_descriptions, g = [], d = $("#" + a);
  if (0 < d.length) {
    var f = [];
    d.each(function() {
  ...
  for (var l in e) {
    d = e[l];
    if (null === d) {
      return c.ctatdebug("Internal error parsing component at index " + l), null;
    }
    if (null === d.name) {
      return c.ctatdebug("Internal error parsing component at index " + l + " (no name attribute available)"), null;
    }
    if (d.name == a) {
...
var CTATMessageHandler = function() {
  ...
  this.processSingleMessage = function(d) {
    ...
    for (var g = 0;g < d.length;g++) {
      var l = d[g];
      if ("properties" == e.getElementName(l)) {
        b.ctatdebug("Parsing properties ...");
        for (var k = e.getElementChildren(l), p = 0;p < k.length;p++) {
          var m = k[p];
          if ("MessageType" == e.getElementName(m)) {
            m = e.getNodeTextValue(m);
            b.ctatdebug("MessageType: " + m);
            "StateGraph" == m && this.processStateGraph(l);
            "StartProblem" == m && (b.ctatdebug("Setting inStartState to true"), inStartState = !0, this.processStartProblem(k));
            "InterfaceIdentification" == m && this.processInterfaceIdentification(k);
            "InterfaceDescription" == m && this.processInterfaceDescription(k);
            "SendWidgetLock" == m && b.ctatdebug("Found: SendWidgetLock");
            if ("StartStateEnd" == m) {
            ...
            "CorrectAction" == m && (b.ctatdebug("Found: CorrectAction"), !0 === this.getInStartState() ? c.push(f) : a.processCorrectAction(f));
            "InCorrectAction" == m && (b.ctatdebug("Found: InCorrectAction"), !0 === inStartState ? c.push(f) : (b.ctatdebug("Handing incorrect message to messagehandler ..."), a.processInCorrectAction(f)));
            "HighlightMsg" == m && (b.ctatdebug("Found: HighlightMsg"), a.processHighlightMsg(f));
            "UnHighlightMsg" == m && (b.ctatdebug("Found: UnHighlightMsg"), a.processUnHighlightMsg(f));
            if ("AssociatedRules" == m) {
              b.ctatdebug("Found: AssociatedRules (" + k.length + ")");
              for (var t = "", r = "", n = 0;n < k.length;n++) {
                var v = k[n];
                "TutorAdvice" == e.getElementName(v) && (t = e.getNodeTextValue(v));
                "Actor" == e.getElementName(v) && e.getNodeTextValue(v);
                "Indicator" == e.getElementName(v) && (r = e.getNodeTextValue(v));
              ...
              a.processAssociatedRules(f, r, t);
            }
            "BuggyMessage" == m && (b.ctatdebug("Found: BuggyMessage"), a.processBuggyMessage(f));
            "SuccessMessage" == m && (b.ctatdebug("Found: SuccessMessage"), a.processSuccessMessage(f));
            "InterfaceAction" == m && (b.ctatdebug("Found: InterfaceAction"), !0 === inStartState ? (b.ctatdebug("inStartState==true => storing for later playback ..."), c.push(f)) : a.processInterfaceAction(f));
            "InterfaceIdentification" == m && b.ctatdebug("Found: InterfaceIdentification");
            "AuthorModeChange" == m && (b.ctatdebug("Found: AuthorModeChange"), a.globalReset());
            "ResetAction" == m && (b.ctatdebug("Found: ResetAction"), a.globalReset());
            if ("ShowHintsMessage" == m) {
              b.ctatdebug("Found: ShowHintsMessage");
              t = !1;
              r = [];
              for (n = 0;n < k.length;n++) {
                if (v = k[n], "HintsMessage" == e.getElementName(v)) {
                  for (var v = e.getElementChildren(v), u = 0;u < v.length;u++) {
                    var w = v[u];
                    "value" == e.getElementName(w) && (r.push(e.getNodeTextValue(w)), t = !0);
                  }
                }
              }
              !0 === t ? a.processHintResponse(f, r) : b.ctatdebug("Error: incomplete hint message received");
            }
            "ConfirmDone" == m && (b.ctatdebug("Found: ConfirmDone"), a.processConfirmDone(f));
            "VersionInfo" == m && (b.ctatdebug("Found: VersionInfo"), a.processVersionInfo(k));
            "TutoringServiceAlert" == m && (b.ctatdebug("Found: TutoringServiceAlert"), a.processTutoringServiceAlert(k));
            "TutoringServiceError" == m && (b.ctatdebug("Found: TutoringServiceError"), a.processTutoringServiceError(k));
            "ProblemSummaryResponse" == m && (b.ctatdebug("Found: ProblemSummaryResponse"), a.processProblemSummaryResponse(f));
            "ProblemRestoreEnd" == m && (b.ctatdebug("Found: ProblemRestoreEnd"), a.processProblemRestoreEnd(f));
          }
        }
      }
    }
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", g = "Unknown", l = null, k = 0;k < a.length;k++) {
      var p = a[k];
      ...
      "CommName" == e.getElementName(p) && (b.ctatdebug("Instance name: " + e.getNodeTextValue(p)), g = e.getNodeTextValue(p));
      if ("serialized" == e.getElementName(p)) {
        b.ctatdebug("Prepareing to de-serialize component ...");
        for (var m = e.getElementChildren(p), t = 0;t < m.length;t++) {
          var r = m[t];
          -1 != e.getElementName(r).indexOf("CTAT") && (l = r);
        }
      }
    ...
    null !== l ? this.deserializeComponent(c, g, l) : b.ctatdebug("Error: unable to find CTAT serialization point of attachement");
  ...
  this.deserializeComponent = function(a, c, g) {
    ...
    if (null === e.getElementAttr(g, "x")) {
      ...
      var l = e.getElementAttr(g, "x"), k = e.getElementAttr(g, "y"), p = e.getElementAttr(g, "width"), m = e.getElementAttr(g, "height"), t = e.getElementAttr(g, "tabIndex"), r = e.getElementAttr(g, "zIndex");
      null === t && (t = -1);
      null === r && (r = 0);
      var n = new CTATComponentDescription;
      n.type = a;
      n.name = c;
      n.x = Math.floor(l);
      n.y = Math.floor(k);
      n.tabIndex = t;
      n.zIndex = r;
      n.width = Math.floor(p);
      n.height = Math.floor(m);
      CTATShellTools.registerComponentDescription(n);
      g = e.getElementChildren(g);
      for (l = 0;l < g.length;l++) {
        k = g[l];
        e.getElementName(k);
        if ("Parameters" == e.getElementName(k)) {
          for (this.ctatdebug("Processing component parameters ..."), p = e.getElementChildren(k)[0], p = e.getElementChildren(p), m = 0;m < p.length;m++) {
            var v = p[m];
            if ("CTATComponentParameter" == e.getElementName(v)) {
              this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
              for (var r = t = void 0, v = e.getElementChildren(v), u = 0;u < v.length;u++) {
                var w = v[u];
                "name" == e.getElementName(w) && (this.ctatdebug("Found parameter name: " + e.getNodeTextValue(w)), t = e.getNodeTextValue(w));
                "value" == e.getElementName(w) && (this.ctatdebug("Found parameter value: " + e.getNodeTextValue(w)), r = e.getNodeTextValue(w).trim());
              }
              this.ctatdebug("Parameter name: " + t + ", value: " + r);
              void 0 !== t && (n.params[t] = r, "group" == t && (n.groupName = r));
            }
          }
        }
        if ("Styles" == e.getElementName(k)) {
          for (this.ctatdebug("Processing component styles ..."), k = e.getElementChildren(k)[0], k = e.getElementChildren(k), p = 0;p < k.length;p++) {
            if (r = k[p], "CTATStyleProperty" == e.getElementName(r)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              t = m = "";
              r = e.getElementChildren(r);
              for (v = 0;v < r.length;v++) {
                u = r[v], "name" == e.getElementName(u) && (m = e.getNodeTextValue(u)), "value" == e.getElementName(u) && (t = e.getNodeTextValue(u).trim());
              }
              this.ctatdebug("Style (name: " + m + ", value: " + t + ")");
              "" !== m && (n.styles[m] = t);
            }
          }
        }
...
var CTATCheckBox = function(a, b, c, e, g) {
  ...
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = null, f = null, h = null, l = "top";
  ...
  this.init = function() {
    ...
    this.getText() ? d.value = k.getText() : this.getDivWrap() && this.getDivWrap().textContent ? d.value = this.getDivWrap().textContent : d.value = d.id;
    this.getComponentGroup() ? d.name = k.getComponentGroup() : this.getDivWrap() && $(this.getDivWrap()).attr("name") ? d.name = $(this.getDivWrap()).attr("name") : d.name = "checkBoxGroup";
    k.assignEnabled(!0);
    !0 === k.getEnabled() ? d.disabled = !1 : d.disabled = !0;
    k.ctatdebug("Final location: " + k.getX() + "," + k.getY() + " with text: " + k.getText());
    k.addComponentReference(k, d);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    k.getDivWrap().appendChild(h);
    ...
    d.addEventListener("click", p.bind(this));
    k.addSafeEventListener("focus", k.processFocus, d);
    this.setSelection(this.getComponentGroup());
  };
  var m = this.setText;
  this.setText = function(a) {
    k.ctatdebug("setText (" + a + ")");
    m(a);
    h && (d.value = a, f.textContent = a);
  };
  this.setStyleHandler("labelText", this.setText);
  var t = this.setEnabled;
  this.setEnabled = function(a) {
    t(a);
  ...
  this.removeCorrect = n.bind(this, "CTAT--correct");
  this.showInCorrect = function(a) {
    n("CTAT--correct");
    n("CTAT--hint");
    r("CTAT--incorrect");
  };
  this.removeInCorrect = n.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    n("CTAT--incorrect");
    n("CTAT--correct");
    a ? r("CTAT--hint") : n("CTAT--hint");
  };
};
...
var CTATHintWindow = function(a, b, c, e, g) {
  ...
  var d = this;
  d.isTabIndexable = !1;
  var f = null, h = null, l = null, k = null;
  ...
  this.init = function() {
    ...
    k.setAttribute("id", CTATGlobalFunctions.gensym.div_id());
    k.setAttribute("onkeypress", "return noenter(event)");
    d.setComponent(k);
    k.classList.add("CTAT-gen-component");
    k.classList.add("CTAT-hint-window");
    d.addComponentReference(d, k);
    ...
    a.style.transform = "scale(2,2) rotate(180deg)";
    ...
    h.appendChild(document.createTextNode("Previous"));
    h.addEventListener("click", function(a) {
      CTATShellTools.showPrevHint();
    }, !1);
    k.appendChild(h);
    l = document.createElement("button");
    l.classList.add("CTAT-hint-window--next");
    ...
    l.appendChild(document.createTextNode("Next"));
    l.appendChild(a);
    ...
    k.appendChild(l);
    var b = function(a) {
      "svg" === this.tagName.toLowerCase() ? a ? this.classList.remove("CTAT-svg-button--disabled") : this.classList.add("CTAT-svg-button--disabled") : this.disabled = !a;
    };
  ...
  this.showHint = function(a) {
    ...
    null === a ? (hints = a, hintIndex = 0, f.innerHTML = "", h.setEnabled(!1), l.setEnabled(!1)) : (hints = a, hintIndex = 0, this.setEnabled(!0), h.setEnabled(!1), l.setEnabled(!1), hints ? "" === hints[hintIndex] ? d.ctatdebug("Empty hint in list, bump") : (f.innerHTML = hints[hintIndex], 1 < hints.length ? (d.ctatdebug("We have more than one hint, enabling next button"), l.setEnabled(!0)) : d.ctatdebug("We only have one hint, leaving next button disabled")) : d.ctatdebug("Null hint in list, bump"));
  };
  this.setEnabled = function(a) {
    d.assignEnabled(a);
  ...
  this.goPrevious = function() {
    ...
    var a = new CTATGuid, b = new CTATTutoringServiceMessageBuilder, c = a.guid(), a = new CTATSAI("previousButton", "ButtonPressed", "-1");
    b.createUntutoredActionMessage(c, a);
    a = new CTATSAI("previousButton", "ButtonPressed", "hint request");
    commLoggingLibrary.logSemanticEvent(c, a, "HINT_REQUEST", "");
    b = d.getCurrentHint();
    c = new CTATMessage;
  ...
  this.goNext = function() {
    ...
    f.innerHTML = hints[hintIndex];
    var a = new CTATGuid, b = new CTATTutoringServiceMessageBuilder, c = a.guid(), a = new CTATSAI("nextButton", "ButtonPressed", "-1");
    b.createUntutoredActionMessage(c, a);
    a = new CTATSAI("nextButton", "ButtonPressed", "hint request");
    commLoggingLibrary.logSemanticEvent(c, a, "HINT_REQUEST", "");
    b = d.getCurrentHint();
    c = new CTATMessage;
    c.setMessageType("AssociatedRules");
...
var CTATRadioButton = function(a, b, c, e, g) {
  ...
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = this, f = null, h = null, l = null, k = CTATRadioButton.Options.Placement.right;
  this.setSelection(this.getComponentGroup());
  ...
  this.init = function() {
    ...
    l.htmlFor = h.id;
    this.getText() ? l.textContent = d.getText() : a && (l.innerHTML = a);
    d.setComponent(f);
    d.setLabel(l);
    f.appendChild(h);
    f.appendChild(l);
  ...
  this.setText = function(a) {
    p(a);
    null !== f && (l.textContent = this.getText());
  };
  ...
  this.setLabelPlacement = function(a) {
    k = String(a);
    if (l && h) {
      switch(a = CTATRadioButton.Options.Placement, k.toLowerCase()) {
        case a.left:
          h.style.width = null;
          h.style.float = "left";
          break;
  ...
  this.showCorrect = function(a) {
    r("CTAT--hint");
    r("CTAT--incorrect");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? t("CTAT--correct") : r("CTAT-correct");
  };
  this.removeCorrect = function() {
    r("CTAT--correct");
  };
  this.showInCorrect = function(a) {
    r("CTAT--hint");
    r("CTAT--correct");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? t("CTAT--incorrect") : r("CTAT-incorrect");
  };
  this.removeInCorrect = r.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    this.removeCorrect();
    this.removeInCorrect();
    a ? t("CTAT--hint") : r("CTAT--hint");
  };
};
...
var CTATTable = function(a, b, c, e, g) {
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = null, b = a = null, c = (d.getHeight() - k) / (h - 1), e = Math.round(d.getWidth() / 2), g = 0;g < h;g++) {
      for (var a = 0 === g ? f.createTHead() : f.createTBody(), a = a.insertRow(), l = 0;2 > l;l++) {
        0 === g ? (b = document.createElement("th"), b.classList.add("CTAT-gen-component"), a.appendChild(b)) : (b = a.insertCell(), b.classList.add("CTAT-gen-component"));
      }
    }
    d.ctatdebug("Determined cell size to be: " + e + "x" + c);
    c = "";
    for (e = 0;e < f.rows.length;e++) {
      for (g = f.rows[e], a = 0;a < g.cells.length;a++) {
        var b = g.cells[a], l = d.getName() + ".R" + e + "C" + a, u = CTATShellTools.findComponent(l);
        if (null != u) {
          var w = d.getGrDescription();
          w.name = l;
          u.setCellContainer(b);
          u.setGrDescription(w);
          l = u.getDivWrap();
          null != l ? (l.parentNode.removeChild(l), l.setAttribute("style", ""), b.appendChild(l)) : d.ctatdebug("Error: unable to get div wrapper from component");
        } else {
          c += " ," + l;
        }
      }
    }
    "" !== c && d.ctatdebug("The following cells could not be mapped to components: " + c);
  };
};
...
var CTATCurriculumService = function(a) {
  ...
  this.sendSummary = function(e) {
    ...
    var g = flashVars.getRawFlashVars(), d = g.curriculum_service_url;
    d ? (CTATScrim.scrim.nextProblemScrimUp(), b = [], this.addVariable("user_guid", g.user_id), this.addVariable("session_id", g.session_id), this.addVariable("authenticity_token", g.authenticity_token), this.addVariable("school_name", g.school_name), this.addVariable("summary", encodeURIComponent(e)), this.addVariable("problem_state", ""), e = g.target_frame, g = g.reuse_swf, this.addVariable("targetFrame", e), this.addVariable("reuseSWF", g), c.ctatdebug("TargetFrame = " + e + " reuseSwf " + g), 
    a.send_post_variables(d, b)) : CTATScrim.scrim.scrimUp("Congratulations, you are done with this problem.");
  };
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, c = null, e = null, g = {}, d = null, f = null, h = [], e = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.requestHint = function() {
    ...
    if ("none" == CTATConfig.external) {
      b.ctatdebug("Calling built-in hint request driver ..."), CTATGlobals.Tab.previousFocus ? CTATGlobals.Tab.previousFocus instanceof CTAT.Component.Base.SAIHandler ? (b.ctatdebug("CTATGlobals.Tab.previousFocus!==null, requesting hint for: " + CTATGlobals.Tab.previousFocus.getSAI().getSelection()), a = new CTATSAI("hint", "ButtonPressed", "hint request"), a.addSelection(CTATGlobals.Tab.previousFocus.getSAI().getSelection()), a.addAction("PreviousFocus")) : b.ctatdebug("Current focus is not a CTAT component, can't ask for a hint yet") : 
  ...
  this.processCorrectAction = function(a) {
    ...
    null != f && (ctatdebug("Calling custom grading processor ..."), f("CORRECT", a));
    var e = a.getSelection();
    if (g[e] && null != d) {
      d("INCORRECT", a);
    } else {
      var h = CTATShellTools.findComponent(e);
      if (null != h) {
        ctatdebug("Processing " + h.length + " components ...");
        for (var m = 0;m < h.length;m++) {
          ctatdebug("Check " + h[m]), h[m] ? h[m].setCorrect(a) : b.ctatdebug("Internal error, component pointer is null");
        }
        if ("done" == e && (CTATScrim.scrim.scrimUp("Please wait, wrapping up ..."), commLibrary.sendXML(commMessageBuilder.createProblemSummaryRequestMessage()), null != c)) {
          window[c]();
        }
      } else {
  ...
  this.processInCorrectAction = function(a) {
    ...
    null != f && (ctatdebug("Calling custom grading processor ..."), f("INCORRECT", a));
    var c = a.getSelection();
    if (g[c] && null != d) {
      d("INCORRECT", a);
    } else {
      var e = CTATShellTools.findComponent(c);
      if (null != e) {
        for (c = 0;c < e.length;c++) {
          ctatdebug("Calling setIncorrect on component (" + e[c].getClassName() + ")..."), e[c].setIncorrect(a);
        }
      } else {
  ...
  this.processAssociatedRules = function(a, d, c) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      var f = a.getSAI();
      console.log(f.toLSxmlString());
      var e = "", g = new CTATActionEvaluationData("");
      b.ctatdebug("Found tutor advice: " + c);
      "Hint" == d || "HintWindow" == d ? (ctatdebug("Preparing log message to indicate a hint response", "commShell"), g.setCurrentHintNumber(hintIndex + 1), g.setTotalHintsAvailable(hints.length), g.setEvaluation("HINT"), e = "HINT_MSG", hints[hintIndex] && (c = hints[hintIndex])) : ("Correct" == a.getIndicator() ? g.setEvaluation("CORRECT") : g.setEvaluation("INCORRECT"), e = "RESULT");
      ctatdebug("Adding custom field names ...");
      d = [];
      var h = [];
      d.push("step_id");
      h.push(a.getProperty("StepID"));
      var v = a.getSkillsObject();
      b.updateSkillWindow(v);
      var u = [];
      null != v ? u = v.getTouched() : ctatdebug("Error: skills object is null in message");
      ctatdebug("Sending log message ...");
      null != commLoggingLibrary ? commLoggingLibrary.logTutorResponse(a.getTransactionID(), f, e, "", g, c, u, d, h) : this.ctatdebug("Info: no logging library available!");
    } else {
      b.updateSkillWindow(null);
    }
  ...
  this.processProblemSummaryResponse = function(a) {
    ...
    var d = new CTATXML;
    commLMSService.sendSummary(d.xmlToString(a.getXMLObject()));
    lastMessage = !0;
  };
    ...
    if (null != c) {
      if (c = c.getSelection(), null != c) {
        if (b.ctatdebug("Highlighting selection for hint: " + c), c = CTATShellTools.findComponent(c), null != c) {
          for (var f = 0;f < c.length;f++) {
            1 == detailedFeedback && c[f].setHintHighlight(!0, null, a);
          }
        } else {
  ...
  this.assignFeedbackHandler = function() {
...
CTATTutor.initializeHTMLComponents = function() {
  for (var a in CTAT.ComponentRegistry) {
    ...
    $("." + a).each(function() {
      ...
      $(this).attr("id") ? a.setName($(this).attr("id")) : (this.id = CTATGlobalFunctions.div_id(), a.setName(this.id));
...
CTATTutor.createStaticInterface = function(a, b, c) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var f, h, l, k;
    "shape" == this.parser.getElementName(g) && (f = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), k = this.parser.getElementAttr(g, "height"), d = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating shape: " + d + " at: " + f + "," + h + "," + l + "," + k), l = "data:image/png;base64, " + this.parser.getNodeTextValue(g), k = new Image, k.setAttribute("style", "position: absolute; top: " + h + "px; left:" + f + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), k.setAttribute("id", d), k.setAttribute("src", l), e.appendChild(k));
    "statictext" == this.parser.getElementName(g) && (f = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), k = this.parser.getElementAttr(g, "height"), d = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating static text: " + d + " at: " + f + "," + h + "," + l + "," + k), l = "data:image/png;base64, " + this.parser.getNodeTextValue(g), k = new Image, k.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    f + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), k.setAttribute("id", d), k.setAttribute("src", l), e.appendChild(k));
    "statictext" == this.parser.getElementName(g) && (d = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + d), f = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), k = this.parser.getElementAttr(g, "height"), f = new CTATMovieClip(d, f, h, l, k), h = f.wrapComponent(e), ctatdebug("Created movieclip: " + d + " at: " + f.x + "," + f.y + "," + f.width + "," + f.height), movieclips.push(f), g = this.parser.getElementChildren(g), 
...
function initTutor(a, b, c, e) {
  ...
  b && (ctatcontainer = b);
  if (b = document.getElementById(ctatcontainer)) {
    b.className += b.className ? " CTATTutorContainer" : "CTATTutorContainer";
  }
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var l = b(this) ? Object(new this(h)) : Array(h), k = 0, p;k < h;) {
      p = g[k], l[k] = d ? "undefined" === typeof f ? d(p, k) : d.call(f, p, k) : p, k += 1;
    }
    l.length = h;
    return l;
  };
...
String.fromCodePoint || function() {
  var a = function() {
    ...
    var a = [], d, f, e = -1, l = arguments.length;
    if (!l) {
      return "";
    }
    for (var k = "";++e < l;) {
...
var CTATExampleTracerSkill = function(a, b, c, e, g, d) {
  ...
  var f = null == a || "" == a.trim() ? b : b + " " + a, h = e, l = 0, k = 0, p = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, m = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, t = null, r = this;
  this.getSkillName = function() {
    return f;
  };
  this.getCategory = function() {
  ...
  this.toXML = function(a) {
    ...
    b += ' pGuess="' + c + '"';
    b += ' pSlip="' + g + '"';
    return a ? "&lt;Skill&gt;" + b + "&lt;/Skill&gt;" : "<Skill>" + b + "</Skill>";
  };
  this.hasReachedMastery = function() {
    return null === h || "undefined" === typeof h ? !1 : h >= m;
  };
  this.getLabel = function() {
    return null === t || "undefined" === typeof t || 1 > t.length ? CTATExampleTracerSkill.getName(f) : t;
  };
      ...
      if (!(null === f || "undefined" === typeof f || 1 > f.length)) {
        for (var e = !1, g = 0;g < f.length;g++) {
          if (null !== f[g] && "undefined" !== typeof f[g]) {
            var k = f[g].toString();
            1 > k.length || f === a && ("hint".toString().toUpperCase() === k.toString().toUpperCase() || "help".toString().toUpperCase() === k.toString().toUpperCase()) || f === b && CTATMsgType.PREVIOUS_FOCUS.toString().toUpperCase() === k.toString().toUpperCase() || (d = d + (e ? "," : "[") + k, e = !0);
          }
        }
        !0 === e && (d += "]");
      }
...
var CTATSkills = function(a) {
  ...
  this.toXML = function(a, c) {
    c || (c = "");
    var e = a ? "&lt;Skills&gt;" : "<Skills>", g = e.length, k;
    for (k in b) {
      b.hasOwnProperty(k) && b[k] && (e += c + b[k].toXML(a));
    }
    e += c && e.length > g ? "\n" : "";
    return e + (a ? "&lt;/Skills&gt;" : "</Skills>");
  };
  this.updateSkill = function(a, b, h) {
    var l = null, k = g.getSkill(b);
    null !== k && "undefined" !== typeof k && (k.setTransactionNumber(c), b = h + " " + b, e.has(b) || (e.add(b), k.updatePKnown(a), k.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && e.delete(b), l = k);
    return l;
  };
...
var CTATDefaultLinkGroup = function(a, b, c, e) {
  ...
  this.getIsOrdered = function() {
    p.ctatdebug("CTATDefaultLinkGroup --\x3e in getIsOrdered: " + d);
    return d;
  };
  this.getIsReenterable = function() {
    p.ctatdebug("CTATDefaultLinkGroup --\x3e in getIsReenterable: " + f);
    return f;
  };
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.breakByLowerLinkID = function(b, c) {
    ...
    var e = b.getSortedLinks(), g = c.getSortedLinks(), d = null, f = null, h = 0, l = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), l >= e.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : l >= g.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), d = e[l], f = g[l]), l++;
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var e = Number.MAX_VALUE, g = b, d = 0, f = new Date, h = {}, l = 0, k = 0, p = 0, m = 0, t = 0, r = 0, n = 0, v = CTATMsgType.CompletionValue[0], u = this;
  ...
  this.toXML = function(b) {
    ...
    c += ' Hints="' + k + '"';
    c += ' UniqueHints="' + m + '"';
    c += ' HintsOnly="' + u.getHintsOnly() + '"';
    c += ' Errors="' + p + '"';
    c += ' UniqueErrors="' + n + '"';
    c += ' ErrorsOnly="' + u.getErrorsOnly() + '"';
    c += ' UniqueSteps="' + u.getUniqueSteps() + '"';
    c += ' RequiredSteps="' + u.getRequiredSteps() + '"';
    c += ' TimeElapsed="' + d + '"';
    var f = u.getSkills() ? u.getSkills().toXML(b) : "";
  ...
  this.addHint = function(a) {
    u.ctatdebug("addHint(" + a + ")");
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNFirstHints() && ++m, b.incrementFirstHints()) : (b = new CTATStep(a, CTATStep.StepResult[2]), h[a] = b, m++);
    k++;
    b.setLastResult(CTATStep.StepResult[2]);
    u.ctatdebug("exiting addHint() hint count " + k + ", trial " + b);
  };
  this.addError = function(a) {
    u.ctatdebug("addError(" + a + ")");
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++n, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), h[a] = b, n++);
    p++;
    b.setLastResult(CTATStep.StepResult[1]);
    u.ctatdebug("exiting addError() error count " + p + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = h[a];
    u.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++t, 1 > b.getNFirstHints() && r++), b.incrementNCorrect()) : (u.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, t++, r++);
    l++;
    b.setLastResult(CTATStep.StepResult[3]);
    u.ctatdebug("exiting addCorrect() correct count " + l + ", trial " + b);
  };
  this.setCompletionStatus = function(a, b) {
    u.ctatdebug("setCompletionStatus(" + a + ", " + b + ")");
...
var CTATDefaultGroupModel = function() {
  function a(a, d, c) {
    ...
    !0 === a.containsLink(d) && (l.getGroupSubgroups(a).forEach(function(a) {
      l.removeLinkFromGroup(a, d);
    }), (a !== f || c) && b(a, d));
  }
  function b(a, b) {
  ...
  function c(a, b) {
    ...
    l.getGroupSubgroups(b).forEach(function(b) {
      !0 !== c && !0 === l.isLinkInGroup(b, a) && (d = l.getImmediateGroupOfLink(a, b), f = null !== d && "undefined" !== typeof d ? d : b, c = !0);
    });
    return !0 === c ? f : null;
  }
  function e(a, b) {
    ...
    if (b.size === l.getGroupLinks(a).size) {
      throw l.getGroupLinks(a).forEach(function(d) {
        if (!1 === b.has(d)) {
    ...
    b.forEach(function(f) {
      if (!0 !== d) {
        if (!1 === l.isLinkInGroup(a, f)) {
          throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
        }
        l.getGroupSubgroups(a).forEach(function(g) {
          !0 !== d && !0 === l.isLinkInGroup(g, f) && (l.getGroupLinkCount(g) >= b.size ? (c = e(g, b), d = !0) : l.getGroupLinks(g).forEach(function(d) {
            if (!1 === b.has(d)) {
              throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
            }
          }));
  ...
  function g(a, b) {
    ...
    l.getGroupSubgroups(a).forEach(function(c) {
      var f = l.getGroupLinks(c);
      if (0 === f.size) {
        l.getGroupSubgroups(a).delete(c), d(b, c);
      } else {
        var e = null, g = !1;
        f.forEach(function(a) {
          !1 === g && (e = a, g = !0);
        });
        !0 === l.isLinkInGroup(b, e) && (l.getGroupSubgroups(a).delete(c), d(b, c));
      }
    });
    d(a, b);
  }
  ...
  this.addLinkToGroup = function(a, b) {
    ...
    for (l.removeLinkFromGroup(f, b);null !== a && "undefined" !== typeof a;a = l.getGroupParent(a)) {
      var d = a, c = b;
  ...
  this.getGroupsContainingLink = function(a) {
    l.ctatdebug("CTATDefaultGroupModel --\x3e in getGroupsContainingLink(" + a + "): TopLevel " + f + ", typeof(TopLevel) " + typeof f);
    var b = new Set, d = new CTATGroupIterator(f);
    l.ctatdebug("CTATDefaultGroupModel --\x3e in getGroupsContainingLink before loop: groupIter " + d + ", typeof(groupIter) " + typeof d);
    for (var c = d.next();!c.done;c = d.next()) {
      c = c.value, !0 === l.isLinkInGroup(c, a) && b.add(c);
    }
  ...
  this.getLowestLevelGroupOfLink = function(a) {
    ...
    var b = c(a, f);
    return null !== b && "undefined" !== typeof b ? b : !0 === l.isLinkInGroup(f, a) ? f : null;
  };
  this.getGroupSubgroups = function(a) {
  ...
  this.createIdToLinkMap = function() {
    ...
    var a = {};
    l.getGroupLinks(f).forEach(function(b) {
      a[b.getUniqueID()] = b;
    });
    return a;
  };
  this.getGroupByName = function(a) {
    l.ctatdebug("CTATDefaultGroupModel --\x3e in getGroupByName TopLevel has: " + f.getSubgroups().size);
    for (var b = new CTATGroupIterator(f), d = b.next();!d.done;d = b.next()) {
      if (d = d.value, l.getGroupName(d).toString() === a.toString()) {
        return d;
      }
    }
    return null;
...
var ProblemStateSaver = function(a) {
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (e && a) {
      var l = {};
      if (ProblemStateSaver.inOLI()) {
        var k = h.getRequiredSteps(), p = h.getCorrect();
        0 == k ? (console.log("WARNING problem summary number of required steps is 0\n" + h.toXML(!1)), l.percentScore = 100, l.completed = !0) : (l.percentScore = Math.round(100 * p / k), l.completed = p >= k);
      } else {
        l.session_id = encodeURIComponent(a.getSessionID()), l.authenticity_token = encodeURIComponent(g), l.summary = encodeURIComponent(h.toXML(!1));
      }
      ...
      ++f;
      b.ctatdebug("saveAsYouGo[" + f + "] to send problem_state length " + l.problem_state.length);
      if (ProblemStateSaver.inOLI()) {
        oliComm.writeFileRecord(a.getQuestionFile(), l.problem_state), oliComm.scoreAttempt("percentScore", String(l.percentScore)), oliComm.scoreAttempt("completed", String(l.completed));
      } else {
...
ProblemStateSaver.prototype.appendToProblemState = function(a, b, c) {
  if (c || b.mustSaveForRestore() && ProblemStateSaver.mustSaveForRestore(CTATMsgType.getMessageType(a))) {
    b = this.getProblemState(), a = this.editForProblemState(a), b.push(ProblemStateSaver.inOLI() ? a : encodeURIComponent(a));
  }
};
...
ProblemStateSaver.inOLI = function() {
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(e) {
    ...
    if (e.mustRetrieveProblemState()) {
      if (a.setWorking(1, !0), ProblemStateSaver.inOLI()) {
      ...
      if (c.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof c && (c = c.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + c.length + ", msgsArr[1].length " + (c[1] ? c[1].length : -1)), !(2 > c.length))) {
          ...
          for (var d = 0, f = !1, h = 1;h < c.length;++h) {
            var l = "<message>" + c[h], k = CTATMsgType.getMessageType(l);
            CTATMsgType.STATE_GRAPH == k ? f = !0 : CTATMsgType.START_STATE_END == k ? f = !1 : f ? d++ : (a.getProblemStateSaver().appendToProblemState(l, null, !0), g.push(l));
            b.ctatdebug("problemStateArr[" + h + "] " + (f ? "omit " : "keep ") + k + " omitted " + d + " kept " + g.length);
          }
        }
...
(function() {
  var a, b, c, e, g, d, f, h, l, k, p, m = [].slice;
  g = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  e = /^\d+(\.\d\d)?$/;
  d = /((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?/g;
  k = /^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;
  ...
  a = function() {
    ...
    a.sum = function() {
      return (1 <= arguments.length ? m.call(arguments, 0) : []).reduce(function(a, b) {
        return a + +b;
      }, 0);
    };
    a.mod = function(a, b) {
    ...
    a.dollarEquals = function() {
      var a, b;
      a = arguments[0];
      b = 2 <= arguments.length ? m.call(arguments, 1) : [];
    ...
    a.matchWithPrecision = function(a, d) {
      var c, f;
      return (c = String(a).match(k)) && (f = String(d).match(k)) && p(c) === p(f) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, d) {
      var f, e;
      return (f = String(a).match(k)) && (e = String(d).match(k)) && (a = p(f) > p(e) ? (+a).toFixed(c(e)) : String(a)) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    ...
    a.pointInRange = function(a, b, d, c, f) {
      ...
      null == c && (c = 0);
      null == f && (f = c);
      return (e = a.match(l)) && b - c <= (g = e[1]) && g <= +b + +c && d - f <= (h = e[8]) && h <= +d + +f;
    };
    ...
    a.columnCell = function(a, b, d, c, f, e, g, h, k, l) {
      switch(k) {
        case "r1c1":
        ;
        case "r2c1":
    ...
    a.first = function() {
      return (1 <= arguments.length ? m.call(arguments, 0) : [])[0];
    };
    a.last = function() {
      var a;
    ...
    a.firstNonNull = function() {
      var a;
      return null != (a = (1 <= arguments.length ? m.call(arguments, 0) : []).find(function(a) {
        return null != a;
      })) ? a : null;
    };
    ...
    a.hasValue = function() {
      return (1 <= arguments.length ? m.call(arguments, 0) : []).every(function(a) {
        return null != a;
      });
    };
    a.equals = function() {
    ...
    a.assign = function(a, b) {
      ...
      c = a.split(".");
      f = 2 <= c.length ? m.call(c, 0, d = c.length - 1) : (d = 0, []);
      e = c[d++];
      d = 0;
...
(function() {
  ...
  a = function(a) {
    function c(a, b, e, g, k, p) {
      this.operator = a;
      this.left = b;
      this.right = e;
      this.parens = null != g ? g : 0;
      this.sign = null != k ? k : 1;
      this.exp = null != p ? p : 1;
    }
    b(c, a);
  ...
  a = function(a) {
    ...
    c.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        var c, e, g, p;
        p = b.constant() ? [null, b] : b.power() ? b.exponent.constant() ? (b.pushInversion(), [b.base, b.exponent]) : (b.exponent = b.exponent.multiplyOne(), [b, b.exponent.factors.shift()]) : (b = b.powerOne(), [b.base, b.exponent]);
        return (c = a.find(function(a) {
          var b;
          return null != (b = a[0]) ? b.equals(p[0]) : void 0;
        })) ? c[1] += (null != (e = p[1]) ? e.evaluate() : void 0) || 1 : a.push([p[0], (null != (g = p[1]) ? g.evaluate() : void 0) || 1]);
      });
    ...
    c.prototype.compare = function(a, b) {
      var e, l;
      return (l = c.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (e = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, d) {
        return l = a.compare(e[d], b);
      }) && l || this.compareSigns(a, b);
    };
    c.prototype.countVariables = function() {
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], e = [1, 7], g = [1, 10], d = [1, 11], f = [1, 12], h = [1, 13], l = [1, 21], k = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], m = [1, 23], t = [1, 24], r = [1, 26], n = [1, 27], v = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], u = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:l, 15:k}, b(p, [2, 11], {22:9, 19:25, 16:m, 18:t, 20:r, 21:n, 24:g, 25:d, 27:f, 28:h}), b(v, [2, 17]), {13:c, 15:e, 17:28, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:29, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(v, [2, 20]), b(v, [2, 23], {23:[1, 30]}), {13:c, 15:e, 17:31, 19:8, 22:9, 24:g, 25:d, 27:f, 
  28:h}, {6:32, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(u, [2, 25]), b(u, [2, 26]), {1:[2, 1]}, {6:33, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:34, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:35, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:36, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:37, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {6:38, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 
  24:g, 25:d, 27:f, 28:h}, {13:c, 14:39, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 14:40, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:41, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:42, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(v, [2, 14]), {13:c, 15:e, 17:43, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:44, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(v, [2, 18]), b(v, [2, 19]), {13:c, 15:e, 17:45, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(v, [2, 22]), {13:l, 
  15:k, 26:[1, 46]}, {5:[2, 2], 13:l, 15:k}, {5:[2, 3], 13:l, 15:k}, {5:[2, 4], 13:l, 15:k}, {5:[2, 5], 13:l, 15:k}, {5:[2, 6], 13:l, 15:k}, {5:[2, 7], 13:l, 15:k}, b(p, [2, 9], {22:9, 19:25, 16:m, 18:t, 20:r, 21:n, 24:g, 25:d, 27:f, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:m, 18:t, 20:r, 21:n, 24:g, 25:d, 27:f, 28:h}), b(v, [2, 12]), b(v, [2, 13]), b(v, [2, 15]), b(v, [2, 16]), b(v, [2, 21]), b(u, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, k = 0, h = 0, l = d.slice.call(arguments, 1), m = Object.create(this.lexer), p = {}, n;
    for (n in this.yy) {
      Object.prototype.hasOwnProperty.call(this.yy, n) && (p[n] = this.yy[n]);
    }
    m.setInput(a, p);
    p.lexer = m;
    p.parser = this;
    ...
    n = m.yylloc;
    d.push(n);
    var t = m.options && m.options.ranges;
    this.parseError = "function" === typeof p.parseError ? p.parseError : Object.getPrototypeOf(this).parseError;
    for (var r, v, u, I, M = {}, N, J;;) {
      u = b[b.length - 1];
      if (this.defaultActions[u]) {
        I = this.defaultActions[u];
      } else {
        if (null === r || "undefined" == typeof r) {
          r = void 0, r = m.lex() || 1, "number" !== typeof r && (r = this.symbols_[r] || r);
        }
        I = e[u] && e[u][r];
      }
      if ("undefined" === typeof I || !I.length || !I[0]) {
        ...
        J = [];
        for (N in e[u]) {
          this.terminals_[N] && 2 < N && J.push("'" + this.terminals_[N] + "'");
        }
        O = m.showPosition ? "Parse error on line " + (g + 1) + ":\n" + m.showPosition() + "\nExpecting " + J.join(", ") + ", got '" + (this.terminals_[r] || r) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == r ? "end of input" : "'" + (this.terminals_[r] || r) + "'");
        this.parseError(O, {text:m.match, token:this.terminals_[r] || r, line:m.yylineno, loc:n, expected:J});
      }
      if (I[0] instanceof Array && 1 < I.length) {
        throw Error("Parse Error: multiple actions possible at state: " + u + ", token: " + r);
      }
      switch(I[0]) {
        case 1:
          b.push(r);
          ...
          b.push(I[1]);
          r = null;
          v ? (r = v, v = null) : (k = m.yyleng, f = m.yytext, g = m.yylineno, n = m.yylloc, 0 < h && h--);
          break;
        case 2:
          J = this.productions_[I[1]][1];
          M.$ = c[c.length - J];
          M._$ = {first_line:d[d.length - (J || 1)].first_line, last_line:d[d.length - 1].last_line, first_column:d[d.length - (J || 1)].first_column, last_column:d[d.length - 1].last_column};
          t && (M._$.range = [d[d.length - (J || 1)].range[0], d[d.length - 1].range[1]]);
          u = this.performAction.apply(M, [f, k, g, p, I[1], c, d].concat(l));
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, l, k) {
      var p, m, t, r, n, v, u, w;
      try {
        n = "undefined" !== typeof window && null !== window ? window : global;
        p = function() {
          var a;
          a = [];
          for (t in n) {
        ...
        u = null != (v = a.match(b)) ? v : [];
        m = 0;
        for (r = u.length;m < r;m++) {
          t = u[m], 0 > g.call(c, t) && CTATFormulaFunctions.assign(t, void 0);
        }
        for (t in w = this.variableTable.getTable()) {
          n[t] = w[t];
        }
        ...
        }).apply(n, [d, l, k].concat(e.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (t in n) {
          null != t && 0 > g.call(p, t) && (w[t] = n[t], delete n[t]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      n = [];
      a = g = 0;
      for (t = r.length;g < t;a = ++g) {
        e = r[a], n.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return n.join("");
    };
    return a;
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, f = "undefined" === typeof c || null === c ? null : c, h = null, l = 1, k = 1, p = "CORRECT_ACTION", m = [], t = !1, r = null, n = "", v = null, u = null, w = this;
  this.getUniqueID = function() {
    return e;
  };
  this.getMatcher = function() {
    w.ctatdebug("CTATExampleTracerLink --\x3e in getMatcher");
    return h;
  };
  this.matchesSAI = function(a, b, c) {
    var d = w.getMatcher();
    w.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAI(); matcher " + d + ", typeof " + typeof d + ", sai " + a);
    a = d.match(a.getSelectionArray(), a.getActionArray(), a.getInputArray(), b, c);
    w.ctatdebug("CTATExampleTracerLink --\x3e out of matchesSAI: result = " + a);
    return a;
  };
  this.matchesSAIforHint = function(a, b, c, d) {
    w.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAIforHint(" + a + ", " + b + ") selectionArray " + a.getSelectionArray());
    if (!1 === w.getMatcher().matchForHint(a.getSelectionArray(), a.getActionArray(), b, d)) {
      return w.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false because no match"), !1;
    }
    if (null !== c && "undefined" !== typeof c && !0 === c.getWantReportableHints() && (a = null === w.getAllHints() || "undefined" === typeof w.getAllHints() ? 0 : w.getAllHints().length, 1 > a)) {
      return w.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false nStaticHints " + a + "< 1"), !1;
    }
    w.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning true");
    return !0;
  };
  ...
  this.toString = function() {
    var a;
    a = "[link " + w.getUniqueID();
    a += " (" + w.getPrevNode() + "-" + w.getNextNode();
    a += ") " + w.getType();
    return a + "]";
  };
  this.getTutorSAI = function(a, b) {
    return w.getMatcher().getTutorSAI(a, b, w.getActionType());
  };
  this.getEvaluatedInput = function(a, b) {
    return w.getMatcher().getEvaluatedInput(a, b);
  };
  ...
  this.isDone = function() {
    var a = String(w.getDefaultSAI().getSelection()).toLowerCase(), b = String(w.getDefaultSAI().getAction()).toLowerCase(), a = CTATMsgType.DONE.toLowerCase() == a && CTATMsgType.BUTTON_PRESSED.toLowerCase() == b;
    w.ctatdebug("CTATExampleTracerLink.isDone() returns " + a);
    return a;
  };
  this.interpolateHints = function(a) {
    w.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints(" + a + ")");
    var b = [];
    if (null === m || "undefined" === typeof m || 0 === m.length) {
      return b;
    }
    ...
    m.forEach(function(a) {
      if (!(1 > String(a).trim().length)) {
        var d = w.getDefaultSAI().getSelection(), e = w.getDefaultSAI().getAction(), f = CTATVariableTable.standardizeType(w.getDefaultSAI().getInput());
        w.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate(" + a + ", " + d + ", " + e + ", " + f + ")");
        a = c.interpolate(a, d, e, f);
        w.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate() returns " + a);
        b.push(a);
      }
    });
    w.ctatdebug("CTATExampleTracerLink --\x3e out of interpolateHints " + b);
    return b;
  };
  this.getHints = function() {
    w.ctatdebug("CTATExampleTracerLink --\x3e in getHints");
    var a = [];
    w.interpolateHints(null).forEach(function(b) {
      w.ctatdebug("CTATExampleTracerLink --\x3e in getHints loop");
      b.toString() !== "".toString() && a.push(b);
    });
    w.ctatdebug("CTATExampleTracerLink --\x3e out of getHints");
    return a;
  };
  ...
  this.isTraversable = function() {
    return 1 > w.getMaxTraversals() ? !1 : CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() == w.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() == w.getActionType().toString().toUpperCase() ? !0 : !1;
  };
  this.replaceInput = function() {
    return CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() !== w.getActionType().toString().toUpperCase() && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() !== w.getActionType().toString().toUpperCase() ? !1 : w.getMatcher().replaceInput();
  };
  this.evaluateReplacement = function(a, b, c) {
    return w.getMatcher().evaluateReplacement(a, b, c);
  };
  this.getActor = function() {
    return w.getMatcher().getActor();
  };
  this.getDefaultSAI = function() {
    w.ctatdebug(w.toString() + ".getSAI(): " + (h ? h.getDefaultSAI() : "(matcher null)"));
  ...
  this.addHint = function(a) {
    null !== a && "undefined" !== typeof a && a.toString() !== "".toString() && m.push(a);
  };
  this.setSelection = function(a) {
    w.getMatcher().setDefaultSelection(null === a[0] || "undefined" === typeof a[0] ? "" : a[0].toString());
  };
  this.setAction = function(a) {
    w.getMatcher().setDefaultAction(null === a[0] || "undefined" === typeof a[0] ? "" : a[0].toString());
  };
  this.setActionType = function(a) {
    if (null === a || "undefined" === typeof a || a.toString() !== CTATExampleTracerLink.CORRECT_ACTION.toString() && a.toString() !== CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString() && a.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString() && a.toString() !== CTATExampleTracerLink.HINT_ACTION.toString() && a.toString() !== CTATExampleTracerLink.UNTRACEABLE_ERROR.toString() && a.toString() !== CTATExampleTracerLink.CLT_ERROR_ACTION.toString() && a.toString() !== CTATExampleTracerLink.GIVEN_ACTION.toString()) {
      throw new CTATExampleTracerException("invalid action type " + p);
    }
    p = a;
  };
  ...
  this.addSkillName = function(a) {
    w.ctatdebug("ETLink[" + e + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === u || "undefined" === typeof u) {
        u = [];
      }
      -1 < u.indexOf(a) || (u.push(a), w.ctatdebug("ETLink.addSkillName() return with skillNames " + u));
    }
  };
  ...
  this.isTutorPerformed = function(a) {
    if (CTATExampleTracerLink.CORRECT_ACTION.toUpperCase() !== w.getActionType().toUpperCase()) {
      return !1;
    }
    var b = w.getMatcher();
  ...
  this.setIsPreferredLink = function(a) {
    w.ctatdebug("ETLink.setIsPreferredLink() was " + t + ", now " + a);
    t = a;
  };
  this.setVisualData = function(a) {
    v = a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.evaluateReplacement = function(a, b, e) {
    ...
    var l = a.getSelection(), k = a.getAction();
    a = CTATVariableTable.standardizeType(a.getInput());
    b || (b = new CTATVariableTable);
    b = new CTATFormulaParser(b);
    c.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + g + ", " + l + ", " + k + ", " + a + ")");
    try {
      e = b.evaluate(g, l, k, a);
    } catch (p) {
      c.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + g + ") " + p.name + ": " + p.message), e = null;
    }
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var e = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, f = !1, h = null, l = null, k = "student", p = null, m = null, t = "", r = null, n = null, v = null, u = null, w = null, B = [], C = !1, q = null, z = this;
  this.getActor = function() {
    return k;
  };
  this.setActor = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e setActor(" + a + ")");
    k = a;
  };
  this.getStudentSAI = function() {
    z.ctatdebug("CTATExampleTracerEvent.getStudentSAI() returning type " + typeof h + ", value " + h);
    return h;
  };
  this.setStudentSAI = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setStudentSAI(" + a + ")");
    null !== a && "undefined" !== typeof a && (h = a);
    z.ctatdebug("CTATExampleTracerEvent --\x3e out of setStudentSAI");
  };
  this.getPreloadedLinkMatches = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getPreloadedLinkMatches");
    return n;
  };
  this.setTutorSAI = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setTutorSAI");
    null !== a && "undefined" !== typeof a && (l = a);
    z.ctatdebug("CTATExampleTracerEvent --\x3e out of setTutorSAI");
  };
  this.setNumberOfInterpretations = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setNumberOfInterpretations( " + a + " )");
  };
  this.getTransactionID = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + e);
    return e;
  };
  this.setTransactionID = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setTransactionID( " + a + " )");
    e = a;
  };
  this.setDoneStepFailed = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setDoneStepFailed( " + a + " )");
    g = a;
  };
  ...
  this.setResult = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( " + a + " )");
    d = a;
  };
  this.isSolverResult = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");
    return !1;
  };
  this.getResult = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + d);
    return d;
  };
  this.setReportableLink = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink(" + a + ")");
    p = a;
  };
  this.setReportableInterpretation = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation(" + a + ")");
    m = a;
  };
  this.setStepID = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID(" + a + ")");
    t = a;
  };
  ...
  this.setSuccessOrBuggyMsg = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg(" + a + ")");
    w = a;
  };
  this.setReportableHints = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints(" + a + ")");
    B = Array.isArray(a) && 0 < a.length ? a : [];
  };
  this.getWantReportableHints = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + C);
    return C;
  };
  this.setOutOfOrder = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder(" + a + ")");
    r = a;
  };
  this.isOutOfOrder = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + r);
    return r;
  };
  this.setEvaluatedInput = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput(" + a + ")");
  ...
  this.addPreloadedLinkMatch = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch(" + a + ")");
  ...
  this.setInterpolateSAI = function(a, b, c) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolateSAI(selection " + a + " action " + b + " input " + c + ")");
  };
  this.setInterpolatedHints = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints(" + a + ")");
    null !== q && "undefined" !== typeof q && (q.length = 0);
    null !== a && "undefined" !== typeof a && (q = a.slice(0));
    z.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints");
  };
  this.setWantReportableHints = function(a) {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints(" + a + ")");
    C = a;
  };
  this.getSuccessOrBuggyMsg = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + w);
    return w;
  };
  this.getReportableHints = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + B);
    return B;
  };
  this.getReportableLink = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + p);
    return p;
  };
  this.getReportableVariableTable = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + u);
    return u;
  };
  this.getReportableInterpretation = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + m);
    return m;
  };
  this.getStepID = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + t);
    return t;
  };
  ...
  this.getTutorInput = function() {
    return null !== v && "undefined" !== typeof v ? z.getEvaluatedInputArray() : null !== l && "undefined" !== typeof l ? l.getInputArray() : null;
  };
  ...
  this.toString = function() {
    var a;
    a = "[" + z.getResult();
    null !== z.getStudentSAI() && "undefined" !== typeof z.getStudentSAI() && (a += ", StudentSAI " + z.getStudentSAI());
    null !== z.getReportableLink() && "undefined" !== typeof z.getReportableLink() && (a += ", reportableLink " + z.getReportableLink());
    !0 === z.isDoneStepFailed() && (a += ", doneStepFailed");
    null !== z.getTutorSAI() && "undefined" !== typeof z.getTutorSAI() && (a += ", TutorSAI " + z.getTutorSAI());
    return a + "]";
  };
...
var CTATExampleTracerPath = function(a) {
  ...
  var c = null, e = null, g = null, d = null, f = null, h = null, l = this;
...
var CTATVectorMatcher = function(a, b, c, e) {
  function g(a, b, c, e, g) {
    k.ctatdebug("CTATVectorMatcher --\x3e in _match(" + a + ", " + b + ", " + c + ", " + e + ")");
    if (0 === d.length || 0 === f.length || 0 === h.length) {
      d.push(new CTATExactMatcher(CTATMatcher.SELECTION, k.array2ConcatString(k.getDefaultSelectionArray()))), f.push(new CTATExactMatcher(CTATMatcher.ACTION, k.array2ConcatString(k.getDefaultActionArray()))), h.push(new CTATExactMatcher(CTATMatcher.INPUT, k.array2ConcatString(k.getDefaultInputArray())));
    }
    var v = [];
    ...
    for (var u = 0;3 > u;u++) {
      var w = l[u][0], B = w instanceof CTATExpressionMatcher ? w.matchConcatenation(a, b, c, e) : w.matchConcatenation(v[u]);
      k.ctatdebug("CTATVectorMatcher --\x3e in _match[" + u + "] after " + w + ".concat returns: " + B);
      if (g) {
        g.push(B);
      } else {
        if (!1 === B) {
  ...
  var d = a instanceof Array ? a : [], f = b instanceof Array ? b : [], h = c instanceof Array ? c : [], l = [];
  l[CTATMatcher.SELECTION] = d;
  l[CTATMatcher.ACTION] = f;
  l[CTATMatcher.INPUT] = h;
  var k = this;
  this.match = function(a, b, c, d, e) {
    return !1 !== g(a, b, c, e) && k.matchActor(d) ? !0 : !1;
  };
  this.getMatchers = function(a) {
    return l[a];
  };
  this.getTutorSAI = function(a, b, c) {
    k.ctatdebug("CTATVectorMatcher.getTutorSAI(" + a + ", vt, " + c + ")");
    if (CTATExampleTracerLink.CORRECT_ACTION.toLowerCase() == c) {
      return a;
    }
    var d = [];
    if (g(a.getSelectionArray(), a.getActionArray(), a.getInputArray(), b, d)) {
      return c = a.clone(), a = k.evaluateReplacement(a, b, null), null != a && c.setInput("object" == typeof a ? a.toString() : a), c;
    }
    c = a.clone();
    for (a = 0;a < d.length;a++) {
      switch(a) {
        case CTATMatcher.SELECTION:
          ...
          c.setSelection(k.getDefaultSelection());
          c.setSelectionArray(k.getDefaultSelectionArray());
          break;
        case CTATMatcher.ACTION:
          if (d[a]) {
            continue;
          }
          c.setAction(k.getDefaultAction());
          c.setActionArray(k.getDefaultActionArray());
          break;
        case CTATMatcher.INPUT:
          if (d[a]) {
            continue;
          }
          c.setInput(k.getDefaultInput());
          c.setInputArray(k.getDefaultInputArray());
          break;
        default:
  ...
  this.getInputMatcher = function() {
    var a = h[0];
    return a instanceof CTATExactMatcher && a.toString() === "".toString() ? k.getDefaultInput() : a.toString();
  };
  this.getActionMatcher = function() {
    var a = f[0];
    return a instanceof CTATExactMatcher && a.toString() === "".toString() ? k.getDefaultAction() : a.toString();
  };
  this.getSelectionMatcher = function() {
    var a = d[0];
    return a instanceof CTATExactMatcher && a.toString() === "".toString() ? k.getDefaultSelection() : a.toString();
  };
  ...
  this.getSelection = function() {
    return 0 === d.length ? k.getDefaultSelection() : d[0].toString();
  };
  this.getAction = function() {
    return 0 === f.length ? k.getDefaultAction() : f[0].getAction();
  };
  this.setDefaultSelection = function(a) {
    return 0 === d.length ? k.internalSetDefaultSelection(a) : d[0].setDefaultSelection(a);
  };
  this.setDefaultAction = function(a) {
    return 0 === f.length ? k.internalSetDefaultAction(a) : f[0].setDefaultAction(a);
  };
  this.setDefaultInput = function(a) {
    return 0 === h.length ? k.internalSetDefaultInput(a) : h[0].setDefaultInput(a);
  };
  this.getEvaluatedInput = function(a, b) {
    if (0 === h.length) {
      return k.getInput();
    ...
    var c = h[0];
    return !1 === c instanceof CTATExpressionMatcher ? k.getInput() : !0 === c.isEqualRelation() ? c.getEvaluatedInput(a, b) : k.getInput();
  };
  this.matchForHint = function(a, b, c, e) {
    ...
    b = !1;
    b = d[0];
    return b = Array.isArray(a) ? b.matchConcatenation(a, k.getDefaultActionArray(), k.getDefaultInputArray(), e) : b.matchConcatenation([a], k.getDefaultActionArray(), k.getDefaultInputArray(), e);
  };
  this.setCaseInsensitive = function(a) {
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function e(a, b, e) {
    q.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate(" + a + ", " + b + ", " + e + ")");
    B = a;
    var k = new Set, m = a.getPreloadedLinkMatches();
    q.ctatdebug("interps # : " + n.length);
    q.ctatdebug("interps: " + n);
    n.forEach(function(c) {
      q.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof m || null === m) {
        q.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), m = g(a.getStudentSAI(), a.getActor(), b, c.getVariableTable(), a), q.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      }
      q.ctatdebug("Link matches # : " + m.length);
      m.forEach(function(b) {
        ...
        var g = c.clone();
        q.ctatdebug("In evaluate size of getPaths " + g.getPaths().size);
        g.getPaths().forEach(function(c) {
          q.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: " + c);
          !1 === d(b, g, c, !1, a) && (q.ctatdebug("In evaluate -- in if condition, checking if isPathOK"), g.getPaths().delete(c), q.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."));
        });
        q.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size " + g.getPaths().size);
        if (0 < g.getPaths().size) {
          ...
          if (!0 === e) {
            ...
            q.ctatdebug("In evaluate -- done updatingVariable table: " + g.getVariableTable());
          }
          k.add(g);
    ...
    a.setNumberOfInterpretations(k.size);
    q.ctatdebug("In evaluate -- number of interpretations " + k.size + " set");
    if (0 === k.size) {
      return q.ctatdebug("In evaluate -- if condition no new interpretations"), 0 !== m.length && !0 === m[0].isDone() && a.setDoneStepFailed(!0), a.setResult(CTATExampleTracerLink.NO_MODEL), q.ctatdebug("In evaluate -- if condition no new interpretations returning false"), !1;
    }
    var r = h(k);
    q.ctatdebug("In evaluate -- just found bestInterp");
    var p = null;
    !0 === a.isSolverResult() ? (q.ctatdebug("In evaluate -- in if branch of isSolverResult"), p = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (q.ctatdebug("In evaluate -- in else branch of isSolverResult"), p = r.getLastMatchedLink().getType());
    if (!0 === e) {
      q.ctatdebug("In evaluate -- in if Branch doUpdate()");
      u.push(a.getStudentSAI());
      if (p.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || p.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        q.ctatdebug("In evaluate -- in first branch doUpdate()");
        k.forEach(function(a) {
          a.getLastMatchedLink().getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && (q.ctatdebug("In evaluate -- deleting an incorrect interp"), k.delete(a));
        });
        q.ctatdebug("In evaluate -- after iterating over interpretations");
        l(k);
        q.ctatdebug("In evaluate -- after setting new interps");
        for (var t in v) {
          v.hasOwnProperty(t) && delete v[t];
        }
        ...
        for (var w in v) {
          v.hasOwnProperty(w) && delete v[w];
        }
        k.forEach(function(a) {
          v[a.getLastMatchedLink().getUniqueID()] = a.getLastMatchedLink();
        });
      }
      p.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && u.splice(u.length - 1, 1);
    }
    t = r.getLastMatchedLink();
    a.isSolverResult() || (q.ctatdebug("In evaluate inside the solver result if condition + " + p), a.setResult(p));
    q.ctatdebug("In evaluate out the solver result if condition");
    a.setReportableLink(t);
    a.setReportableInterpretation(r);
    a.setReportableVariableTable(r.getVariableTable());
    a.setHintRequest(b);
    b || (w = t.getTutorSAI(a.getStudentSAI(), r.getVariableTable()), q.ctatdebug("In evaluate -- TUTORSAI object: " + w + ", getInput() " + w.getInput() + ";"), a.setTutorSAI(w));
    w = p == CTATExampleTracerLink.CORRECT_ACTION ? t.getSuccessMsg() : t.getBuggyMsg();
    a.setSuccessOrBuggyMsg(c(w, r.getVariableTable(), a.getStudentSAI()));
    w = a.getStudentSAI();
    a.setInterpolateSAI(w.getSelection(), w.getAction(), w.getInput());
    q.ctatdebug("In evaluate after calling setInterpolatesSAI");
    b && (r = t.interpolateHints(r.getVariableTable()), a.setInterpolatedHints(r), q.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(r) && 0 < r.length ? a.setReportableHints(r) : a.setReportableHints(t.getHints()), q.ctatdebug("In evaluate --\x3e after setReportableHints"));
    q.ctatdebug("In evaluate after fireExampleTracerEvent");
    q.ctatdebug("CTATExampleTracerTracer --\x3e out of _evaluate");
    return p.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString();
  }
  function g(a, b, c, d, e) {
    q.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks(" + a + ", " + b + ", " + c + ")");
    var f = [];
    w.getLinks().forEach(function(g) {
      if (!1 === c) {
        q.ctatdebug("Calling link.matchesSAI() on link " + g + ", sai " + a);
        var h = g.matchesSAI(a, b, d);
        q.ctatdebug("Result from link.matchesSAI() on link " + g + ": " + h + ", typeof " + typeof h);
        !0 === h && f.push(g);
      } else {
        !0 === g.matchesSAIforHint(a, b, e, d) && f.push(g);
      }
    });
    q.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks " + f.length);
    return f;
  }
  function d(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === w.observesOrderingConstraints(h, a, f, e) || !1 === p(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
    ...
    if (a.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      if (!1 === w.isIncorrectLinkOK(b.getMatchedLinks(), a, f, b)) {
        return q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"), !1;
      }
    } else {
      if (!1 === w.observesOrderingConstraints(b.getMatchedLinks(), a, f, e)) {
  ...
  function l(a) {
    ...
    0 === a.size ? q.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (q.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      n.push(a);
    }), C = null, q.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function k() {
    q.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");
    var a = w.findAllPaths();
  ...
  function m(a, b) {
    ...
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < q.nonEmptyHints(b, c.getVariableTable())) && w.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && p(c, b, d.getLinks()) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
  ...
  function t(a, b, c, e) {
    ...
    var f = new CTATExampleTracerEvent(q, null, CTATMsgType.DEFAULT_STUDENT_ACTOR), g = !0, h = [];
    b.getSortedLinks().forEach(function(b) {
      ...
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop interp.isTraversed(link, countOptionalAsTraversed): " + a.isTraversed(b, e));
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop isNoOp(link): " + r(b));
      !0 === a.isTraversed(b, e) || !0 === r(b) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), g = !0) : (!0 === g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), w.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
        c && 1 > q.nonEmptyHints(b, a.getVariableTable()) || a.getTraversalCount(b) >= b.getMaxTraversals() || (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink pushing outlink: " + b.getUniqueID()), h.push(b));
    ...
    h.forEach(function(c) {
      !0 !== k && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in fro loop"), !0 === d(c, a, b, !1, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting first if"), l = c, k = !0) : a.getPaths().forEach(function(e) {
        !0 !== k && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in inner loop"), b !== e && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting second if"), !0 === d(c, a, e, !1, f) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting third if"), l = c, k = !0)));
      }));
    });
    if (!0 === k) {
  ...
  var n = null, v = null, u = null, w = a, B = null;
  ...
  this.resetTracer = function() {
    ...
    null === n || "undefined" === typeof n ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), n = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), n.length = 0);
    var a = new CTATExampleTracerInterpretation(k());
    ...
    C = a;
    if (null === v || "undefined" === typeof v) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), v = {};
    } else {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");
      for (var c in v) {
        v.hasOwnProperty(c) && delete v[c];
      }
    }
    null === u || "undefined" === typeof u ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), u = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), u.length = 0);
    q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");
    w.getLinks().forEach(function(a) {
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === C || "undefined" === typeof C) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), C = h(q.getInterpretationsInternal());
    }
    q.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === C || void 0 === C));
    return C;
  };
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = m(!1, [a])) ? a.getPrevNode() : w ? w.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, c) {
  function e(a, b, c) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in isOrderOK");
    ...
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of isOrderOK");
    return !0;
  }
  function g(a, b, c) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in isReenteringOK");
    b = d(b);
    ...
    if (0 !== a.length) {
      ...
      y.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups null? " + (null === h));
      y.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups undefined? " + ("undefined" === typeof h));
      y.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups last traversedLink " + a[a.length - 1].getUniqueID());
      y.ctatdebug("CTATExampleTracerGraph --\x3e in isReentrableOK: exitedGroups length " + (h ? h.length : null));
      b.forEach(function(a) {
      ...
      h.forEach(function(b) {
        !1 !== k && c.forEach(function(c) {
          !1 !== k && l(a, c) < c.getMinTraversals() && !0 === A.isLinkInGroup(b, c) && (k = !1);
        });
      });
      if (!1 === k) {
        return !1;
    ...
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of isReenteringOK");
    return !0;
  }
  function d(a) {
    y.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof A);
    a = A.getGroupsContainingLink(a);
    y.ctatdebug("in findGroupsOfLink groupsSet.size " + a.size);
    var b = [];
    a.forEach(function(a) {
      y.ctatdebug("in findGroupsOfLink group element " + a.getName());
      b.push(a);
    });
    b.sort(function(a, b) {
  ...
  function f(a, b, c, d) {
    var e = -1, f = null, g = Number.MAX_VALUE, k = null;
    A.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === A.isLinkInGroup(a, b) && 0 !== A.getGroupLinkCount(a)) {
        var l = h(a, d);
        null !== l && "undefined" !== typeof l && (l = l.getDepth(), l < b.getDepth() && l > e && (!1 === p(a) || !0 === m(a, c)) && (e = l, f = a), l > b.getDepth() && l < g && (!1 === p(a) || !0 === m(a, c)) && (g = l, k = a));
      }
    });
    A.getUniqueLinks(a).forEach(function(a) {
      if (!0 === d.has(a)) {
        ...
        h > b.getDepth() && h < g && (0 < a.getMinTraversals() || -1 < c.indexOf(a)) && (g = h, k = a);
      }
    });
    if (null !== f && "undefined" !== typeof f) {
      if (f instanceof CTATExampleTracerLink) {
        if (l(c, f) < f.getMinTraversals()) {
          return !1;
        }
      } else {
        if (f instanceof CTATLinkGroup && !1 === t(f, c, d)) {
          return !1;
        }
      }
    }
    return null !== k && "undefined" !== typeof k && (k instanceof CTATExampleTracerLink && -1 < c.indexOf(k) || k instanceof CTATLinkGroup && !0 === m(k, c)) ? !1 : !0;
  }
  function h(a, b) {
  ...
  var u = null, w = null, B = null, C = null, q = null, z = null, x = new Set, D = null, A = null, y = this;
  this.getLinks = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getLinks");
    return B;
  };
  this.addLink = function(a, b) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in addLink");
    B.push(a);
    null === b || "undefined" === typeof b ? A.addLinkToGroup(A.getTopLevelGroup(), a) : A.addLinkToGroup(b, a);
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of addLink");
  };
  this.addNode = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in addNode");
    w.push(a);
    C[a.getNodeID()] = a;
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of addNode");
  };
  this.findAllPaths = function() {
    ctatdebug("CTATExampleTracerGraph --\x3e in findAllPaths " + y.getStartNode().getNodeID());
    return y.findPathsFromNode(y.getStartNode());
  };
  this.observesOrderingConstraints = function(a, b, c, d) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints");
    if (null === c || "undefined" === typeof c || 0 === c.size || null === b || "undefined" === typeof b) {
      return y.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints first if"), null !== d && "undefined" !== typeof d && (y.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints setting out of order false"), d.setOutOfOrder(!1)), y.ctatdebug("CTATExampleTracerGraph --\x3e returning first true observesOrderingConstraints"), !0;
    }
    ...
    null !== d && "undefined" !== typeof d && (y.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints setting out of order true"), d.setOutOfOrder(!0));
    y.ctatdebug("CTATExampleTracerGraph --\x3e returning false observesOrderingConstraints");
    return !1;
  };
  this.isIncorrectLinkOK = function(a, b, c, d) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in isIncorrectLinkOK");
    var f = !1, g = null, h = !0, l = !1;
    y.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
      !0 !== l && !1 !== h && b.getType().toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString() && !0 === c.has(b) && (f = !0, !1 === e(a, b, c) ? h = !1 : (g = b, l = !0));
    });
    if (!1 === h || null === g || "undefined" === typeof g) {
      return !1;
    }
    if (!1 === f) {
      return y.ctatdebug("isIncorrectLinkOK(): no siblings of link in path"), !1;
    }
    if (!0 === f && (b = y.getSmallestContainingGroup(b), !0 === A.isLinkInGroup(b, g) && !1 === A.isGroupOrdered(b) && !0 === k(b, c, d))) {
      return !1;
    }
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of isIncorrectLinkOK");
    return !0;
  };
  this.getNode = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getNode(" + a + ") returning " + C[a]);
    return C[a];
  };
  this.findPathsFromNode = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in findPathsFromNode outlinks " + a.getOutLinks().size);
    var b = new Set;
    if (!a || 0 === a.getOutLinks().size) {
      return b.add(new CTATExampleTracerPath(null)), b;
    }
    y.ctatdebug("CTATExampleTracerGraph --\x3e before forEach ");
    a.getOutLinks().forEach(function(a) {
      y.ctatdebug("CTATExampleTracerGraph --\x3e in forEach " + a.getType().toString());
      if (a.getType().toString() != CTATExampleTracerLink.BUGGY_ACTION.toString()) {
        var c = y.findPathsFromNode(y.getNode(a.getNextNode()));
        y.ctatdebug("findPathsFromNode childPaths.size " + c.size);
        c.forEach(function(c) {
          y.ctatdebug("findPathsFromNode childPath.size " + c.size + ", outLink " + a);
          c.addLink(a);
          b.add(c);
        });
      }
    ...
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of findPathsFromNode " + b.size);
    return b;
  };
  ...
  this.checkForDoneState = function(a) {
    if (a.isDone() && a.isTraversable()) {
      var b = y.getNode(a.getNextNode());
      y.ctatdebug("CTATExampleTracerGraph.addDoneState(linkID " + a.getUniqueID() + ") adding destNode " + b);
      x.add(b);
    }
  };
  this.getBestSubpath = function(a, b, c) {
    ...
    var d = y.findPathsFromNode(a), e = new Set;
    d.forEach(function(a) {
      a = a.subpath(b);
      !a || c && !a.containsAll(c) || e.add(a);
    });
    y.ctatdebug("CTATExampleTracerGraph.getBestSubpath(" + a + ", " + b + ", [" + (c ? c.length : -1) + "]) pathsFrom " + d.size + ", pathsFromTo " + e.size);
    return 1 > e.size ? null : CTATExampleTracerPath.getBestPath(e);
  };
  this.getStartNode = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + q);
    return q;
  };
  this.getLinkByID = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getLinkByID");
    for (var b = 0;b < B.length;b++) {
      if (B[b].getUniqueID() === a) {
        return B[b];
      }
    }
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of getLinkByID");
    return null;
  };
  this.setStartNode = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in setStartNode(" + a + ")");
    q = a;
  };
  this.getStudentStartsHereNode = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + z);
    return z;
  };
  this.setStudentStartsHereNode = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in setStudentStartsHereNode(" + a + ")");
    z = a;
  };
  this.getExampleTracer = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning " + u);
    return u;
  };
  this.forDebugging = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in forDebugging");
    y.ctatdebug("Nodes in the graph -- ids");
    w.forEach(function(a) {
      y.ctatdebug(a.getNodeID());
    });
    y.ctatdebug("Links in the graph -- ids, from, to");
    B.forEach(function(a) {
      y.ctatdebug(a);
    });
  };
  ...
  this.setVisualData = function(a) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");
    D = a;
  };
  this.getVisualData = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + D);
    return D;
  };
  (function(a, b) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph (" + a + " , " + b);
    B = [];
    w = [];
    C = {};
    if (null === A || "undefined" === typeof A) {
      A = new CTATDefaultGroupModel, y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    A.clear();
    ...
    u = new CTATExampleTracerTracer(y, c);
    y.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph");
  })(!a, b);
};
...
var CTATMessageTank = function(a, b) {
  function c(a) {
    m.ctatdebug("entering updateProblemSummary()");
    a && f.forEach(function(b) {
      if (b.msgType == CTATMsgType.ASSOCIATED_RULES) {
        var c = b.evt;
        m.ctatdebug("entering updateProblemSummaryWithEvent(" + c + ")");
        if (c) {
          b = c.getResult();
          ...
          m.ctatdebug("updateProblemSummmary() Completion status " + d + ", doneStep " + f + ", correct " + e);
          ...
          d = c.getActor();
          m.ctatdebug("updateProblemSummmary() actor " + d + ", indicatorObj " + b);
  ...
  function e(a) {
    switch(m.suppressFeedback(a, g.getFeedbackPolicy())) {
  ...
  var g = a, d = null, f = null, h = null, l = null, k = new Set;
  k.add("SuccessMessage");
  k.add("BuggyMessage");
  k.add("HighlightMsg");
  k.add("NotDoneMessage");
  var p = b, m = this, d = null;
  this.toString = function() {
    m.ctatdebug("toString tank " + f);
    if (!f || 1 > f.length) {
  ...
  this.enqueueToolActionToStudent = function(a, b, c, d) {
    m.ctatdebug("Entering enqueueToolActionToStudent(" + a + ", " + b + ", " + c + ", " + d + ")");
    var e = CTATMsgType.INTERFACE_ACTION;
    m.ctatdebug("entering enqueueMessageToStudent()");
    ...
    m.addToMessageTank(e, h, a);
    return f;
  };
  this.addToMessageTank = function(a, b, c) {
    m.ctatdebug("Entering addToMessageTank(" + a + ", " + b + ", " + c + ")");
    if (b) {
      f || (f = [], h = {}, l = {});
      var d = {};
      d.msgType = a;
      ...
      l[a] = l[a] ? l[a] + 1 : 1;
      m.ctatdebug("Exiting addToMessageTank() this " + m.toString());
    }
  };
  this.flushMessageTank = function(a, b) {
    m.ctatdebug("Entering flushMessageTank(" + a + ", " + b + ")");
    if (f && !(1 > f.length)) {
      c(a);
      m.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + f.length + ", transaction_id " + p);
      for (var d = [], k = 0;k < f.length;++k) {
        var u = f[k];
        if (u.msg) {
          var w = u.msgType, B = u.evt;
          m.ctatdebug("entering processInterfaceVariables() msgType " + w + ", evt " + B);
          w && (m.ctatdebug("entering processInterfaceVariables() et " + g + ", tracer " + (g ? g.getTracer() : null)), w = w.toLowerCase(), 0 !== w.indexOf("correct") && 0 !== w.indexOf("interfaceaction") || g.getTracer().addInterfaceVariablesFromEvent(B));
          e(u) || d.push(u.msg);
        }
      }
      0 < d.length && (m.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + d.length + " via " + g), g.sendBundle(d) && (l[CTATExampleTracerLink.CORRECT_ACTION] || l[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || h.CorrectAction || h.InterfaceAction || h.UntutoredAction) && g.getOutputStatus().isSendingSavedMsgsForRestore() && g.getProblemStateSaver().saveAsYouGo(a), m.ctatdebug("Exiting flushMessageTank() #CorrectAction " + h.CorrectAction + ", #InterfaceAction " + h.InterfaceAction + 
      ", #UntutoredAction " + h.UntutoredAction));
      h = f = p = null;
    }
  };
  this.flushDelayedFeedback = function() {
    m.ctatdebug("Entering flushDelayedFeedback()");
    if (null !== d && "undefined" !== typeof d) {
      for (var a in d) {
        if (d.hasOwnProperty(a)) {
          var b = d[a];
          m.ctatdebug("entering sendMessage()");
  ...
  this.suppressFeedback = function(a, b) {
    m.ctatdebug("CTATMessageTank.suppressFeedback(" + a.msgType + ", " + b + ")");
    var c = null;
    b == CTATMsgType.SHOW_ALL_FEEDBACK ? (m.ctatdebug("if.1"), c = b) : CTATMsgType.hasTextFeedback(a.msgType) ? (m.ctatdebug("if.2"), b == CTATMsgType.HIDE_ALL_FEEDBACK || b == CTATMsgType.HIDE_BUT_ENFORCE ? (m.ctatdebug("if.2.1"), c = b) : (m.ctatdebug("if.2.2"), (c = CTATMsgType.getProperty(a.msg, CTATMsgType.BUGGY_MSG)) && CTATMsgType.NOT_DONE_MSG.toLowerCase() == c.toLowerCase() ? (m.ctatdebug("if.2.2.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (m.ctatdebug("if.2.2.2"), c = CTATMsgType.HIDE_ALL_FEEDBACK))) : 
    CTATMsgType.isCorrectOrIncorrect(a.msgType) ? (m.ctatdebug("if.3: " + a.msg), CTATMsgType.isDoneMessage(a.msg) ? (m.ctatdebug("if.3.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (m.ctatdebug("if.3.2"), c = b)) : (m.ctatdebug("if.4"), c = CTATMsgType.SHOW_ALL_FEEDBACK);
    m.ctatdebug("CTATMessageTank.suppressFeedback() returning " + c);
    return c;
  };
};
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, m, t = a = -1, x = CTATMsgType.DEFAULT_ACTOR, D = !1, A = 0;A < e.length;A++) {
      "sourceID" === f.getElementName(e[A]) && (a = parseInt(f.getNodeTextValue(e[A])), c.setPrevNode(a));
      "destID" === f.getElementName(e[A]) && (t = parseInt(f.getNodeTextValue(e[A])), c.setNextNode(t));
      if ("rule" === f.getElementName(e[A])) {
        for (var y = f.getElementChildren(e[A]), E = 0;E < y.length;E++) {
          "text" === f.getElementName(y[E]) && c.addSkillName(f.getNodeTextValue(y[E]).toString());
        }
      }
      if ("actionLabel" === f.getElementName(e[A])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[A], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[A], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[A], "maxTraversals")), y = f.getElementChildren(e[A]), E = 0;E < y.length;E++) {
          "uniqueID" === f.getElementName(y[E]) && (m = f.getNodeTextValue(y[E]), c.setUniqueID(parseInt(f.getNodeTextValue(y[E]))));
          "message" === f.getElementName(y[E]) && (l = new CTATMessage(y[E]));
          "actionType" === f.getElementName(y[E]) && c.setActionType(f.getNodeTextValue(y[E]));
          "buggyMessage" === f.getElementName(y[E]) && c.setBuggyMsg(f.getNodeTextValue(y[E]));
          "successMessage" === f.getElementName(y[E]) && c.setSuccessMsg(f.getNodeTextValue(y[E]));
          "hintMessage" === f.getElementName(y[E]) && c.addHint(f.getNodeTextValue(y[E]));
          if ("matchers" === f.getElementName(y[E])) {
            for (var F = f.getElementChildren(y[E]), G = 0;G < F.length;G++) {
              "Selection" === f.getElementName(F[G]) && (g = b(F[G], 0)), "Action" === f.getElementName(F[G]) && (h = b(F[G], 1)), "Input" === f.getElementName(F[G]) && (k = b(F[G], 2)), "Actor" === f.getElementName(F[G]) && (x = f.getNodeTextValue(F[G]), D = (D = f.getElementAttr(F[G], "linkTriggered")) && "false" != D.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === f.getElementName(y[E])) {
            h = y[E];
            g = f.getElementAttr(h, "replacementFormula");
            h = f.getElementChildren(h);
            var G = F = x = k = void 0, K = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var x = new CTATExactMatcher(CTATMatcher.ACTION, null), H = 0;H < h.length;H++) {
    ...
    d.getStartNode() && t == d.getStartNode().getNodeID() && console.log("***WARNING*** edge " + m + " destination is graph startNode " + d.getStartNode());
    m = new CTATVectorMatcher(g, h, k, x);
    m.setDefaultSAI(l.getSAI());
    m.setCaseInsensitive(p);
    m.setLinkTriggered(D);
    c.setMatcher(m);
    ctatdebug("GraphParser.processEdge() " + a + "->" + t + ", edge " + c);
      ...
      if ("matcher" === f.getElementName(c[g])) {
        for (var h = null, k = f.getElementAttr(c[g], "replacementFormula"), l = f.getElementChildren(c[g]), m = 0;m < l.length;m++) {
          ...
          if ("matcherParameter" === f.getElementName(l[m])) {
            var p = f.getElementAttr(l[m], "name");
            "single" === p ? h.setParameter(f.getNodeTextValue(l[m])) : "minimum" === p ? h.setParameter(f.getNodeTextValue(l[m]), "minimum") : "maximum" === p ? h.setParameter(f.getNodeTextValue(l[m]), "maximum") : h.setParameter(l[m], p, f);
          }
        }
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      d.add(a);
    }, l = f.getElementChildren(a), m = 0;m < l.length;m++) {
      if ("link" === f.getElementName(l[m])) {
        var p = Number(f.getElementAttr(l[m], "id")), t = b[p];
        if (null !== t || void 0 !== t) {
          ctatdebug("Added link ID : " + p), d.add(t);
        }
      }
      "group" === f.getElementName(l[m]) && (ctatdebug("encountered a subgroup"), c(l[m], b).forEach(h));
    }
    k.addGroup(e, g, d);
    k.setGroupReenterable(k.getGroupByName(e), !0);
    return d;
  }
  CTATBase.call(this, "CTATGraphParser", "__undefined__");
  var e = this, g, d, f = new CTATXML, h = null, l = [];
  new XMLSerializer;
  var k, p = !0, m = CTATMsgType.SHOW_ALL_FEEDBACK, t = !0;
  ...
  this.parseGraph = function(b, e) {
    ctatdebug("parseBRD()");
    var v = 0, u = f.getElementAttr(b, "startStateNodeName"), w = "true" === f.getElementAttr(b, "unordered");
    p = "false" != String(f.getElementAttr(b, "caseInsensitive")).toLowerCase();
    t = f.getElementAttr(b, "lockWidget");
    var B = new CTATVariableTable;
    d = new CTATExampleTracerGraph(w, !1, B);
    var C = f.getElementChildren(b);
    m = f.getElementAttr(b, "suppressStudentFeedback");
    if (null === m || void 0 === m) {
      m = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    e.setFeedbackPolicy(m);
    var q = f.getElementAttr(b, "highlightRightSelection");
    e.setHighlightRightSelection("false" != q);
    var z = f.getElementAttr(b, "confirmDone");
    e.setHintPolicy(f.getElementAttr(b, "hintPolicy"));
    e.setOutOfOrderMessage(f.getElementAttr(b, "outOfOrderMessage"));
    for (var B = null, x = 0;x < C.length;x++) {
      switch(f.getElementName(C[x])) {
        case "startNodeMessages":
          l = f.getElementChildren(C[x]);
          var D = new CTATTutorMessageBuilder;
          "true" !== z && "false" !== z && m === CTATMsgType.HIDE_ALL_FEEDBACK && (z = "true");
          h = D.createStateGraphMessage(p, w, t, m === CTATMsgType.HIDE_ALL_FEEDBACK, q, confirmDone, e.getSkillBarVector());
          break;
        case "node":
          v++;
          D = C[x];
          ctatdebug("processNode(" + D + ")");
          for (var A = f.getElementChildren(D), y = -1, D = "", E = 0;E < A.length;E++) {
            switch(f.getElementName(A[E])) {
              case "uniqueID":
                y = parseInt(f.getNodeTextValue(A[E]));
                break;
              case "text":
                D = f.getNodeTextValue(A[E]);
            }
          }
          A = new CTATExampleTracerNode(y, new Set);
          "" !== D && A.setNodeName(D);
          D = A;
          d.addNode(D);
          1 == v && (d.setStartNode(D), d.setStudentStartsHereNode(D));
          D.getNodeName() == u && d.setStudentStartsHereNode(D);
          break;
        case "edge":
          d.addLink(a(C[x]));
          break;
    ...
    if (B) {
      v = f.getElementAttr(B, "ordered");
      if (null === v || "undefined" == typeof isordered) {
        v = !w;
      }
      ctatdebug("parseGraph() value of isOrdered = " + v);
      ctatdebug("parseGraph() value of isUnordered = " + w);
      ctatdebug("parseGraph() typeof isOrdered: " + typeof v);
      ctatdebug("parseGraph()typeof isUnordered: " + typeof w);
      u = B;
      ctatdebug("processGroup()");
      k = d.getGroupModel();
      w = k.createIdToLinkMap();
      k.setGroupOrdered(k.getTopLevelGroup(), v);
      ctatdebug("processGroup() name of group: " + k.getGroupName(k.getTopLevelGroup()));
      ctatdebug("processGroup() group isOrdered?: " + k.isGroupOrdered(k.getTopLevelGroup()));
      ctatdebug("processGroup() order of group: isOrdered= " + v);
      ctatdebug("processGroup() order of group: isOrdered typeof= " + typeof v);
      v = f.getElementChildren(u);
      for (u = 0;u < v.length;u++) {
        "group" == f.getElementName(v[u]) && c(v[u], w);
      }
    }
    d.redoLinkDepths();
    ...
    return {gr:d, tracer:g, ssm:l, sgMsg:h};
  };
};
...
var CTATExampleTracer = function() {
  function a() {
    k.ctatdebug("workTheQueue() working " + F + ", workQueue.length " + E.length + ", restoreQueue.length " + y.length);
    if (0 == F) {
      for (;0 != (F = 0 < E.length | (0 < y.length) << 1);) {
        var a = null, c = !1;
        0 < y.length ? (a = y.shift(), c = !0) : a = E.shift();
        if (!b(a, c)) {
          k.ctatdebug("workTheQueue() suspending workQueue.length " + E.length + ", restoreQueue.length " + y.length);
          k.setWorking(c ? 1 : 0, !0);
          break;
        }
        k.ctatdebug("workTheQueue() bottom workQueue.length " + E.length + ", restoreQueue.length " + y.length);
      }
    }
  }
  function b(a, b) {
    k.lastMessageAsString = a;
    var d = k.lastMessageAsXML = (new CTATXML).parseXML(a), f = k.lastMessage = new CTATMessage(d), h = f.getMessageType();
    k.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType " + h + ")");
    switch(h) {
      case CTATMsgType.SET_PREFERENCES:
        return c(a, f, n, d), !1;
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && k.sendBundle([a]), e(a, f, n, d), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && k.sendBundle([a]), g(a, f, n, d), !0;
      case CTATMsgType.PROBLEM_SUMMARY_REQUEST:
        return setTimeout(function(a) {
          a = k.getProblemSummary();
          k.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() " + k.getProblemSummary());
          ...
          d.push(c);
          k.sendBundle(d);
          A.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE, a.getCompletionStatus());
          k.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '" + c + "';");
          k.setWorking(b ? 1 : 0, !1);
        }, 4E3), !1;
      case CTATMsgType.START_STATE_END:
        return A.transition(CTATMsgType.START_STATE_END), !0;
      case CTATMsgType.PROBLEM_RESTORE_END:
        return l(), !0;
      default:
        return console.log("CTATExampleTracer.handleMessageFromInterface(restoring " + b + ") " + (b ? "sending" : "unprocessed") + " message, type " + h + "\n  " + a), b && k.sendBundle([a]), !0;
    }
  }
  function c(a, b, c, d) {
    k.ctatdebug("SetPreferences received: " + a);
    G = !1;
    z = b.getProperty("problem_name");
    k.ctatdebug("SetPreferences.problem_name = " + z);
    a = c.getElementChildren(c.getElementChildren(d)[1]);
    for (b = 0;b < a.length;b++) {
      if (d = c.getElementName(a[b]), k.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          case "question_file":
            p = c.getNodeTextValue(a[b]);
            break;
          case "skills":
            k.ctatdebug(" parseSkills(" + a[b] + ")");
            d = [];
            for (var e = n.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              var g = n.getElementName(e[f]);
              if (g && "skill" == g.toLowerCase()) {
                var h = n.getElementAttr(e[f], "name");
                if (h && "" != h.trim()) {
                  var g = n.getElementAttr(e[f], "label"), l = n.getElementAttr(e[f], "pSlip"), m = n.getElementAttr(e[f], "description"), q = n.getElementAttr(e[f], "pKnown"), r = n.getElementAttr(e[f], "category"), t = n.getElementAttr(e[f], "pLearn"), v = n.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(r, h, v, q, l, t);
                  h.setLabel(g);
                  h.setDescription(m);
                  d.push(h);
                }
            ...
            k.getProblemSummary().setSkills(new CTATSkills(d));
            break;
          case "problem_state_status":
            A.transition(CTATMsgType.SET_PREFERENCES, c.getNodeTextValue(a[b]));
            D || (D = new ProblemStateRestorer(k));
            k.ctatdebug("SetPreferences problemStateRestorer " + D);
            break;
          case "curriculum_service_url":
            x.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
          case "restore_problem_url":
            D || (D = new ProblemStateRestorer(k));
            k.ctatdebug("SetPreferences problemStateRestorer " + D);
            D.setRestoreProblemUrl(c.getNodeTextValue(a[b]));
            break;
          case "session_id":
            K = c.getNodeTextValue(a[b]);
            break;
          case "authenticity_token":
            x.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    k.ctatdebug("questionFile " + p + ", outputStatus " + A + ", problemStateRestorer " + D);
    a = p;
    k.ctatdebug("retrieveBRD (" + a + ")");
    H.retrieveXMLFile(a, c, k);
    D && D.retrieveMessages(A);
  }
  function e(a, b, c, d) {
    b = b.getTransactionID();
    k.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    x.appendToProblemState(a, k.getOutputStatus(), !1);
    if (!G) {
      return !1;
    }
    k.setVariablesFromSAI(d, c);
    return !0;
  }
  function g(a, b, c, d) {
    k.ctatdebug("Interface action received.");
    c = b.getTransactionID();
    if (!G) {
      return !1;
    }
    k.messageTank = new CTATMessageTank(k, c);
    k.ctatdebug("MessageTank " + k.messageTank);
    k.ctatdebug("InterfaceAction (" + a + "), getTransactionID " + c);
    d = b.getSelectionArray().slice(0);
    var e = b.getActionArray().slice(0);
    k.ctatdebug("selectionArray " + d + ", message.getSelectionArray() " + b.getSelectionArray());
    !d[0] || "hint" != d[0].toLowerCase() && "help" != d[0].toLowerCase() ? (k.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), h(null, b.getSAI(), "student", !0, c, a)) : (k.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + u + ", errorSAI " + v), u === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < d.length && (d[1] = ""), 1 < e.length && (e[1] = "")) : u !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (u === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? v && v.getSelection() ? (d.splice(1, 0, v.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : u === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && v && v.getSelection() && (d.splice(1, 0, v.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), k.startSkillTransaction(), a = [], d = m.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), b.setStepID(d.getUniqueID()), k.updateSkills(CTATExampleTracerSkill.HINT, 
    d.getSkillNames(), d.getUniqueID()), k.ctatdebug("Before building hint message: tutorSAI " + b.getTutorSAI() + ", hints " + a + ", edge # " + d.getUniqueID()), e = (new CTATTutorMessageBuilder).createHintMessage(a, b.getTutorSAI(), d.getUniqueID(), c), k.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE, e, b), c = (new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(d, a, b.getTutorSAI(), k.getSkillBarVector(), c), k.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, 
    c, b), c = k.getProblemSummary(b.getReportableInterpretation()), k.messageTank.flushMessageTank(c, !0), k.ctatdebug("handleInterfaceAction() sent hint result " + b), v = null);
    return !0;
  }
  function d(a, b, c, d) {
    k.ctatdebug("checkForTutorAction(" + a + ", " + b + ", " + c + ", " + d + ")");
    var e = [];
    e[0] = f(r.getNode(a), !0);
    e[1] = f(r.getNode(b), !1);
    k.ctatdebug("checkForTutorAction() links[0] " + e[0] + ", links[1] " + e[1] + ";");
    a = 0;
    if (e[0] === e[1]) {
      e[1] = null;
    } else {
    ...
    for (b = null;a < e.length && null !== e[a] && "undefined" !== typeof e[a];++a) {
      if (null == c || "undefined" == typeof c) {
        b = h(e[a], e[a].getDefaultSAI(), e[a].getActor(), !0, null);
      } else {
        b = e[a].getEvaluatedInput(c, d.getReportableVariableTable());
        var g = e[a].getDefaultSAI().clone();
        g.setInput(b);
        b = h(e[a], g, e[a].getActor(), !0, null);
      }
    }
    k.ctatdebug("checkForTutorAction() returning " + b + ";");
    return b;
  }
  function f(a, b) {
  ...
  function h(a, b, c, e, f, g) {
    k.ctatdebug("doNewExampleTrace (link " + a + ", sai " + b + ", actor " + c + ", doTutorPerformedSteps " + e + ", transactionID " + f + ", origMsgTxt " + g);
    k.startSkillTransaction();
    var h = new CTATExampleTracerEvent(k, b, c);
    a && h.addPreloadedLinkMatch(a);
    var l = m.evaluate(h);
    k.ctatdebug("Evaluate returned : " + l + ", given link " + a + ", result " + h);
    a ? (k.ctatdebug("result.getTutorSelection() " + h.getTutorSelection()), k.ctatdebug("result.getTutorAction() " + h.getTutorAction()), k.ctatdebug("result.getTutorInput() " + h.getTutorInput()), k.ctatdebug("typeof(messageTank) " + typeof messageTank), f = h.getTutorSelection(), g = h.getTutorAction(), l = h.getTutorInput(), (f = k.messageTank.enqueueToolActionToStudent(f, g, l, CTATTutorMessageBuilder.TUTOR_PERFORMED)) && k.messageTank.setTransaction_id(f)) : h.getResult() != CTATExampleTracerLink.CORRECT_ACTION && 
    h.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || x.appendToProblemState(g, k.getOutputStatus(), !1);
    h.setTransactionID(f);
    k.ctatdebug("finishNewExampleTrace(" + h + ", " + b + ", " + c + ", " + e + ")");
    g = h.getStudentSAI();
    var l = h.getTutorSAI(), n = h.getTransactionID(), p = new CTATTutorMessageBuilder, q, r = [];
    null !== h.getReportableLink() && "undefined" !== typeof h.getReportableLink() ? r[0] = h.getReportableLink() : r[0] = null;
    var r = r[0], t = null;
    if (h.isSolverResult()) {
      h.getResult();
    } else {
      if (h.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        q = r ? "" + r.getUniqueID() : "", h.setStepID(q), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && k.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, p.createCorrectActionMessage(n, l), h), null !== r && "undefined" !== typeof r && k.updateSkills(CTATExampleTracerSkill.CORRECT, r.getSkillNames(), r.getUniqueID()), q = h.getSuccessOrBuggyMsg(), k.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, p.createAssociatedRulesMessageForAction(h.getResult(), l, 
        g, k.getSkillBarVector(), r.getUniqueID(), n, q), h), k.ctatdebug("finishNewExampleTrace() successMsg " + q), q && k.messageTank.addToMessageTank("SuccessMessage", p.createSuccessMessage(n, q), h), v = null, e && (t = d(r ? r.getNextNode() : null, m.findCurrentState(!1, !1), k.lastMessage ? k.lastMessage.getSAI() : null, h)) && (h = t);
      } else {
        k.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, p.createInCorrectActionMessage(n, g), h);
        r && r.getBuggyMsg();
        k.ctatdebug("about to do silent traceForHint(" + g + "), selectionArray " + g.getSelectionArray());
        var t = k.lastSilentHintResult = new CTATExampleTracerEvent(k, g, c), u = m.traceForHint(t);
        k.ctatdebug("silent hint result: " + t + "; hintLink " + u);
        u || (u = m.getBestNextLink(!1, t), k.ctatdebug("getBestNextLink result: " + t + "; hintLink " + u));
        l = t ? t.getTutorSAI() : null;
        u && (q = "" + u.getUniqueID(), h.setStepID(q));
        var w = h, y = {tutorAdvice:null, msg:null, msgType:null};
        if (w.getReportableLink()) {
          y.tutorAdvice = w.getSuccessOrBuggyMsg(), y.tutorAdvice && y.tutorAdvice.trim() ? (y.msg = p.createBuggyMessage(w.getTransactionID(), y.tutorAdvice), y.msgType = "BuggyMessage") : y.tutorAdvice = null;
        } else {
          if (k.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()"), w.isDoneStepFailed()) {
            y.tutorAdvice = CTATMsgType.NOT_DONE_MSG, y.msg = p.createBuggyMessage(w.getTransactionID(), y.tutorAdvice), y.msgType = "BuggyMessage";
          } else {
            k.ctatdebug("CTATET.createBuggyMessage() past isDoneStepFailed()");
            var z = t && t.getTutorSAI() ? t.getTutorSAI().getSelection() : null, z = z && "" !== z.trim() ? z : null, A = w.getStudentSAI() ? w.getStudentSAI().getSelection() : null, A = A && "" !== A.trim() ? A : null;
            k.ctatdebug("CTATET.createBuggyMessage() past hintSelection0 " + z + ", studentSelection0 " + A);
            w.getResult() == CTATExampleTracerLink.NO_MODEL && w.isOutOfOrder() && z && z != A && (k.ctatdebug("CTATET.createBuggyMessage() to create out of order"), k.isHighlightRightSelection() ? (y.tutorAdvice = k.getOutOfOrderMessage(), y.msg = p.createHighlightWidgetMessage(z, t.getTutorSAI().getAction(), y.tutorAdvice, w.getTransactionID()), y.msgType = "HighlightMsg", k.ctatdebug("createBuggyMessage() out of order with highlight; rtn: " + y)) : (y.tutorAdvice = "You need to do other steps first, before doing the step you just worked on. You might request a hint for more help.", 
            y.msg = p.createBuggyMessage(w.getTransactionID, y.tutorAdvice), y.msgType = "BuggyMessage", k.ctatdebug("createBuggyMessage() out of order without highlight; rtn: " + y)));
            k.ctatdebug("createBuggyMessage() exiting rtn: " + y);
          }
        }
        k.ctatdebug("createBuggyMessage() tutorAdvice: " + y.tutorAdvice + ";\n  msg " + y.msg);
        k.updateSkills(CTATExampleTracerSkill.INCORRECT, u.getSkillNames(), u.getUniqueID());
        k.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, p.createAssociatedRulesMessageForAction(h.getResult(), l && l.getSelection() ? l : g, g, k.getSkillBarVector(), q, n, y.tutorAdvice), h);
        y.msg && k.messageTank.addToMessageTank(y.msgType, y.msg, h);
        v = g;
        e && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == h.getResult() && d(r ? r.getNextNode() : null, m.findCurrentState(!1, !1), k.lastMessage ? k.lastMessage.getSAI() : null, h);
      }
    }
    k.lastResult = h;
    q = k.getProblemSummary(h.getReportableInterpretation());
    k.ctatdebug("finishNewExampleTrace() to flushMessageTank");
    k.messageTank.flushMessageTank(q, !0);
    k.ctatdebug("finishNewExampleTrace() sent result " + h.getResult() + ", studentSAI " + g);
    k.ctatdebug("doNewExampleTrace(" + a + ", " + b + ", " + c + ", " + e + ", " + f + ") returns undefined");
  }
  function l() {
    A.transition(CTATMsgType.PROBLEM_RESTORE_END);
    var a = k.getSkillBarVector(), b = [], c = new CTATTutorMessageBuilder;
  ...
  var k = this, p = null, m, t, r, n = new CTATXML;
  new XMLSerializer;
  var v = null, u, w = CTATMsgType.SHOW_ALL_FEEDBACK, B = !0, C = !1, q = null, z = null, x = new ProblemStateSaver(k), D = null, A = new CTATProblemStateStatus, y = [], E = [], F = 0, G = !1, K = "";
  k.ctatdebug("CTATExampleTracer constructor outputStatus=" + A);
  ...
  var H = new CTATCommLibrary;
  this.receiveFromInterface = function(b) {
    k.ctatdebug("CTATExampleTracer.receiveFromInterface(" + b + ")");
    E.push(b);
    a();
  };
  this.setVariablesFromSAI = function(a, b) {
    var c = CTATMsgType.getSAIArraysFromElement(a, b);
    k.getTracer() && k.getTracer().addInterfaceVariables(c.selection, c.input);
  };
  this.traceLinks = function(a) {
    for (var b = [], c = 0;c < a.length && null != a[c];++c) {
      k.messageTank = new CTATMessageTank(k, null), b.push(h(a[c], a[c].getDefaultSAI(), a[c].getActor(), !1, null)), k.ctatdebug("traceLinks[" + c + "] result " + b[c]);
    }
    return b;
  };
  this.enqueueForRestore = function(a) {
    k.ctatdebug("enqueueForRestore: got " + a.length + " message elements");
    y = y.concat(a);
  ...
  this.setWorking = function(b, c) {
    c ? F |= 1 << b : (F &= -65537 >> 16 - b, a());
  };
  this.processXML = function(a) {
    k.ctatdebug("processXML ()");
    if (null != a) {
      k.ctatdebug("No of children" + n.getElementChildren(a).length);
      var b = new CTATGraphParser, c = b.parseGraph(a, k);
      r = c.gr;
      m = c.tracer;
      C = b.getSuppressStudentFeedback() === CTATMsgType.HIDE_ALL_FEEDBACK;
      a = c.ssm;
      var d = c.sgMsg;
      k.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + A);
      for (var c = [], e = new XMLSerializer, f = -1, g = 0;g < a.length;g++) {
        if ("message" == n.getElementName(a[g])) {
          var h = e.serializeToString(a[g]), l = CTATMsgType.getMessageType(h);
          CTATMsgType.UNTUTORED_ACTION != l && CTATMsgType.INTERFACE_ACTION != l || k.setVariablesFromSAI(a[g], n);
          A.isIncomplete() && CTATMsgType.START_STATE_END == l ? f = 0 : c.push(h);
        }
      }
      d = c.unshift(d);
      e = new CTATTutorMessageBuilder;
      c.splice(d - f, 0, e.createLockWidgetMsg(b.getLockWidget()));
      k.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + A);
      k.sendBundle(c);
      b = r.getStartNode();
      a = r.getStudentStartsHereNode();
      null != b && null != a && b.getNodeID() != a.getNodeID() && (b = r.getBestSubpath(b, a), k.ctatdebug("advanceToStudentStartsHere() path " + b), b = k.traceLinks(b.getSortedLinks()), k.ctatdebug("advanceToStudentStartsHere() results " + b));
      G = !0;
    }
    k.setWorking(0, !1);
  };
  this.sendBundle = function(a) {
    k.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + A);
    for (var b = 0, c = 0;c < a.length;c++) {
      k.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      x.forwardToInterface(d, c >= a.length - 1, A) && ++b;
    }
    return 0 < b;
  };
  this.setHintPolicy = function(a) {
    u = CTATHintPolicyEnum.lookup(a);
  };
  ...
  this.updateSkills = function(a, b, c) {
    var d = [];
    k.ctatdebug("in updateSkills(" + b + ") with step ID = " + c + ", transaction result = " + a);
    var e = k.getProblemSummary().getSkills();
    if (null === e || "undefined" === typeof e) {
      return d;
    }
    b.forEach(function(b) {
  ...
  this.getProblemSummary = function(a) {
    k.ctatdebug("Entering getProblemSummary() problemSummary " + q);
    if (null === q || "undefined" === typeof q) {
      var b = k.getProblemName();
      if (null === b || "undefined" === typeof b || 1 > b.length) {
        b = "NoProblemDefined";
      }
      q = new CTATProblemSummary(b, null, k.isFeedbackSuppressed());
    }
    a && q.setRequiredSteps(a.countStepsForScore(r));
    return q;
  };
  ...
  this.getSkillBarVector = function() {
    var a = k.getProblemSummary().getSkills();
  ...
  this.setOutputStatus = function(a) {
    var b = A.getStatus();
    k.ctatdebug("setOutputStatus() old " + b + ", new " + a);
    CTATProblemStateStatus[a] ? A.setStatus(CTATProblemStateStatus[a]) : (console.error("CTATExampleTracer.setOutputStatus() unexpected argument " + a), A.setStatus(CTATProblemStateStatus.empty));
  };
  this.getFeedbackPolicy = function() {
    return w;
  };
  this.setFeedbackPolicy = function(a) {
    w = "false" === a ? CTATMsgType.SHOW_ALL_FEEDBACK : "true" === a ? CTATMsgType.HIDE_ALL_FEEDBACK : a;
  };
  ...
  this.getOutOfOrderMessage = function() {
    return t ? t : CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE;
  };
