...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(e) {
    ...
    if (e.mustRetrieveProblemState()) {
      if (CTATBase.inXBlock()) {
        console.log("Attempting problem restore within XBlock environment ..."), e = getVariable("saveandrestore"), "" != e && (console.log("Restore string: " + e), a.setWorking(1, !0), b.process(e));
      } else {
