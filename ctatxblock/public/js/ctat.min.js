    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      var d = function() {
        for (var a = [], d = 0;d < b.olson.dst_rules.years.length;d++) {
          ...
          for (var g = (new Date(c)).getTimezoneOffset(), h = null, m = null;c < e - 864E5;) {
            var k = new Date(c), l = k.getTimezoneOffset();
            l !== g && (l < g && (h = k), l > g && (m = k), g = l);
            c += 864E5;
          }
          e = h && m ? {s:f(h).getTime(), e:f(m).getTime()} : !1;
          a.push(e);
        }
        return a;
      }();
...
(function(a, b) {
  ...
  function k() {
    ...
    h.prototype.lines = function(a, e) {
      function c() {
        return g(d("group", {coordsize:k + " " + k, coordorigin:-m + " " + -m}), {width:k, height:k});
      }
      function h(a, k, l) {
        b(r, b(g(c(), {rotation:360 / e.lines * a + "deg", left:~~k}), b(g(d("roundrect", {arcsize:e.corners}), {width:m, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:l}), d("fill", {color:f(e.color, a), opacity:e.opacity}), d("stroke", {opacity:0}))));
      }
      var m = e.scale * (e.length + e.width), k = 2 * e.scale * m, l = -(e.width + e.length) * e.scale * 2 + "px", r = g(c(), {position:"absolute", top:l, left:l});
      if (e.shadow) {
        for (l = 1;l <= e.lines;l++) {
  ...
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!l) {
      var c = 0, h = (f.lines - 1) * (1 - f.direction) / 2, m, k = f.fps, r = k / f.speed, n = (1 - f.opacity) / (r * f.trail / 100), v = r / f.lines;
      (function y() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          m = Math.max(1 - (c + (f.lines - a) * v) % r * n, f.opacity), d.opacity(e, a * f.direction + h, m, f);
        }
    ...
    function h(b, d) {
      return g(a(), {position:"absolute", width:e.scale * (e.length + e.width) + "px", height:e.scale * e.width + "px", background:b, boxShadow:d, transformOrigin:"left", transform:"rotate(" + ~~(360 / e.lines * m + e.rotate) + "deg) translate(" + e.scale * e.radius + "px,0)", borderRadius:(e.corners * e.scale * e.width >> 1) + "px"});
    }
    for (var m = 0, k = (e.lines - 1) * (1 - e.direction) / 2, r;m < e.lines;m++) {
      r = g(a(), {position:"absolute", top:1 + ~(e.scale * e.width / 2) + "px", transform:e.hwaccel ? "translate3d(0,0,0)" : "", opacity:e.opacity, animation:l && c(e.opacity, e.trail, k + m * e.direction, e.lines) + " " + 1 / e.speed + "s linear infinite"}), e.shadow && b(r, g(h("#000", "0 0 4px #000"), {top:"2px"})), b(d, b(r, h(f(e.color, m), "0 0 1px rgba(0,0,0,.1)")));
    }
    return d;
...
var CTATGraphicsTools = function(a, b, c, e, g, d) {
  ...
  this.drawTextFormatted = function(a, b, d, e, f, c, g, m, h, k) {
    if (null != l) {
      a += p;
      b += p;
      e = "";
      ...
      e += "12pt " + n;
      try {
        l.fillStyle = c, l.font = e, l.fillText(d, a, b);
      } catch (v) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  ...
  this.clearCanvas = function(a, b, d, e) {
    "ctat" == CTATConfig.platform && l.clearRect(a, b, d, e);
  };
};
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), f = 0;f < a.length;f++) {
            var e = a[f];
            d.ctatdebug("Drawing skill " + f + " " + e.getDisplayName() + " level: " + e.getLevel() + " ...");
            var c = document.createElement("div");
            c.classList.add("CTAT-skill-window--bar");
            var g = document.createElement("div"), r = e.getLevel();
            ...
            c.textContent = e.getDisplayName() || "no-name";
            c.classList.add("CTAT-skill-window--label");
            b.appendChild(c);
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("selection" == r.getElementName(f) || "Selection" == r.getElementName(f)) {
        for (var e = r.getElementChildren(f), c = !1, g = 0;g < e.length;g++) {
          b = e[g], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), c = !0, this.setSelection(b));
        }
        !1 === c && (b = r.getNodeTextValue(f), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == r.getElementName(f) || "Action" == r.getElementName(f)) {
        e = r.getElementChildren(f);
        c = !1;
        for (g = 0;g < e.length;g++) {
          b = e[g], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), c = !0, this.setAction(b));
        }
        !1 === c && (b = r.getNodeTextValue(f), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == r.getElementName(f) || "value" == r.getElementName(f) || "Input" == r.getElementName(f)) {
        ...
        for (var h = 0;h < b.length;h++) {
          var l = b[h];
          "value" == r.getElementName(l) && (m = r.getElementChildren(l), null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (m = e.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + m), c.setValue(m)) : (m = e.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + m), c.setValue(m), c.setName(l.attributes.getNamedItem("name").value), c.setType(l.attributes.getNamedItem("type").value), 
          c.setFormat(l.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)) : (l = e.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), c.setValue(l), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)));
        }
      }
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(f) || "Input" == r.getElementName(f)) {
        b = f.childNodes;
        k = [];
        var e = new CTATHTMLManager, c = new CTATArgument, g = 0, m = null;
        k.push(c);
        for (var h = 0;h < b.length;h++) {
          if (m = b[h], "value" == r.getElementName(m)) {
            var l = r.getElementChildren(m);
            null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (m = e.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), c.setValue(m)) : (m = e.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), c.setValue(m), c.setName(r.getElementAttr("name")), c.setType(r.getElementAttr("type")), c.setFormat(r.getElementAttr("format")), g++)) : (m = e.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + 
            m), c.setValue(m));
...
var CTATNumberLine = function(a, b, c, e, g) {
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            b.length > m.length ? h.style.textDecoration = "underline" : l.style.textDecoration = "overline";
  ...
  var v = function() {
    if (null != this.X_Axis && null != this.X_Axis.svg_group) {
      ...
      if (0 < Math.abs(CTAT.Math.round(v))) {
        var v = new DOMPoint(a.left, (l - e * a.left) / g), n = new DOMPoint(a.right, (l - e * a.right) / g);
        if (a.contains(v) || a.contains(n)) {
          c.distance(v) < c.distance(n) ? (b = n, d = v) : (b = v, d = n);
        }
      }
  ...
  var B = function(a, b) {
    ...
    for (var d = u(a, b), c = null, f = Number.POSITIVE_INFINITY, e, g, m = 0;m < this._tickmarks.length;m++) {
      e = this._tickmarks[m], g = d.distance(e.location), g < f && (c = e, f = g);
    }
    return c;
  }, q = function() {
    ...
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, f, m) {
        if (1 <= b.valueOf()) {
          ...
          m = e.add(CTAT.Geom.Point.polar(c, l));
          b.reduce();
          var k = e.add(CTAT.Geom.Point.polar(c, 2 * Math.PI * b.valueOf() + l)), v = e.clone();
          if (0 < d && d < c) {
            l = CTAT.Geom.Point.polar(d, l + Math.PI * b.valueOf());
            v = v.add(l);
            m = m.add(l);
            var n = function(a, b, d) {
              return a.distance(b) < a.distance(d) ? b : d;
            };
            m = CTAT.Geom.Point.circle_intersection(v, m, e, c).reduce(n.bind(this, m));
            k = k.add(l);
            k = CTAT.Geom.Point.circle_intersection(v, k, e, c).reduce(n.bind(this, k));
          }
          l = CTAT.Geom.Point.to2DString;
          v = "M " + l(v);
          n = new DOMPoint(c, c);
          v += " L " + l(m);
          v += " A " + l(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + l(k);
...
NOTDONE:"I'm sorry, but you are not done yet. Please continue working."}, CTATLanguageManager = function(a, b, c) {
  ...
  this.filterString = function(a) {
    return "undefined" !== typeof CTATLanguagePack && CTATLanguagePack[a] ? CTATLanguagePack[a] : a;
  };
};
    ...
    if ("google" != CTATConfig.platform) {
      if (t.ctatdebug("scrimUp ()"), t.ctatdebug("Message: " + b), 1 == scrimIsUp ? (e = 1 == waitScrim ? b : e + (" \n " + b), m.removeComponent()) : (e = b, scrimIsUp = !0), t.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        ...
        1 == waitScrim)) {
          ...
          $("#scrimpanel").append(b);
          try {
            var n = (new Spinner({className:"scrim_spinner"})).spin();
            $("#scrim_spin").append(n.el);
          } catch (r) {
            (r instanceof ReferenceError || r instanceof TypeError) && t.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', r, typeof r);
          }
        }
      }
    }
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  this.logTutorResponse = function(a, d, c, f, e, g, h, m, l) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var k = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(m, l);
    ...
    m = "";
    void 0 != g && null != g ? -1 != g.indexOf("'") || -1 != g.indexOf('"') || -1 != g.indexOf("<") || -1 != g.indexOf(">") || -1 != g.indexOf("&") ? (b.ctatdebug("Feedback message contains invalid characters, wrapping in CDATA ..."), m = "<![CDATA[" + g + "]]\x3e") : (b.ctatdebug("Feedback message doesn't contain any invalid characters, using as-is"), m = g) : (b.ctatdebug("No feedback provided, using empty string"), m = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(d, a, c, e, m, f, h, !0);
    this.sendMessage(a);
  };
...
var OLIDriver = function(a) {
  ...
  this.translateURL = function(a) {
    ...
    for (var c = flashVars.getRawFlashVars(), d = getIndicesOf("<img", a, !1), f = getIndicesOf("<a", a, !1), h = -1, k = h = -1, m = !1, n = "", h = "";0 == m;) {
      m = !0;
      ...
      for (f = 0;f < d.length;f++) {
        h = d[f], h = a.indexOf("src", h), -1 != h && (h += 5, k = a.indexOf('"', h), -1 != k && (n = a.substr(h, k - h), b.ctatdebug("We have a valid url (img) to replace between: " + h + "," + k + ", with content: " + n), -1 == n.indexOf("http:") ? (m = !1, n = c.web_content_url + "webcontent/" + currentOLIModule + "/" + n, h = a.substr(0, h) + n + a.substr(k), b.ctatdebug("Replaced: " + h), a = h) : b.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      f = getIndicesOf("<a", a, !1);
      for (d = 0;d < f.length;d++) {
        h = f[d], h = a.indexOf("href", h), -1 != h && (h += 6, k = a.indexOf('"', h), -1 != k && (n = a.substr(h, k - h), b.ctatdebug("We have a valid url (href) to replace between: " + h + "," + k + ", with content: " + n), -1 == n.indexOf("http:") ? (m = !1, n = c.web_content_url + "webcontent/" + currentOLIModule + "/" + n, h = a.substr(0, h) + n + a.substr(k), b.ctatdebug("Replaced: " + h), a = h) : b.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      d = getIndicesOf("<img", a, !1);
      f = getIndicesOf("<a", a, !1);
    }
  ...
  this.parseBeginSession = function(b) {
    ...
    if (void 0 == f) {
      ...
      if (f = b.getElementsByTagName("file_record")[0]) {
        ...
        for (var f = c.getElementChildren(f), m = 0;m < f.length;m++) {
          var n = f[m];
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (a && h) {
      ...
      if (CTATBase.inXBlock()) {
        var l = 1 / parseInt(k.max_score), k = parseInt(k.score) * l;
        gradeStudent(k, "1.0");
      } else {
        if (CTATBase.inOLI()) {
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  15:m, 26:[1, 46]}, {5:[2, 2], 13:k, 15:m}, {5:[2, 3], 13:k, 15:m}, {5:[2, 4], 13:k, 15:m}, {5:[2, 5], 13:k, 15:m}, {5:[2, 6], 13:k, 15:m}, {5:[2, 7], 13:k, 15:m}, b(n, [2, 9], {22:9, 19:25, 16:l, 18:p, 20:v, 21:r, 24:g, 25:d, 27:f, 28:h}), b(n, [2, 10], {22:9, 19:25, 16:l, 18:p, 20:v, 21:r, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 12]), b(t, [2, 13]), b(t, [2, 15]), b(t, [2, 16]), b(t, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, k = 0, h = 0, l = d.slice.call(arguments, 1), m = Object.create(this.lexer), n = {}, p;
    for (p in this.yy) {
    ...
    for (var r, t, L, w, M = {}, N, J;;) {
      ...
      switch(w[0]) {
        case 1:
          ...
          b.push(w[1]);
          r = null;
          t ? (r = t, t = null) : (k = m.yyleng, f = m.yytext, g = m.yylineno, p = m.yylloc, 0 < h && h--);
          break;
        case 2:
          ...
          L = this.performAction.apply(M, [f, k, g, n, w[1], c, d].concat(l));
  ...
  function h(a, b, c, d, e) {
    ...
    z.getLinks().forEach(function(h) {
      if (!1 === c) {
        ...
        q.ctatdebug("Result from link.matchesSAI() on link " + h + ": " + l + ", typeof " + typeof l);
        !0 === l && g.push(h);
        z.hideButRequireSteps() && f(a, l, h, b, d);
      } else {
  ...
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== l && (!1 === z.observesOrderingConstraints(h, a, f, e) || !1 === v(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), l = !1) : h.push(a));
      });
      if (!1 === l) {
...
var CTATExampleTracerGraph = function(a, b, c) {
  function e(a, b, c) {
    ...
    for (var e = d(b), g = 0;g < e.length;g++) {
      var l = e[g];
      if (!0 === D.isGroupOrdered(l)) {
        if (g !== e.length - 1) {
          if (!1 === f(l, h(e[g + 1], c), a, c)) {
            return !1;
          }
        } else {
          if (!1 === f(l, b, a, c)) {
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, l, k, m, p = a = -1, u = CTATMsgType.DEFAULT_ACTOR, E = !1, q = 0;q < e.length;q++) {
      ...
      if ("actionLabel" === f.getElementName(e[q])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[q], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[q], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[q], "maxTraversals")), D = f.getElementChildren(e[q]), F = 0;F < D.length;F++) {
          ...
          "message" === f.getElementName(D[F]) && (k = new CTATMessage(D[F]));
          ...
          if ("matchers" === f.getElementName(D[F])) {
            for (var y = f.getElementChildren(D[F]), G = 0;G < y.length;G++) {
              "Selection" === f.getElementName(y[G]) && (g = b(y[G], 0)), "Action" === f.getElementName(y[G]) && (h = b(y[G], 1)), "Input" === f.getElementName(y[G]) && (l = b(y[G], 2)), "Actor" === f.getElementName(y[G]) && (u = f.getNodeTextValue(y[G]), E = (E = f.getElementAttr(y[G], "linkTriggered")) && "false" != E.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === f.getElementName(D[F])) {
            ...
            var G = y = u = l = void 0, I = CTATMsgType.DEFAULT_ACTOR;
            ...
            for (var u = new CTATExactMatcher(CTATMatcher.ACTION, null), H = 0;H < h.length;H++) {
              ...
              "matcherParameter" === f.getElementName(h[H])) {
                ...
                "selection" == K && l.setParameter(f.getNodeTextValue(h[H]));
    ...
    m = new CTATVectorMatcher(g, h, l, u);
    m.setDefaultSAI(k.getSAI());
  ...
  function b(a, b) {
    ...
    for (var c = f.getElementChildren(a), d = [], g = 0;g < c.length;g++) {
      if ("matcher" === f.getElementName(c[g])) {
        for (var h = null, l = f.getElementAttr(c[g], "replacementFormula"), k = f.getElementChildren(c[g]), m = 0;m < k.length;m++) {
          if ("matcherType" === f.getElementName(k[m])) {
            switch(h = f.getNodeTextValue(k[m]), e.ctatdebug("CTATGraphParser.processMatchers() matcherType[" + m + "] = " + h), h) {
              case "ExactMatcher":
          ...
          if ("matcherParameter" === f.getElementName(k[m])) {
            var n = f.getElementAttr(k[m], "name");
            "single" === n ? h.setParameter(f.getNodeTextValue(k[m])) : "minimum" === n ? h.setParameter(f.getNodeTextValue(k[m]), "minimum") : "maximum" === n ? h.setParameter(f.getNodeTextValue(k[m]), "maximum") : h.setParameter(k[m], n, f);
          }
        }
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      d.add(a);
    }, l = f.getElementChildren(a), k = 0;k < l.length;k++) {
      if ("link" === f.getElementName(l[k])) {
        var n = Number(f.getElementAttr(l[k], "id")), p = b[n];
        if (null !== p || void 0 !== p) {
          ctatdebug("Added link ID : " + n), d.add(p);
        }
      }
      "group" === f.getElementName(l[k]) && (ctatdebug("encountered a subgroup"), c(l[k], b).forEach(h));
    }
    m.addGroup(e, g, d);
