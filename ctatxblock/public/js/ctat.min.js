...
function CTATXBlock(a, b) {
  ...
  this.translateResourceFile = function(a) {
    ...
    return baseURL + "/" + FlashVars.module + "/" + a;
  };
  loadCTAT();
}
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var C = 0, z = null, B = null, u = this, D = null, q = "hidden", E = CTATGlobalFunctions.gensym.z_index(), F = CTATGlobalFunctions.gensym.div_id(), y = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.createCanvas = function() {
    ...
    D.setAttribute("width", k + canvasCalibrate + "px");
    D.setAttribute("height", m + canvasCalibrate + "px");
    D.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == q ? "visibility: hidden; " : "") + "z-index:" + y + ";");
    w.firstChild ? w.insertBefore(D, w.firstChild) : w.appendChild(D);
    return D;
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    q = !0 === a ? "block" : "hidden";
    D && D.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + f + "px; top:" + h + "px; z-index:" + y + ";");
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, m = "white", n = 1, l = CTATGlobals.Visual.BorderColor, p = !1, v = "solid", r = 0, t = "1px", w = 0, x = CTATGlobals.Font.color, A = "black", C = CTATGlobals.Font.family, z = CTATGlobals.Font.size, B = !1, u = !1, D = !1;
    ...
    if ("tool_message" == k) {
      ...
      if (d) {
        ...
        for (this.ctatdebug("!isLogMessage ..."), u = e.getElementChildren(b), D = 0;D < u.length;D++) {
          if (q = u[D], "properties" == e.getElementName(q)) {
    ...
    if (0 !== Object.keys(D).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        ...
        if (a instanceof CTATSAI) {
          if (a.getSelection() != t.getName() && D.hasOwnProperty(a.getSelection())) {
            return D[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != t.getName() && D.hasOwnProperty(a)) {
              return D[a];
            }
          } else {
            if (a instanceof Element && a != t.getComponent() && D.hasOwnProperty(a.id)) {
              return D[a.id];
            }
          }
        }
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  var v = function() {
    ...
    if (!0 === this.getEnabled()) {
      this.setHintHighlight(!1);
      var b;
      p ? (a = D(a.clientX, a.clientY), b = a.location, a = a.data) : (a = B(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  }.bind(this.X_Axis), D = function(a, b) {
...
(function(a) {
  ...
  b.format = function(a, d) {
    var f = 1, h = a.length, k = "", m = [], n, p, B, u, D = !0, q = "";
    for (n = 0;n < h;n++) {
      if (k = c(a[n]), "string" === k) {
        m[m.length] = a[n];
      } else {
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function g(a, b, c, d) {
    ...
    if (!b && z.hideButRequireSteps()) {
      ...
      for (var f;!(f = b.next()).done;) {
        if (z.pathToLinkIsSubset(f.value, D)) {
  ...
  function f(a, b, c, d, e) {
    var f = b && c.isCorrect();
    if ("undefined" != typeof D[c.getUniqueID()] || c.matchesSAIforHint(a, d, null, e)) {
      D[c.getUniqueID()] = f;
    }
    q.ctatdebug("updateMatchedSelections(): link " + c.getUniqueID() + ", matched " + b + ", newResult " + f + ", matchedSelections[link] " + D[c.getUniqueID()]);
  }
...
var CTATExampleTracerGraph = function(a, b, c) {
  ...
  function d(a) {
    y.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof E);
  ...
  var w = null, x = null, A = null, C = null, z = null, B = null, u = new Set, D = new Set, q = null, E = null, F = CTATMsgType.SHOW_ALL_FEEDBACK, y = this;
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === f && (b = y.getSmallestContainingGroup(b), !0 === E.isLinkInGroup(b, g) && !1 === E.isGroupOrdered(b) && !0 === m(b, c, d))) {
      return !1;
    }
  ...
  (function(a, b) {
    ...
    C = {};
    if (null === E || "undefined" === typeof E) {
      E = new CTATDefaultGroupModel, y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    E.clear();
        ...
        if (A.msg) {
          ...
          if (!(C = e(A))) {
            ...
            if (!(C && C.sai && (B = C.sai.getAction()) && (u = p.exec(B))) || 3 > u.length || 1 >= u[2]) {
              ...
              var D = z.length - 1, D = 0 > D ? null : z[D];
              C.msg = C.msg.replace(B, u[1]);
              D && D.timeout == u[2] ? D.msgTuples.push(C) : z.push({timeout:Number(u[2]), msgTuples:[C]});
              C = !0;
            }
          }
          C || m.push(A.msg);
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, m, p = a = -1, u = CTATMsgType.DEFAULT_ACTOR, D = !1, q = 0;q < e.length;q++) {
      ...
      if ("actionLabel" === f.getElementName(e[q])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[q], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[q], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[q], "maxTraversals")), E = f.getElementChildren(e[q]), F = 0;F < E.length;F++) {
          "uniqueID" === f.getElementName(E[F]) && (m = f.getNodeTextValue(E[F]), c.setUniqueID(parseInt(f.getNodeTextValue(E[F]))));
          ...
          if ("matchers" === f.getElementName(E[F])) {
            for (var y = f.getElementChildren(E[F]), G = 0;G < y.length;G++) {
              "Selection" === f.getElementName(y[G]) && (g = b(y[G], 0)), "Action" === f.getElementName(y[G]) && (h = b(y[G], 1)), "Input" === f.getElementName(y[G]) && (k = b(y[G], 2)), "Actor" === f.getElementName(y[G]) && (u = f.getNodeTextValue(y[G]), D = (D = f.getElementAttr(y[G], "linkTriggered")) && "false" != D.toLowerCase().trim() ? !0 : !1);
            }
          }
    ...
    for (var B = null, u = 0;u < C.length;u++) {
      switch(f.getElementName(C[u])) {
        ...
        case "node":
          ...
          var q = f.getElementChildren(D), E = -1;
          D = "";
          ...
          D = q;
          d.addNode(D);
          1 == t && (d.setStartNode(D), d.setStudentStartsHereNode(D));
          D.getNodeName() == w && d.setStudentStartsHereNode(D);
          break;
        case "edge":
          d.addLink(a(C[u]));
          break;
        ...
        case "productionRule":
          ...
          D = void 0;
          for (var F = "unknown", q = void 0, E = null, y = f.getElementChildren(y), G = 0;G < y.length;G++) {
            var I = f.getElementName(y[G]);
            "ruleName" === I && (D = f.getNodeTextValue(y[G]), ctatdebug("ruleName=" + D));
            "productionSet" === I && (F = f.getNodeTextValue(y[G]), ctatdebug("productionSet=" + F));
            "label" === I && (q = f.getNodeTextValue(y[G]), ctatdebug("label=" + F));
            "description" === I && (E = f.getNodeTextValue(y[G]), ctatdebug("description=" + F));
          }
          F = new CTATExampleTracerSkill(F, D, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN);
          null != q ? F.setLabel(q) : F.setLabel(D);
          null != E ? F.setDescription(E) : F.setDescription(D);
          p.push(F);
      }
    }
    if (B) {
...
var CTATExampleTracer = function() {
    ...
    switch(h) {
      ...
      case CTATMsgType.PROBLEM_SUMMARY_REQUEST:
        return setTimeout(function(a) {
          ...
          d.push(c);
          l.sendBundle(d);
          E.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE, a.getCompletionStatus());
          l.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '" + c + "';");
          l.setWorking(b ? 1 : 0, !1);
        }, 4E3), !1;
      case CTATMsgType.START_STATE_END:
        return E.transition(CTATMsgType.START_STATE_END), !0;
      case CTATMsgType.PROBLEM_RESTORE_END:
        return n(), !0;
      default:
      ...
      if (d = c.getElementName(a[b]), l.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "problem_state_status":
            E.transition(CTATMsgType.SET_PREFERENCES, c.getNodeTextValue(a[b]));
            q || (q = new ProblemStateRestorer(l));
            l.ctatdebug("SetPreferences problemStateRestorer " + q);
            break;
          case "curriculum_service_url":
            D.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
          ...
          case "authenticity_token":
            D.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    l.ctatdebug("questionFile " + p + ", outputStatus " + E + ", problemStateRestorer " + q);
    a = p;
    l.ctatdebug("retrieveBRD (" + a + ")");
    P.retrieveXMLFile(a, c, l);
    q && q.retrieveMessages(E);
  }
  function e(a, b, c, d) {
    b = b.getTransactionID();
    l.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    D.appendToProblemState(a, l.getOutputStatus(), !1);
    if (!I) {
      return !1;
    }
  ...
  function k(a, b, c, e, g, h) {
    ...
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || D.appendToProblemState(h, l.getOutputStatus(), !1);
  ...
  function n() {
    E.transition(CTATMsgType.PROBLEM_RESTORE_END);
  ...
  new XMLSerializer;
  var x = null, A, C = !0, z = !1, B = null, u = null, D = new ProblemStateSaver(l);
  D.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var q = null, E = new CTATProblemStateStatus, F = [], y = [], G = 0, I = !1, H = "", K = null;
  l.ctatdebug("CTATExampleTracer constructor outputStatus=" + E);
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      ...
      a = c.ssm;
      var d = c.sgMsg;
      l.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + E);
      for (var c = [], e = new XMLSerializer, g = null, h = 0;h < a.length;h++) {
        if ("message" == w.getElementName(a[h])) {
          ...
          CTATMsgType.START_STATE_END == m && (g = k);
          c.push(k);
        }
      }
      d = c.unshift(d);
      g && (g = new CTATTutorMessageBuilder, c.splice(d, 0, g.createLockWidgetMsg(b.getLockWidget())));
      l.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + E);
      l.sendBundle(c);
      b = [];
      a = t.getStartNode();
      c = t.getStudentStartsHereNode();
      null != a && null != c && a.getNodeID() != c.getNodeID() && (b = t.getBestSubpath(a, c), l.ctatdebug("advanceToStudentStartsHere() path " + b), b = b.getSortedLinks(), b = l.traceLinks(b), l.ctatdebug("advanceToStudentStartsHere() results " + b));
      c = a = null;
      0 < b.length && (c = b[b.length - 1], b = c.getReportableLink(), null != b && (a = b.getNextNode()));
      l.ctatdebug("advanceToStudentStartsHere() to check for TPA " + a + ", " + c);
      f(a, v.findCurrentState(!1, !1), null, c);
      I = !0;
    }
    l.setWorking(0, !1);
  };
  ...
  this.sendBundle = function(a) {
    l.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + E);
    for (var b = 0, c = 0;c < a.length;c++) {
      l.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      D.forwardToInterface(d, c >= a.length - 1, E) && ++b;
    }
    return 0 < b;
  };
  ...
  this.setOutputStatus = function(a) {
    ...
    CTATProblemStateStatus[a] ? E.setStatus(CTATProblemStateStatus[a]) : (console.error("CTATExampleTracer.setOutputStatus() unexpected argument " + a), E.setStatus(CTATProblemStateStatus.empty));
  };
  this.getFeedbackPolicy = function() {
