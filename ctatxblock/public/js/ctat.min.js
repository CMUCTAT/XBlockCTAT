  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("selection" == t.getElementName(f) || "Selection" == t.getElementName(f)) {
        for (var c = t.getElementChildren(f), e = !1, g = 0;g < c.length;g++) {
          b = c[g], "value" == t.getElementName(b) && (b = t.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = t.getNodeTextValue(f), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == t.getElementName(f) || "Action" == t.getElementName(f)) {
        c = t.getElementChildren(f);
        e = !1;
        for (g = 0;g < c.length;g++) {
          b = c[g], "value" == t.getElementName(b) && (b = t.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = t.getNodeTextValue(f), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == t.getElementName(f) || "value" == t.getElementName(f) || "Input" == t.getElementName(f)) {
        ...
        for (var h = 0;h < b.length;h++) {
          var m = b[h];
          "value" == t.getElementName(m) && (l = t.getElementChildren(m), null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (l = c.htmlDecode(t.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = c.htmlDecode(t.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(m.attributes.getNamedItem("name").value), e.setType(m.attributes.getNamedItem("type").value), 
          e.setFormat(m.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)) : (m = c.htmlDecode(t.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
      ...
      if ("internalArguments" == t.getElementName(f) || "Input" == t.getElementName(f)) {
        ...
        for (var h = 0;h < b.length;h++) {
          if (l = b[h], "value" == t.getElementName(l)) {
            ...
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (l = c.htmlDecode(t.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = c.htmlDecode(t.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(t.getElementAttr("name")), e.setType(t.getElementAttr("type")), e.setFormat(t.getElementAttr("format")), g++)) : (l = c.htmlDecode(t.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + 
            l), e.setValue(l));
...
var CTATCommShell = function() {
  ...
  this.processAssociatedRules = function(a, d, c) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      ...
      null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, f, "", e, c, k, d, g) : this.ctatdebug("Info: no logging library available!");
