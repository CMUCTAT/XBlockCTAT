...
!function(a, b) {
  ...
  function l(a, b, c, d) {
    var g, e = 1, f = 20, h = d ? function() {
      ...
      return m.css(a, b, "");
    }, k = h(), q = c && c[3] || (m.cssNumber[b] ? "" : "px"), l = (m.cssNumber[b] || "px" !== q && +k) && ja.exec(m.css(a, b));
    if (l && l[3] !== q) {
      q = q || l[3];
      c = c || [];
      l = +k || 1;
      do {
        e = e || ".5", l /= e, m.style(a, b, l + q);
      } while (e !== (e = h() / k) && 1 !== e && --f);
    }
    return c && (l = +l || +k || 0, g = c[1] ? l + (c[1] + 1) * c[2] : +c[2], d && (d.unit = q, d.start = l, d.end = g)), g;
  }
  function q(a, b) {
  ...
  function p(a, b, c, d, g) {
    for (var e, f, h, k, l = b.createDocumentFragment(), v = [], r = 0, t = a.length;t > r;r++) {
      if (e = a[r], e || 0 === e) {
        if ("object" === m.type(e)) {
          m.merge(v, e.nodeType ? [e] : e);
        } else {
          if (kb.test(e)) {
            f = f || l.appendChild(b.createElement("div"));
            ...
            m.merge(v, f.childNodes);
            f = l.firstChild;
            f.textContent = "";
          } else {
            v.push(b.createTextNode(e));
          }
        }
      }
    }
    ...
    for (r = 0;e = v[r++];) {
      if (d && -1 < m.inArray(e, d)) {
        ...
        if (k = m.contains(e.ownerDocument, e), f = q(l.appendChild(e), "script"), k && n(f), c) {
          for (h = 0;e = f[h++];) {
  ...
  function E(a, b, c, d) {
    b = wa.apply([], b);
    var e, g, f, h, k = 0, l = a.length, v = l - 1, r = b[0], t = m.isFunction(r);
    if (t || 1 < l && "string" == typeof r && !R.checkClone && mb.test(r)) {
      return a.each(function(e) {
        var g = a.eq(e);
        t && (b[0] = r.call(this, e, g.html()));
        E(g, b, c, d);
      });
    }
    if (l && (e = p(b, a[0].ownerDocument, !1, a, d), g = e.firstChild, 1 === e.childNodes.length && (e = g), g || d)) {
      g = m.map(q(e, "script"), z);
      for (f = g.length;l > k;k++) {
        h = e, k !== v && (h = m.clone(h, !0, !0), f && m.merge(g, q(h, "script"))), c.call(a[k], h, k);
      }
      if (f) {
  ...
  function L(b, c, d) {
    ...
    if (M.msFullscreenElement && a.top !== a && b.getClientRects().length && (g = Math.round(100 * b.getBoundingClientRect()[c])), 0 >= g || null == g) {
      if (g = B(b, c, f), (0 > g || null == g) && (g = b.style[c]), Da.test(g)) {
        return g;
      }
  ...
  m.extend = m.fn.extend = function() {
    var a, b, c, d, e, g, f = arguments[0] || {}, h = 1, k = arguments.length, l = !1;
    "boolean" == typeof f && (l = f, f = arguments[h] || {}, h++);
    "object" == typeof f || m.isFunction(f) || (f = {});
    for (h === k && (f = this, h--);k > h;h++) {
      if (null != (a = arguments[h])) {
        for (b in a) {
          c = f[b], d = a[b], f !== d && (l && d && (m.isPlainObject(d) || (e = m.isArray(d))) ? (e ? (e = !1, g = c && m.isArray(c) ? c : []) : g = c && m.isPlainObject(c) ? c : {}, f[b] = m.extend(l, g, d)) : void 0 !== d && (f[b] = d));
        }
      }
    }
    return f;
  ...
  var ma = function(a) {
    function b(a, c, d, e) {
      var g, f, h, k, l, I = c && c.ownerDocument, v = c ? c.nodeType : 9;
      if (d = d || [], "string" != typeof a || !a || 1 !== v && 9 !== v && 11 !== v) {
        return d;
      }
        ...
        if (11 !== v && (k = ra.exec(a))) {
          if (g = k[1]) {
            if (9 === v) {
              ...
              if (I && (f = I.getElementById(g)) && T(c, f) && f.id === g) {
                return d.push(f), d;
              }
            }
          } else {
            ...
            if ((g = k[3]) && B.getElementsByClassName && c.getElementsByClassName) {
              return Y.apply(d, c.getElementsByClassName(g)), d;
            }
          }
        }
        if (!(!B.qsa || la[a + " "] || N && N.test(a))) {
          if (1 !== v) {
            I = c, l = a;
          } else {
            if ("object" !== c.nodeName.toLowerCase()) {
              ...
              l = k.join(",");
              I = ia.test(a) && q(c.parentNode) || c;
            }
          }
          if (l) {
            try {
              return Y.apply(d, I.querySelectorAll(l)), d;
            } catch (t) {
            } finally {
    ...
    function c() {
      function a(c, d) {
        return b.push(c + " ") > C.cacheLength && delete a[b.shift()], a[c + " "] = d;
      }
      var b = [];
      return a;
    }
    ...
    function t(a, b, c) {
      ...
      return b.first ? function(b, c, g) {
        ...
        if (f) {
          ...
          for (;b = b[d];) {
            if (1 === b.nodeType || e) {
              if (l = b[O] || (b[O] = {}), k = l[b.uniqueID] || (l[b.uniqueID] = {}), (h = k[d]) && h[0] === ca && h[1] === g) {
                return I[2] = h[2];
              }
    ...
    function p(a, b, c, d, e) {
      for (var g, f = [], h = 0, k = a.length, l = null != b;k > h;h++) {
        (g = a[h]) && (c && !c(g, d, e) || (f.push(g), l && b.push(h)));
      }
      return f;
    }
    function u(a, c, e, g, f, h) {
      return g && !g[O] && (g = u(g)), f && !f[O] && (f = u(f, h)), d(function(d, h, k, l) {
        var I, q, v = [], r = [], t = h.length, z;
        if (!(z = d)) {
          z = c || "*";
          for (var u = k.nodeType ? [k] : k, n = [], y = 0, m = u.length;m > y;y++) {
            b(z, u[y], n);
          }
          z = n;
        }
        z = !a || !d && c ? z : p(z, v, a, k, l);
        u = e ? f || (d ? a : t || g) ? [] : h : z;
        if (e && e(z, u, k, l), g) {
          for (I = p(u, r), g(I, [], k, l), k = I.length;k--;) {
            (q = I[k]) && (u[r[k]] = !(z[r[k]] = q));
          }
        }
        if (d) {
          if (f || a) {
            ...
            for (k = u.length;k--;) {
              (q = u[k]) && -1 < (I = f ? W(d, q) : v[k]) && (d[I] = !(h[I] = q));
            }
          }
        } else {
          u = p(u === h ? u.splice(t, u.length) : u), f ? f(null, h, u, l) : Y.apply(h, u);
        }
      });
    }
    function n(a) {
      var b, c, d, e = a.length, g = C.relative[a[0].type];
      c = g || C.relative[" "];
      for (var f = g ? 1 : 0, h = t(function(a) {
        return a === b;
      }, c, !0), k = t(function(a) {
        return -1 < W(b, a);
        ...
        if (c = C.relative[a[f].type]) {
          l = [t(z(l), c)];
        } else {
          if (c = C.filter[a[f].type].apply(null, a[f].matches), c[O]) {
            for (d = ++f;e > d && !C.relative[a[d].type];d++) {
            }
            return u(1 < f && z(l), 1 < f && r(a.slice(0, f - 1).concat({value:" " === a[f - 2].type ? "*" : ""})).replace(ba, "$1"), c, d > f && n(a.slice(f, d)), e > d && n(a = a.slice(d)), e > d && r(a));
          }
          l.push(c);
        }
      }
    ...
    function y(a, c) {
      var e = 0 < c.length, g = 0 < a.length, f = function(d, f, h, k, l) {
        var I, q, v, r = 0, z = "0", t = d && [], u = [], n = w, y = d || g && C.find.TAG("*", l), m = ca += null == n ? 1 : Math.random() || .1, B = y.length;
        for (l && (w = f === H || f || l);z !== B && null != (I = y[z]);z++) {
          if (g && I) {
            q = 0;
            for (f || I.ownerDocument === H || (G(I), h = !S);v = a[q++];) {
              if (v(I, f || H, h)) {
                k.push(I);
                break;
              }
        ...
        if (r += z, e && z !== r) {
          ...
          if (d) {
            if (0 < r) {
              for (;z--;) {
                t[z] || u[z] || (u[z] = wa.call(k));
              }
            }
            u = p(u);
          }
          Y.apply(k, u);
          l && !d && 0 < u.length && 1 < r + c.length && b.uniqueSort(k);
        }
        return l && (ca = m, w = n), t;
      };
      return e ? d(f) : f;
    }
    var m, B, C, F, A, D, x, J, w, L, P, G, H, E, S, N, X, Q, T, O = "sizzle" + 1 * new Date, U = a.document, ca = 0, M = 0, ta = c(), K = c(), la = c(), pa = function(a, b) {
      return a === b && (P = !0), 0;
    ...
    G = b.setDocument = function(a) {
      ...
      return a !== H && 9 === a.nodeType && a.documentElement ? (H = a, E = H.documentElement, S = !A(H), (c = H.defaultView) && c.top !== c && (c.addEventListener ? c.addEventListener("unload", oa, !1) : c.attachEvent && c.attachEvent("onunload", oa)), B.attributes = e(function(a) {
        return a.className = "i", !a.getAttribute("className");
      }), B.getElementsByTagName = e(function(a) {
        return a.appendChild(H.createComment("")), !a.getElementsByTagName("*").length;
      }), B.getElementsByClassName = da.test(H.getElementsByClassName), B.getById = e(function(a) {
        return E.appendChild(a).id = O, !H.getElementsByName || !H.getElementsByName(O).length;
      }), B.getById ? (C.find.ID = function(a, b) {
      ...
      }), C.find.TAG = B.getElementsByTagName ? function(a, b) {
        return "undefined" != typeof b.getElementsByTagName ? b.getElementsByTagName(a) : B.qsa ? b.querySelectorAll(a) : void 0;
      } : function(a, b) {
        ...
        return g;
      }, C.find.CLASS = B.getElementsByClassName && function(a, b) {
        return "undefined" != typeof b.getElementsByClassName && S ? b.getElementsByClassName(a) : void 0;
      }, X = [], N = [], (B.qsa = da.test(H.querySelectorAll)) && (e(function(a) {
        ...
        N.push(",.*:");
      })), (B.matchesSelector = da.test(Q = E.matches || E.webkitMatchesSelector || E.mozMatchesSelector || E.oMatchesSelector || E.msMatchesSelector)) && e(function(a) {
        B.disconnectedMatch = Q.call(a, "div");
        Q.call(a, "[s!='']:x");
        ...
        return c ? c : (c = (a.ownerDocument || a) === (b.ownerDocument || b) ? a.compareDocumentPosition(b) : 1, 1 & c || !B.sortDetached && b.compareDocumentPosition(a) === c ? a === H || a.ownerDocument === U && T(U, a) ? -1 : b === H || b.ownerDocument === U && T(U, b) ? 1 : L ? W(L, a) - W(L, b) : 0 : 4 & c ? -1 : 1);
      } : function(a, b) {
        if (a === b) {
          return P = !0, 0;
        }
    ...
    b.matchesSelector = function(a, c) {
      if ((a.ownerDocument || a) !== H && G(a), c = c.replace(ma, "='$1']"), !(!B.matchesSelector || !S || la[c + " "] || X && X.test(c) || N && N.test(c))) {
        try {
          var d = Q.call(a, c);
    ...
    b.attr = function(a, b) {
      ...
      var c = C.attrHandle[b.toLowerCase()], c = c && R.call(C.attrHandle, b.toLowerCase()) ? c(a, b, !S) : void 0;
      return void 0 !== c ? c : B.attributes || !S ? a.getAttribute(b) : (c = a.getAttributeNode(b)) && c.specified ? c.value : null;
    };
    b.error = function(a) {
    ...
    b.uniqueSort = function(a) {
      var b, c = [], d = 0, e = 0;
      if (P = !B.detectDuplicates, L = !B.sortStable && a.slice(0), a.sort(pa), P) {
        for (;b = a[e++];) {
          b === a[e] && (d = c.push(e));
        }
        for (;d--;) {
    ...
    C = b.selectors = {cacheLength:50, createPseudo:d, match:ea, attrHandle:{}, find:{}, relative:{">":{dir:"parentNode", first:!0}, " ":{dir:"parentNode"}, "+":{dir:"previousSibling", first:!0}, "~":{dir:"previousSibling"}}, preFilter:{ATTR:function(a) {
      ...
      return 1 === d && 0 === e ? function(a) {
        ...
        var t = b.parentNode, u = h && b.nodeName.toLowerCase();
        k = !k && !h;
        var p = !1;
        if (t) {
          if (g) {
            for (;c;) {
              for (v = b;v = v[c];) {
                if (h ? v.nodeName.toLowerCase() === u : 1 === v.nodeType) {
                  return !1;
                }
              }
          ...
          if (z = [f ? t.firstChild : t.lastChild], f && k) {
            for (v = t, q = v[O] || (v[O] = {}), I = q[v.uniqueID] || (q[v.uniqueID] = {}), l = I[a] || [], p = (r = l[0] === ca && l[1]) && l[2], v = r && t.childNodes[r];v = ++r && v && v[c] || (p = r = 0) || z.pop();) {
              if (1 === v.nodeType && ++p && v === b) {
                I[a] = [ca, r, p];
                break;
              }
            }
          } else {
            if (k && (v = b, q = v[O] || (v[O] = {}), I = q[v.uniqueID] || (q[v.uniqueID] = {}), l = I[a] || [], r = l[0] === ca && l[1], p = r), !1 === p) {
              for (;(v = ++r && v && v[c] || (p = r = 0) || z.pop()) && ((h ? v.nodeName.toLowerCase() !== u : 1 !== v.nodeType) || !++p || (k && (q = v[O] || (v[O] = {}), I = q[v.uniqueID] || (q[v.uniqueID] = {}), I[a] = [ca, p]), v !== b));) {
              }
            }
          }
      ...
      var e, g = C.pseudos[a] || C.setFilters[a.toLowerCase()] || b.error("unsupported pseudo: " + a);
      return g[O] ? g(c) : 1 < g.length ? (e = [a, a, "", c], C.setFilters.hasOwnProperty(a.toLowerCase()) ? d(function(a, b) {
    ...
    v.prototype = C.filters = C.pseudos;
    C.setFilters = new v;
    D = b.tokenize = function(a, c) {
      ...
      for (l = C.preFilter;h;) {
        ...
        for (f in C.filter) {
          !(e = ea[f].exec(h)) || l[f] && !(e = l[f](e)) || (d = e.shift(), g.push({value:d, type:f, matches:e}), h = h.slice(d.length));
        }
        if (!d) {
          break;
        }
    ...
    return x = b.compile = function(a, b) {
      ...
      var e, g, f, h, k, l = "function" == typeof a && a, I = !d && D(a = l.selector || a);
      if (c = c || [], 1 === I.length) {
        if (g = I[0] = I[0].slice(0), 2 < g.length && "ID" === (f = g[0]).type && B.getById && 9 === b.nodeType && S && C.relative[g[1].type]) {
          if (b = (C.find.ID(f.matches[0].replace(ga, ha), b) || [])[0], !b) {
            return c;
          }
          l && (b = b.parentNode);
          a = a.slice(g.shift().value.length);
        }
        for (e = ea.needsContext.test(a) ? 0 : g.length;e-- && (f = g[e], !C.relative[h = f.type]);) {
          if ((k = C.find[h]) && (d = k(f.matches[0].replace(ga, ha), ia.test(g[0].type) && q(b.parentNode) || b))) {
      ...
      return (l || x(a, I))(d, b, !S, c, !b || ia.test(a) && q(b.parentNode) || b), c;
    }, B.sortStable = O.split("").sort(pa).join("") === O, B.detectDuplicates = !!P, G(), B.sortDetached = e(function(a) {
  ...
  m.Callbacks = function(a) {
    ...
    var b, d, e, g, f = [], h = [], k = -1, l = function() {
      g = a.once;
      ...
      return f && (d && !b && (k = f.length - 1, h.push(d)), function jb(b) {
        m.each(b, function(b, c) {
          m.isFunction(c) ? a.unique && v.has(c) || f.push(c) : c && c.length && "string" !== m.type(c) && jb(c);
        });
      ...
      return g || (c = c || [], c = [a, c.slice ? c.slice() : c], h.push(c), b || l()), this;
    }, fire:function() {
  ...
  m.extend({Deferred:function(a) {
    ...
    if (1 < d) {
      for (h = Array(d), k = Array(d), l = Array(d);d > b;b++) {
        c[b] && m.isFunction(c[b].promise) ? c[b].promise().progress(f(b, k, h)).done(f(b, l, c)).fail(g.reject) : --e;
      }
    }
  ...
  var ba = function(a, b, c, d, e, g, f) {
    ...
    if ("object" === m.type(c)) {
      ...
      if (void 0 !== d && (e = !0, m.isFunction(d) || (f = !0), l && (f ? (b.call(a, d), b = null) : (l = b, b = function(a, b, c) {
        return l.call(m(a), c);
      })), b)) {
        for (;k > h;h++) {
    ...
    return e ? a : l ? b.call(a) : k ? b(a[0], c) : g;
  }, da = function(a) {
  ...
  m.event = {global:{}, add:function(a, b, c, d, e) {
    var g, f, h, k, l, v, q, r, z, t;
    if (l = K.get(a)) {
      for (c.handler && (g = c, c = g.handler, e = g.selector), c.guid || (c.guid = m.guid++), (k = l.events) || (k = l.events = {}), (f = l.handle) || (f = l.handle = function(b) {
        return "undefined" != typeof m && m.event.triggered !== b.type ? m.event.dispatch.apply(a, arguments) : void 0;
      }), b = (b || "").match(W) || [""], l = b.length;l--;) {
        h = Ya.exec(b[l]) || [], z = t = h[1], h = (h[2] || "").split(".").sort(), z && (q = m.event.special[z] || {}, z = (e ? q.delegateType : q.bindType) || z, q = m.event.special[z] || {}, v = m.extend({type:z, origType:t, data:d, handler:c, guid:c.guid, selector:e, needsContext:e && m.expr.match.needsContext.test(e), namespace:h.join(".")}, g), (r = k[z]) || (r = k[z] = [], r.delegateCount = 0, q.setup && !1 !== q.setup.call(a, d, h, f) || a.addEventListener && a.addEventListener(z, f)), q.add && 
        (q.add.call(a, v), v.handler.guid || (v.handler.guid = c.guid)), e ? r.splice(r.delegateCount++, 0, v) : r.push(v), m.event.global[z] = !0);
      }
    }
  }, remove:function(a, b, c, d, e) {
    var g, f, h, k, l, v, q, r, z, t, p, u = K.hasData(a) && K.get(a);
    if (u && (k = u.events)) {
      b = (b || "").match(W) || [""];
      for (l = b.length;l--;) {
        if (h = Ya.exec(b[l]) || [], z = p = h[1], t = (h[2] || "").split(".").sort(), z) {
          q = m.event.special[z] || {};
          z = (d ? q.delegateType : q.bindType) || z;
          r = k[z] || [];
          h = h[2] && new RegExp("(^|\\.)" + t.join("\\.(?:.*\\.|)") + "(\\.|$)");
          for (f = g = r.length;g--;) {
            v = r[g], !e && p !== v.origType || c && c.guid !== v.guid || h && !h.test(v.namespace) || d && d !== v.selector && ("**" !== d || !v.selector) || (r.splice(g, 1), v.selector && r.delegateCount--, q.remove && q.remove.call(a, v));
          }
          f && !r.length && (q.teardown && !1 !== q.teardown.call(a, t, u.handle) || m.removeEvent(a, z, u.handle), delete k[z]);
        } else {
          for (z in k) {
            m.event.remove(a, z + b[l], c, d, !0);
          }
        }
      }
  ...
  m.Event = function(a, b) {
    return this instanceof m.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? u : t) : this.type = a, b && m.extend(this, b), this.timeStamp = a && a.timeStamp || m.now(), void(this[m.expando] = !0)) : new m.Event(a, b);
  };
  m.Event.prototype = {constructor:m.Event, isDefaultPrevented:t, isPropagationStopped:t, isImmediatePropagationStopped:t, preventDefault:function() {
  ...
  m.extend({htmlPrefilter:function(a) {
    ...
    if (!(R.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || m.isXMLDoc(a))) {
      for (f = q(h), g = q(a), d = 0, e = g.length;e > d;d++) {
        var l = g[d], v = f[d], r = v.nodeName.toLowerCase();
        "input" === r && Xa.test(l.type) ? v.checked = l.checked : "input" !== r && "textarea" !== r || (v.defaultValue = l.defaultValue);
      }
    }
    if (b) {
      if (c) {
  ...
  m.extend({cssHooks:{opacity:{get:function(a, b) {
    ...
    return b = m.cssProps[h] || (m.cssProps[h] = A(h) || h), f = m.cssHooks[b] || m.cssHooks[h], f && "get" in f && (e = f.get(a, !0, c)), void 0 === e && (e = B(a, b, d)), "normal" === e && b in Za && (e = Za[b]), "" === c || c ? (g = parseFloat(e), !0 === c || isFinite(g) ? g || 0 : e) : e;
  }});
  ...
  m.cssHooks.marginLeft = C(R.reliableMarginLeft, function(a, b) {
    return b ? (parseFloat(B(a, "marginLeft")) || a.getBoundingClientRect().left - Fa(a, {marginLeft:0}, function() {
      return a.getBoundingClientRect().left;
    })) + "px" : void 0;
  });
  m.cssHooks.marginRight = C(R.reliableMarginRight, function(a, b) {
    return b ? Fa(a, {display:"inline-block"}, B, [a, "marginRight"]) : void 0;
  });
  ...
  m.Animation = m.extend(Q, {tweeners:{"*":[function(a, b) {
    ...
    var d, e, g, f, h, k, l, v = this, q = {}, r = a.style, z = a.nodeType && ea(a), t = K.get(a, "fxshow");
    c.queue || (f = m._queueHooks(a, "fx"), null == f.unqueued && (f.unqueued = 0, h = f.empty.fire, f.empty.fire = function() {
      f.unqueued || h();
    }), f.unqueued++, v.always(function() {
      v.always(function() {
        f.unqueued--;
        m.queue(a, "fx").length || f.empty.fire();
      });
    }));
    1 === a.nodeType && ("height" in b || "width" in b) && (c.overflow = [r.overflow, r.overflowX, r.overflowY], k = m.css(a, "display"), l = "none" === k ? K.get(a, "olddisplay") || w(a.nodeName) : k, "inline" === l && "none" === m.css(a, "float") && (r.display = "inline-block"));
    c.overflow && (r.overflow = "hidden", v.always(function() {
    ...
    if (m.isEmptyObject(q)) {
      ...
      for (d in t ? "hidden" in t && (z = t.hidden) : t = K.access(a, "fxshow", {}), g && (t.hidden = !z), z ? m(a).show() : v.done(function() {
        m(a).hide();
      }), v.done(function() {
        var b;
        K.remove(a, "fxshow");
        ...
        b = S(z ? t[d] : 0, d, v), d in t || (t[d] = b.start, z && (b.end = b.start, b.start = "width" === d || "height" === d ? 1 : 0));
      }
    }
  ...
  m.extend(m.event, {trigger:function(b, c, d, e) {
    var g, f, h, k, l, v, q, r = [d || M], z = qa.call(b, "type") ? b.type : b;
    g = qa.call(b, "namespace") ? b.namespace.split(".") : [];
    if (f = h = d = d || M, 3 !== d.nodeType && 8 !== d.nodeType && !ab.test(z + m.event.triggered) && (-1 < z.indexOf(".") && (g = z.split("."), z = g.shift(), g.sort()), l = 0 > z.indexOf(":") && "on" + z, b = b[m.expando] ? b : new m.Event(z, "object" == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = g.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [b] : m.makeArray(c, 
    [b]), q = m.event.special[z] || {}, e || !q.trigger || !1 !== q.trigger.apply(d, c))) {
      ...
      for (g = 0;(f = r[g++]) && !b.isPropagationStopped();) {
        b.type = 1 < g ? k : q.bindType || z, (v = (K.get(f, "events") || {})[b.type] && K.get(f, "handle")) && v.apply(f, c), (v = l && f[l]) && v.apply && da(f) && (b.result = v.apply(f, c), !1 === b.result && b.preventDefault());
      }
      return b.type = z, e || b.isDefaultPrevented() || q._default && !1 !== q._default.apply(r.pop(), c) || !da(d) || l && m.isFunction(d[z]) && !m.isWindow(d) && (h = d[l], h && (d[l] = null), m.event.triggered = z, d[z](), m.event.triggered = void 0, h && (d[l] = h)), b.result;
    }
  ...
  json:"responseJSON"}, converters:{"* text":String, "text html":!0, "text json":m.parseJSON, "text xml":m.parseXML}, flatOptions:{url:!0, context:!0}}, ajaxSetup:function(a, b) {
    ...
    function d(b, c, h, l) {
      ...
      if (2 !== C) {
        ...
        if (h) {
          B = r;
          for (var x = A, w, J, L, H, P = B.contents, G = B.dataTypes;"*" === G[0];) {
            G.shift(), void 0 === w && (w = B.mimeType || x.getResponseHeader("Content-Type"));
          }
          if (w) {
            for (J in P) {
              if (P[J] && P[J].test(w)) {
          ...
          B = L ? (L !== G[0] && G.unshift(L), h[L]) : void 0;
        }
        var E;
        a: {
          h = r;
          ...
          if (x[1]) {
            for (I in h.converters) {
              B[I.toLowerCase()] = h.converters[I];
            }
          }
          for (H = x.shift();H;) {
            if (h.responseFields[H] && (J[h.responseFields[H]] = w), !N && L && h.dataFilter && (w = h.dataFilter(w, h.dataType)), N = H, H = x.shift()) {
              if ("*" === H) {
                ...
                if ("*" !== N && N !== H) {
                  if (I = B[N + " " + H] || B["* " + H], !I) {
                    for (E in B) {
                      if (S = E.split(" "), S[1] === H && (I = B[N + " " + S[0]] || B["* " + S[0]])) {
                        !0 === I ? I = B[E] : !0 !== B[E] && (H = S[0], x.unshift(S[1]));
                        break;
                      }
                    }
                  }
        ...
        B = E;
        l ? (r.ifModified && (F = A.getResponseHeader("Last-Modified"), F && (m.lastModified[g] = F), F = A.getResponseHeader("etag"), F && (m.etag[g] = F)), 204 === b || "HEAD" === r.type ? D = "nocontent" : 304 === b ? D = "notmodified" : (D = B.state, q = B.data, y = B.error, l = !y)) : (y = D, !b && D || (D = "error", 0 > b && (b = 0)));
        A.status = b;
        A.statusText = (c || D) + "";
        l ? p.resolveWith(z, [q, D, A]) : p.rejectWith(z, [A, D, y]);
        A.statusCode(n);
        n = void 0;
        v && t.trigger(l ? "ajaxSuccess" : "ajaxError", [A, r, l ? q : y]);
        u.fireWith(z, [A, D]);
        v && (t.trigger("ajaxComplete", [A, r]), --m.active || m.event.trigger("ajaxStop"));
      }
    }
    "object" == typeof b && (c = b, b = void 0);
    c = c || {};
    var e, g, f, h, k, l, v, q, r = m.ajaxSetup({}, c), z = r.context || r, t = r.context && (z.nodeType || z.jquery) ? m(z) : m.event, p = m.Deferred(), u = m.Callbacks("once memory"), n = r.statusCode || {}, y = {}, B = {}, C = 0, F = "canceled", A = {readyState:0, getResponseHeader:function(a) {
      var b;
      if (2 === C) {
        if (!h) {
          for (h = {};b = Kb.exec(f);) {
      ...
      var c = a.toLowerCase();
      return C || (a = B[c] = B[c] || a, y[a] = b), this;
    ...
    if (p.promise(A).complete = u.add, A.success = A.done, A.error = A.fail, r.url = ((b || r.url || sa.href) + "").replace(Jb, "").replace(Mb, sa.protocol + "//"), r.type = c.method || c.type || r.method || r.type, r.dataTypes = m.trim(r.dataType || "*").toLowerCase().match(W) || [""], null == r.crossDomain) {
      l = M.createElement("a");
      try {
        l.href = r.url, l.href = l.href, r.crossDomain = Ja.protocol + "//" + Ja.host != l.protocol + "//" + l.host;
      } catch (D) {
        r.crossDomain = !0;
      }
    }
    if (r.data && r.processData && "string" != typeof r.data && (r.data = m.param(r.data, r.traditional)), ca(cb, r, c, A), 2 === C) {
      return A;
    }
    (v = m.event && r.global) && 0 === m.active++ && m.event.trigger("ajaxStart");
    ...
    if (r.beforeSend && (!1 === r.beforeSend.call(z, A, r) || 2 === C)) {
      return A.abort();
    }
    F = "abort";
    ...
    if (e = ca(Ea, r, c, A)) {
      if (A.readyState = 1, v && t.trigger("ajaxSend", [A, r]), 2 === C) {
        return A;
      }
  ...
  m.offset = {setOffset:function(a, b, c) {
    var d, e, g, f, h, k, l = m.css(a, "position"), r = m(a), v = {};
    "static" === l && (a.style.position = "relative");
    h = r.offset();
    g = m.css(a, "top");
    k = m.css(a, "left");
    ("absolute" === l || "fixed" === l) && -1 < (g + k).indexOf("auto") ? (d = r.position(), f = d.top, e = d.left) : (f = parseFloat(g) || 0, e = parseFloat(k) || 0);
    m.isFunction(b) && (b = b.call(a, c, m.extend({}, h)));
    null != b.top && (v.top = b.top - h.top + f);
    null != b.left && (v.left = b.left - h.left + e);
    "using" in b ? b.using.call(a, v) : r.css(v);
  }};
  ...
  m.each(["top", "left"], function(a, b) {
    m.cssHooks[b] = C(R.pixelPosition, function(a, c) {
      return c ? (c = B(a, b), Da.test(c) ? m(a).position()[b] + "px" : c) : void 0;
    });
  });
...
!function(a) {
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, d = function(a) {
      ...
      for (var g = {}, f = b.olson.dst_rules.zones, k = f.length, l = a[d], v = 0;k > v;v++) {
        var z = f[v], D;
        D = f[v];
...
!function(a, b) {
  ...
  function k() {
    ...
    h.prototype.lines = function(a, d) {
      ...
      function h(a, k, q) {
        b(t, b(f(e(), {rotation:360 / d.lines * a + "deg", left:~~k}), b(f(c("roundrect", {arcsize:d.corners}), {width:l, height:d.scale * d.width, left:d.scale * d.radius, top:-d.scale * d.width >> 1, filter:q}), c("fill", {color:g(d.color, a), opacity:d.opacity}), c("stroke", {opacity:0}))));
      }
      var k, l = d.scale * (d.length + d.width), q = 2 * d.scale * l;
      k = -(d.width + d.length) * d.scale * 2 + "px";
      var t = f(e(), {position:"absolute", top:k, left:k});
      if (d.shadow) {
        for (k = 1;k <= d.lines;k++) {
  ...
  var l, q, n = ["webkit", "Moz", "ms", "O"], p = {}, u = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  if (h.defaults = {}, c(h.prototype, {spin:function(b) {
    ...
    if (f(e, {position:d.position, width:0, zIndex:d.zIndex, left:d.left, top:d.top}), b && b.insertBefore(e, b.firstChild || null), e.setAttribute("role", "progressbar"), c.lines(e, c.opts), !l) {
      var g, h = 0, k = (d.lines - 1) * (1 - d.direction) / 2, q = d.fps, t = q / d.speed, p = (1 - d.opacity) / (t * d.trail / 100), u = t / d.lines;
      !function A() {
        h++;
        for (var a = 0;a < d.lines;a++) {
          g = Math.max(1 - (h + (d.lines - a) * u) % t * p, d.opacity), c.opacity(e, a * d.direction + k, g, d);
        }
    ...
    for (var k, q = 0, t = (d.lines - 1) * (1 - d.direction) / 2;q < d.lines;q++) {
      k = f(a(), {position:"absolute", top:1 + ~(d.scale * d.width / 2) + "px", transform:d.hwaccel ? "translate3d(0,0,0)" : "", opacity:d.opacity, animation:l && e(d.opacity, d.trail, t + q * d.direction, d.lines) + " " + 1 / d.speed + "s linear infinite"}), d.shadow && b(k, f(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(k, h(g(d.color, q), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
    ...
    var t = f(a("group"), {behavior:"url(#default#VML)"});
    !d(t, "transform") && t.adj ? k() : l = d(t, "animation");
  }
  return h;
});
...
var CTATSAI = function(a, b, e, d) {
  function f(a, b, c, d) {
    d = String(t.getElementName(b)).toLowerCase();
    if (d == a || "value" == d) {
      if (d = t.getElementChildren(b), !Array.isArray(d) || 1 > d.length) {
  ...
  var c = "undefined", g = "undefined", h = new CTATStringUtil, k = [], l = [], q = [], n = [], p = [], u = [], t, r = this;
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      var d = a[c];
      if ("selection" == t.getElementName(d) || "Selection" == t.getElementName(d)) {
        for (var e = t.getElementChildren(d), g = !1, f = 0;f < e.length;f++) {
          b = e[f], "value" == t.getElementName(b) && (b = t.getNodeTextValue(b), 1 > f ? this.setSelectionArray(b) : this.appendToSelectionArray(b), g = !0, this.setSelection(b));
        }
        !1 === g && (b = t.getNodeTextValue(d), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == t.getElementName(d) || "Action" == t.getElementName(d)) {
        e = t.getElementChildren(d);
        g = !1;
        for (f = 0;f < e.length;f++) {
          b = e[f], "value" == t.getElementName(b) && (b = t.getNodeTextValue(b), 1 > f ? this.setActionArray(b) : this.appendToActionArray(b), g = !0, this.setAction(b));
        }
        !1 === g && (b = t.getNodeTextValue(d), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == t.getElementName(d) || "value" == t.getElementName(d) || "Input" == t.getElementName(d)) {
        var b = t.getElementChildren(d), h = null;
        k = [];
        ...
        for (var l = 0;l < b.length;l++) {
          var q = b[l];
          "value" == t.getElementName(q) && (h = t.getElementChildren(q), null !== h ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = e.htmlDecode(t.getNodeTextValue(q)), this.ctatdebug("Setting new value to: " + h), g.setValue(h)) : (h = e.htmlDecode(t.getNodeTextValue(q)), this.ctatdebug("Setting new value to: " + h), g.setValue(h), g.setName(q.attributes.getNamedItem("name").value), g.setType(q.attributes.getNamedItem("type").value), 
          g.setFormat(q.attributes.getNamedItem("format").value), f++), 1 > l ? this.setInputArray(h) : this.appendToInputArray(h)) : (q = e.htmlDecode(t.getNodeTextValue(q)), this.ctatdebug("Setting new value to: " + q), g.setValue(q), 1 > l ? this.setInputArray(q) : this.appendToInputArray(q)));
        }
      }
      if ("prompt" == t.getElementName(d) || "Prompt" == t.getElementName(d)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(t.getNodeTextValue(d));
      }
    }
    this.checkDefaultArgument();
  };
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("internalArguments" == t.getElementName(d) || "Input" == t.getElementName(d)) {
        b = d.childNodes;
        k = [];
        ...
        for (var l = 0;l < b.length;l++) {
          if (h = b[l], "value" == t.getElementName(h)) {
            var q = t.getElementChildren(h);
            null !== q ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + q.length), 1 === q.length ? (h = e.htmlDecode(t.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), g.setValue(h)) : (h = e.htmlDecode(t.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), g.setValue(h), g.setName(t.getElementAttr("name")), g.setType(t.getElementAttr("type")), g.setFormat(t.getElementAttr("format")), f++)) : (h = e.htmlDecode(t.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + 
            h), g.setValue(h));
...
var CTATMessage = function(a) {
  ...
  var f = "ungraded", c = !1, g = !1, h = new CTATSkillSet, k = "", l = "", q = "", n = "", p = "", u = null, t = !1;
      ...
      for (e = 0;e < a.length;e++) {
        if (f = a[e], "tool_message" == d.getElementName(f)) {
          for (f = d.getElementChildren(f), l = 0;l < f.length;l++) {
            t = f[l], "event_descriptor" == d.getElementName(t) && (u = new CTATSAI, u.fromXMLInternal(t));
          }
        }
      }
      g = !0;
      ...
      if (c) {
        ...
        for (var x = d.getElementChildren(b), G = 0;G < x.length;G++) {
          ...
          if ("event_descriptor" == d.getElementName(w)) {
            for (var w = d.getElementChildren(w), B = 0;B < w.length;B++) {
              var C = w[B];
              "selection" == d.getElementName(C) && (a = d.getNodeTextValue(C), t.push(C));
              "action" == d.getElementName(C) && (e = d.getNodeTextValue(C), F.push(C));
              "input" == d.getElementName(C) && (f = d.getNodeTextValue(C), E.push(C));
              "prompt" == d.getElementName(C) && (l = d.getNodeTextValue(C));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), x = d.getElementChildren(b), G = 0;G < x.length;G++) {
          if (w = x[G], "properties" == d.getElementName(w)) {
            for (w = d.getElementChildren(w), B = 0;B < w.length;B++) {
              C = w[B], this.ctatdebug("Nodename: " + d.getElementName(C)), "Skills" == d.getElementName(C) && h.parseByValue(C), "SuccessMsg" == d.getElementName(C) && (q = a = d.getNodeTextValue(C)), "BuggyMsg" == d.getElementName(C) && (n = d.getNodeTextValue(C)), "Selection" == d.getElementName(C) && (a = d.getNodeTextValue(C), t.push(C)), "Action" == d.getElementName(C) && (e = d.getNodeTextValue(C), F.push(C)), "Input" == d.getElementName(C) && (f = d.getNodeTextValue(C), E.push(C)), "prompt" == 
              d.getElementName(C) && (l = d.getNodeTextValue(C)), "HighlightMsgText" == d.getElementName(C) && (p = d.getNodeTextValue(C));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + e + "," + f);
      "" !== a && null !== a ? (u = new CTATSAI(a, e, f, l), u.setArrayFromElements(t), u.setArrayFromElements(F), u.setArrayFromElements(E), g = !0) : (this.ctatdebug("No SAI found"), g = !1);
  ...
  this.getSAI = function() {
    return g ? u : new CTATSAI;
  };
  this.getSelection = function() {
    return g ? u.getSelection() : "";
  };
  this.getAction = function() {
    return g ? u.getAction() : "";
  };
  this.getInput = function() {
    return g ? u.getInput() : "";
  };
  this.getSelectionArray = function() {
    return g ? u.getSelectionArray() : [];
  };
  this.getActionArray = function() {
    return g ? u.getActionArray() : [];
  };
  this.getInputArray = function() {
    return g ? u.getInputArray() : [];
  };
...
var CTATCompBase = function(a, b, e, d, f, c) {
  ...
  var g = e || 0, h = d || 0, k = f || -2, l = c || -2, q = 50, n = 25, p = !1, u = "", t = !1, r = !0, y = null, v = "", z = -1;
  this.isTabIndexable = !0;
  var D = 0, F = null, E = null, x = this, G = null, w = "hidden", B = CTATGlobalFunctions.gensym.z_index(), C = CTATGlobalFunctions.gensym.div_id(), A = CTATGlobalFunctions.gensym.z_index(), J = CTATGlobalFunctions.gensym.div_id();
...
CTAT.Component.Base.Graphical = function(a, b, e, d, f, c, g) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", q = 1, n = CTATGlobals.Visual.BorderColor, p = !1, u = "solid", t = 0, r = "1px", y = 0, v = CTATGlobals.Font.color, z = "black", D = CTATGlobals.Font.family, F = CTATGlobals.Font.size, E = !1, x = !1, G = !1;
  ...
  this.setFontColor = function(a) {
    v = CTATGlobalFunctions.formatColor(a);
    this.component && this.getFontColor() !== v && (this.component.style.color = v);
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== p && (p ? (this.setBorderStyle(u), this.setBorderWidth(r)) : this.setBorderStyle("none"));
    return this;
  };
...
CTAT.Component.Base.Tutorable = function(a, b, e, d, f, c, g) {
  ...
  var h = !0, k = !0, l = !0, q = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = !0, p = this, u = !1;
  ...
  this.setHintHighlight = function(a, b) {
    ...
    if (t) {
      ...
      c !== u && (u = c, this.showHintHighlight(c, b));
    }
  };
...
var CTATImageButtonComponent = function(a, b, e, d, f, c, g) {
  ...
  var h = "", k = "", l = "", q = "", n = !1, p = "Image to Component", u = this;
  ...
  this.setEnabled = function(a) {
    ...
    u.assignEnabled(a);
    null === u.getComponent() ? u.ctatdebug("Error: pointer is null!") : (u.getComponent().disabled = !a, !1 === u.getEnabled() ? u.assignActiveImage(q) : u.assignActiveImage(h), u.ctatdebug("setEnabled () -> " + u.getEnabled()));
  };
...
var CTATJumble = function(a, b, e, d, f) {
  ...
  this.init = function() {
    ...
    a ? (n.innerHTML = a, $(n).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      ...
      this.addEventListener("drop", v, !1);
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var c = a.length, d = 0;d < c;d++) {
        ...
        e.addEventListener("dragstart", u, !1);
...
var CTATShape = function(a, b, e, d, f, c) {
  ...
  var h = [], k = [], l = f, q = c, n = b, p = void 0, u = "black", t = "black", r = "Arial", y = 12, v = [], z = 1, D = 5, F = document.createElement("canvas");
  F.id = n;
  F.width = l;
  F.height = q;
  var E = new CTATCSS;
  ...
  this.drawLine = function() {
    x.drawLine(h[0] + z, k[0] + z, h[1], k[1], u, z);
  };
  ...
  this.erase = function() {
    ...
    for (var b = 0;b < v.length;b++) {
      F.addEventListener(v[b][0], v[b][1]);
    }
  };
};
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && r.scrimDownForced(), r.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == g && (g = !1, getSafeElementById(ctatcontainer).removeChild(u)) : 1 == warnScrim && (g = !0), r.scrimUp(a));
  }
  function e(a, b) {
  ...
  var d = "", f = !1, c = !1, g = !1, h = null, k = null, l = new CTATCanvasComponent("CTAT Scrim"), q = [], n = null, p = null, u = null, t = null, r = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (r.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), r.ctatdebug("Message: " + b), 1 == scrimIsUp ? (d = 1 == waitScrim ? b : d + (" \n " + b), l.removeComponent()) : (d = b, scrimIsUp = !0), r.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        ...
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + d + "<br><br></div></div></div>"), !0 === g && (u = e(a, "close"), $(u).appendTo("#scrimpanel")), !0 === f && (n = e(h, "yes"), $(n).appendTo("#scrimpanel")), !0 === c && (p = e(k, "no"), $(p).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
          ...
          try {
            ...
            (t instanceof ReferenceError || t instanceof TypeError) && r.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', t, typeof t);
          }
        }
      }
    }
  ...
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && r.scrimDownForced(), r.ctatdebug("OKScrimUp (" + a + "," + b + ")"), c = f = g = warnScrim = errorScrim = !1, r.scrimUp(a), t = e(b, "OK"), $(t).appendTo("#scrimpanel"));
  };
  ...
  this.setInAuthorTime = function(a) {
    ...
    inAuthorTime = a;
    if (!a) {
      warnScrim = errorScrim = !1, g && null.removeChild(u);
    } else {
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, e = !0, d = !1, f = !1, c = [], g = "undefined", h = "undefined", k = "undefined", l = "undefined", q = "undefined", n = "undefined", p = "undefined", u = "undefined", t = "UnassignedDataset", r = "UnassignedLevelName", y = "UnassignedLevelType", u = (new CTATGuid).guid();
  void 0 != a && null != a ? (d = a, 0 == d && (commLogMessageBuilder = new CTATLogMessageBuilder)) : commLogMessageBuilder = new CTATLogMessageBuilder;
  var v = new CTATCommLibrary;
  v.setName("commLoggingLibrary");
  v.setUseCommSettings(!1);
  v.assignHandler(this);
  ...
  this.logTutorResponse = function(a, c, d, e, g, f, h, k, l) {
...
var CTATMessageHandler = function() {
        ...
        for (var q = d.getElementChildren(l), n = 0;n < q.length;n++) {
          ...
          if ("MessageType" == d.getElementName(p)) {
            ...
            if ("AssociatedRules" == p) {
              ...
              for (var u = "", t = "", r = 0;r < q.length;r++) {
                var y = q[r];
                "TutorAdvice" == d.getElementName(y) && (u = d.getNodeTextValue(y));
                "Actor" == d.getElementName(y) && d.getNodeTextValue(y);
                "Indicator" == d.getElementName(y) && (t = d.getNodeTextValue(y));
              ...
              a.processAssociatedRules(h, t, u);
            ...
            if ("ShowHintsMessage" == p) {
              ...
              for (r = 0;r < q.length;r++) {
                if (y = q[r], "HintsMessage" == d.getElementName(y)) {
                  for (var y = d.getElementChildren(y), v = 0;v < y.length;v++) {
                    var z = y[v];
                    "value" == d.getElementName(z) && (t.push(d.getNodeTextValue(z)), u = !0);
                  }
                }
              }
              !0 === u ? a.processHintResponse(h, t) : b.ctatdebug("Error: incomplete hint message received");
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", e = "Unknown", f = null, q = 0;q < a.length;q++) {
      ...
      if ("serialized" == d.getElementName(n)) {
        ...
        for (var p = d.getElementChildren(n), u = 0;u < p.length;u++) {
          var t = p[u];
          -1 != d.getElementName(t).indexOf("CTAT") && (f = t);
        }
      }
  ...
  this.deserializeComponent = function(a, c, e) {
    ...
    if (null === d.getElementAttr(e, "x")) {
      ...
      var f = d.getElementAttr(e, "x"), q = d.getElementAttr(e, "y"), n = d.getElementAttr(e, "width"), p = d.getElementAttr(e, "height"), u = d.getElementAttr(e, "tabIndex"), t = d.getElementAttr(e, "zIndex");
      null === u && (u = -1);
      null === t && (t = 0);
      ...
      for (f = 0;f < e.length;f++) {
        ...
        if ("Parameters" == d.getElementName(q)) {
          for (this.ctatdebug("Processing component parameters ..."), n = d.getElementChildren(q)[0], n = d.getElementChildren(n), p = 0;p < n.length;p++) {
            ...
            if ("CTATComponentParameter" == d.getElementName(y)) {
              ...
              for (var t = u = void 0, y = d.getElementChildren(y), v = 0;v < y.length;v++) {
                var z = y[v];
                "name" == d.getElementName(z) && (this.ctatdebug("Found parameter name: " + d.getNodeTextValue(z)), u = d.getNodeTextValue(z));
                "value" == d.getElementName(z) && (this.ctatdebug("Found parameter value: " + d.getNodeTextValue(z)), t = d.getNodeTextValue(z).trim());
              }
              this.ctatdebug("Parameter name: " + u + ", value: " + t);
              void 0 !== u && (r.params[u] = t, "group" == u && (r.groupName = t));
            }
          }
        }
        if ("Styles" == d.getElementName(q)) {
          for (this.ctatdebug("Processing component styles ..."), q = d.getElementChildren(q)[0], q = d.getElementChildren(q), n = 0;n < q.length;n++) {
            if (t = q[n], "CTATStyleProperty" == d.getElementName(t)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              u = p = "";
              t = d.getElementChildren(t);
              for (y = 0;y < t.length;y++) {
                v = t[y], "name" == d.getElementName(v) && (p = d.getNodeTextValue(v)), "value" == d.getElementName(v) && (u = d.getNodeTextValue(v).trim());
              }
              this.ctatdebug("Style (name: " + p + ", value: " + u + ")");
              "" !== p && (r.styles[p] = u);
            }
          }
        }
...
var CTATLMS = {identifier:null, initLMSConnection:function() {
  ...
  CTATLMS.saveProblemState = function(a) {
    return CTATLMS.setValue("saveandrestore", a);
  };
  ...
  CTATLMS.saveProblemState = function(a) {
    if (oliComm) {
      return oliComm.writeFileRecord(CTAT.ToolTutor.tutor.getQuestionFile(), a);
    }
  };
  CTATLMS.loadProblemState = function(a) {
    oliDriver.registerClientHandler(a);
    return oliComm.loadFileRecord(CTAT.ToolTutor.tutor.getQuestionFile());
  };
  CTATLMS.gradeStudent = function(a, b) {
    if (oliComm) {
      var e = !1, d = 0;
      0 >= b ? (d = 100, e = !0) : (d = Math.round(100 * a / b), e = a >= b);
      oliComm.scoreAttempt("percentScore", String(d));
      oliComm.scoreAttempt("completed", String(e));
    }
  };
}};
...
CTAT.Component.Base.UnitDisplay = function(a, b, e, d, f, c, g) {
  ...
  var k = "#FF00FF", l = 1, q = "#FF00FF", n = .2, p = "black", u = 1;
  ...
  this.clickHandler = function(a) {
    !0 === r.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), v(this, !a), r.setActionInput("SetPieces", r.updateValue()), r.processAction());
  };
  this.updateSAI = function() {
  ...
  this.get_denominator = function() {
    return t.reduce(function(a, b, c, d) {
    ...
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, g, k) {
        if (1 <= b.valueOf()) {
          ...
          b.reduce();
          var q = e.add(CTAT.Geom.Point.polar(d, 2 * Math.PI * b.valueOf() + l)), u = e.clone();
          if (0 < c && c < d) {
            ...
            k = CTAT.Geom.Point.circle_intersection(u, k, e, d).reduce(n.bind(this, k));
            q = q.add(l);
            q = CTAT.Geom.Point.circle_intersection(u, q, e, d).reduce(n.bind(this, q));
          }
          l = CTAT.Geom.Point.to2DString;
          u = "M " + l(u);
          n = new DOMPoint(d, d);
          u += " L " + l(k);
          u += " A " + l(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + l(q);
          g.setAttributeNS(null, "d", u + " Z");
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), d = 0;d < a.length;d++) {
            ...
            var f = document.createElement("div"), t = e.getLevel();
            .95 > t ? f.classList.add("CTAT-skill-window--bar--nonmastered") : f.classList.add("CTAT-skill-window--bar--mastery");
            f.style.width = .95 < t ? "100%" : 100 * t + "%";
            g.appendChild(f);
            b.appendChild(g);
            g = document.createElement("div");
...
var CTATNumberLine = function(a, b, e, d, f) {
  ...
  }.bind(this), t = 0, r = null, y = new DOMPoint(-30, -30), v = !1, z = function(a) {
    y.x = a.clientX;
    y.y = a.clientY;
  }, D = function(a) {
  ...
  this.init = function() {
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && (v = !0, r.style.visibility = null, t = requestAnimationFrame(w));
    });
    ...
    if (this.baseGroup) {
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? d -= c / 2 : (e += c / 2, d = b.x + b.width >= u ? d - c / 2 : d - c);
...
var ProblemStateSaver = function(a) {
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (a && h) {
      ...
      ++g;
      b.ctatdebug("saveAsYouGo[" + g + "] to send problem_state length " + k.problem_state.length);
      if (null !== CTATLMS.identifier) {
        CTATLMS.saveProblemState(k.problem_state), CTATLMS.gradeStudent(parseInt(h.getCorrect()), parseInt(h.getRequiredSteps()));
      } else {
        if (d) {
          c || (h = {}, h.session_id = a.getSessionID(), c = new CTATCommLibrary(this, !1, h));
          h = [];
          for (var q in k) {
            l = new CTATVariable, l.name = q, l.value = k[q], h.push(l);
          }
          c.send_post_variables(d, h);
          b.ctatdebug("saveAsYouGo[" + g + "] sent problemState.length " + e.length);
        }
      }
    } else {
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(d) {
    ...
    if (d.mustRetrieveProblemState()) {
      if (null !== CTATLMS.identifier) {
        a.stopWorking(1), CTATLMS.getProblemState(b.process);
      } else {
        a.stopWorking(1);
        console.log("Attempting problem restore within generic/tutorshop environment ...");
        var f = (new CTATConnection).getHTTPObject();
        f.onreadystatechange = function() {
          b.ctatdebug("onready... GET for problemState xmlhttp.readyState " + f.readyState + ", .status " + f.status);
          if (4 == f.readyState && 200 == f.status) {
            b.ctatdebug("problemState responseText: " + f.responseText);
            var a = decodeURIComponent(f.responseText);
            b.process(a);
          }
        };
        f.onerror = function() {
          a.enqueueForRestore([]);
          var c = (new CTATTutorMessageBuilder).createErrorMessage("Load ProblemState Error", f.status + " " + f.statusText);
          b.ctatdebug("onerror GET for problemState " + c);
          CTAT.ToolTutor.sendToInterface(c, !0);
        };
        f.open("GET", e, !0);
        f.send();
        b.ctatdebug("sent GET for restoreProblemUrl,  " + e);
      }
    } else {
...
var CTATProblemSummary = function(a, b, e) {
  ...
  var d = Number.MAX_VALUE, f = b, c = 0, g = new Date, h = {}, k = 0, l = 0, q = 0, n = 0, p = 0, u = 0, t = 0, r = CTATMsgType.CompletionValue[0], y = this;
  ...
  this.addCorrect = function(a) {
    ...
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++p, 1 > b.getNFirstHints() && u++), b.incrementNCorrect()) : (y.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, p++, u++);
    k++;
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, e = [1, 6], d = [1, 7], f = [1, 10], c = [1, 11], g = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], q = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], p = [1, 24], u = [1, 26], t = [1, 27], r = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], y = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:e, 14:4, 15:d, 17:5, 19:8, 22:9, 24:f, 25:c, 27:g, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(q, [2, 11], {22:9, 19:25, 16:n, 18:p, 20:u, 21:t, 24:f, 25:c, 27:g, 28:h}), b(r, [2, 17]), {13:e, 15:d, 17:28, 19:8, 22:9, 24:f, 25:c, 27:g, 28:h}, {13:e, 15:d, 17:29, 19:8, 22:9, 24:f, 25:c, 27:g, 28:h}, b(r, [2, 20]), b(r, [2, 23], {23:[1, 30]}), {13:e, 15:d, 17:31, 19:8, 22:9, 24:f, 25:c, 27:g, 
  ...
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(q, [2, 9], {22:9, 19:25, 16:n, 18:p, 20:u, 21:t, 24:f, 25:c, 27:g, 28:h}), b(q, [2, 10], {22:9, 19:25, 16:n, 18:p, 20:u, 21:t, 24:f, 25:c, 27:g, 28:h}), b(r, [2, 12]), b(r, [2, 13]), b(r, [2, 15]), b(r, [2, 16]), b(r, [2, 21]), b(y, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      var c = function(a, b) {
    ...
    for (var t, r, y, P, S = {}, X, Q;;) {
      ...
      if ("undefined" === typeof P || !P.length || !P[0]) {
        ...
        U = p.showPosition ? "Parse error on line " + (f + 1) + ":\n" + p.showPosition() + "\nExpecting " + Q.join(", ") + ", got '" + (this.terminals_[t] || t) + "'" : "Parse error on line " + (f + 1) + ": Unexpected " + (1 == t ? "end of input" : "'" + (this.terminals_[t] || t) + "'");
        this.parseError(U, {text:p.match, token:this.terminals_[t] || t, line:p.yylineno, loc:n, expected:Q});
      }
      ...
      switch(P[0]) {
        case 1:
          ...
          b.push(P[1]);
          t = null;
          r ? (t = r, r = null) : (h = p.yyleng, g = p.yytext, f = p.yylineno, n = p.yylloc, 0 < k && k--);
          break;
        case 2:
          ...
          u && (S._$.range = [d[d.length - (Q || 1)].range[0], d[d.length - 1].range[1]]);
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, c, k, l) {
      ...
      try {
        ...
        n = 0;
        for (u = y.length;n < u;n++) {
          p = y[n], 0 > f.call(e, p) && CTATFormulaFunctions.assign(p, void 0);
        }
        for (p in v = this.variableTable.getTable()) {
          t[p] = v[p];
        }
        ...
        }).apply(t, [c, k, l].concat(d.call(this.values)));
      } catch (z) {
        return console.log(z), null;
      } finally {
        for (p in t) {
          null != p && 0 > f.call(q, p) && (v[p] = t[p], delete t[p]);
        }
      }
    };
...
var CTATExpressionMatcher = function(a, b) {
  function e(a, b, e, g, f) {
    ...
    var u = CTATVariableTable.standardizeType(e);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof e + "; inputConv " + u + ", typeof " + typeof u);
    e = h.evaluate(a, b, u, f);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + u + ", " + f + ") returned " + e + ", type " + typeof e);
    f = null;
    switch(g) {
...
var CTATVectorMatcher = function(a, b, e, d) {
  function f(a, b, d, e, f) {
    ...
    for (var y = 0;3 > y;y++) {
      var v = k[y][0], z = v instanceof CTATExpressionMatcher ? v.matchConcatenation(a, b, d, e) : v.matchConcatenation(r[y]);
      l.ctatdebug("CTATVectorMatcher --\x3e in _match[" + y + "] after " + v + ".concat returns: " + z);
      if (f) {
        f.push(z);
      } else {
        if (!1 === z) {
...
var CTATExampleTracerLink = function(a, b, e) {
  ...
  var d = "undefined" === typeof a || null === a ? null : a, f = null, c = "undefined" === typeof b || null === b ? null : b, g = "undefined" === typeof e || null === e ? null : e, h = null, k = 1, l = 1, q = "CORRECT_ACTION", n = [], p = !1, u = null, t = "", r = null, y = null, v = this;
  this.getUniqueID = function() {
    return d;
  };
  this.getMatcher = function() {
    v.ctatdebug("CTATExampleTracerLink --\x3e in getMatcher");
    return h;
  };
  this.isCorrect = function() {
  ...
  this.matchesSAI = function(a, b, c) {
    var d = v.getMatcher();
    v.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAI(); matcher " + d + ", typeof " + typeof d + ", sai " + a);
    a = d.match(a.getSelectionArray(), a.getActionArray(), a.getInputArray(), b, c);
    v.ctatdebug("CTATExampleTracerLink --\x3e out of matchesSAI: result = " + a);
    return a;
  };
  this.matchesSAIforHint = function(a, b, c, d) {
    v.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAIforHint(" + a + ", " + b + ") selectionArray " + a.getSelectionArray());
    if (!1 === v.getMatcher().matchForHint(a.getSelectionArray(), a.getActionArray(), b, d)) {
      return v.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false because no match"), !1;
    }
    if (null !== c && "undefined" !== typeof c && !0 === c.getWantReportableHints() && (a = null === v.getAllHints() || "undefined" === typeof v.getAllHints() ? 0 : v.getAllHints().length, 1 > a)) {
      return v.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false nStaticHints " + a + "< 1"), !1;
    }
    v.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning true");
    return !0;
  };
  ...
  this.toString = function() {
    var a;
    a = "[link " + v.getUniqueID();
    a += " (" + v.getPrevNode() + "-" + v.getNextNode();
    a += ") " + v.getType();
    return a + "]";
  };
  this.getTutorSAI = function(a, b) {
    return v.getMatcher().getTutorSAI(a, b, v.getActionType());
  };
  this.getEvaluatedInput = function(a, b) {
    return v.getMatcher().getEvaluatedInput(a, b);
  };
  ...
  this.isDone = function() {
    var a = String(v.getDefaultSAI().getSelection()).toLowerCase(), b = String(v.getDefaultSAI().getAction()).toLowerCase(), a = CTATMsgType.DONE.toLowerCase() == a && CTATMsgType.BUTTON_PRESSED.toLowerCase() == b;
    v.ctatdebug("CTATExampleTracerLink.isDone() returns " + a);
    return a;
  };
  this.interpolateHints = function(a) {
    v.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints(" + a + ")");
    var b = [];
    ...
    n.forEach(function(a) {
      if (!(1 > String(a).trim().length)) {
        var d = v.getDefaultSAI().getSelection(), e = v.getDefaultSAI().getAction(), g = CTATVariableTable.standardizeType(v.getDefaultSAI().getInput());
        v.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate(" + a + ", " + d + ", " + e + ", " + g + ")");
        a = c.interpolate(a, d, e, g);
        v.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate() returns " + a);
        b.push(a);
      }
    });
    v.ctatdebug("CTATExampleTracerLink --\x3e out of interpolateHints " + b);
    return b;
  };
  this.getHints = function() {
    v.ctatdebug("CTATExampleTracerLink --\x3e in getHints");
    var a = [];
    v.interpolateHints(null).forEach(function(b) {
      v.ctatdebug("CTATExampleTracerLink --\x3e in getHints loop");
      b.toString() !== "".toString() && a.push(b);
    });
    v.ctatdebug("CTATExampleTracerLink --\x3e out of getHints");
    return a;
  };
  ...
  this.isTraversable = function() {
    return 1 > v.getMaxTraversals() ? !1 : CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() == v.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() == v.getActionType().toString().toUpperCase() ? !0 : !1;
  };
  this.replaceInput = function() {
    return CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() !== v.getActionType().toString().toUpperCase() && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() !== v.getActionType().toString().toUpperCase() ? !1 : v.getMatcher().replaceInput();
  };
  this.evaluateReplacement = function(a, b, c) {
    return v.getMatcher().evaluateReplacement(a, b, c);
  };
  this.getActor = function() {
    return v.getMatcher().getActor();
  };
  this.getDefaultSAI = function() {
    v.ctatdebug(v.toString() + ".getSAI(): " + (h ? h.getDefaultSAI() : "(matcher null)"));
  ...
  this.setSelection = function(a) {
    v.getMatcher().setDefaultSelection(null === a[0] || "undefined" === typeof a[0] ? "" : a[0].toString());
  };
  this.setAction = function(a) {
    v.getMatcher().setDefaultAction(null === a[0] || "undefined" === typeof a[0] ? "" : a[0].toString());
  };
  ...
  this.addSkillName = function(a) {
    v.ctatdebug("ETLink[" + d + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === y || "undefined" === typeof y) {
        y = [];
      }
      -1 < y.indexOf(a) || (y.push(a), v.ctatdebug("ETLink.addSkillName() return with skillNames " + y));
    }
  };
  ...
  this.isTutorPerformed = function(a) {
    if (CTATExampleTracerLink.CORRECT_ACTION.toUpperCase() !== v.getActionType().toUpperCase()) {
      return !1;
    }
    var b = v.getMatcher();
  ...
  this.setIsPreferredLink = function(a) {
    v.ctatdebug("ETLink.setIsPreferredLink() was " + p + ", now " + a);
    p = a;
  };
...
var CTATExampleTracerSkill = function(a, b, e, d, f, c, g) {
  ...
  var h = null == a || "" == a.trim() ? b : b + " " + a, k = d, l = /^0*[xX]([0-9a-fA-F]+)$/.test(g) ? parseInt(g, 16) : /^(\-|\+)?[0-9]+$/.test(g) ? parseInt(g, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, q = 0, n = 0, p = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, u = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, t = null, r = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.hasReachedMastery = function() {
    return null === k || "undefined" === typeof k ? !1 : k >= u;
  };
  this.getLabel = function() {
...
var CTATExampleTracerEvent = function(a, b, e) {
  ...
  var d = "", f = !1, c = CTATExampleTracerLink.NO_MODEL, g = !1, h = null, k = null, l = "student", q = null, n = null, p = "", u = null, t = null, r = null, y = null, v = null, z = [], D = !1, F = null, E = null, x = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
  ...
  this.isOutOfOrder = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + u);
    return u;
  };
  ...
  this.getSuccessOrBuggyMsg = function() {
    x.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + v);
    return v;
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function c(a, b, c) {
    ...
    w.ctatdebug("interps # : " + v.length);
    w.ctatdebug("interps: " + v);
  ...
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === F.observesOrderingConstraints(h, a, g, e) || !1 === u(b, a, g) ? (w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
  ...
  var v = null, z = null, D = null, F = a, E = null;
  ...
  this.resetTracer = function() {
    ...
    null === v || "undefined" === typeof v ? (w.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), v = []) : (w.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), v.length = 0);
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = t(!1, [a])) ? a.getPrevNode() : F ? F.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, e) {
  ...
  function f(a, b, d) {
    ...
    for (var e = !0, g = 0;g < b.length;g++) {
      if (!0 === e && !1 === B.isGroupReenterable(b[g])) {
        for (var e = !1, f = 0;f < a.length;f++) {
          if (!0 === B.isLinkInGroup(b[g], a[f])) {
            e = !0;
          } else {
            if (!0 === e) {
              return !1;
    ...
    if (0 !== a.length) {
      ...
      h.forEach(function(a) {
        !0 === B.isGroupReenterable(a) && h.splice(h.indexOf(a), 1);
      });
      var l = !0;
      h.forEach(function(b) {
        !1 !== l && d.forEach(function(c) {
          !1 !== l && k(a, c) < c.getMinTraversals() && !0 === B.isLinkInGroup(b, c) && (l = !1);
        });
      });
      if (!1 === l) {
        return !1;
  ...
  function c(a) {
    A.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof B);
    a = B.getGroupsContainingLink(a);
    ...
    b.sort(function(a, b) {
      return B.getGroupLinkCount(b) - B.getGroupLinkCount(a);
    });
    return b;
  }
  function g(a, b, c, d) {
    var e = -1, g = null, f = Number.MAX_VALUE, l = null;
    B.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === B.isLinkInGroup(a, b) && 0 !== B.getGroupLinkCount(a)) {
        var k = h(a, d);
        null !== k && "undefined" !== typeof k && (k = k.getDepth(), k < b.getDepth() && k > e && (!1 === q(a) || !0 === n(a, c)) && (e = k, g = a), k > b.getDepth() && k < f && (!1 === q(a) || !0 === n(a, c)) && (f = k, l = a));
      }
    });
    B.getUniqueLinks(a).forEach(function(a) {
      if (!0 === d.has(a)) {
        var h = a.getDepth();
  ...
  function h(a, b) {
    ...
    B.getGroupLinks(a).forEach(function(a) {
  ...
  function l(a, b, c) {
    ...
    (new CTATExampleTracerPath(b)).getSortedLinks().forEach(function(b) {
      if (!1 !== e && !0 !== g) {
        if (!1 === d) {
          !0 === B.isLinkInGroup(a, b) && (d = !0);
        } else {
          if (!1 === B.isLinkInGroup(a, b)) {
            g = !0;
            return;
          }
        }
  ...
  var y = null, v = null, z = null, D = null, F = null, E = null, x = new Set, G = new Set, w = null, B = null, C = CTATMsgType.SHOW_ALL_FEEDBACK, A = this;
  this.getFeedbackPolicy = function() {
    return C;
  };
  this.setFeedbackPolicy = function(a) {
    A.ctatdebug("Graph.setFeedbackPolicy(" + a + ") old policy " + C);
  ...
  this.getDefaultBuggyMsg = function() {
    return B.getTopLevelGroup() ? B.getTopLevelGroup().getDefaultBuggyMsg() : null;
  };
  this.getLinks = function() {
  ...
  this.addLink = function(a, b) {
    ...
    null === b || "undefined" === typeof b ? B.addLinkToGroup(B.getTopLevelGroup(), a) : B.addLinkToGroup(b, a);
  ...
  this.isIncorrectLinkOK = function(a, b, c, e) {
    ...
    if (!0 === g && (b = A.getSmallestContainingGroup(b), !0 === B.isLinkInGroup(b, f) && !1 === B.isGroupOrdered(b) && !0 === l(b, c, e))) {
      return !1;
    }
  ...
  this.getSmallestContainingGroup = function(a) {
    return B.getLowestLevelGroupOfLink(a);
  };
  ...
  (function(a, b) {
    ...
    D = {};
    if (null === B || "undefined" === typeof B) {
      B = new CTATDefaultGroupModel, A.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    B.clear();
    B.setDefaultReenterable(!b);
    B.setGroupOrdered(B.getTopLevelGroup(), a);
    B.setGroupName(B.getTopLevelGroup(), CTATExampleTracerGraph.TOP_LEVEL);
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var d = new CTATExampleTracerLink(null, null, null), e = g.getElementChildren(a), f, h, k, l, n, p = a = -1, x = CTATMsgType.DEFAULT_ACTOR, G = !1, w = 0;w < e.length;w++) {
      ...
      if ("rule" === g.getElementName(e[w])) {
        for (var B = g.getElementChildren(e[w]), C = 0;C < B.length;C++) {
          "text" === g.getElementName(B[C]) && d.addSkillName(g.getNodeTextValue(B[C]).toString());
        }
      }
      if ("actionLabel" === g.getElementName(e[w])) {
        for (d.setIsPreferredLink("false" != g.getElementAttr(e[w], "preferPathMark")), d.setMinTraversalsStr(g.getElementAttr(e[w], "minTraversals")), d.setMaxTraversalsStr(g.getElementAttr(e[w], "maxTraversals")), B = g.getElementChildren(e[w]), C = 0;C < B.length;C++) {
          "uniqueID" === g.getElementName(B[C]) && (n = g.getNodeTextValue(B[C]), d.setUniqueID(parseInt(g.getNodeTextValue(B[C]))));
          "message" === g.getElementName(B[C]) && (l = new CTATMessage(B[C]));
          "actionType" === g.getElementName(B[C]) && d.setActionType(g.getNodeTextValue(B[C]));
          "buggyMessage" === g.getElementName(B[C]) && d.setBuggyMsg(g.getNodeTextValue(B[C]));
          "successMessage" === g.getElementName(B[C]) && d.setSuccessMsg(g.getNodeTextValue(B[C]));
          "hintMessage" === g.getElementName(B[C]) && d.addHint(g.getNodeTextValue(B[C]));
          if ("matchers" === g.getElementName(B[C])) {
            for (var A = g.getElementChildren(B[C]), J = 0;J < A.length;J++) {
          ...
          if ("matcher" === g.getElementName(B[C])) {
            h = B[C];
  ...
  this.parseGraph = function(b, d) {
    ...
    for (var E = null, x = 0;x < D.length;x++) {
      switch(g.getElementName(D[x])) {
        ...
        case "node":
          ...
          var w = g.getElementChildren(G), B = -1;
          G = "";
          for (var C = 0;C < w.length;C++) {
            switch(g.getElementName(w[C])) {
              case "uniqueID":
                B = parseInt(g.getNodeTextValue(w[C]));
                break;
              case "text":
                G = g.getNodeTextValue(w[C]);
            }
          }
          w = new CTATExampleTracerNode(B, new Set);
          "" !== G && w.setNodeName(G);
          G = w;
          c.addNode(G);
        ...
        case "productionRule":
          ...
          G = void 0;
          for (var C = "unknown", w = void 0, B = null, A = g.getElementChildren(A), J = 0;J < A.length;J++) {
            var H = g.getElementName(A[J]);
            "ruleName" === H && (G = g.getNodeTextValue(A[J]), ctatdebug("ruleName=" + G));
            "productionSet" === H && (C = g.getNodeTextValue(A[J]), ctatdebug("productionSet=" + C));
            "label" === H && (w = g.getNodeTextValue(A[J]), ctatdebug("label=" + C));
            "description" === H && (B = g.getNodeTextValue(A[J]), ctatdebug("description=" + C));
          }
          C = new CTATExampleTracerSkill(C, G, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN, CTATExampleTracerSkill.DEFAULT_HISTORY);
          null != w ? C.setLabel(w) : C.setLabel(G);
          null != B ? C.setDescription(B) : C.setDescription(G);
          p.push(C);
      }
    }
    if (E) {
      ...
      ctatdebug("parseGraph() value of isUnordered = " + v);
      ctatdebug("parseGraph() typeof isOrdered: " + typeof r);
      ctatdebug("parseGraph()typeof isUnordered: " + typeof v);
      y = E;
      D = r;
    ...
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(q, v, n, d.isFeedbackSuppressed(), z, F, r);
    c.redoLinkDepths();
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (g && !(1 > g.length)) {
      ...
      for (v = 0;v < y.length;++v) {
        z = y[v], n.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + z.timeout + ", .msgTuples.length " + z.msgTuples.length), setTimeout(f, z.timeout, c, z.msgTuples);
      }
...
var CTATExampleTracer = function() {
  ...
  function e(a, b) {
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && p.sendBundle([a]), f(a, g, v, e), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && p.sendBundle([a]), c(a, g, v, e), !0;
  ...
  function d(a, b, c, d) {
      ...
      if (d = c.getElementName(a[b]), p.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            for (var e = v.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = v.getElementAttr(e[f], "label"), k = v.getElementAttr(e[f], "pSlip"), l = v.getElementAttr(e[f], "description"), n = v.getElementAttr(e[f], "pKnown"), q = v.getElementAttr(e[f], "category"), r = v.getElementAttr(e[f], "pLearn"), t = v.getElementAttr(e[f], "pGuess"), x = v.getElementAttr(e[f], "history"), h = new CTATExampleTracerSkill(q, h, t, n, k, r, x);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
          ...
          case "problem_state_status":
            ...
            B || (B = new ProblemStateRestorer(p));
            p.ctatdebug("SetPreferences problemStateRestorer " + B);
            break;
          case "curriculum_service_url":
            w.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
    ...
    p.ctatdebug("questionFile " + u + ", outputStatus " + C + ", problemStateRestorer " + B);
    a = u;
    p.ctatdebug("retrieveBRD (" + a + ")");
    O.retrieveXMLFile(a, c, p);
    B && B.retrieveMessages(C);
  }
  function f(a, b, c, d) {
  ...
  function c(a, b, c, d) {
    ...
    (D === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? z && z.getSelection() ? (d.splice(1, 0, z.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : D === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && z && z.getSelection() && (d.splice(1, 0, z.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), p.startSkillTransaction(), a = [], d = t.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), b.setStepID(d.getUniqueID()), p.updateSkills(CTATExampleTracerSkill.HINT, 
  ...
  function l(a, b, c, d, e, f) {
    ...
    f = k.getStudentSAI();
    var l = k.getTutorSAI(), r = k.getTransactionID(), v = new CTATTutorMessageBuilder, u = [];
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        n = u ? "" + u.getUniqueID() : "", k.setStepID(n), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && p.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, v.createCorrectActionMessage(r, l), k, l), null !== u && "undefined" !== typeof u && p.updateSkills(CTATExampleTracerSkill.CORRECT, u.getSkillNames(), u.getUniqueID()), n = k.getSuccessOrBuggyMsg(), p.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, v.createAssociatedRulesMessageForAction(k.getResult(), 
        l, q(c), f, p.getSkillBarVector(!0, c), u.getUniqueID(), r, n), k, l), p.ctatdebug("finishNewExampleTrace() successMsg " + n), n && p.messageTank.addToMessageTank("SuccessMessage", v.createSuccessMessage(r, n), k, null), z = null, d && (x = h(u ? u.getNextNode() : null, t.findCurrentState(!1, !1), p.lastMessage ? p.lastMessage.getSAI() : null, k)) && (k = x);
      } else {
        p.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, v.createInCorrectActionMessage(r, k.getInterpolatedSAI()), k, null);
        ...
        x || (x = t.getBestNextLink(!1, y), p.ctatdebug("getBestNextLink result: " + y + "; hintLink " + x));
        ...
        p.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, v.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : f, q(c), f, p.getSkillBarVector(!0, c), n, r, y.tutorAdvice), k, null);
        y.msg && p.messageTank.addToMessageTank(y.msgType, y.msg, k);
        z = f;
        d && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() ? (x = h(u ? u.getNextNode() : null, t.findCurrentState(!1, !1), p.lastMessage ? p.lastMessage.getSAI() : null, k)) && (k = x) : k.isDoneStepFailed() && p.messageTank.flushDelayedFeedback();
      }
    }
    p.lastResult = k;
  ...
  var p = this, u = null, t, r, y, v = new CTATXML;
  new XMLSerializer;
  var z = null, D, F = !0, E = !1, x = null, G = null, w = new ProblemStateSaver(p);
  w.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var B = null, C = new CTATProblemStateStatus, A = [], J = [], H = 0, L = !1, N = "", T = null;
  p.ctatdebug("CTATExampleTracer constructor outputStatus=" + C);
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      p.ctatdebug("No of children" + v.getElementChildren(a).length);
      var b = new CTATGraphParser, c = b.parseGraph(a, p);
      y = c.gr;
      t = c.tracer;
      a = c.ssm;
      var d = c.sgMsg;
      p.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + C);
      for (var c = [], e = new XMLSerializer, f = null, g = 0;g < a.length;g++) {
        if ("message" == v.getElementName(a[g])) {
          var k = e.serializeToString(a[g]), l = CTATMsgType.getMessageType(k);
          CTATMsgType.UNTUTORED_ACTION != l && CTATMsgType.INTERFACE_ACTION != l || p.setVariablesFromSAI(a[g], v);
      ...
      p.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + C);
      p.sendBundle(c);
      b = [];
      a = y.getStartNode();
      ...
      C.isIncomplete() || (b = [], b.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END, null)), p.sendBundle([b]));
      L = !0;
    }
    p.startWorking(0);
  };
  ...
  this.sendBundle = function(a) {
    p.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + C);
    for (var b = 0, c = 0;c < a.length;c++) {
      p.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      w.forwardToInterface(d, c >= a.length - 1, C) && ++b;
    }
    return 0 < b;
  };
