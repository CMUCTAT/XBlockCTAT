...
(function(a) {
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      return 864E5 === b ? l(c, 36E5, 6E4) : 36E5 === b ? l(c, 6E4, 1E3) : c;
    }, h = function(a, b, d, f) {
      if ("N/A" !== d) {
        return d;
      }
      ...
      for (var e = {}, g = b.olson.dst_rules.zones, m = g.length, k = a[f], x = 0;x < m;x++) {
        var A = g[x], C;
        C = g[x];
        for (var z = 0, B = 0;B < d.length;B++) {
          if (C.rules[B] && d[B]) {
            if (d[B].s >= C.rules[B].s && d[B].e <= C.rules[B].e) {
              z = 0, z += Math.abs(d[B].s - C.rules[B].s), z += Math.abs(C.rules[B].e - d[B].e);
            } else {
              z = "N/A";
              break;
            }
      ...
      for (var u in e) {
        if (e.hasOwnProperty(u) && -1 != k.indexOf(u)) {
          return u;
        }
      }
      return f;
      ...
      var d = function() {
        for (var a = [], d = 0;d < b.olson.dst_rules.years.length;d++) {
          ...
          for (var g = (new Date(c)).getTimezoneOffset(), m = null, h = null;c < e - 864E5;) {
            var k = new Date(c), l = k.getTimezoneOffset();
            l !== g && (l < g && (m = k), l > g && (h = k), g = l);
            c += 864E5;
          }
          e = m && h ? {s:f(m).getTime(), e:f(h).getTime()} : !1;
          a.push(e);
        }
        return a;
      }();
    ...
    return {determine:function() {
      var f = d();
      f || (f = b.olson.timezones[g()], "undefined" !== typeof a[f] && (f = m(f)));
...
(function(a, b) {
  ...
  function c(a, b, d, f) {
    ...
    var c = l.substring(0, l.indexOf("Animation")).toLowerCase();
    n[e] || (p.insertRule("@" + (c && "-" + c + "-" || "") + "keyframes " + e + "{0%{opacity:" + f + "}" + d + "%{opacity:" + a + "}" + (d + .01) + "%{opacity:1}" + (d + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + f + "}}", p.cssRules.length), n[e] = 1);
    return e;
  }
  function e(a, b) {
    var d = a.style, f, e;
  ...
  function k() {
    ...
    h.prototype.lines = function(a, e) {
      ...
      function m(a, k, l) {
        b(r, b(g(c(), {rotation:360 / e.lines * a + "deg", left:~~k}), b(g(d("roundrect", {arcsize:e.corners}), {width:h, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:l}), d("fill", {color:f(e.color, a), opacity:e.opacity}), d("stroke", {opacity:0}))));
      }
      var h = e.scale * (e.length + e.width), k = 2 * e.scale * h, l = -(e.width + e.length) * e.scale * 2 + "px", r = g(c(), {position:"absolute", top:l, left:l});
      if (e.shadow) {
        for (l = 1;l <= e.lines;l++) {
          m(l, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
        }
      }
      for (l = 1;l <= e.lines;l++) {
        m(l);
  ...
  var m = ["webkit", "Moz", "ms", "O"], n = {}, l, p, v = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!l) {
      var c = 0, m = (f.lines - 1) * (1 - f.direction) / 2, h, k = f.fps, r = k / f.speed, n = (1 - f.opacity) / (r * f.trail / 100), v = r / f.lines;
      (function y() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          h = Math.max(1 - (c + (f.lines - a) * v) % r * n, f.opacity), d.opacity(e, a * f.direction + m, h, f);
        }
        d.timeout = d.el && setTimeout(y, ~~(1E3 / k));
      })();
    }
    return d;
  }, stop:function() {
    ...
    for (var h = 0, k = (e.lines - 1) * (1 - e.direction) / 2, r;h < e.lines;h++) {
      r = g(a(), {position:"absolute", top:1 + ~(e.scale * e.width / 2) + "px", transform:e.hwaccel ? "translate3d(0,0,0)" : "", opacity:e.opacity, animation:l && c(e.opacity, e.trail, k + h * e.direction, e.lines) + " " + 1 / e.speed + "s linear infinite"}), e.shadow && b(r, g(m("#000", "0 0 4px #000"), {top:"2px"})), b(d, b(r, m(f(e.color, h), "0 0 1px rgba(0,0,0,.1)")));
    }
    return d;
  ...
  if ("undefined" !== typeof document) {
    ...
    !e(r, "transform") && r.adj ? k() : l = e(r, "animation");
  }
  return h;
});
  ...
  this.addSelectorAttribute = function(a, b, d) {
    ...
    a: {
      if (0 === c) {
        ...
        for (var n = 0;n < e.length && null !== e[n][0];n++) {
          if (e[n][0] == a) {
            a = n;
            break a;
          }
...
function setVariable(a, b) {
  ...
  var c = window.btoa(b), c = '{"' + a + '": "' + c + '"}';
  $.ajax({type:"POST", url:xblockRuntime.handlerUrl(xblockElement, "ctat_set_variable"), data:c, success:function(a) {
    console.log("success");
...
var CTATGraphicsTools = function(a, b, c, e, g, d) {
  ...
  var f = b || 1, h = c || "#000000", k = e || "#EEEEEE", m = g || !1, n = "Arial", l = a || null;
  a = d || !1;
  var p = 0, v = this;
  if (null == l) {
  ...
  this.drawLine = function(a, b, d, f, e, c) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawLine");
    a += p;
    d += p;
    b += p;
    f += p;
  ...
  this.drawCircle = function(a, b, d) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawCircle");
    a += p;
    b += p;
    l.strokeStyle = h;
    l.lineWidth = f;
    l.beginPath();
    l.arc(a, b, d, 0, 2 * Math.PI);
    l.stroke();
  };
  this.drawCircleFilled = function(a, b, d) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawCircleFilled");
    a += p;
    b += p;
    l.fillStyle = k;
    l.beginPath();
  ...
  this.drawRectangle = function(a, b, d, e) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangle");
    a += p;
    b += p;
    l.lineWidth = f;
    1 == m ? (l.fillStyle = k, l.fillRect(a, b, d, e)) : (l.strokeStyle = h, l.beginPath(), l.rect(a, b, d, e), l.stroke());
  };
  this.drawRectangleFilled = function(a, b, d, f) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangleFilled");
    a += p;
    b += p;
    l.fillStyle = k;
    l.fillRect(a, b, d, f);
  ...
  this.drawRoundedRect = function(a, b, d, e, c) {
    a += p;
    b += p;
    null != l && (l.strokeStyle = h, l.lineWidth = f, l.beginPath(), l.moveTo(a, b + c), l.lineTo(a, b + e - c), l.quadraticCurveTo(a, b + e, a + c, b + e), l.lineTo(a + d - c, b + e), l.quadraticCurveTo(a + d, b + e, a + d, b + e - c), l.lineTo(a + d, b + c), l.quadraticCurveTo(a + d, b, a + d - c, b), l.lineTo(a + c, b), l.quadraticCurveTo(a, b, a, b + c), l.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, d, e, c) {
    a += p;
    b += p;
    null != l && (l.strokeStyle = h, l.lineWidth = f, l.beginPath(), l.moveTo(a, b + c), l.lineTo(a, b + e - c), l.quadraticCurveTo(a, b + e, a + c, b + e), l.lineTo(a + d - c, b + e), l.quadraticCurveTo(a + d, b + e, a + d, b + e - c), l.lineTo(a + d, b + c), l.quadraticCurveTo(a + d, b, a + d - c, b), l.lineTo(a + c, b), l.quadraticCurveTo(a, b, a, b + c), l.stroke(), l.fillStyle = k, l.beginPath(), l.moveTo(a, b + c), l.lineTo(a, b + e - c), l.quadraticCurveTo(a, b + e, a + c, b + e), l.lineTo(a + 
    d - c, b + e), l.quadraticCurveTo(a + d, b + e, a + d, b + e - c), l.lineTo(a + d, b + c), l.quadraticCurveTo(a + d, b, a + d - c, b), l.lineTo(a + c, b), l.quadraticCurveTo(a, b, a, b + c), l.fill());
  };
  this.drawText = function(a, b, d) {
    if (null != l) {
      ...
      b += p;
      try {
        l.fillStyle = h, l.font = n + " 12pt", l.fillText(d, a, b);
      } catch (f) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTextFormatted = function(a, b, d, f, e, c, g, m, h, k) {
    if (null != l) {
      a += p;
      b += p;
      f = "";
      ...
      f += "12pt " + n;
      try {
        l.fillStyle = c, l.font = f, l.fillText(d, a, b);
      } catch (v) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  ...
  this.drawTriangle = function(a, b, d, e, c, g) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangle");
    a += p;
    d += p;
    c += p;
    b += p;
  ...
  this.drawTriangleFilled = function(a, b, d, e, c, g) {
    null == l && v.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangleFilled");
    a += p;
    d += p;
    c += p;
    b += p;
  ...
  this.clearCanvas = function(a, b, d, f) {
    "ctat" == CTATConfig.platform && l.clearRect(a, b, d, f);
  };
};
...
var CTATMobileTutorHandler = function(a, b) {
  ...
  this.processTextFocus = function(a, b, h, k, m) {
    this.ctatdebug("processTextFocus (" + a + "," + b + "," + h + "," + k + "," + m + ")");
...
;var CTATShape = function(a, b, c, e, g, d) {
  ...
  var h = [], k = [], m = g, n = d, l = b, p = void 0, v = "black", r = "black", t = "Arial", w = 12, x = [], A = 1, C = 5, z = document.createElement("canvas");
  z.id = l;
  z.width = m;
  z.height = n;
  var B = new CTATCSS;
  B.addCSSAttribute("position", "absolute");
  B.addCSSAttribute("left", c + "px");
  B.addCSSAttribute("top", e + "px");
  B.addCSSAttribute("visibility", "visible");
  B.addCSSAttribute("background-color", "rgba(0, 0, 0, 0)");
  B.addCSSAttribute("border-style", "none");
  z.setAttribute("style", B.toCSSString());
  getSafeElementById(a).appendChild(z);
  var u = new CTATGraphicsTools(z.getContext("2d"));
  u.setGraphicBorderWidth(A);
  u.setLineColor(v);
  u.setFillColor(r);
  ...
  this.setXPoints = function(a) {
    h = a;
    B.modifyCSSAttribute("left", h[0] + "px");
    z.setAttribute("style", B.toCSSString());
  };
  this.setYPoints = function(a) {
    k = a;
    B.modifyCSSAttribute("top", k[0] + "px");
    z.setAttribute("style", B.toCSSString());
  };
  this.setWidth = function(b) {
    m = b;
    "main-canvas" != a && (z.width = m);
  };
  this.setHeight = function(b) {
    n = b;
    "main-canvas" != a && (z.height = n);
  };
  this.setName = function(a) {
    l = a;
  };
  ...
  this.modifyCanvasCSS = function(a, b) {
    B.modifyCSSAttribute(a, b);
    z.setAttribute("style", B.toCSSString());
  };
  this.detatchCanvas = function() {
    a == ctatcontainer ? getSafeElementById(a).removeChild(z) : getSafeElementById("ctatdiv" + a).removeChild(z);
  };
  ...
  this.drawLine = function() {
    u.drawLine(h[0] + A, k[0] + A, h[1], k[1], v, A);
  };
  this.drawCircle = function() {
    u.drawCircle(h[0] + C, k[0] + C, C);
  };
  this.drawCircleFilled = function() {
    u.drawCircleFilled(h[0] + C, k[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, d, f) {
    u.drawRectangle(a[0] + A, b[0] + A, m - A, n - A);
  };
  this.drawRectangleFilled = function() {
    u.drawRectangleFilled(h[0], k[0], m, n);
  };
  this.drawRoundedRect = function() {
    u.drawRoundedRect(h[0] + A, k[0] + A, m - C - A, n - C - A, C);
  };
  this.drawRoundedRectFilled = function() {
    u.drawRoundedRectFilled(h[0] + A, k[0] + A, m - C - A, n - C - A, C);
  };
  this.drawText = function() {
    u.drawText(w / 2, w / 2, p);
  };
  this.drawTriangle = function() {
    u.drawTriangle(h[0] + A, k[0] + A, h[1], k[1], h[2], k[2]);
  };
  this.drawTriangleFilled = function() {
    u.drawTriangleFilled(h[0], k[0], h[1], k[1], h[2], k[2]);
  };
  this.save = function() {
    u.save();
  };
  ...
  this.erase = function() {
    ...
    B.addCSSAttribute("border-style", "none");
    z.setAttribute("style", B.toCSSString());
    a == ctatcontainer ? getSafeElementById(a).appendChild(z) : getSafeElementById("ctatdiv" + a).appendChild(z);
    for (var b = 0;b < x.length;b++) {
      z.addEventListener(x[b][0], x[b][1]);
    }
  };
};
...
var CTATWSConnection = function(a) {
  ...
  var b = "", c = !1, e = this, g = null, e = this, d = [], f = !1, h = 0, k = 0, m = null;
  e.setSocketType("ws");
  this.setConsumed = function(a) {
    c = a;
  ...
  this.init = function() {
    ...
    g.addEventListener("message", function(a) {
      ...
      m ? m() : e.ctatdebug("Error: no processing function provided");
    });
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    var f = f + d, d = flashVars.getCustomFields(), m;
    for (m in d) {
      d.hasOwnProperty(m) && (f += "<custom_field>", f += "<name>" + m + "</name>", f += "<value>" + d[m] + "</value>", f += "</custom_field>");
    }
    f += "</context_message>";
  ...
  this.createSemanticEventToolMessage = function(e, g, d, f, h) {
    ...
    var m = '<tool_message context_message_id="' + this.getContextName() + '">';
    h || (m += this.makeMetaElement(k));
  ...
  this.createTutorMessage = function(e, g, d, f, h, k, m, n) {
    ...
    null != m && (a.ctatdebug("Adding skills to log message ..."), p += m.toLogString());
    p += this.createCustomFields(b, c);
    p += "</tutor_message>";
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForHint = function(a, b, c, e, g, d) {
  ...
  b += "<Actor>" + c + "</Actor>";
  b += this.fmtSkillBarVector(e);
  b += "<skillBarDelimiter><![CDATA[`]]\x3e</skillBarDelimiter>";
  b += "<StepID>" + g + "</StepID>";
  b += "<transaction_id>" + d + "</transaction_id>";
  b += "<LogAsResult>true</LogAsResult>";
  return b += "</properties></message>";
};
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForAction = function(a, b, c, e, g, d, f, h) {
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var f = c || 0, h = e || 0, k = g || -2, m = d || -2, n = 50, l = 25, p = !1, v = "", r = !1, t = !0, w = null, x = "", A = -1;
  this.isTabIndexable = !0;
  var C = 0, z = null, B = null, u = this, E = null, q = "hidden", D = CTATGlobalFunctions.gensym.z_index(), F = CTATGlobalFunctions.gensym.div_id(), y = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.makeDivWrapper = function(a) {
    ...
    w.style.top = h + "px";
    w.style.zIndex = D;
    w.style.width = u.getWidth() + "px";
    w.style.height = u.getHeight() + "px";
  ...
  this.createCanvas = function() {
    ...
    E.setAttribute("width", k + canvasCalibrate + "px");
    E.setAttribute("height", m + canvasCalibrate + "px");
    E.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == q ? "visibility: hidden; " : "") + "z-index:" + y + ";");
    w.firstChild ? w.insertBefore(E, w.firstChild) : w.appendChild(E);
    return E;
  };
  ...
  this.getWidth = function() {
    if (0 >= k) {
      var a;
      z ? a = window.getComputedStyle(z) : w && (a = window.getComputedStyle(w));
      if (a) {
  ...
  this.setEnabled = function(a) {
    ...
    u.assignEnabled(a);
    z ? z.disabled = !t : u.ctatdebug("Error: component pointer is null");
  };
  ...
  this.setComponent = function(a) {
    z = a;
    z.classList.add("CTAT-gen-component");
  ...
  this.addSafeEventListener = function(a, b, d) {
    ...
    d ? d.addEventListener(a, b) : (z ? (u.ctatdebug("Adding eventlistener to component instead of target"), z.addEventListener(a, b)) : u.ctatdebug("Error: pointer to component is null, can't add event listener"), u.ctatdebug("addSafeEventListener () done"));
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    q = !0 === a ? "block" : "hidden";
    E && E.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + f + "px; top:" + h + "px; z-index:" + y + ";");
  ...
  this.processTabOrder = function() {
    u.ctatdebug("processTabOrder (" + A + ")");
    !0 === p ? u.ctatdebug("Component is an abstract component, bump") : z ? (u.ctatdebug("We have a component, actually assigning to html component ..."), z.tabIndex = A, z.onfocus = u.processOnFocus) : u.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
var CTATSkill = function() {
  ...
  var a = "", b = "", c = "", e = "", g = 0, d = "", f = !1, h = "", k = "", m = "", n = "", l = "";
  ...
  this.toSetPreferencesXMLString = function() {
    ...
    return f += '" pKnown="' + m + '" category="' + c + '" pLearn="' + n + '" name="' + a + '" pGuess="' + h + '" history="' + l + '" />';
  };
...
var CTATSkillSet = function() {
  ...
  this.addSkill = function(a, c, e, g, d, f, h, k, m, n) {
    this.ctatdebug("addSkill() name = " + a + " level = " + c + " mastery = " + e + " aDescription = " + g + " adisplayName = " + d + " aCategory = " + f + " pguess= " + h + " plearn = " + k + " pslip = " + m + " history = " + n);
    ...
    "" !== h && (a.setPGuess(h), a.setPLearn(k), a.setPSlip(m));
    "" != n && a.setSkillHistory(n);
    return a;
  };
  this.setSkillLevel = function(a, c, e) {
    this.ctatdebug("setSkillLevel (" + a + "," + c + "," + e + ")");
    e = this.getSkill(a);
    null == e ? (this.ctatdebug("Skill not found, creating new one ..."), e = new CTATSkill, e.setSkillName(a), e.setLevel(c), this.internalSkillSet.push(e)) : (this.ctatdebug("Skill found, adjusting ..."), e.setLevel(1), e.setLevel(c));
    e.setTouched(!0);
    return e;
  };
  this.getSkill = function(a) {
    ...
    for (var c = 0;c < this.internalSkillSet.length;c++) {
      var e = this.internalSkillSet[c];
      if (e.getSkillName() == a) {
  ...
  this.getSkillLevel = function(a) {
    ...
    for (var c in this.internalSkillSet) {
      if (c.getSkillName() == a) {
        return c.getLevel();
      }
    }
  ...
  this.getTouched = function() {
    ...
    for (var a = [], c = 0;c < this.internalSkillSet.length;c++) {
      var e = this.internalSkillSet[c];
  ...
  this.toSetPreferencesXMLString = function() {
    ...
    for (var a = "<skills>", c = 0;c < this.internalSkillSet.length;c++) {
      a += this.internalSkillSet[c].toSetPreferencesXMLString();
    }
    return a + "</skills>";
  };
  this.toLogString = function() {
    ...
    for (var a = "", c = 0;c < this.internalSkillSet.length;c++) {
      var e = this.internalSkillSet[c], a = a + ('<skill probability="' + e.getLevel() + '"><name>' + e.getSkillName() + "</name>");
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, m = "white", n = 1, l = CTATGlobals.Visual.BorderColor, p = !1, v = "solid", r = 0, t = "1px", w = 0, x = CTATGlobals.Font.color, A = "black", C = CTATGlobals.Font.family, z = CTATGlobals.Font.size, B = !1, u = !1, E = !1;
  ...
  this.getBorderColor = function() {
    return this.component ? $(this.component).css("border-color") : l;
  };
  this.setBorderColor = function(a) {
    l = CTATGlobalFunctions.formatColor(a);
    this.component && l !== this.getBorderColor() && (this.component.style.borderColor = l);
    return this;
  };
  this.getBorderRoundness = function() {
    return this.component ? $(this.component).css("border-radius") : r;
  };
  this.setBorderRoundness = function(a) {
    a = parseInt(a);
    r = isNaN(a) ? 0 : a;
    this.component && this.getBorderRoundness() !== r && (this.component.style.borderRadius = r);
    return this;
  };
  ...
  this.setFontSize = function(a) {
    a = parseInt(a);
    z = isNaN(a) ? CTATGlobals.Font.size : a;
    this.component && parseInt(this.getFontSize()) !== z && (this.component.style.fontSize = z + "pt");
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== p && (p ? (this.setBorderStyle(v), this.setBorderWidth(t)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getUnderlined = function() {
    return this.component ? "underline" === window.getComputedStyle(this.component).getPropertyValue("text-decoration") : E;
  };
  this.setUnderlined = function(a) {
    E = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getUnderlined() !== E && (this.component.style.textDecoration = E ? "underline" : null);
    return this;
  };
  this.getBolded = function() {
    return this.component ? "bold" === window.getComputedStyle(this.component).getPropertyValue("font-weight") : B;
  };
  this.setBolded = function(a) {
    B = CTATGlobalFunctions.stringToBoolean(a);
    this.component && this.getBolded() !== B && (this.component.style.fontWeight = B ? "bold" : null);
    return this;
  };
...
var CTATSkillWindow = function(a, b, c, e, g) {
  ...
  this.updateSkillSet = function(a) {
    if (null == skillSet) {
      d.ctatdebug("Error: updateSkillSet () no initial skill set given, can't update");
    } else {
      d.ctatdebug("updateSkillSet (" + a.getSkillSet().length + ")");
      a = a.getSkillSet();
      for (var b = 0;b < a.length;b++) {
        var f = a[b];
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), f = 0;f < a.length;f++) {
            ...
            var g = document.createElement("div"), r = c.getLevel();
            .95 > r ? g.classList.add("CTAT-skill-window--bar--nonmastered") : g.classList.add("CTAT-skill-window--bar--mastery");
            g.style.width = .95 < r ? "100%" : 100 * r + "%";
            e.appendChild(g);
            b.appendChild(e);
...
var CTATSAI = function(a, b, c, e) {
  function g(a, b, d, f) {
    f = String(r.getElementName(b)).toLowerCase();
    if (f == a || "value" == f) {
      if (f = r.getElementChildren(b), !Array.isArray(f) || 1 > f.length) {
        d.push(r.getNodeTextValue(b));
      } else {
  ...
  var d = "undefined", f = "undefined", h = new CTATStringUtil, k = [], m = [], n = [], l = [], p = [], v = [], r, t = this;
  r = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.appendToSelectionArray = function(a) {
    null == a ? l.push("") : l.push(String(a));
  };
  this.setSelectionArray = function(a) {
    l = null == a ? [] : Array.isArray(a) ? a.slice() : [String(a)];
  };
  ...
  this.fromXML = function(a) {
    ...
    k = [];
    a = r.getElementChildren(a);
    for (var b = null, d = 0;d < a.length;d++) {
      var f = a[d];
      if ("selection" == r.getElementName(f) || "Selection" == r.getElementName(f)) {
        for (var c = r.getElementChildren(f), e = !1, g = 0;g < c.length;g++) {
          b = c[g], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = r.getNodeTextValue(f), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == r.getElementName(f) || "Action" == r.getElementName(f)) {
        c = r.getElementChildren(f);
        e = !1;
        for (g = 0;g < c.length;g++) {
          b = c[g], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = r.getNodeTextValue(f), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == r.getElementName(f) || "value" == r.getElementName(f) || "Input" == r.getElementName(f)) {
        var b = r.getElementChildren(f), m = null;
        k = [];
        ...
        for (var h = 0;h < b.length;h++) {
          var l = b[h];
          "value" == r.getElementName(l) && (m = r.getElementChildren(l), null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (m = c.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + m), e.setValue(m)) : (m = c.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), e.setName(l.attributes.getNamedItem("name").value), e.setType(l.attributes.getNamedItem("type").value), 
          e.setFormat(l.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)) : (l = c.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)));
        }
      }
      if ("prompt" == r.getElementName(f) || "Prompt" == r.getElementName(f)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(r.getNodeTextValue(f));
      }
    }
    this.checkDefaultArgument();
  };
  this.setArrayFromElements = function(a) {
    if (a && Array.isArray(a) && !(1 > a.length)) {
      var b = null, d = String(r.getElementName(a[0])).toLowerCase();
      switch(d) {
        case "selection":
          b = l = [];
          break;
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(f) || "Input" == r.getElementName(f)) {
        b = f.childNodes;
        k = [];
        var c = new CTATHTMLManager, e = new CTATArgument, g = 0, m = null;
        k.push(e);
        for (var h = 0;h < b.length;h++) {
          if (m = b[h], "value" == r.getElementName(m)) {
            var l = r.getElementChildren(m);
            null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (m = c.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m)) : (m = c.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), e.setName(r.getElementAttr("name")), e.setType(r.getElementAttr("type")), e.setFormat(r.getElementAttr("format")), g++)) : (m = c.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + 
            m), e.setValue(m));
            1 > h ? this.setInputArray(m) : this.appendToInputArray(m);
          }
        }
      }
      if ("prompt" == r.getElementName(f) || "Prompt" == r.getElementName(f)) {
  ...
  this.isDone = function() {
    var a, b;
    return null == (a = t.getSelection()) || null == (b = t.getAction()) ? !1 : "done" == a.toString().toLowerCase() && "buttonpressed" == b.toString().toLowerCase();
  };
};
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, f = !1, h = new CTATSkillSet, k = "", m = "", n = "", l = "", p = "", v = null, r = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      this.ctatdebug("Message " + k + ", with transaction id: " + m);
    }
  };
    ...
    if ("tool_message" == k) {
      ...
      for (c = 0;c < a.length;c++) {
        if (g = a[c], "tool_message" == e.getElementName(g)) {
          for (g = e.getElementChildren(g), m = 0;m < g.length;m++) {
            r = g[m], "event_descriptor" == e.getElementName(r) && (v = new CTATSAI, v.fromXMLInternal(r));
          }
        }
      }
      f = !0;
      ...
      if (d) {
        ...
        for (var u = e.getElementChildren(b), E = 0;E < u.length;E++) {
          var q = u[E];
          if ("event_descriptor" == e.getElementName(q)) {
            for (var q = e.getElementChildren(q), D = 0;D < q.length;D++) {
              var F = q[D];
              "selection" == e.getElementName(F) && (a = e.getNodeTextValue(F), r.push(F));
              "action" == e.getElementName(F) && (c = e.getNodeTextValue(F), z.push(F));
              "input" == e.getElementName(F) && (g = e.getNodeTextValue(F), B.push(F));
              "prompt" == e.getElementName(F) && (m = e.getNodeTextValue(F));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), u = e.getElementChildren(b), E = 0;E < u.length;E++) {
          if (q = u[E], "properties" == e.getElementName(q)) {
            for (q = e.getElementChildren(q), D = 0;D < q.length;D++) {
              F = q[D], this.ctatdebug("Nodename: " + e.getElementName(F)), "Skills" == e.getElementName(F) && h.parseByValue(F), "SuccessMsg" == e.getElementName(F) && (n = a = e.getNodeTextValue(F)), "BuggyMsg" == e.getElementName(F) && (l = e.getNodeTextValue(F)), "Selection" == e.getElementName(F) && (a = e.getNodeTextValue(F), r.push(F)), "Action" == e.getElementName(F) && (c = e.getNodeTextValue(F), z.push(F)), "Input" == e.getElementName(F) && (g = e.getNodeTextValue(F), B.push(F)), "prompt" == 
              e.getElementName(F) && (m = e.getNodeTextValue(F)), "HighlightMsgText" == e.getElementName(F) && (p = e.getNodeTextValue(F));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + g);
      "" !== a && null !== a ? (v = new CTATSAI(a, c, g, m), v.setArrayFromElements(r), v.setArrayFromElements(z), v.setArrayFromElements(B), f = !0) : (this.ctatdebug("No SAI found"), f = !1);
      this.ctatdebug("parseSAI () done, hassai: " + f + ", (" + a + "," + c + "," + g + "," + m + ")");
    }
  };
  ...
  this.getSAI = function() {
    return f ? v : new CTATSAI;
  };
  this.getSelection = function() {
    return f ? v.getSelection() : "";
  };
  this.getAction = function() {
    return f ? v.getAction() : "";
  };
  this.getInput = function() {
    return f ? v.getInput() : "";
  };
  this.getSelectionArray = function() {
    return f ? v.getSelectionArray() : [];
  };
  this.getActionArray = function() {
    return f ? v.getActionArray() : [];
  };
  this.getInputArray = function() {
    return f ? v.getInputArray() : [];
  };
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createTracerActionMessage = function(a, b) {
    ...
    var c;
    c = "<message><verb>NotePropertySet</verb><properties><MessageType>TracerAction</MessageType>" + ("<transaction_id>" + a + "</transaction_id>") + b.toXMLString(!1);
    c += "</properties></message>";
    return "" + c;
  };
...
CTAT.Component.Base.Tutorable = function(a, b, c, e, g, d, f) {
  ...
  var h = !0, k = !0, m = !0, n = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, l = !0, p = this, v = !1;
  ...
  this.getTutorComponent = function() {
    ...
    return h && k && m ? a.TUTOR : h && k && !m ? a.TUTOR_NO_FEEDBACK : !h && k ? a.DO_NOT_TUTOR : n;
  };
  ...
  this.setHintHighlight = function(a, b) {
    ...
    if (r) {
      ...
      d !== v && (v = d, this.showHintHighlight(d, b));
    }
  };
...
var CTATImageButtonComponent = function(a, b, c, e, g, d, f) {
  ...
  var h = "", k = "", m = "", n = "", l = !1, p = "Image to Component", v = this;
  ...
  this.setEnabled = function(a) {
    ...
    v.assignEnabled(a);
    null === v.getComponent() ? v.ctatdebug("Error: pointer is null!") : (v.getComponent().disabled = !a, !1 === v.getEnabled() ? v.assignActiveImage(n) : v.assignActiveImage(h), v.ctatdebug("setEnabled () -> " + v.getEnabled()));
  };
  this.processMouseOver = function(a) {
    !0 !== l && (l = !0, !0 === v.getEnabled() ? v.assignActiveImage(m) : v.ctatdebug("Error component is disabled"), l = !1);
  };
  this.processMouseOut = function(a) {
    !0 !== l && (l = !0, !0 === v.getEnabled() && v.assignActiveImage(h), l = !1);
  };
};
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  var k = "#FF00FF", m = 1, n = "#FF00FF", l = .2, p = "black", v = 1;
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = B(b), this.get_denominator() != a)) {
      var d = t.evaluate();
      t.clear();
      a = [];
      d.set_denominator(b);
      ...
      b.equals(0) || (a.push(C(b, !0)), a.push(C(f.subtract(b), !1)), e--);
      for (b = 0;b < e;b++) {
        a.push(C(f, !1));
      }
  ...
  this.get_denominator = function() {
    return r.reduce(function(a, b, d, f) {
  ...
  this.change_number_pieces = function(a) {
    this.set_number_pieces(r.length + a);
  };
  ...
  var u = function(a) {
    if (0 !== Object.keys(E).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        if (a != t) {
          if (E.hasOwnProperty(a.getName())) {
            return E[a.getName()];
          }
          if (E.hasOwnProperty(a.getComponentGroup())) {
            return E[a.getComponentGroup()];
          }
        }
      } else {
        if (a instanceof CTATSAI) {
          if (a.getSelection() != t.getName() && E.hasOwnProperty(a.getSelection())) {
            return E[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != t.getName() && E.hasOwnProperty(a)) {
              return E[a];
            }
          } else {
            if (a instanceof Element && a != t.getComponent() && E.hasOwnProperty(a.id)) {
              return E[a.id];
            }
          }
        }
  ...
  this.change_numerator = function(a) {
    0 !== a && (0 < a ? r.every(function(b) {
      !1 === w(b) && (x(b, !0), a--);
      return 0 < a;
    }) : (r.reverse(), r.every(function(b) {
      !0 === w(b) && (x(b, !1), a++);
      return 0 > a;
    }), r.reverse()));
  };
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, c = document.createDocumentFragment(), e = 0;e < a.length;e++) {
        var g = a[e], l = 100 * g, p = document.createElementNS(d, "rect");
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? f -= d / 2 : (c += d / 2, f = b.x + b.width >= v ? f - d / 2 : f - d);
...
var CTATJumble = function(a, b, c, e, g) {
  ...
  var d = "", f = "center", h = 0, k = 10, m = !1, n = this;
  n.setActionInput("SetOrder", d);
  var l = null;
  this.init = function() {
    n.setInitialized(!0);
    l = document.createElement("div");
    l.classList.add("CTAT-jumble");
    this.setComponent(l);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    this.getDivWrap().appendChild(l);
    n.addComponentReference(n, n.getDivWrap());
    a ? (l.innerHTML = a, $(l).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      this.addEventListener("dragstart", v, !1);
      this.addEventListener("dragenter", t, !1);
      this.addEventListener("dragover", r, !1);
  ...
  this.init_items = function(a) {
    if (l) {
      ...
      for (var d = a.length, f = 0;f < d;f++) {
        ...
        c.addEventListener("dragstart", v, !1);
        c.addEventListener("dragenter", t, !1);
        c.addEventListener("dragover", r, !1);
        c.addEventListener("dragleave", w, !1);
        c.addEventListener("drop", x, !1);
        c.addEventListener("dragend", C, !1);
        b.appendChild(c);
        A.push(c);
      }
      l.innerHTML = "";
  ...
  this.getOrder = function() {
    for (var a = l.children, b = [], f = 0;f < a.length;f++) {
      var c = a[f];
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  var m = new a(this, new d(0), 25, "CTAT-number-line--denominator-tickmark", "CTAT-number-line--denominator-tickmark-label");
  ...
  this.X_Axis = new function(a, b, d, f) {
    ...
    this.getAxisValue = function(a) {
      return CTAT.Math.round(m + this.scalar() * this.min_loc.distance(this.getProjectedPoint(a)));
    };
  ...
  this.setPointSize = function(a) {
    l = Number(a);
    t && (t.setAttributeNS(null, "r", l), $(this._point_group).find("circle").each(function() {
      $(this).attr("r", l);
    }));
  };
  ...
  this.genTickmark = function(a, b, d) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var e = document.createElementNS(f, "line"), g = this.X_Axis.getPosition(a), m = CTAT.Geom.Point.polar(d / 2, this.theta + Math.PI / 2).add(g);
      d = CTAT.Geom.Point.polar(-d / 2, this.theta + Math.PI / 2).add(g);
      e.setAttributeNS(null, "x1", m.x);
      e.setAttributeNS(null, "y1", m.y);
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            b.length > m.length ? h.style.textDecoration = "underline" : k.style.textDecoration = "overline";
  ...
  var v = function() {
    if (null != this.X_Axis && null != this.X_Axis.svg_group) {
      var a = this.getBoundingBox(), b = window.getComputedStyle(this._axis_line_group), b = parseInt(b.getPropertyValue("stroke-width")), a = CTAT.Geom.Rectangle.inflate(a, -b, -b), d = new DOMPoint(a.width / 2, a.height / 2), c = d.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, this.theta)), e = Math.sin(this.theta), g = -Math.cos(this.theta), l = e * d.x + g * d.y, v = -a.height * g, t = -e * a.width, b = new DOMPoint(a.left, d.y), d = new DOMPoint(a.right, d.y);
      if (0 < Math.abs(CTAT.Math.round(v))) {
        var v = new DOMPoint(a.left, (l - e * a.left) / g), r = new DOMPoint(a.right, (l - e * a.right) / g);
        if (a.contains(v) || a.contains(r)) {
          c.distance(v) < c.distance(r) ? (b = r, d = v) : (b = v, d = r);
        }
      }
      0 < Math.abs(CTAT.Math.round(t)) && (t = new DOMPoint((l - g * a.top) / e, a.top), e = new DOMPoint((l - g * a.bottom) / e, a.bottom), a.containsPoint(t) || a.containsPoint(e)) && (c.distance(t) < c.distance(e) ? (b = e, d = t) : (b = t, d = e));
  ...
  }.bind(this), r = 0, t = null, w = new DOMPoint(-30, -30), x = !1, A = function(a) {
    w.x = a.clientX;
    w.y = a.clientY;
  }, C = function(a) {
    ...
    if (!0 === this.getEnabled()) {
      this.setHintHighlight(!1);
      var b;
      p ? (a = E(a.clientX, a.clientY), b = a.location, a = a.data) : (a = B(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  this.init = function() {
    ...
    t = document.createElementNS(f, "circle");
    t.setAttributeNS(null, "r", l);
    t.classList.add("CTAT-number-line--cursor");
    t.setAttributeNS(null, "transform", "translate(-30,-30)");
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && (x = !0, t.style.visibility = null, r = requestAnimationFrame(q));
    });
    this.addSafeEventListener("click", z);
    this.component.addEventListener("focus", this.processFocus);
  };
  var B = function(a, b) {
    ...
    var f = this.component.createSVGPoint();
    f.y = $(this.component).offset().top;
    f.x = $(this.component).offset().left;
    var f = f.matrixTransform(d), c = $(this.component), d = f.x + parseInt(c.css("borderLeftWidth")) + parseInt(c.css("paddingLeft")) + parseInt(c.css("marginLeft")), f = f.y + parseInt(c.css("borderTopWidth")) + parseInt(c.css("paddingTop")) + parseInt(c.css("marginTop"));
    return new DOMPoint(this.svgPoint.x - d, this.svgPoint.y - f);
  }.bind(this), u = function(a, b) {
    return this.getProjectedPoint(B(a, b));
  }.bind(this.X_Axis), E = function(a, b) {
    for (var d = u(a, b), f = null, c = Number.POSITIVE_INFINITY, e, g, m = 0;m < this._tickmarks.length;m++) {
      e = this._tickmarks[m], g = d.distance(e.location), g < c && (f = e, c = g);
    }
    return f;
  }, q = function() {
    if (x && !0 === this.getEnabled()) {
      if (p) {
        var a = E(w.x, w.y);
        t.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(a.location, !0));
      } else {
        t.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(u(w.x, w.y), !0));
      }
  ...
  this.calcXCoordinate = function(a) {
    a = new d(a);
    var b = this.getWidth() - 30, b = Math.abs(b - 30), f = max.subtract(min);
    return 30 + a.subtract(min).divide(f) / b;
  };
...
var CTATPieChart = function(a, b, c, e, g) {
  ...
  var d = 3, f = 3, h = this, k, m, n, l = null, p = CTATGlobals.NameSpace.svg;
  this.init = function() {
    this.initSVG();
    ...
    l = document.createElementNS(p, "feOffset");
    l.setAttributeNS(null, "in", "SourceAlpha");
    l.setAttributeNS(null, "result", "offOut");
    l.setAttributeNS(null, "dx", f);
    l.setAttributeNS(null, "dy", f);
    k.appendChild(l);
    ...
    0 < f && this.baseGroup.setAttributeNS(null, "filter", n);
    this.drawPieces();
    this.addComponentReference(this, this.getDivWrap());
    this.component.addEventListener("focus", this.processFocus);
  };
    ...
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, f, m) {
        if (1 <= b.valueOf()) {
          ...
          m = e.add(CTAT.Geom.Point.polar(c, k));
          b.reduce();
          var l = e.add(CTAT.Geom.Point.polar(c, 2 * Math.PI * b.valueOf() + k)), v = e.clone();
          if (0 < d && d < c) {
            ...
            m = CTAT.Geom.Point.circle_intersection(v, m, e, c).reduce(r.bind(this, m));
            l = l.add(k);
            l = CTAT.Geom.Point.circle_intersection(v, l, e, c).reduce(r.bind(this, l));
          }
          k = CTAT.Geom.Point.to2DString;
          v = "M " + k(v);
          r = new DOMPoint(c, c);
          v += " L " + k(m);
          v += " A " + k(r) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + k(l);
          f.setAttributeNS(null, "d", v + " Z");
  ...
  this.setDropShadowDistance = function(a) {
    f = parseInt(a);
    f = isNaN(f) ? 0 : f;
    l && (l.setAttributeNS(null, "dx", f), l.setAttributeNS(null, "dy", f), 0 >= f && this.baseGroup ? this.baseGroup.removeAttributeNS(null, "filter") : this.baseGroup.hasAttributeNS(null, "filter") || this.baseGroup.setAttributeNS(null, "filter", n));
  };
...
NOTDONE:"I'm sorry, but you are not done yet. Please continue working."}, CTATLanguageManager = function(a, b, c) {
  CTATBase.call(this, "CTATLanguageManager", a);
  var e = this;
  this.getString = function(a) {
    e.ctatdebug("getString (" + a + ")");
  ...
  this.filterString = function(a) {
    e.ctatdebug("filterString (" + a + ")");
    return "undefined" !== typeof CTATLanguagePack && CTATLanguagePack[a] ? (e.ctatdebug("Found tag in provided language pack, returning: " + CTATLanguagePack[a]), CTATLanguagePack[a]) : "undefined" !== typeof CTATDefaultLangagePack && CTATDefaultLangagePack[a] ? (e.ctatdebug("Found tag in default language pack, returning: " + CTATDefaultLangagePack[a]), CTATDefaultLangagePack[a]) : a;
  };
};
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), t.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == f && (f = !1, getSafeElementById(ctatcontainer).removeChild(v)) : 1 == warnScrim && (f = !0), t.scrimUp(a));
  }
  function c(a, b) {
    t.ctatdebug("makeHTMLButton ()");
    var d = document.createElement("input");
    d.type = "button";
    d.value = b;
    null != a ? (t.ctatdebug("clickHandle!=null"), d.onclick = a) : (t.ctatdebug("clickHandle==null"), d.onclick = t.defaultClickHandler);
    d.id = b;
    d.setAttribute("class", "scrimButton");
    return d;
  }
  CTATBase.call(this, "CTATScrim", "__undefined__");
  var e = "", g = !1, d = !1, f = !1, h = null, k = null, m = new CTATCanvasComponent("CTAT Scrim"), n = [], l = null, p = null, v = null, r = null, t = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (t.ctatdebug("scrimUp ()"), t.ctatdebug("Message: " + b), 1 == scrimIsUp ? (e = 1 == waitScrim ? b : e + (" \n " + b), m.removeComponent()) : (e = b, scrimIsUp = !0), t.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        t.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + e + "<br><br></div></div></div>"), !0 === f && (v = c(a, "close"), $(v).appendTo("#scrimpanel")), !0 === g && (l = c(h, "yes"), $(l).appendTo("#scrimpanel")), !0 === d && (p = c(k, "no"), $(p).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
          t.ctatdebug("Adding spinner ...");
          ...
          $("#scrimpanel").append(b);
          try {
            var r = (new Spinner({className:"scrim_spinner"})).spin();
            $("#scrim_spin").append(r.el);
          } catch (n) {
            (n instanceof ReferenceError || n instanceof TypeError) && t.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', n, typeof n);
          }
        }
      }
    }
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), t.ctatdebug("waitScrimUp ()"), waitScrim = !0, t.scrimUp(CTATGlobals.languageManager.getString("LOADING")));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), t.ctatdebug("nextProblemScrimUp ()"), t.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), t.ctatdebug("OKScrimUp (" + a + "," + b + ")"), t.scrimUp(a), r = c(b, spaceUsedUp, "OK"), $(r).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, c) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), t.ctatdebug("confirmScrimUp (" + a + "," + b + "," + c + ")"), d = g = !0, k = c, h = b, t.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), 0 == authorTimeSet ? (t.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), n.push("ERROR: " + a), errorScrim = !0) : 0 == inAuthorTime ? t.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (errorScrim = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), 0 == authorTimeSet ? (t.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), n.push("WARNING: " + a), warnScrim = !0) : 0 == inAuthorTime ? t.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (warnScrim = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    connectionScrim = !0;
    t.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"));
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == scrimIsUp ? t.ctatdebug("The scrim isn't up, returning") : 1 == errorScrim ? t.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == warnScrim ? t.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == connectionScrim ? t.ctatdebug("The scrim is up for a connection issue leave it up!") : t.scrimDownForced());
  };
  ...
  this.defaultClickHandler = function() {
    t.ctatdebug("defaultClickHandler ()");
    t.scrimDown();
  };
  this.setInAuthorTime = function(a) {
    t.ctatdebug("setting inAuthorTime = " + a);
    authorTimeSet = !0;
    inAuthorTime = a;
    if (!a) {
      warnScrim = errorScrim = !1, f && null.removeChild(v);
    } else {
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var e = authenticityToken = "", g = 0, d = [], f = a ? a : null, h = null == b ? !0 : b, k = !0, m = null, n = c ? c : {}, l = this, p = "http";
  ...
  this.getURL = function() {
    l.ctatdebug("getURL ()");
    if ("" != e) {
      return l.ctatdebug("Returning fixedURL: " + e), e;
    }
  ...
  this.sendXMLNoBundle = function(a) {
    ...
    flashVars.getRawFlashVars();
    1 == this.getUseCommSettings() ? "javascript" == l.getSocketType() ? CTAT.ToolTutor.sendToTutor(d) : this.send_post(b, d) : this.send_post(b, d);
  };
  ...
  this.send_post_variables = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var f = l.createConnection(n, a);
      f.setContentType("application/x-www-form-urlencoded");
      g++;
      d.push(f);
      l.ctatdebug(c);
      null != m && m.processOutgoing(c);
      f.setURL(a);
      f.setData(c);
  ...
  this.send_post = function(a, b) {
    ...
    !0 === globalCommDisabled ? l.ctatdebug("Communications globally disabled, please check your settings") : (l.ctatdebug("Outoing on wire: " + b), flashVars.getRawFlashVars(), d = a, "websocket" == l.getSocketType() ? (d = a.replace("http:", "ws:"), d = l.createConnection(n, d), d.setData(b), l.ctatdebug(b)) : (d = l.createConnection(n, d), d.setData(b)), null != m && m.processOutgoing(b), d.send());
  };
  this.processReply = function(a) {
    l.ctatdebug("processReply (" + d.length + "," + a + ")");
    var b = 0, c = !1;
    a = [];
    for (var e = 0, e = 0;e < d.length;e++) {
      var g = d[e], k = g.getHTTPObject();
      l.ctatdebug("Testing connection entry " + e + ", readyState: " + k.readyState + ", testConnection.consumed: " + g.getConsumed());
      4 == k.readyState && 0 == g.getConsumed() ? (l.ctatdebug("Investigating request response: " + b + " -> " + k.status + ", for: " + g.getURL()), c = !1, 0 === k.status && (c = !0, l.ctatdebug("Received message (status 0): " + k.responseText)), 408 == k.status && (c = !0, l.ctatdebug("Received message (status 408): " + k.responseText), h && CTATScrim.scrim.scrimDown()), 502 == k.status && (c = !0, l.ctatdebug("Received message (status 502): " + k.responseText), h && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == k.status ? (c = !0, l.ctatdebug("Processing 200 response ..."), null !== f ? (a.push(k.responseText), null != m && m.processIncoming(k.responseText)) : l.ctatdebug("Error: httphandler is null, can't process response!")) : f && f.processError && (c = !0, l.ctatdebug("Processing non-200 response, status " + k.status), f.processError(k.status, k.responseText)), !1 === c && l.ctatdebug("Error: status not handled for: " + k.status), l.ctatdebug("Marking connection as consumed ..."), g.setConsumed(!0)) : 
      (0 === k.readyState && l.ctatdebug("Received message (status 0, request not initialized)"), 1 === k.readyState && l.ctatdebug("Received message (status 1, server connection established)"), 2 === k.readyState && l.ctatdebug("Received message (status 2, request received)"), 3 === k.readyState && l.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    l.cleanup();
    for (b = 0;b < a.length;b++) {
      c = a[b], -1 != c.indexOf("status=success") ? l.ctatdebug("Info: logging success message received, not propagating to message handler") : (l.ctatdebug("Processing incoming message: " + c), f.processMessage(c));
    }
  };
  ...
  this.checkEntries = function() {
    l.ctatdebug("checkEntries (" + d.length + ")");
    for (var a = 0, b = 0, b = 0;b < d.length;b++) {
      var c = d[b];
      if (!0 === c.getConsumed()) {
        return l.ctatdebug("Removing : " + c.getID()), d.splice(a, 1), !0;
      }
      var f = c.getHTTPObject();
      l.ctatdebug("Check, readyState: " + f.readyState + ", consumed: " + c.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, d) {
    ...
    c.onreadystatechange = function() {
      l.ctatdebug("onready... GET for xmlFile xmlhttp.readyState " + c.readyState + ", .status " + c.status + ", parser " + b);
      if (4 == c.readyState && 200 == c.status) {
        var f = null;
        c.responseXML ? (l.ctatdebug("parsing brd xml using something else"), f = c.responseXML.documentElement) : (l.ctatdebug("parsing brd xml using node"), f = (b = new CTATXML).parseXML(c.responseText));
        null == f ? (f = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), l.ctatdebug("Error parsing xmlFile " + a + ": " + f), CTAT.ToolTutor.sendToInterface(f, !0)) : d.processXML(f);
      }
    };
    c.onerror = function() {
  ...
  this.retrieveJSONFile = function(a, b) {
    ...
    d.onreadystatechange = function() {
      4 == d.readyState && 200 == d.status && (l.ctatdebug("Successfully retrieved file: " + a), b(JSON.parse(d.responseText)));
    };
    d.onerror = function() {
  ...
  this.retrieveFile = function(a, b) {
    ...
    var d = (new CTATConnection).getHTTPObject();
    d.onreadystatechange = function() {
      4 == d.readyState && 200 == d.status && (l.ctatdebug("Successfully retrieved file: " + a), b(d.responseText));
    };
    d.onerror = function() {
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, e = !1, g = !1, d = [], f = "undefined", h = "undefined", k = "undefined", m = "undefined", n = "undefined", l = "undefined", p = "undefined", v = "undefined", r = "UnassignedDataset", t = "UnassignedLevelName", w = "UnassignedLevelType", v = (new CTATGuid).guid();
  ...
  this.logSemanticEvent = function(a, d, c, f, e, g) {
    ...
    commLogMessageBuilder.addCustomField("tool_event_time", commLogMessageBuilder.formatTimeStamp(m) + " UTC");
    a = commLogMessageBuilder.createSemanticEventToolMessage(d, a, c, f, !0);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, d, c, f, e, g, m, h, l) {
    ...
    h = "";
    void 0 != g && null != g ? -1 != g.indexOf("'") || -1 != g.indexOf('"') || -1 != g.indexOf("<") || -1 != g.indexOf(">") || -1 != g.indexOf("&") ? (b.ctatdebug("Feedback message contains invalid characters, wrapping in CDATA ..."), h = "<![CDATA[" + g + "]]\x3e") : (b.ctatdebug("Feedback message doesn't contain any invalid characters, using as-is"), h = g) : (b.ctatdebug("No feedback provided, using empty string"), h = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(d, a, c, e, h, f, m, !0);
    this.sendMessage(a);
  };
...
var OLIComm = function(a) {
  ...
  this.writeFileRecord = function(a, d, f, h, k) {
    ...
    var m = flashVars.getRawFlashVars();
    a = [b("commandName", "writeFileRecord"), b("activityContextGuid", m.activity_context_guid), b("activityGuid", m.activity_guid), b("userGuid", m.user_guid), b("authenticationToken", m.oli_auth_token), b("resourceTypeID", m.resource_type_id), b("activityMode", m.activity_mode), b("attemptNumber", f ? f : m.current_attempt), b("fileName", a), b("mimeType", h ? h : "text/xml"), b("byteEncoding", k ? k : "urlencoded"), b("fileRecordData", d)];
    c(a, "writeFileRecord");
  };
...
var OLIDriver = function(a) {
  ...
  this.translateResourceFile = function(a) {
    ...
    return c.translateOLIResourceFile(a);
  };
  this.translateOLIResourceFile = function(a) {
    c.ctatdebug("translateOLIResourceFile (" + a + ")");
    var d = flashVars.getRawFlashVars();
    return -1 == a.indexOf("webcontent") ? d.web_content_url + b(currentOLIModule) + "/" + a : d.web_content_url + "/" + a;
  };
  ...
  this.translateURL = function(a) {
    c.ctatdebug("translateURL ()");
    for (var d = flashVars.getRawFlashVars(), f = getIndicesOf("<img", a, !1), e = getIndicesOf("<a", a, !1), k = -1, m = k = -1, n = !1, l = "", k = "";0 == n;) {
      n = !0;
      if (0 == f.length && 0 == e.length) {
        return c.ctatdebug("Nothing to do here, bump"), a;
      }
      f = getIndicesOf("<img", a, !1);
      for (e = 0;e < f.length;e++) {
        k = f[e], k = a.indexOf("src", k), -1 != k && (k += 5, m = a.indexOf('"', k), -1 != m && (l = a.substr(k, m - k), c.ctatdebug("We have a valid url (img) to replace between: " + k + "," + m + ", with content: " + l), -1 == l.indexOf("http:") ? (n = !1, l = d.web_content_url + b(currentOLIModule) + "/" + l, k = a.substr(0, k) + l + a.substr(m), c.ctatdebug("Replaced: " + k), a = k) : c.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      e = getIndicesOf("<a", a, !1);
      for (f = 0;f < e.length;f++) {
        k = e[f], k = a.indexOf("href", k), -1 != k && (k += 6, m = a.indexOf('"', k), -1 != m && (l = a.substr(k, m - k), c.ctatdebug("We have a valid url (href) to replace between: " + k + "," + m + ", with content: " + l), -1 == l.indexOf("http:") ? (n = !1, l = d.web_content_url + b(currentOLIModule) + "/" + l, k = a.substr(0, k) + l + a.substr(m), c.ctatdebug("Replaced: " + k), a = k) : c.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      f = getIndicesOf("<img", a, !1);
      e = getIndicesOf("<a", a, !1);
    }
  ...
  this.forwardToClientHandler = function(a) {
    c.ctatdebug("OLIDriver.forwardToClientHandler() handler is " + typeof e);
    e && e.process && e.process(a);
  };
...
var currentOLIModule = "", OLIMessageHandler = function() {
  ...
  this.parseClientConfig = function(b) {
    ...
    for (var g = null, k = 0;k < b.length;k++) {
      var m = b[k], n = c.getElementName(m);
      "resource_type" != n && "base" != n && ("authentication" == n && "review" != f.activity_mode ? f.user_guid = c.getElementAttr(m, "user_guid") : "logging" == n && (f.log_session_id = c.getElementAttr(m, "session_id"), f.source_id = c.getElementAttr(m, "source_id"), g = c.getElementChildren(m), g = c.getNodeTextValue(g[0])));
    }
    a.oliClientConfig(g);
  };
  this.parseBeginSession = function(b) {
    ...
    if (void 0 == f) {
          ...
          if (f = f.getElementsByTagName("resource_info")[0]) {
            if (f = f.getElementsByTagName("file")[0]) {
              if (f = c.getElementAttr(f, "href")) {
                var m = f.indexOf("/x-cmu");
                this.setCurrentModule(f.substr(0, m));
              }
            }
          }
        }
      ...
      if (f = b.getElementsByTagName("file_record")[0]) {
        for (g.file_record_file_name = c.getElementAttr(f, "file_name"), f = c.getElementChildren(f), m = 0;m < f.length;m++) {
          var n = f[m];
          "record_context" == String(c.getElementName(n)).toLowerCase() && c.getElementAttr(n, "activity_guid") == g.activity_guid && (g.file_record_attempt = c.getElementAttr(n, "attempt")) && (g.problem_state_status = "incomplete");
        }
      }
  ...
  this.setAttemptFromAttemptHistory = function(a, b) {
    ...
    var g = flashVars.getRawFlashVars(), k = a ? a.getElementsByTagName("activity_attempt") : [], m = null;
    return 1 > k.length || !(m = k[k.length - 1]) ? (e.ctatdebug("can't find activity_attempt in attempt_history"), null != b ? g.current_attempt = b : "") : g.current_attempt = c.getElementAttr(m, "number");
  };
  this.parseResourceFile = function(a, b) {
    e.ctatdebug("parseResourceFile ()");
    g = [];
    for (var h = c.getElementChildren(a), k = flashVars.getRawFlashVars(), m = 0;m < h.length;m++) {
      var n = h[m], l = c.getElementName(n);
      "interface" == l ? (n = c.getNodeTextValue(n), l = oliDriver.translateResourceFile(n), e.ctatdebug("Building BRD url from web_content_url: " + k.web_content_url + " and OLI-provided url: " + n + " = " + l), g.push(l)) : "title" == l && (k.problem_name = c.getNodeTextValue(n));
    }
...
var CTATMessageHandler = function() {
  ...
  this.processSingleMessage = function(d) {
    ...
    for (var g = 0;g < d.length;g++) {
      ...
      if ("properties" == e.getElementName(k)) {
        ...
        for (var m = e.getElementChildren(k), n = 0;n < m.length;n++) {
          var l = m[n];
          if ("MessageType" == e.getElementName(l)) {
            l = e.getNodeTextValue(l);
            b.ctatdebug("MessageType: " + l);
            "StateGraph" == l && this.processStateGraph(k);
            "StartProblem" == l && (b.ctatdebug("Setting inStartState to true"), inStartState = !0, this.processStartProblem(m));
            "InterfaceIdentification" == l && this.processInterfaceIdentification(m);
            "InterfaceDescription" == l && this.processInterfaceDescription(m);
            "SendWidgetLock" == l && b.ctatdebug("Found: SendWidgetLock");
            if ("StartStateEnd" == l) {
              ...
              try {
                ...
                b.ctatdebug("Caught in the act: " + A.message);
              }
              inStartState = !1;
            }
            "CorrectAction" == l && (b.ctatdebug("Found: CorrectAction"), !0 === this.getInStartState() ? c.push(f) : a.processCorrectAction(f));
            "InCorrectAction" == l && (b.ctatdebug("Found: InCorrectAction"), !0 === inStartState ? c.push(f) : (b.ctatdebug("Handing incorrect message to messagehandler ..."), a.processInCorrectAction(f)));
            "HighlightMsg" == l && (b.ctatdebug("Found: HighlightMsg"), a.processHighlightMsg(f));
            "UnHighlightMsg" == l && (b.ctatdebug("Found: UnHighlightMsg"), a.processUnHighlightMsg(f));
            if ("AssociatedRules" == l) {
              b.ctatdebug("Found: AssociatedRules (" + m.length + ")");
              for (var p = "", v = "", r = 0;r < m.length;r++) {
                var t = m[r];
                "TutorAdvice" == e.getElementName(t) && (p = e.getNodeTextValue(t));
                "Actor" == e.getElementName(t) && e.getNodeTextValue(t);
                "Indicator" == e.getElementName(t) && (v = e.getNodeTextValue(t));
              ...
              a.processAssociatedRules(f, v, p);
            }
            "BuggyMessage" == l && (b.ctatdebug("Found: BuggyMessage"), a.processBuggyMessage(f));
            "SuccessMessage" == l && (b.ctatdebug("Found: SuccessMessage"), a.processSuccessMessage(f));
            "InterfaceAction" == l && (b.ctatdebug("Found: InterfaceAction"), !0 === inStartState ? (b.ctatdebug("inStartState==true => storing for later playback ..."), c.push(f)) : a.processInterfaceAction(f));
            "InterfaceIdentification" == l && b.ctatdebug("Found: InterfaceIdentification");
            "AuthorModeChange" == l && (b.ctatdebug("Found: AuthorModeChange"), a.globalReset());
            "ResetAction" == l && (b.ctatdebug("Found: ResetAction"), a.globalReset());
            if ("ShowHintsMessage" == l) {
              b.ctatdebug("Found: ShowHintsMessage");
              p = !1;
              v = [];
              for (r = 0;r < m.length;r++) {
                if (t = m[r], "HintsMessage" == e.getElementName(t)) {
                  for (var t = e.getElementChildren(t), w = 0;w < t.length;w++) {
                    var x = t[w];
                    "value" == e.getElementName(x) && (v.push(e.getNodeTextValue(x)), p = !0);
                  }
                }
              }
              !0 === p ? a.processHintResponse(f, v) : b.ctatdebug("Error: incomplete hint message received");
            }
            "ConfirmDone" == l && (b.ctatdebug("Found: ConfirmDone"), a.processConfirmDone(f));
            "VersionInfo" == l && (b.ctatdebug("Found: VersionInfo"), a.processVersionInfo(m));
            "TutoringServiceAlert" == l && (b.ctatdebug("Found: TutoringServiceAlert"), a.processTutoringServiceAlert(m));
            "TutoringServiceError" == l && (b.ctatdebug("Found: TutoringServiceError"), a.processTutoringServiceError(m));
            "ProblemSummaryResponse" == l && (b.ctatdebug("Found: ProblemSummaryResponse"), a.processProblemSummaryResponse(f));
            "ProblemRestoreEnd" == l && (b.ctatdebug("Found: ProblemRestoreEnd"), a.processProblemRestoreEnd(f));
          }
        }
      }
    }
    ...
    if (void 0 === d || null === d) {
      ...
      if (b.ctatdebug("Processing node: " + d.nodeName), null === e.getElementChildren(d)) {
        ...
        for (var c = 0;c < d.length;c++) {
          ...
          "Skills" == e.getElementName(g) && (null === skillSet && (skillSet = new CTATSkillSet), skillSet.parseByValue(g), a.updateSkillWindow());
        }
      }
    }
  };
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", g = "Unknown", k = null, m = 0;m < a.length;m++) {
      var n = a[m];
      ...
      if ("serialized" == e.getElementName(n)) {
        ...
        for (var l = e.getElementChildren(n), p = 0;p < l.length;p++) {
          var v = l[p];
          -1 != e.getElementName(v).indexOf("CTAT") && (k = v);
        }
      }
  ...
  this.deserializeComponent = function(a, c, g) {
    ...
    if (null === e.getElementAttr(g, "x")) {
      ...
      var k = e.getElementAttr(g, "x"), m = e.getElementAttr(g, "y"), n = e.getElementAttr(g, "width"), l = e.getElementAttr(g, "height"), p = e.getElementAttr(g, "tabIndex"), v = e.getElementAttr(g, "zIndex");
      null === p && (p = -1);
      null === v && (v = 0);
      ...
      r.height = Math.floor(l);
      CTATShellTools.registerComponentDescription(r);
      g = e.getElementChildren(g);
      for (k = 0;k < g.length;k++) {
        m = g[k];
        e.getElementName(m);
        if ("Parameters" == e.getElementName(m)) {
          for (this.ctatdebug("Processing component parameters ..."), n = e.getElementChildren(m)[0], n = e.getElementChildren(n), l = 0;l < n.length;l++) {
            var t = n[l];
            if ("CTATComponentParameter" == e.getElementName(t)) {
              this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
              for (var v = p = void 0, t = e.getElementChildren(t), w = 0;w < t.length;w++) {
                var x = t[w];
                "name" == e.getElementName(x) && (this.ctatdebug("Found parameter name: " + e.getNodeTextValue(x)), p = e.getNodeTextValue(x));
                "value" == e.getElementName(x) && (this.ctatdebug("Found parameter value: " + e.getNodeTextValue(x)), v = e.getNodeTextValue(x).trim());
              }
              this.ctatdebug("Parameter name: " + p + ", value: " + v);
              void 0 !== p && (r.params[p] = v, "group" == p && (r.groupName = v));
            }
          }
        }
        if ("Styles" == e.getElementName(m)) {
          for (this.ctatdebug("Processing component styles ..."), m = e.getElementChildren(m)[0], m = e.getElementChildren(m), n = 0;n < m.length;n++) {
            if (v = m[n], "CTATStyleProperty" == e.getElementName(v)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              p = l = "";
              v = e.getElementChildren(v);
              for (t = 0;t < v.length;t++) {
                w = v[t], "name" == e.getElementName(w) && (l = e.getNodeTextValue(w)), "value" == e.getElementName(w) && (p = e.getNodeTextValue(w).trim());
              }
              this.ctatdebug("Style (name: " + l + ", value: " + p + ")");
              "" !== l && (r.styles[l] = p);
            }
          }
        }
...
var CTATCheckBox = function(a, b, c, e, g) {
  ...
  this.init = function() {
    ...
    this.getText() ? d.value = m.getText() : this.getDivWrap() && this.getDivWrap().textContent ? d.value = this.getDivWrap().textContent : d.value = d.id;
    this.getComponentGroup() ? d.name = m.getComponentGroup() : this.getDivWrap() && $(this.getDivWrap()).attr("name") ? d.name = $(this.getDivWrap()).attr("name") : d.name = "checkBoxGroup";
    m.assignEnabled(!0);
    !0 === m.getEnabled() ? d.disabled = !1 : d.disabled = !0;
    m.ctatdebug("Final location: " + m.getX() + "," + m.getY() + " with text: " + m.getText());
    m.addComponentReference(m, d);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    ...
    d.addEventListener("focus", m.processFocus);
    d.onfocus = this.processOnFocus;
    this.setSelection(this.getComponentGroup());
  };
  var l = this.setText;
  this.setText = function(a) {
  ...
  this.removeCorrect = r.bind(this, "CTAT--correct");
  this.showInCorrect = function(a) {
    r("CTAT--correct");
    r("CTAT--hint");
    v("CTAT--incorrect");
...
var CTATHintWindow = function(a, b, c, e, g) {
  ...
  var d = this;
  d.isTabIndexable = !1;
  var f = null, h = null, k = null, m = null, n = CTATGlobals.languageManager.getString("NEXT"), l = CTATGlobals.languageManager.getString("PREVIOUS"), p = null;
  ...
  this.data_ctat_handlers["use-svg"] = function(a) {
    r = CTATGlobalFunctions.stringToBoolean(a);
  };
  ...
  this.init = function() {
    ...
    m.setAttribute("id", CTATGlobalFunctions.gensym.div_id());
    m.setAttribute("onkeypress", "return noenter(event)");
    d.setComponent(m);
    m.classList.add("CTAT-gen-component");
    m.classList.add("CTAT-hint-window");
    d.addComponentReference(d, m);
    d.getDivWrap().appendChild(m);
    f = document.createElement("div");
    m.appendChild(f);
    ...
    if (v) {
      ...
      if (r) {
        ...
        h.appendChild(a);
        l && (a = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), a.setAttributeNS(null, "pointer-events", "none"), a.textContent = l, a.setAttributeNS(null, "text-anchor", "middle"), a.setAttributeNS(null, "x", "50px"), a.setAttributeNS(null, "dominant-baseline", "middle"), a.setAttributeNS(null, "y", "50%"), h.appendChild(a));
      } else {
        h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), a = document.createElement("span"), a.style.fontWeight = "bold", a.style.marginLeft = "6px", a.style.marginRight = "4px", a.textContent = "\u25c0", h.appendChild(a), l && (a.style.cssFloat = "left", h.appendChild(document.createTextNode(l)));
      }
    }
    ...
    m.appendChild(h);
    p ? (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), k.innerHTML = p) : r ? (k = document.createElementNS(CTATGlobals.NameSpace.svg, "svg"), k.classList.add("CTAT-hint-window--next"), k.setAttributeNS(null, "viewBox", "0 0 82 20"), a = document.createElementNS(CTATGlobals.NameSpace.svg, "path"), a.style.fill = "none", a.style.strokeWidth = "3px", a.style.strokeLinecap = "round", a.setAttributeNS(null, "d", "M75 10 h-12 M75 10 m-4 -4 l4 4 -4 4"), a.setAttributeNS(null, 
    "pointer-events", "none"), k.appendChild(a), n && (a = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), a.setAttributeNS(null, "pointer-events", "none"), a.textContent = n, a.setAttributeNS(null, "text-anchor", "middle"), a.setAttributeNS(null, "x", "34px"), a.setAttributeNS(null, "dominant-baseline", "middle"), a.setAttributeNS(null, "y", "50%"), k.appendChild(a))) : (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), a = document.createElement("span"), 
    a.style.fontWeight = "bold", a.style.marginRight = "6px", a.textContent = "\u25b6", n && (a.style.cssFloat = "right", k.appendChild(document.createTextNode(n))), k.appendChild(a));
  ...
  this.goPrevious = function() {
    ...
    f.innerHTML = CTATGlobals.languageManager.filterString(hints[hintIndex]);
...
var CTATRadioButton = function(a, b, c, e, g) {
  ...
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = this, f = null, h = null, k = null, m = CTATRadioButton.Options.Placement.right;
  this.setSelection(this.getComponentGroup());
...
var CTATTable = function(a, b, c, e, g) {
  ...
  this.init = function() {
    d.ctatdebug("init (" + d.getName() + ")");
    m = CTATGlobalFunctions.gensym.div_id();
  ...
  this.adjustTableContents = function() {
    ...
    for (a = 0;a < f.rows.length;a++) {
      for (b = f.rows[a], c = 0;c < b.cells.length;c++) {
        var m = b.cells[c], w = d.getName() + ".R" + a + "C" + c;
        CTATShellTools.findComponent(w).forEach(function(a) {
          var b = d.getGrDescription();
          b.name = w;
          a.setCellContainer(m);
          a.setGrDescription(b);
          a = a.getDivWrap();
          null != a ? (a.parentNode.removeChild(a), a.style.position = null, a.style.top = null, a.style.left = null, m.appendChild(a)) : d.ctatdebug("Error: unable to get div wrapper from component");
        });
      }
    }
  };
...
var CTATCurriculumService = function(a) {
  ...
  this.processIncoming = function(a) {
    ...
    c.ctatdebug("CTATCurriculumService.processIncoming(" + (a ? a.substring(0, 12) + "..." : "") + ") parent.location.replace " + parent.location.replace + ', runProblemUrl "' + b + '"');
...
var CTATCommShell = function() {
  ...
  this.init = function(d) {
    ...
    new CTATHTMLManager;
    this.ctatdebug("CTATCommShell.init() FlashVar info: " + c.info);
    "" != c.info ? parent.javaScriptInfo && parent.javaScriptInfo(decodeURIComponent(c.info)) : this.ctatdebug("There is no info flash var");
  ...
  this.processAssociatedRules = function(a, d, c) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      ...
      null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, f, "", e, c, h, d, g) : this.ctatdebug("Info: no logging library available!");
  ...
  this.processInterfaceAction = function(a) {
    ...
    0 == inStartState ? (b.ctatdebug("This is not a start state TPA so it should be logged", "commShell"), null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logSemanticEvent(a.getTransactionID(), a.getSAI(), "ATTEMPT", "tutor-performed") : this.ctatdebug("Info: no logging library available!")) : b.ctatdebug("Info for incoming TPA, commMessageHandler.getInStartState (): " + commMessageHandler.getInStartState());
...
CTATTutor.createStaticInterface = function(a, b, c) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var f, h, k, m;
    "shape" == this.parser.getElementName(g) && (f = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), k = this.parser.getElementAttr(g, "width"), m = this.parser.getElementAttr(g, "height"), d = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating shape: " + d + " at: " + f + "," + h + "," + k + "," + m), k = "data:image/png;base64, " + this.parser.getNodeTextValue(g), m = new Image, m.setAttribute("style", "position: absolute; top: " + h + "px; left:" + f + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), m.setAttribute("id", d), m.setAttribute("src", k), e.appendChild(m));
    "statictext" == this.parser.getElementName(g) && (f = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), k = this.parser.getElementAttr(g, "width"), m = this.parser.getElementAttr(g, "height"), d = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating static text: " + d + " at: " + f + "," + h + "," + k + "," + m), k = "data:image/png;base64, " + this.parser.getNodeTextValue(g), m = new Image, m.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    f + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), m.setAttribute("id", d), m.setAttribute("src", k), e.appendChild(m));
    "statictext" == this.parser.getElementName(g) && (d = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + d), f = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), k = this.parser.getElementAttr(g, "width"), m = this.parser.getElementAttr(g, "height"), f = new CTATMovieClip(d, f, h, k, m), h = f.wrapComponent(e), ctatdebug("Created movieclip: " + d + " at: " + f.x + "," + f.y + "," + f.width + "," + f.height), movieclips.push(f), g = this.parser.getElementChildren(g), 
    this.createStaticInterface(h, g, f));
  }
};
CTATTutor.runTutor = function(a) {
  ctatdebug("runTutor ()");
  !0 === CTATGlobals.tutorRunning ? ctatdebug("The tutor is already running") : (null == skillSet && (skillSet = new CTATSkillSet), window.onerror = function(a, c, e) {
...
function initTutor(a, b, c, e) {
  ...
  b = [];
  b = null != a ? tutorPrep(a) : tutorPrep(FlashVars);
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var k = b(this) ? Object(new this(h)) : Array(h), m = 0, n;m < h;) {
      n = g[m], k[m] = d ? "undefined" === typeof f ? d(n, m) : d.call(f, n, m) : n, m += 1;
    }
    k.length = h;
    return k;
  };
...
(function(a) {
  ...
  var e = /[^s]/, g = /[def]/, d = /^[^\x25]+/, f = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, k = /^([a-z_][a-z_\d]*)/i, m = /^\.([a-z_][a-z_\d]*)/i, n = /^\[(\d+)\]/, l = /^[\+\-]/;
  b.format = function(a, d) {
    var f = 1, h = a.length, k = "", m = [], n, p, B, u, E = !0, q = "";
    for (n = 0;n < h;n++) {
      if (k = c(a[n]), "string" === k) {
        m[m.length] = a[n];
      } else {
        if ("array" === k) {
          B = a[n];
          if (B[2]) {
            for (k = d[f], p = 0;p < B[2].length;p++) {
              if (!k.hasOwnProperty(B[2][p])) {
                throw Error(b("[sprintf] property '%s' does not exist", B[2][p]));
              }
              k = k[B[2][p]];
            }
          } else {
          ...
          "function" == c(k) && (k = k());
          if (e.test(B[8]) && "number" != c(k) && isNaN(k)) {
          ...
          switch(B[8]) {
            ...
            case "d":
              ...
              break;
            case "e":
              k = B[7] ? k.toExponential(B[7]) : k.toExponential();
              break;
            case "f":
              k = B[7] ? parseFloat(k).toFixed(B[7]) : parseFloat(k);
              break;
            case "o":
              k = k.toString(8);
              break;
            case "s":
              k = (k = String(k)) && B[7] ? k.substring(0, B[7]) : k;
              break;
            case "u":
              k >>>= 0;
              break;
          ...
          if (!E || g.test(B[8]) && B[3]) {
            q = E ? "+" : "-", k = k.toString().replace(l, "");
          }
          p = B[4] ? "0" == B[4] ? "0" : B[4].charAt(1) : " ";
          u = B[6] - (q + k).length;
          u = B[6] ? Array(u + 1).join(p) : "";
          m[m.length] = B[5] ? q + k + u : 0 == p ? q + u + k : u + q + k;
        }
      }
    }
    return m.join("");
        ...
        if (null !== (b = f.exec(a))) {
          ...
          if (null !== (b = h.exec(a))) {
            if (b[2]) {
              var e = e | 1, g = [], l = b[2], p = [];
              if (null !== (p = k.exec(l))) {
                for (g[g.length] = p[1];"" !== (l = l.substring(p[0].length));) {
                  if (null !== (p = m.exec(l))) {
                    g[g.length] = p[1];
                  } else {
                    if (null !== (p = n.exec(l))) {
...
var CTATExampleTracerSkill = function(a, b, c, e, g, d) {
  ...
  var f = null == a || "" == a.trim() ? b : b + " " + a, h = e, k = 0, m = 0, n = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, l = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, p = null, v = this;
  this.getSkillName = function() {
    return f;
  };
  this.getCategory = function() {
  ...
  this.hasReachedMastery = function() {
    return null === h || "undefined" === typeof h ? !1 : h >= l;
  };
  this.getLabel = function() {
...
var CTATSkills = function(a) {
  ...
  this.toXML = function(a, c) {
    c || (c = "");
    var e = a ? "&lt;Skills&gt;" : "<Skills>", g = e.length, m;
    for (m in b) {
      b.hasOwnProperty(m) && b[m] && (e += c + b[m].toXML(a));
    }
    e += c && e.length > g ? "\n" : "";
    return e + (a ? "&lt;/Skills&gt;" : "</Skills>");
  };
  this.updateSkill = function(a, b, h) {
    var k = null, m = g.getSkill(b);
    null !== m && "undefined" !== typeof m && (m.setTransactionNumber(c), b = h + " " + b, e.has(b) || (e.add(b), m.updatePKnown(a), m.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && e.delete(b), k = m);
    return k;
  };
...
var CTATDefaultLinkGroup = function(a, b, c, e) {
  ...
  var k = new Set, m = null, n = null, l = this;
  l.ctatdebug("CTATDefaultLinkGroup constructor group name: " + a);
  l.ctatdebug("CTATDefaultLinkGroup constructor group isOrdered: " + b);
  l.ctatdebug("CTATDefaultLinkGroup constructor group isReenterable: " + c);
  this.setOrdered = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in setOrdered group name: " + g);
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in setOrdered:: " + a);
    d = a;
  };
  this.setName = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in setName: " + a);
    g = a;
  };
  this.containsLink = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in containsLink: " + a.getUniqueID());
    return h.has(a);
  };
  this.removeLink = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in removeLink: " + a.getUniqueID());
    return h.delete(a);
  };
  this.getParent = function() {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in getParent");
    return m;
  };
  this.addLink = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in addLink: " + a.getUniqueID());
    h.add(a);
  };
  this.getIsOrdered = function() {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in getIsOrdered: " + d);
    return d;
  };
  this.getIsReenterable = function() {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in getIsReenterable: " + f);
    return f;
  };
  this.getSubgroups = function() {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in getSubgroups");
    return k;
  };
  this.getLinks = function() {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in getLinks");
    return h;
  };
  this.setReenterable = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in setReenterable: " + a);
    f = a;
  };
  this.setParent = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in setParent: " + a.getName());
    m = a;
  };
  this.addSubgroup = function(a) {
    l.ctatdebug("CTATDefaultLinkGroup --\x3e in addSubgroup groupName: " + a.getName());
    k.add(a);
  };
  this.getName = function() {
    return g;
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var e = Number.MAX_VALUE, g = b, d = 0, f = new Date, h = {}, k = 0, m = 0, n = 0, l = 0, p = 0, v = 0, r = 0, t = CTATMsgType.CompletionValue[0], w = this;
  ...
  this.addHint = function(a) {
    ...
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNFirstHints() && ++l, b.incrementFirstHints()) : (b = new CTATStep(a, CTATStep.StepResult[2]), h[a] = b, l++);
    m++;
    b.setLastResult(CTATStep.StepResult[2]);
    w.ctatdebug("exiting addHint() hint count " + m + ", trial " + b);
  };
  this.addError = function(a) {
    w.ctatdebug("addError(" + a + ")");
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++r, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), h[a] = b, r++);
    n++;
    b.setLastResult(CTATStep.StepResult[1]);
    w.ctatdebug("exiting addError() error count " + n + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = h[a];
    w.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++p, 1 > b.getNFirstHints() && v++), b.incrementNCorrect()) : (w.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, p++, v++);
    k++;
...
var ProblemStateSaver = function(a) {
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (a && h) {
      var k = {};
      if (CTATBase.inOLI()) {
        var m = h.getRequiredSteps(), n = h.getCorrect();
        0 == m ? (console.log("WARNING problem summary number of required steps is 0\n" + h.toXML(!1)), k.percentScore = 100, k.completed = !0) : (k.percentScore = Math.round(100 * n / m), k.completed = n >= m);
      } else {
      ...
      if (CTATBase.inXBlock()) {
        var l = 1 / parseInt(k.max_score), l = (parseInt(k.score) * l).toFixed(2);
        setVariable("saveandrestore", k.problem_state);
        gradeStudent(l, "1.0");
      } else {
        if (CTATBase.inOLI()) {
          ...
          if (e && a && h) {
            ...
            h = [];
            for (l in k) {
              m = new CTATVariable, m.name = l, m.value = k[l], h.push(m);
            }
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(e) {
    ...
    if (CTATBase.inXBlock()) {
      console.log("Attempting problem restore within XBlock environment ..."), a.setWorking(1, !0), e = getVariable("saveandrestore"), "" != e && (console.log("Restore string: " + e), b.process(e));
    } else {
      if (e.mustRetrieveProblemState()) {
        if (a.setWorking(1, !0), CTATBase.inOLI()) {
          console.log("Attempting problem restore within OLI environment ..."), oliDriver.registerClientHandler(b), oliComm.loadFileRecord(a.getQuestionFile());
        } else {
      ...
      if (c.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof c && (c = c.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + c.length + ", msgsArr[1].length " + (c[1] ? c[1].length : -1)), !(2 > c.length))) {
          ...
          for (var d = 0, f = !1, h = 1;h < c.length;++h) {
            var k = "<message>" + c[h], m = CTATMsgType.getMessageType(k);
            CTATMsgType.STATE_GRAPH == m ? f = !0 : CTATMsgType.START_STATE_END == m ? f = !1 : f ? d++ : (a.getProblemStateSaver().appendToProblemState(k, null, !0), g.push(k));
            b.ctatdebug("problemStateArr[" + h + "] " + (f ? "omit " : "keep ") + m + " omitted " + d + " kept " + g.length);
          }
        }
...
(function() {
  var a, b, c, e, g, d, f, h, k, m, n, l = [].slice;
  g = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  e = /^\d+(\.\d\d)?$/;
  d = /((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?/g;
  m = /^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;
  ...
  a = function() {
    ...
    a.sum = function() {
      return (1 <= arguments.length ? l.call(arguments, 0) : []).reduce(function(a, b) {
        return a + +b;
      }, 0);
    };
    a.mod = function(a, b) {
    ...
    a.dollarEquals = function() {
      var a, b;
      a = arguments[0];
      b = 2 <= arguments.length ? l.call(arguments, 1) : [];
    ...
    a.matchWithPrecision = function(a, d) {
      var c, f;
      return (c = String(a).match(m)) && (f = String(d).match(m)) && n(c) === n(f) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, d) {
      var f, e;
      return (f = String(a).match(m)) && (e = String(d).match(m)) && (a = n(f) > n(e) ? (+a).toFixed(c(e)) : String(a)) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    ...
    a.columnCell = function(a, b, d, c, f, e, g, k, h, l) {
      switch(h) {
        case "r1c1":
        ;
        case "r2c1":
    ...
    a.first = function() {
      return (1 <= arguments.length ? l.call(arguments, 0) : [])[0];
    };
    a.last = function() {
      var a;
    ...
    a.firstNonNull = function() {
      var a;
      return null != (a = (1 <= arguments.length ? l.call(arguments, 0) : []).find(function(a) {
        return null != a;
      })) ? a : null;
    };
    ...
    a.hasValue = function() {
      return (1 <= arguments.length ? l.call(arguments, 0) : []).every(function(a) {
        return null != a;
      });
    };
    a.equals = function() {
      var a, b, d;
      b = arguments[0];
      d = 2 <= arguments.length ? l.call(arguments, 1) : [];
    ...
    a.assign = function(a, b) {
      var d, c, f, e, g, k;
      k = "undefined" !== typeof window && null !== window ? window : global;
      c = a.split(".");
      f = 2 <= c.length ? l.call(c, 0, d = c.length - 1) : (d = 0, []);
      e = c[d++];
      d = 0;
      for (g = f.length;d < g;d++) {
        c = f[d], k = null != k[c] ? k[c] : k[c] = {};
      }
      return k[e] = b;
    };
    return a;
...
(function() {
  ...
  a = function(a) {
    function c(a, b, e, g, m, n) {
      this.operator = a;
      this.left = b;
      this.right = e;
      this.parens = null != g ? g : 0;
      this.sign = null != m ? m : 1;
      this.exp = null != n ? n : 1;
    }
    b(c, a);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], e = [1, 7], g = [1, 10], d = [1, 11], f = [1, 12], h = [1, 13], k = [1, 21], m = [1, 22], n = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], l = [1, 23], p = [1, 24], v = [1, 26], r = [1, 27], t = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:m}, b(n, [2, 11], {22:9, 19:25, 16:l, 18:p, 20:v, 21:r, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 17]), {13:c, 15:e, 17:28, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:29, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(t, [2, 20]), b(t, [2, 23], {23:[1, 30]}), {13:c, 15:e, 17:31, 19:8, 22:9, 24:g, 25:d, 27:f, 
  ...
  15:m, 26:[1, 46]}, {5:[2, 2], 13:k, 15:m}, {5:[2, 3], 13:k, 15:m}, {5:[2, 4], 13:k, 15:m}, {5:[2, 5], 13:k, 15:m}, {5:[2, 6], 13:k, 15:m}, {5:[2, 7], 13:k, 15:m}, b(n, [2, 9], {22:9, 19:25, 16:l, 18:p, 20:v, 21:r, 24:g, 25:d, 27:f, 28:h}), b(n, [2, 10], {22:9, 19:25, 16:l, 18:p, 20:v, 21:r, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 12]), b(t, [2, 13]), b(t, [2, 15]), b(t, [2, 16]), b(t, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, k = 0, l = 0, h = d.slice.call(arguments, 1), m = Object.create(this.lexer), n = {}, p;
    for (p in this.yy) {
    ...
    for (var r, t, L, w, M = {}, N, J;;) {
      L = b[b.length - 1];
      if (this.defaultActions[L]) {
        w = this.defaultActions[L];
      } else {
      ...
      if (w[0] instanceof Array && 1 < w.length) {
        throw Error("Parse Error: multiple actions possible at state: " + L + ", token: " + r);
      }
      switch(w[0]) {
        case 1:
          b.push(r);
          ...
          b.push(w[1]);
          r = null;
          t ? (r = t, t = null) : (k = m.yyleng, f = m.yytext, g = m.yylineno, p = m.yylloc, 0 < l && l--);
          break;
        case 2:
          ...
          v && (M._$.range = [d[d.length - (J || 1)].range[0], d[d.length - 1].range[1]]);
          L = this.performAction.apply(M, [f, k, g, n, w[1], c, d].concat(h));
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, k, m) {
      var n, l, p, v, r, t, w, x;
      try {
        r = "undefined" !== typeof window && null !== window ? window : global;
        n = function() {
          var a;
          a = [];
          for (p in r) {
        ...
        l = 0;
        for (v = w.length;l < v;l++) {
          p = w[l], 0 > g.call(c, p) && CTATFormulaFunctions.assign(p, void 0);
        }
        ...
        }).apply(r, [d, k, m].concat(e.call(this.values)));
      } catch (A) {
        return console.log(A), null;
      } finally {
        for (p in r) {
          null != p && 0 > g.call(n, p) && (x[p] = r[p], delete r[p]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      r = [];
      a = g = 0;
      for (p = v.length;g < p;a = ++g) {
        e = v[a], r.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return r.join("");
    };
    return a;
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, f = "undefined" === typeof c || null === c ? null : c, h = null, k = 1, m = 1, n = "CORRECT_ACTION", l = [], p = !1, v = null, r = "", t = null, w = null, x = this;
  ...
  this.interpolateHints = function(a) {
    ...
    var b = [];
    if (null === l || "undefined" === typeof l || 0 === l.length) {
      return b;
    }
  ...
  this.addHint = function(a) {
    null !== a && "undefined" !== typeof a && a.toString() !== "".toString() && l.push(a);
  };
  this.setSelection = function(a) {
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.evaluateReplacement = function(a, b, e) {
    ...
    var k = a.getSelection(), m = a.getAction();
    a = CTATVariableTable.standardizeType(a.getInput());
    b || (b = new CTATVariableTable);
    b = new CTATFormulaParser(b);
    c.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + g + ", " + k + ", " + m + ", " + a + ")");
    try {
      e = b.evaluate(g, k, m, a);
    } catch (n) {
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var e = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, f = !1, h = null, k = null, m = "student", n = null, l = null, p = "", v = null, r = null, t = null, w = null, x = null, A = [], C = !1, z = null, B = null, u = this;
  this.getActor = function() {
    return m;
  };
  this.setActor = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e setActor(" + a + ")");
    m = a;
  };
  this.getStudentSAI = function() {
    u.ctatdebug("CTATExampleTracerEvent.getStudentSAI() returning type " + typeof h + ", value " + h);
    return h;
  };
  this.setStudentSAI = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setStudentSAI(" + a + ")");
    null !== a && "undefined" !== typeof a && (h = a);
    u.ctatdebug("CTATExampleTracerEvent --\x3e out of setStudentSAI");
  };
  this.getPreloadedLinkMatches = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getPreloadedLinkMatches");
    return r;
  };
  this.setTutorSAI = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setTutorSAI");
    null !== a && "undefined" !== typeof a && (k = a);
    u.ctatdebug("CTATExampleTracerEvent --\x3e out of setTutorSAI");
  };
  this.setNumberOfInterpretations = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setNumberOfInterpretations( " + a + " )");
  };
  this.getTransactionID = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + e);
    return e;
  };
  this.setTransactionID = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setTransactionID( " + a + " )");
    e = a;
  };
  this.setDoneStepFailed = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setDoneStepFailed( " + a + " )");
    g = a;
  };
  ...
  this.setResult = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( " + a + " )");
    d = a;
  };
  this.isSolverResult = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");
    return !1;
  };
  this.getResult = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + d);
    return d;
  };
  this.setReportableLink = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink(" + a + ")");
    n = a;
  };
  this.setReportableInterpretation = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation(" + a + ")");
    l = a;
  };
  this.setStepID = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID(" + a + ")");
    p = a;
  };
  ...
  this.setSuccessOrBuggyMsg = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg(" + a + ")");
    x = a;
  };
  this.setReportableHints = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints(" + a + ")");
    A = Array.isArray(a) && 0 < a.length ? a : [];
  };
  this.getWantReportableHints = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + C);
    return C;
  };
  this.setOutOfOrder = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder(" + a + ")");
    v = a;
  };
  this.isOutOfOrder = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + v);
    return v;
  };
  this.setEvaluatedInput = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput(" + a + ")");
  ...
  this.addPreloadedLinkMatch = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch(" + a + ")");
    if (null === r || "undefined" === typeof r) {
      r = [];
    }
    r.push(a);
  ...
  this.setInterpolatedSAI = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI(" + a + ")");
    a && (z = a);
  };
  this.getInterpolatedSAI = function() {
    return z ? z : u.getStudentSAI();
  };
  this.setInterpolatedHints = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints(" + a + ")");
    null !== B && "undefined" !== typeof B && (B.length = 0);
    null !== a && "undefined" !== typeof a && (B = a.slice(0));
    u.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints");
  };
  this.setWantReportableHints = function(a) {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints(" + a + ")");
    C = a;
  };
  this.getSuccessOrBuggyMsg = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + x);
    return x;
  };
  this.getReportableHints = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + A);
    return A;
  };
  this.getReportableLink = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + n);
    return n;
  };
  this.getReportableVariableTable = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + w);
    return w;
  };
  this.getReportableInterpretation = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + l);
    return l;
  };
  this.getStepID = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + p);
    return p;
  };
  ...
  this.getTutorInput = function() {
    return null !== t && "undefined" !== typeof t ? u.getEvaluatedInputArray() : null !== k && "undefined" !== typeof k ? k.getInputArray() : null;
  };
  ...
  this.toString = function() {
    var a;
    a = "[" + u.getResult();
    null !== u.getStudentSAI() && "undefined" !== typeof u.getStudentSAI() && (a += ", StudentSAI " + u.getStudentSAI());
    null !== u.getReportableLink() && "undefined" !== typeof u.getReportableLink() && (a += ", reportableLink " + u.getReportableLink());
    !0 === u.isDoneStepFailed() && (a += ", doneStepFailed");
    null !== u.getTutorSAI() && "undefined" !== typeof u.getTutorSAI() && (a += ", TutorSAI " + u.getTutorSAI());
    return a + "]";
  };
...
var CTATExpressionMatcher = function(a, b) {
  function c(a, b, c, f, g) {
    ...
    var v = CTATVariableTable.standardizeType(c);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof c + "; inputConv " + v + ", typeof " + typeof v);
    c = h.evaluate(a, b, v, g);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + v + ", " + g + ") returned " + c + ", type " + typeof c);
    g = null;
    switch(f) {
...
var CTATVectorMatcher = function(a, b, c, e) {
  function g(a, b, c, e, g) {
    m.ctatdebug("CTATVectorMatcher --\x3e in _match(" + a + ", " + b + ", " + c + ", " + e + ")");
    if (0 === d.length || 0 === f.length || 0 === h.length) {
      d.push(new CTATExactMatcher(CTATMatcher.SELECTION, m.array2ConcatString(m.getDefaultSelectionArray()))), f.push(new CTATExactMatcher(CTATMatcher.ACTION, m.array2ConcatString(m.getDefaultActionArray()))), h.push(new CTATExactMatcher(CTATMatcher.INPUT, m.array2ConcatString(m.getDefaultInputArray())));
    }
    var t = [];
    ...
    for (var w = 0;3 > w;w++) {
      var x = k[w][0], A = x instanceof CTATExpressionMatcher ? x.matchConcatenation(a, b, c, e) : x.matchConcatenation(t[w]);
      m.ctatdebug("CTATVectorMatcher --\x3e in _match[" + w + "] after " + x + ".concat returns: " + A);
      if (g) {
        g.push(A);
      } else {
        if (!1 === A) {
  ...
  var m = this;
  this.match = function(a, b, c, d, e) {
    return !1 !== g(a, b, c, e) && m.matchActor(d) ? !0 : !1;
  };
  ...
  this.getSelection = function() {
    return 0 === d.length ? m.getDefaultSelection() : d[0].toString();
  };
  this.getAction = function() {
    return 0 === f.length ? m.getDefaultAction() : f[0].getAction();
  };
  this.setDefaultSelection = function(a) {
    return 0 === d.length ? m.internalSetDefaultSelection(a) : d[0].setDefaultSelection(a);
  };
  this.setDefaultAction = function(a) {
    return 0 === f.length ? m.internalSetDefaultAction(a) : f[0].setDefaultAction(a);
  };
  ...
  this.matchForHint = function(a, b, c, e) {
    ...
    b = !1;
    b = d[0];
    return b = Array.isArray(a) ? b.matchConcatenation(a, m.getDefaultActionArray(), m.getDefaultInputArray(), e) : b.matchConcatenation([a], m.getDefaultActionArray(), m.getDefaultInputArray(), e);
  };
  this.setCaseInsensitive = function(a) {
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function e(a, b, d, e, f, g) {
    ...
    if (b) {
      ...
      d.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && C.splice(C.length - 1, 1);
    }
  ...
  function g(a, b, c, d) {
    q.ctatdebug("checkDoneStep() hintTrace " + b + ", sai " + a.getStudentSAI() + ", exitOnIncorrectDone " + z.exitOnIncorrectDone() + ", hideButRequireSteps " + z.hideButRequireSteps() + ", nInterps " + d.size);
    if (!a.getStudentSAI().isDone()) {
      return null;
    }
    if (z.exitOnIncorrectDone()) {
      return a.setDoneStepFailed(!1), null;
    }
    if (!b && z.hideButRequireSteps()) {
      b = z.getDoneLinks();
      q.ctatdebug("checkDoneStep getDoneLinks().size " + b.size);
      b = b.values();
      for (var f;!(f = b.next()).done;) {
        if (z.pathToLinkIsSubset(f.value, E)) {
          return a.setDoneStepFailed(!1), 1 > d.size ? e(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, q.getBestInterpretation(), q.getInterpretationsInternal()) : e(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, n(d), d);
        }
      }
    }
  ...
  function d(a, b, c) {
    ...
    B = a;
    var d = new Set, l = a.getPreloadedLinkMatches();
    ...
    x.forEach(function(e) {
      ...
      if ("undefined" === typeof l || null === l) {
        q.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), l = h(a.getStudentSAI(), a.getActor(), b, e.getVariableTable(), a), q.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      } else {
        for (var g = 0;g < l.length;++g) {
          f(a.getStudentSAI(), !0, l[g], l[g].getActor(), e.getVariableTable());
        }
      }
      q.ctatdebug("Link matches # : " + l.length);
      l.forEach(function(b) {
    ...
    if (0 === d.size) {
      return q.ctatdebug("In evaluate -- if condition no new interpretations"), 0 !== l.length && !0 === l[0].isDone() && a.setDoneStepFailed(!0), a.setResult(CTATExampleTracerLink.NO_MODEL), q.ctatdebug("In evaluate -- if condition no new interpretations returning false"), !1;
    }
    r = n(d);
    q.ctatdebug("In evaluate -- just found bestInterp");
    var v = null;
    !0 === a.isSolverResult() ? (q.ctatdebug("In evaluate -- in if branch of isSolverResult"), v = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (q.ctatdebug("In evaluate -- in else branch of isSolverResult"), v = r.getLastMatchedLink().getType());
    return e(a, c, v, null, r, d);
  }
  function f(a, b, c, d, e) {
    var f = b && c.isCorrect();
    if ("undefined" != typeof E[c.getUniqueID()] || c.matchesSAIforHint(a, d, null, e)) {
      E[c.getUniqueID()] = f;
    }
    q.ctatdebug("updateMatchedSelections(): link " + c.getUniqueID() + ", matched " + b + ", newResult " + f + ", matchedSelections[link] " + E[c.getUniqueID()]);
  }
  function h(a, b, c, d, e) {
    q.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks(" + a + ", " + b + ", " + c + ")");
    var g = [];
    z.getLinks().forEach(function(h) {
      if (!1 === c) {
        ...
        !0 === k && g.push(h);
        z.hideButRequireSteps() && f(a, k, h, b, d);
      } else {
  ...
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === z.observesOrderingConstraints(h, a, f, e) || !1 === v(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
    ...
    if (a.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      if (!1 === z.isIncorrectLinkOK(b.getMatchedLinks(), a, f, b)) {
        return q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"), !1;
      }
    } else {
      if (!1 === z.observesOrderingConstraints(b.getMatchedLinks(), a, f, e)) {
  ...
  function l(a) {
    ...
    0 === a.size ? q.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (q.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      x.push(a);
    }), u = null, q.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function p() {
    q.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");
    var a = z.findAllPaths();
  ...
  function v(a, b, c) {
    ...
    if (b.isDone() && z.exitOnIncorrectDone()) {
      return !0;
    }
  ...
  function r(a, b) {
    ...
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < q.nonEmptyHints(b, c.getVariableTable())) && z.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && v(c, b, d.getLinks()) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
  ...
  function t(a, b, c, d) {
    ...
    b.getSortedLinks().forEach(function(b) {
      ...
      !0 === a.isTraversed(b, d) || !0 === w(b) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), f = !0) : (!0 === f && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), z.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
  ...
  var x = null, A = null, C = null, z = a, B = null;
  ...
  this.resetTracer = function() {
    ...
    u = a;
    if (null === A || "undefined" === typeof A) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), A = {};
    } else {
    ...
    E = {};
    null === C || "undefined" === typeof C ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), C = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), C.length = 0);
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === u || "undefined" === typeof u) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), u = n(q.getInterpretationsInternal());
    }
    q.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === u || void 0 === u));
    return u;
  };
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = r(!1, [a])) ? a.getPrevNode() : z ? z.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, c) {
  function e(a, b, c) {
    ...
    if (b.isDone() && y.exitOnIncorrectDone()) {
      return !0;
    }
  ...
  function d(a) {
    y.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof D);
  ...
  function f(a, b, c, d) {
    var e = -1, f = null, g = Number.MAX_VALUE, m = null;
    D.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === D.isLinkInGroup(a, b) && 0 !== D.getGroupLinkCount(a)) {
        var k = h(a, d);
        null !== k && "undefined" !== typeof k && (k = k.getDepth(), k < b.getDepth() && k > e && (!1 === n(a) || !0 === l(a, c)) && (e = k, f = a), k > b.getDepth() && k < g && (!1 === n(a) || !0 === l(a, c)) && (g = k, m = a));
      }
    });
    D.getUniqueLinks(a).forEach(function(a) {
      if (!0 === d.has(a)) {
        ...
        h > b.getDepth() && h < g && (0 < a.getMinTraversals() || -1 < c.indexOf(a)) && (g = h, m = a);
      }
    });
    if (null !== f && "undefined" !== typeof f) {
    ...
    return null !== m && "undefined" !== typeof m && (m instanceof CTATExampleTracerLink && -1 < c.indexOf(m) || m instanceof CTATLinkGroup && !0 === l(m, c)) ? !1 : !0;
  }
  function h(a, b) {
  ...
  var w = null, x = null, A = null, C = null, z = null, B = null, u = new Set, E = new Set, q = null, D = null, F = CTATMsgType.SHOW_ALL_FEEDBACK, y = this;
  this.getFeedbackPolicy = function() {
    return F;
  };
  this.setFeedbackPolicy = function(a) {
    y.ctatdebug("Graph.setFeedbackPolicy(" + a + ") old policy " + F);
  ...
  this.pathToLinkIsSubset = function(a, b) {
    var c = y.getNode(a.getPrevNode());
    y.ctatdebug("pathToLinkIsSubset(" + a + ") sourceNode " + c.getNodeID());
    ...
    for (c = c.getInLinks().values();!(c = c.next()).done;) {
      return y.pathToLinkIsSubset(c.value, b);
    }
    return !1;
  };
  this.observesOrderingConstraints = function(a, b, c, d) {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints");
    null !== d && "undefined" !== typeof d && (y.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints initializing out of order false"), d.setOutOfOrder(!1));
    if (null === c || "undefined" === typeof c || 0 === c.size || null === b || "undefined" === typeof b) {
      return y.ctatdebug("CTATExampleTracerGraph --\x3e returning first true observesOrderingConstraints"), !0;
    }
    if (b.isDone() && y.exitOnIncorrectDone()) {
      return y.ctatdebug("CTATExampleTracerGraph.observesOrderingConstraints --\x3e returning true for doneStep && exitOnIncorrectDone"), !0;
    }
    if (!0 === c.has(b) && !0 === e(a, b, c) && !0 === g(a, b, c)) {
      return y.ctatdebug("CTATExampleTracerGraph.observesOrderingConstraints --\x3e returning isOrderOK true && isisReenteringOK() true"), !0;
    }
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === f && (b = y.getSmallestContainingGroup(b), !0 === D.isLinkInGroup(b, g) && !1 === D.isGroupOrdered(b) && !0 === m(b, c, d))) {
      return !1;
    }
  ...
  this.getStartNode = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + z);
    return z;
  };
  ...
  this.getStudentStartsHereNode = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + B);
    return B;
  };
  ...
  this.getExampleTracer = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning " + w);
    return w;
  };
  ...
  this.getVisualData = function() {
    y.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + q);
    return q;
  };
  ...
  (function(a, b) {
    ...
    C = {};
    if (null === D || "undefined" === typeof D) {
      D = new CTATDefaultGroupModel, y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    D.clear();
    ...
    w = new CTATExampleTracerTracer(y, c);
...
var CTATMessageTank = function(a, b) {
  function c(a) {
    l.ctatdebug("entering updateProblemSummary()");
    a && f.forEach(function(b) {
      if (b.msgType == CTATMsgType.ASSOCIATED_RULES) {
        var c = b.evt;
        l.ctatdebug("entering updateProblemSummaryWithEvent(" + c + ")");
        if (c) {
          b = c.getResult();
          ...
          l.ctatdebug("updateProblemSummary() Completion status " + e + ", doneStep " + g + ", correct " + f);
          ...
          e = c.getActor();
          l.ctatdebug("updateProblemSummmary() actor " + e + ", indicatorObj " + b);
  ...
  function e(a) {
    switch(l.suppressFeedback(a, d.getFeedbackPolicy())) {
      case CTATMsgType.SHOW_ALL_FEEDBACK:
        return !1;
      case CTATMsgType.DELAY_FEEDBACK:
        a = a.msg;
        var b = CTATMsgType.getProperty(a, "Selection");
        l.ctatdebug("CTATMessageTank.addToDelayedFeedbackTank(\n  " + a + ") selection " + b);
        b && (d.getDelayedFeedback()[b.toLowerCase()] = a);
        return !0;
      case CTATMsgType.HIDE_ALL_FEEDBACK:
        return !0;
  ...
  this.enqueueToolActionToStudent = function(a, b, c, e) {
    l.ctatdebug("Entering enqueueToolActionToStudent(" + a + ", " + b + ", " + c + ", " + e + ")");
    var f = CTATMsgType.INTERFACE_ACTION;
    l.ctatdebug("entering enqueueMessageToStudent()");
    ...
    l.addToMessageTank(f, b, e, a);
    return g;
  };
  this.addToMessageTank = function(a, b, c, d) {
    l.ctatdebug("Entering addToMessageTank(" + a + ", " + b + ", " + c + ")");
    if (b) {
      f || (f = [], h = {}, k = {});
      var e = {};
      e.msgType = a;
      ...
      k[a] = k[a] ? k[a] + 1 : 1;
      l.ctatdebug("Exiting addToMessageTank() this " + l.toString());
    }
  };
  this.flushMessageTank = function(a, b) {
    l.ctatdebug("Entering flushMessageTank(" + a + ", " + b + ")");
    if (f && !(1 > f.length)) {
      c(a);
      l.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + f.length + ", transaction_id " + n);
      for (var m = [], w = [], x = 0;x < f.length;++x) {
        var A = f[x];
        if (A.msg) {
          var C = A.msgType, z = A.evt;
          l.ctatdebug("entering processInterfaceVariables() msgType " + C + ", evt " + z);
          C && (l.ctatdebug("entering processInterfaceVariables() et " + d + ", tracer " + (d ? d.getTracer() : null)), C = C.toLowerCase(), 0 !== C.indexOf("correct") && 0 !== C.indexOf("interfaceaction") || d.getTracer().addInterfaceVariablesFromEvent(z));
          if (!(C = e(A))) {
            var C = A, z = w, B = void 0, u = void 0;
            if (!(C && C.sai && (B = C.sai.getAction()) && (u = p.exec(B))) || 3 > u.length || 1 >= u[2]) {
              C = !1;
            } else {
              var E = z.length - 1, E = 0 > E ? null : z[E];
              C.msg = C.msg.replace(B, u[1]);
              E && E.timeout == u[2] ? E.msgTuples.push(C) : z.push({timeout:Number(u[2]), msgTuples:[C]});
              C = !0;
            }
          }
          C || m.push(A.msg);
      ...
      l.ctatdebug("flushMessageTank(): msgBundle.length " + m.length + ", delayedMsgsBundle.length " + w.length);
      for (x = 0;x < w.length;++x) {
        A = w[x], l.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + A.timeout + ", .msgTuples.length " + A.msgTuples.length), setTimeout(g, A.timeout, d, A.msgTuples);
      }
      0 < m.length && (l.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + m.length + " via " + d), d.sendBundle(m) && (l.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes " + k + ", msgTypes " + h), (k[CTATExampleTracerLink.CORRECT_ACTION] || k[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || h.CorrectAction || h.InterfaceAction || h.UntutoredAction) && d.getOutputStatus().isSendingSavedMsgsForRestore() && (CTATGlobalFunctions.isInstructorMode() ? l.ctatdebug("We're in reviewer mode: we shouldn't save as we go") : 
      d.getProblemStateSaver().saveAsYouGo(a))), l.ctatdebug("Exiting flushMessageTank() #CorrectAction " + h.CorrectAction + ", #InterfaceAction " + h.InterfaceAction + ", #UntutoredAction " + h.UntutoredAction));
      h = f = n = null;
    }
  };
  this.flushDelayedFeedback = function() {
    l.ctatdebug("Entering flushDelayedFeedback()");
    var a = d.getDelayedFeedback(), b;
    for (b in a) {
      a.hasOwnProperty(b) && CTAT.ToolTutor.sendToInterface(a[b]);
    }
    d.clearDelayedFeedback();
  };
  this.suppressFeedback = function(a, b) {
    l.ctatdebug("CTATMessageTank.suppressFeedback(" + a.msgType + ", " + b + ")");
    var c = null;
    b == CTATMsgType.SHOW_ALL_FEEDBACK ? (l.ctatdebug("if.1"), c = b) : CTATMsgType.hasTextFeedback(a.msgType) ? (l.ctatdebug("if.2"), b == CTATMsgType.HIDE_ALL_FEEDBACK || b == CTATMsgType.HIDE_BUT_ENFORCE ? (l.ctatdebug("if.2.1"), c = b) : (l.ctatdebug("if.2.2"), (c = CTATMsgType.getProperty(a.msg, CTATMsgType.BUGGY_MSG)) && -1 != c.toLowerCase().indexOf(CTATMsgType.NOT_DONE_MSG.toLowerCase()) ? (l.ctatdebug("if.2.2.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (l.ctatdebug("if.2.2.2"), c = CTATMsgType.HIDE_ALL_FEEDBACK))) : 
    CTATMsgType.isCorrectOrIncorrect(a.msgType) ? (l.ctatdebug("if.3: " + a.msg), CTATMsgType.isDoneMessage(a.msg) ? (l.ctatdebug("if.3.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (l.ctatdebug("if.3.2"), c = b)) : (l.ctatdebug("if.4"), c = CTATMsgType.SHOW_ALL_FEEDBACK);
    l.ctatdebug("CTATMessageTank.suppressFeedback() returning " + c);
    return c;
  };
};
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, m, p = a = -1, u = CTATMsgType.DEFAULT_ACTOR, E = !1, q = 0;q < e.length;q++) {
      ...
      if ("rule" === f.getElementName(e[q])) {
        for (var D = f.getElementChildren(e[q]), F = 0;F < D.length;F++) {
          "text" === f.getElementName(D[F]) && c.addSkillName(f.getNodeTextValue(D[F]).toString());
        }
      }
      if ("actionLabel" === f.getElementName(e[q])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[q], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[q], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[q], "maxTraversals")), D = f.getElementChildren(e[q]), F = 0;F < D.length;F++) {
          "uniqueID" === f.getElementName(D[F]) && (m = f.getNodeTextValue(D[F]), c.setUniqueID(parseInt(f.getNodeTextValue(D[F]))));
          "message" === f.getElementName(D[F]) && (l = new CTATMessage(D[F]));
          "actionType" === f.getElementName(D[F]) && c.setActionType(f.getNodeTextValue(D[F]));
          "buggyMessage" === f.getElementName(D[F]) && c.setBuggyMsg(f.getNodeTextValue(D[F]));
          "successMessage" === f.getElementName(D[F]) && c.setSuccessMsg(f.getNodeTextValue(D[F]));
          "hintMessage" === f.getElementName(D[F]) && c.addHint(f.getNodeTextValue(D[F]));
          if ("matchers" === f.getElementName(D[F])) {
            for (var y = f.getElementChildren(D[F]), G = 0;G < y.length;G++) {
              "Selection" === f.getElementName(y[G]) && (g = b(y[G], 0)), "Action" === f.getElementName(y[G]) && (h = b(y[G], 1)), "Input" === f.getElementName(y[G]) && (k = b(y[G], 2)), "Actor" === f.getElementName(y[G]) && (u = f.getNodeTextValue(y[G]), E = (E = f.getElementAttr(y[G], "linkTriggered")) && "false" != E.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === f.getElementName(D[F])) {
            h = D[F];
            g = f.getElementAttr(h, "replacementFormula");
            h = f.getElementChildren(h);
            var G = y = u = k = void 0, I = CTATMsgType.DEFAULT_ACTOR;
            ...
            for (var u = new CTATExactMatcher(CTATMatcher.ACTION, null), H = 0;H < h.length;H++) {
              ...
              "matcherParameter" === f.getElementName(h[H])) {
                var K = f.getElementAttr(h[H], "name");
                "selection" == K && k.setParameter(f.getNodeTextValue(h[H]));
                "action" == K && u.setParameter(f.getNodeTextValue(h[H]));
                "input" == K && (y = y ? y : new G(CTATMatcher.INPUT, null), y.setParameter(f.getNodeTextValue(h[H])));
                "actor" == K && (I = f.getNodeTextValue(h[H]));
                "minimum" == K && (y = y ? y : new G(CTATMatcher.INPUT, null), y.setParameter(f.getNodeTextValue(h[H]), "minimum"));
                "maximum" == K && (y = y ? y : new G(CTATMatcher.INPUT, null), y.setParameter(f.getNodeTextValue(h[H]), "maximum"));
              }
            }
            y.setReplacementFormula(g);
            u = [[k], [u], [y], I];
            g = u[0];
            h = u[1];
            k = u[2];
    ...
    d.getStartNode() && p == d.getStartNode().getNodeID() && console.log("***WARNING*** edge " + m + " destination is graph startNode " + d.getStartNode());
    m = new CTATVectorMatcher(g, h, k, u);
    m.setDefaultSAI(l.getSAI());
    m.setCaseInsensitive(n);
    m.setLinkTriggered(E);
    c.setMatcher(m);
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      d.add(a);
    }, k = f.getElementChildren(a), l = 0;l < k.length;l++) {
      if ("link" === f.getElementName(k[l])) {
        var n = Number(f.getElementAttr(k[l], "id")), p = b[n];
        if (null !== p || void 0 !== p) {
          ctatdebug("Added link ID : " + n), d.add(p);
        }
      }
      "group" === f.getElementName(k[l]) && (ctatdebug("encountered a subgroup"), c(k[l], b).forEach(h));
    }
    m.addGroup(e, g, d);
    m.setGroupReenterable(m.getGroupByName(e), !0);
    return d;
  }
  ...
  this.parseGraph = function(b, e) {
    ...
    l = f.getElementAttr(b, "lockWidget");
    var A = new CTATVariableTable;
    d = new CTATExampleTracerGraph(x, !1, A);
    var C = f.getElementChildren(b), A = f.getElementAttr(b, "suppressStudentFeedback");
    if (null === A || void 0 === A) {
      A = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    d.setFeedbackPolicy(A);
    e.setFeedbackSuppressed(A);
    A = f.getElementAttr(b, "highlightRightSelection");
    e.setHighlightRightSelection("false" != A);
    var z = f.getElementAttr(b, "confirmDone");
    "true" !== z && "false" !== z && (z = d.getFeedbackPolicy() === CTATMsgType.HIDE_ALL_FEEDBACK ? "true" : "false");
    ...
    for (var B = null, u = 0;u < C.length;u++) {
      switch(f.getElementName(C[u])) {
        case "startNodeMessages":
          k = f.getElementChildren(C[u]);
          break;
        case "node":
          t++;
          var E;
          E = C[u];
          ctatdebug("processNode(" + E + ")");
          var q = f.getElementChildren(E), D = -1;
          E = "";
          for (var F = 0;F < q.length;F++) {
            switch(f.getElementName(q[F])) {
              case "uniqueID":
                D = parseInt(f.getNodeTextValue(q[F]));
                break;
              case "text":
                E = f.getNodeTextValue(q[F]);
            }
          }
          q = new CTATExampleTracerNode(D, new Set);
          "" !== E && q.setNodeName(E);
          E = q;
          d.addNode(E);
          1 == t && (d.setStartNode(E), d.setStudentStartsHereNode(E));
          E.getNodeName() == w && d.setStudentStartsHereNode(E);
          break;
        case "edge":
          d.addLink(a(C[u]));
          break;
        ...
        case "productionRule":
          ...
          E = void 0;
          for (var F = "unknown", q = void 0, D = null, y = f.getElementChildren(y), G = 0;G < y.length;G++) {
            var I = f.getElementName(y[G]);
            "ruleName" === I && (E = f.getNodeTextValue(y[G]), ctatdebug("ruleName=" + E));
            "productionSet" === I && (F = f.getNodeTextValue(y[G]), ctatdebug("productionSet=" + F));
            "label" === I && (q = f.getNodeTextValue(y[G]), ctatdebug("label=" + F));
            "description" === I && (D = f.getNodeTextValue(y[G]), ctatdebug("description=" + F));
          }
          F = new CTATExampleTracerSkill(F, E, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN);
          null != q ? F.setLabel(q) : F.setLabel(E);
          null != D ? F.setDescription(D) : F.setDescription(E);
          p.push(F);
      }
    }
    if (B) {
      ...
      for (C = 0;C < w.length;C++) {
        switch(f.getElementName(w[C])) {
          case "group":
            c(w[C], t);
            break;
          case "outOfOrderMessage":
            m.getTopLevelGroup().setDefaultBuggyMsg(f.getNodeTextValue(w[C]));
        }
      }
    }
    t = e.getSkillBarVector();
    if (!t || 1 > t.length) {
      ctatdebug("No existing skills. Add skills from BRD."), e.addGraphSkills(p), t = e.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(n, x, l, e.isFeedbackSuppressed(), A, z, t);
    d.redoLinkDepths();
...
var CTATExampleTracer = function() {
  function a() {
    l.ctatdebug("workTheQueue() working " + G + ", workQueue.length " + y.length + ", restoreQueue.length " + F.length);
    if (0 == G) {
      for (;0 != (G = 0 < y.length | (0 < F.length) << 1);) {
        var a = null, c = !1;
        0 < F.length ? (a = F.shift(), c = !0) : a = y.shift();
        if (!b(a, c)) {
          l.ctatdebug("workTheQueue() suspending workQueue.length " + y.length + ", restoreQueue.length " + F.length);
          l.setWorking(c ? 1 : 0, !0);
          break;
        }
        l.ctatdebug("workTheQueue() bottom workQueue.length " + y.length + ", restoreQueue.length " + F.length);
      }
    }
  }
  function b(a, b) {
    l.lastMessageAsString = a;
    var d = l.lastMessageAsXML = (new CTATXML).parseXML(a), f = l.lastMessage = new CTATMessage(d), h = f.getMessageType();
    l.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType " + h + ")");
    switch(h) {
      case CTATMsgType.SET_PREFERENCES:
        return c(a, f, w, d), !1;
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && l.sendBundle([a]), e(a, f, w, d), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && l.sendBundle([a]), g(a, f, w, d), !0;
      case CTATMsgType.PROBLEM_SUMMARY_REQUEST:
        return setTimeout(function(a) {
          a = l.getProblemSummary();
          l.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() " + l.getProblemSummary());
          ...
          d.push(c);
          l.sendBundle(d);
          D.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE, a.getCompletionStatus());
          l.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '" + c + "';");
          l.setWorking(b ? 1 : 0, !1);
        }, 4E3), !1;
      case CTATMsgType.START_STATE_END:
        return D.transition(CTATMsgType.START_STATE_END), !0;
      case CTATMsgType.PROBLEM_RESTORE_END:
        return n(), !0;
      default:
        return console.log("CTATExampleTracer.handleMessageFromInterface(restoring " + b + ") " + (b ? "sending" : "unprocessed") + " message, type " + h + "\n  " + a), b && l.sendBundle([a]), !0;
    }
  }
  function c(a, b, c, d) {
    l.ctatdebug("SetPreferences received: " + a);
    I = !1;
    u = b.getProperty("problem_name");
    l.ctatdebug("SetPreferences.problem_name = " + u);
    a = c.getElementChildren(c.getElementChildren(d)[1]);
    for (b = 0;b < a.length;b++) {
      if (d = c.getElementName(a[b]), l.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          case "question_file":
            p = c.getNodeTextValue(a[b]);
            break;
          case "skills":
            l.ctatdebug(" parseSkills(" + a[b] + ")");
            d = [];
            for (var e = w.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              var g = w.getElementName(e[f]);
              if (g && "skill" == g.toLowerCase()) {
                var h = w.getElementAttr(e[f], "name");
                if (h && "" != h.trim()) {
                  var g = w.getElementAttr(e[f], "label"), k = w.getElementAttr(e[f], "pSlip"), m = w.getElementAttr(e[f], "description"), n = w.getElementAttr(e[f], "pKnown"), r = w.getElementAttr(e[f], "category"), v = w.getElementAttr(e[f], "pLearn"), t = w.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(r, h, t, n, k, v);
                  h.setLabel(g);
                  h.setDescription(m);
                  d.push(h);
                }
            ...
            l.getProblemSummary().setSkills(new CTATSkills(d));
            break;
          case "problem_state_status":
            D.transition(CTATMsgType.SET_PREFERENCES, c.getNodeTextValue(a[b]));
            q || (q = new ProblemStateRestorer(l));
            l.ctatdebug("SetPreferences problemStateRestorer " + q);
            break;
          case "curriculum_service_url":
            E.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
          case "restore_problem_url":
            q || (q = new ProblemStateRestorer(l));
            l.ctatdebug("SetPreferences problemStateRestorer " + q);
            q.setRestoreProblemUrl(c.getNodeTextValue(a[b]));
            break;
          case "session_id":
            H = c.getNodeTextValue(a[b]);
            break;
          case "authenticity_token":
            E.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    l.ctatdebug("questionFile " + p + ", outputStatus " + D + ", problemStateRestorer " + q);
    a = p;
    l.ctatdebug("retrieveBRD (" + a + ")");
    P.retrieveXMLFile(a, c, l);
    q && q.retrieveMessages(D);
  }
  function e(a, b, c, d) {
    b = b.getTransactionID();
    l.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    E.appendToProblemState(a, l.getOutputStatus(), !1);
    if (!I) {
      return !1;
    }
    l.setVariablesFromSAI(d, c);
    return !0;
  }
  function g(a, b, c, d) {
    l.ctatdebug("Interface action received.");
    c = b.getTransactionID();
    if (!I) {
      return !1;
    }
    l.messageTank = new CTATMessageTank(l, c);
    l.ctatdebug("MessageTank " + l.messageTank);
    l.ctatdebug("InterfaceAction (" + a + "), getTransactionID " + c);
    d = b.getSelectionArray().slice(0);
    var e = b.getActionArray().slice(0);
    l.ctatdebug("selectionArray " + d + ", message.getSelectionArray() " + b.getSelectionArray());
    !d[0] || "hint" != d[0].toLowerCase() && "help" != d[0].toLowerCase() ? (l.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), k(null, b.getSAI(), "student", !0, c, a)) : (l.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + A + ", errorSAI " + x), A === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < d.length && (d[1] = ""), 1 < e.length && (e[1] = "")) : A !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (A === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? x && x.getSelection() ? (d.splice(1, 0, x.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : A === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && x && x.getSelection() && (d.splice(1, 0, x.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), l.startSkillTransaction(), a = [], d = v.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), b.setStepID(d.getUniqueID()), l.updateSkills(CTATExampleTracerSkill.HINT, 
    d.getSkillNames(), d.getUniqueID()), l.ctatdebug("Before building hint message: tutorSAI " + b.getTutorSAI() + ", hints " + a + ", edge # " + d.getUniqueID()), e = (new CTATTutorMessageBuilder).createHintMessage(a, b.getTutorSAI(), d.getUniqueID(), c), l.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE, e, b, null), c = (new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(a, b.getTutorSAI(), m(CTATMsgType.DEFAULT_STUDENT_ACTOR), l.getSkillBarVector(!0), d.getUniqueID(), 
    c), l.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, c, b, null), c = l.getProblemSummary(b.getReportableInterpretation()), l.messageTank.flushMessageTank(c, !0), l.ctatdebug("handleInterfaceAction() sent hint result " + b), x = null);
    return !0;
  }
  function d(a, b, c) {
    ...
    l.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()");
    ...
    l.ctatdebug("CTATET.createBuggyMessage() past isDoneStepFailed()");
    ...
    l.ctatdebug("CTATET.createBuggyMessage() past hintSelection0 " + e + ", studentSelection0 " + f);
    if (a.getResult() == CTATExampleTracerLink.NO_MODEL && a.isOutOfOrder() && e && e != f) {
      return l.ctatdebug("CTATET.createBuggyMessage() to create out of order"), l.isHighlightRightSelection() ? (d.tutorAdvice = l.getOutOfOrderMessage(), d.msg = c.createHighlightWidgetMessage(e, b.getTutorSAI().getAction(), d.tutorAdvice, a.getTransactionID()), d.msgType = "HighlightMsg", l.ctatdebug("createBuggyMessage() out of order with highlight; rtn: " + d)) : (d.tutorAdvice = CTATGlobals.languageManager.getString("OUTOFORDER"), d.msg = c.createBuggyMessage(a.getTransactionID, d.tutorAdvice), 
      d.msgType = "BuggyMessage", l.ctatdebug("createBuggyMessage() out of order without highlight; rtn: " + d)), d;
    }
    if (b = t.getDefaultBuggyMsg()) {
      return d.tutorAdvice = b, d.msg = c.createBuggyMessage(a.getTransactionID, d.tutorAdvice), d.msgType = "BuggyMessage", l.ctatdebug("createBuggyMessage() default buggy msg: " + d), d;
    }
    l.ctatdebug("createBuggyMessage() no buggy msg: " + d);
    return d;
  }
  function f(a, b, c, d) {
    l.ctatdebug("checkForTutorAction(" + a + ", " + b + ", " + c + ", " + d + ")");
    var e = [];
    e[0] = h(t.getNode(a), !0);
    e[1] = h(t.getNode(b), !1);
    l.ctatdebug("checkForTutorAction() links[0] " + e[0] + ", links[1] " + e[1] + ";");
    a = 0;
    if (e[0] === e[1]) {
      e[1] = null;
    } else {
    ...
    b = null;
    l.messageTank || (l.messageTank = new CTATMessageTank(l, null));
    ...
    l.ctatdebug("checkForTutorAction() returning " + b + ";");
    return b;
  }
  function h(a, b) {
  ...
  function k(a, b, c, e, g, h) {
    l.ctatdebug("doNewExampleTrace (link " + a + ", sai " + b + ", actor " + c + ", doTutorPerformedSteps " + e + ", transactionID " + g + ", origMsgTxt " + h);
    l.startSkillTransaction();
    var k = new CTATExampleTracerEvent(l, b, c);
    a && k.addPreloadedLinkMatch(a);
    var n = v.evaluate(k);
    l.ctatdebug("Evaluate returned : " + n + ", given link " + a + ", result " + k);
    a ? (l.ctatdebug("result.getTutorSelection() " + k.getTutorSelection()), l.ctatdebug("result.getTutorAction() " + k.getTutorAction()), l.ctatdebug("result.getTutorInput() " + k.getTutorInput()), l.ctatdebug("typeof(messageTank) " + typeof messageTank), g = k.getTutorSelection(), h = k.getTutorAction(), n = k.getTutorInput(), (g = l.messageTank.enqueueToolActionToStudent(g, h, n, CTATTutorMessageBuilder.TUTOR_PERFORMED)) && l.messageTank.setTransaction_id(g)) : k.getResult() != CTATExampleTracerLink.CORRECT_ACTION && 
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || E.appendToProblemState(h, l.getOutputStatus(), !1);
    k.setTransactionID(g);
    var p;
    l.ctatdebug("finishNewExampleTrace(" + k + ", " + b + ", " + c + ", " + e + ")");
    h = k.getStudentSAI();
    var n = k.getTutorSAI(), q = k.getTransactionID(), r = new CTATTutorMessageBuilder, t = [];
    null !== k.getReportableLink() && "undefined" !== typeof k.getReportableLink() ? t[0] = k.getReportableLink() : t[0] = null;
    var t = t[0], u = null;
    if (k.isSolverResult()) {
      k.getResult();
    } else {
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        p = t ? "" + t.getUniqueID() : "", k.setStepID(p), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && l.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, r.createCorrectActionMessage(q, n), k, n), null !== t && "undefined" !== typeof t && l.updateSkills(CTATExampleTracerSkill.CORRECT, t.getSkillNames(), t.getUniqueID()), p = k.getSuccessOrBuggyMsg(), l.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), 
        n, m(c), h, l.getSkillBarVector(!0, c), t.getUniqueID(), q, p), k, n), l.ctatdebug("finishNewExampleTrace() successMsg " + p), p && l.messageTank.addToMessageTank("SuccessMessage", r.createSuccessMessage(q, p), k, null), x = null, e && (u = f(t ? t.getNextNode() : null, v.findCurrentState(!1, !1), l.lastMessage ? l.lastMessage.getSAI() : null, k)) && (k = u);
      } else {
        l.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, r.createInCorrectActionMessage(q, k.getInterpolatedSAI()), k, null);
        l.ctatdebug("about to do silent traceForHint(" + h + "), selectionArray " + h.getSelectionArray());
        var w = l.lastSilentHintResult = new CTATExampleTracerEvent(l, h, c);
        w.setHintRequest(!0);
        u = v.traceForHint(w);
        l.ctatdebug("silent hint result: " + w + "; hintLink " + u);
        u || (u = v.getBestNextLink(!1, w), l.ctatdebug("getBestNextLink result: " + w + "; hintLink " + u));
        n = w ? w.getTutorSAI() : null;
        u && (p = "" + u.getUniqueID(), k.setStepID(p));
        w = d(k, w, r);
        l.ctatdebug("createBuggyMessage() tutorAdvice: " + w.tutorAdvice + ";\n  msg " + w.msg);
        l.updateSkills(CTATExampleTracerSkill.INCORRECT, u.getSkillNames(), u.getUniqueID());
        l.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), n && n.getSelection() ? n : h, m(c), h, l.getSkillBarVector(!0, c), p, q, w.tutorAdvice), k, null);
        w.msg && l.messageTank.addToMessageTank(w.msgType, w.msg, k);
        x = h;
        e && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() ? (u = f(t ? t.getNextNode() : null, v.findCurrentState(!1, !1), l.lastMessage ? l.lastMessage.getSAI() : null, k)) && (k = u) : k.isDoneStepFailed() && l.messageTank.flushDelayedFeedback();
      }
    }
    l.lastResult = k;
    p = l.getProblemSummary(k.getReportableInterpretation());
    l.ctatdebug("finishNewExampleTrace() to flushMessageTank");
    l.messageTank.flushMessageTank(p, !0);
    l.ctatdebug("finishNewExampleTrace() sent result " + k.getResult() + ", studentSAI " + h);
    p = k;
    l.ctatdebug("doNewExampleTrace(" + a + ", " + b + ", " + c + ", " + e + ", " + g + ") returns " + p);
    return p;
  }
  function m(a) {
  ...
  function n() {
    D.transition(CTATMsgType.PROBLEM_RESTORE_END);
    var a = l.getSkillBarVector(), b = [], c = new CTATTutorMessageBuilder;
  ...
  var l = this, p = null, v, r, t, w = new CTATXML;
  new XMLSerializer;
  var x = null, A, C = !0, z = !1, B = null, u = null, E = new ProblemStateSaver(l);
  E.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var q = null, D = new CTATProblemStateStatus, F = [], y = [], G = 0, I = !1, H = "", K = null;
  l.ctatdebug("CTATExampleTracer constructor outputStatus=" + D);
  ...
  var P = new CTATCommLibrary;
  this.receiveFromInterface = function(b) {
    l.ctatdebug("CTATExampleTracer.receiveFromInterface(" + b + ")");
    y.push(b);
    a();
  };
  this.setVariablesFromSAI = function(a, b) {
    var c = CTATMsgType.getSAIArraysFromElement(a, b);
    l.getTracer() && l.getTracer().addInterfaceVariables(c.selection, c.input);
  };
  this.traceLinks = function(a) {
    for (var b = [], c = 0;c < a.length && null != a[c];++c) {
      l.messageTank = new CTATMessageTank(l, null), b.push(k(a[c], a[c].getDefaultSAI(), a[c].getActor(), !1, null)), l.ctatdebug("traceLinks[" + c + "] result " + b[c]);
    }
    return b;
  };
  this.enqueueForRestore = function(a) {
    l.ctatdebug("enqueueForRestore: got " + a.length + " message elements");
    F = F.concat(a);
  ...
  this.processXML = function(a) {
    l.ctatdebug("processXML ()");
    if (null != a) {
      l.ctatdebug("No of children" + w.getElementChildren(a).length);
      var b = new CTATGraphParser, c = b.parseGraph(a, l);
      t = c.gr;
      v = c.tracer;
      a = c.ssm;
      var d = c.sgMsg;
      l.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + D);
      for (var c = [], e = new XMLSerializer, g = null, h = 0;h < a.length;h++) {
        if ("message" == w.getElementName(a[h])) {
          var k = e.serializeToString(a[h]), m = CTATMsgType.getMessageType(k);
          CTATMsgType.UNTUTORED_ACTION != m && CTATMsgType.INTERFACE_ACTION != m || l.setVariablesFromSAI(a[h], w);
          CTATMsgType.START_STATE_END == m ? g = k : c.push(k);
        }
      }
      d = c.unshift(d);
      g && (e = new CTATTutorMessageBuilder, c.splice(d, 0, e.createLockWidgetMsg(b.getLockWidget())));
      l.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + D);
      l.sendBundle(c);
      b = g;
      a = [];
      c = t.getStartNode();
      g = t.getStudentStartsHereNode();
      null != c && null != g && c.getNodeID() != g.getNodeID() && (a = t.getBestSubpath(c, g), l.ctatdebug("advanceToStudentStartsHere() path " + a), a = a.getSortedLinks(), a = l.traceLinks(a), l.ctatdebug("advanceToStudentStartsHere() results " + a));
      g = c = null;
      0 < a.length && (g = a[a.length - 1], a = g.getReportableLink(), null != a && (c = a.getNextNode()));
      l.ctatdebug("advanceToStudentStartsHere() to check for TPA " + c + ", " + g);
      f(c, v.findCurrentState(!1, !1), null, g);
      b && !D.isIncomplete() && l.sendBundle([b]);
      I = !0;
    }
    l.setWorking(0, !1);
  };
  this.addGraphSkills = function(a) {
    l.ctatdebug("adding graph skills: " + a.length);
    0 < a.length && (a = new CTATSkills(a), a.setExternallyDefined(!1), l.getProblemSummary().setSkills(a));
  };
  this.sendBundle = function(a) {
    l.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + D);
    for (var b = 0, c = 0;c < a.length;c++) {
      l.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      E.forwardToInterface(d, c >= a.length - 1, D) && ++b;
    }
    return 0 < b;
  };
  this.setHintPolicy = function(a) {
    A = CTATHintPolicyEnum.lookup(a);
  };
  ...
  this.updateSkills = function(a, b, c) {
    var d = [];
    l.ctatdebug("in updateSkills(" + b + ") with step ID = " + c + ", transaction result = " + a);
    var e = l.getProblemSummary().getSkills();
    if (null === e || "undefined" === typeof e) {
      return d;
    }
    b.forEach(function(b) {
  ...
  this.getProblemSummary = function(a) {
    l.ctatdebug("Entering getProblemSummary() problemSummary " + B);
    if (null === B || "undefined" === typeof B) {
      var b = l.getProblemName();
      if (null === b || "undefined" === typeof b || 1 > b.length) {
        b = "NoProblemDefined";
      }
      B = new CTATProblemSummary(b, null, l.isFeedbackSuppressed());
    }
    a && B.setRequiredSteps(a.countStepsForScore(t));
    return B;
  };
  ...
  this.setFeedbackSuppressed = function(a) {
    z = "false" === a ? !1 : "true" === a ? !0 : a === CTATMsgType.SHOW_ALL_FEEDBACK ? !1 : a === CTATMsgType.HIDE_ALL_FEEDBACK ? !0 : a === CTATMsgType.HIDE_BUT_ENFORCE ? !0 : a === CTATMsgType.HIDE_BUT_COMPLETE ? !0 : a === CTATMsgType.DELAY_FEEDBACK ? !0 : !1;
    l.ctatdebug("setFeedbackSuppressed(" + a + "): " + z);
  };
  this.getSkillBarVector = function(a, b) {
    var c = l.getProblemSummary().getSkills();
    return null === c || "undefined" === typeof c ? null : "Student" != m(b) ? null : "undefined" != typeof a && a ? c.getSkillBarVector(!1, !1) : c.getSkillBarVector(!0, !0);
  };
  this.startSkillTransaction = function() {
    var a = l.getProblemSummary().getSkills();
  ...
  this.setOutputStatus = function(a) {
    var b = D.getStatus();
    l.ctatdebug("setOutputStatus() old " + b + ", new " + a);
    CTATProblemStateStatus[a] ? D.setStatus(CTATProblemStateStatus[a]) : (console.error("CTATExampleTracer.setOutputStatus() unexpected argument " + a), D.setStatus(CTATProblemStateStatus.empty));
  };
  this.getFeedbackPolicy = function() {
